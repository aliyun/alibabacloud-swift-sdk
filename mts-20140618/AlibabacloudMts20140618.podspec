Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudMts20140618"
  spec.version      = "4.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ApsaraVideo for Media Processing (20140618) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/mts-20140618" 
