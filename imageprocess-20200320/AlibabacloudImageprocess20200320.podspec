Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudImageprocess20200320"
  spec.version      = "1.1.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud imageprocess (20200320) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/imageprocess-20200320" 
