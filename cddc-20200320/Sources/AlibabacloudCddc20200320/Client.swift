...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func createDedicatedHostWithOptions(_ request: CreateDedicatedHostRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateDedicatedHostResponse {
