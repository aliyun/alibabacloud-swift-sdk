...
public class CreateAppRequest : Tea.TeaModel {
    public class Authentication : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["basicAuth"] as? [Any?] {
    ...
    public class PrivateNetwork : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["pvlEndpointId"] as? String {
                self.pvlEndpointId = value
            }
            if let value = dict["type"] as? String {
                self.type = value
            }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["authentication"] as? [String: Any?] {
        ...
        if let value = dict["network"] as? [Any?] {
        ...
        if let value = dict["privateNetwork"] as? [Any?] {
...
public class CreateAppResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["instaneId"] as? String {
                self.instaneId = value
            }
        }
    }
    public var requestId: String?
...
public class CreateEndpointRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["endpointZones"] as? [Any?] {
...
public class GetAppRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["detailed"] as? Bool {
            self.detailed = value
        }
    }
}
...
public class GetAppQuotaResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public class LimiterInfo : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["limiters"] as? [Any?] {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["limiterInfo"] as? [String: Any?] {
...
public class GetSpecReviewTaskResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["applyLimiter"] as? [String: Any] {
                self.applyLimiter = value
            }
            if let value = dict["applyQuota"] as? [String: Any] {
                self.applyQuota = value
            }
            if let value = dict["applyReason"] as? String {
                self.applyReason = value
            }
            if let value = dict["effectiveLimiter"] as? [String: Any] {
                self.effectiveLimiter = value
            }
            if let value = dict["effectiveQuota"] as? [String: Any] {
                self.effectiveQuota = value
            }
            ...
            if let value = dict["oldLimiter"] as? [String: Any] {
                self.oldLimiter = value
            }
            if let value = dict["oldQuota"] as? [String: Any] {
                self.oldQuota = value
            }
...
public class ListAppsResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        ...
        public var tags: [ListAppsResponseBody.Result.Tags]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["tags"] as? [Any?] {
                var tmp : [ListAppsResponseBody.Result.Tags] = []
                for v in value {
                    if v != nil {
                        var model = ListAppsResponseBody.Result.Tags()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class UpdateDictRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["allowCover"] as? Bool {
            self.allowCover = value
        }
...
public class UpdateNetworkRequest : Tea.TeaModel {
    public class Body : Tea.TeaModel {
        ...
        public var whiteIpGroup: [UpdateNetworkRequest.Body.WhiteIpGroup]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["whiteIpGroup"] as? [Any?] {
                var tmp : [UpdateNetworkRequest.Body.WhiteIpGroup] = []
                for v in value {
                    if v != nil {
                        var model = UpdateNetworkRequest.Body.WhiteIpGroup()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var body: [UpdateNetworkRequest.Body]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [Any?] {
            var tmp : [UpdateNetworkRequest.Body] = []
            for v in value {
                if v != nil {
                    var model = UpdateNetworkRequest.Body()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdateNetworkResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public class WhiteIpGroup : Tea.TeaModel {
            public var groupName: String?
        ...
        public var whiteIpGroup: [UpdateNetworkResponseBody.Result.WhiteIpGroup]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["whiteIpGroup"] as? [Any?] {
                var tmp : [UpdateNetworkResponseBody.Result.WhiteIpGroup] = []
                for v in value {
                    if v != nil {
                        var model = UpdateNetworkResponseBody.Result.WhiteIpGroup()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var result: [UpdateNetworkResponseBody.Result]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["result"] as? [Any?] {
            var tmp : [UpdateNetworkResponseBody.Result] = []
            for v in value {
                if v != nil {
                    var model = UpdateNetworkResponseBody.Result()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdateNetworkResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateNetworkResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateNetworkResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdatePrivateNetwrokRequest : Tea.TeaModel {
    public class Body : Tea.TeaModel {
        public class WhiteIpGroup : Tea.TeaModel {
            public var groupName: String?
        ...
        public var whiteIpGroup: [UpdatePrivateNetwrokRequest.Body.WhiteIpGroup]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["whiteIpGroup"] as? [Any?] {
                var tmp : [UpdatePrivateNetwrokRequest.Body.WhiteIpGroup] = []
                for v in value {
                    if v != nil {
                        var model = UpdatePrivateNetwrokRequest.Body.WhiteIpGroup()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var body: [UpdatePrivateNetwrokRequest.Body]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["body"] as? [Any?] {
            var tmp : [UpdatePrivateNetwrokRequest.Body] = []
            for v in value {
                if v != nil {
                    var model = UpdatePrivateNetwrokRequest.Body()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdatePrivateNetwrokResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public class WhiteIpGroup : Tea.TeaModel {
            public var groupName: String?
        ...
        public var whiteIpGroup: [UpdatePrivateNetwrokResponseBody.Result.WhiteIpGroup]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["whiteIpGroup"] as? [Any?] {
                var tmp : [UpdatePrivateNetwrokResponseBody.Result.WhiteIpGroup] = []
                for v in value {
                    if v != nil {
                        var model = UpdatePrivateNetwrokResponseBody.Result.WhiteIpGroup()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var result: [UpdatePrivateNetwrokResponseBody.Result]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["result"] as? [Any?] {
            var tmp : [UpdatePrivateNetwrokResponseBody.Result] = []
            for v in value {
                if v != nil {
                    var model = UpdatePrivateNetwrokResponseBody.Result()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdatePrivateNetwrokResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdatePrivateNetwrokResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdatePrivateNetwrokResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
