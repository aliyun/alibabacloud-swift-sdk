Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudVcs20200515"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Visual Compute Service (20200515) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/vcs-20200515" 
