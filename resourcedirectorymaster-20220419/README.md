...
```ruby
pod 'AlibabacloudResourceDirectoryMaster20220419', '~> 1.0.2'
```
...
```ogdl
github "alibabacloud-sdk-swift/resourcedirectorymaster-20220419" "1.0.2"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/resourcedirectorymaster-20220419.git", from: "1.0.2")
]
```
