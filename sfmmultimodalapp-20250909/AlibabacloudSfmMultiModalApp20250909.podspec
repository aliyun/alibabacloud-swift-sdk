Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudSfmMultiModalApp20250909"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud SfmMultiModalApp (20250909) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/sfmmultimodalapp-20250909" 
