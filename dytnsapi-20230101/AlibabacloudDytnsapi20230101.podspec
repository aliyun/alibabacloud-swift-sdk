Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDytnsapi20230101"
  spec.version      = "1.3.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Dytnsapi (20230101) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/dytnsapi-20230101" 
