Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudXrEngine20230313"
  spec.version      = "1.8.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud xrEngine (20230313) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/xrengine-20230313" 
