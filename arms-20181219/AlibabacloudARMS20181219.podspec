Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudARMS20181219"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Application Real-Time Monitoring Service (20181219) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/arms-20181219" 
