...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func disableDelegateAccountWithOptions(_ request: DisableDelegateAccountRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DisableDelegateAccountResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DisableDelegateAccountResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func disableDelegateAccount(_ request: DisableDelegateAccountRequest) async throws -> DisableDelegateAccountResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await disableDelegateAccountWithOptions(request as! DisableDelegateAccountRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func enableDelegateAccountWithOptions(_ request: EnableDelegateAccountRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> EnableDelegateAccountResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accountId)) {
            query["AccountId"] = request.accountId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(EnableDelegateAccountResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func enableDelegateAccount(_ request: EnableDelegateAccountRequest) async throws -> EnableDelegateAccountResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await enableDelegateAccountWithOptions(request as! EnableDelegateAccountRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAttributePassingSettingWithOptions(_ request: GetAttributePassingSettingRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAttributePassingSettingResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.directoryId)) {
            query["DirectoryId"] = request.directoryId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAttributePassingSettingResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAttributePassingSetting(_ request: GetAttributePassingSettingRequest) async throws -> GetAttributePassingSettingResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAttributePassingSettingWithOptions(request as! GetAttributePassingSettingRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func setLoginPreferenceWithOptions(_ request: SetLoginPreferenceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SetLoginPreferenceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.allowUserToGetCredentials)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateAttributePassingSettingWithOptions(_ request: UpdateAttributePassingSettingRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateAttributePassingSettingResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.directoryId)) {
            query["DirectoryId"] = request.directoryId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.sourceIdentityPassing)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateAttributePassingSettingResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateAttributePassingSetting(_ request: UpdateAttributePassingSettingRequest) async throws -> UpdateAttributePassingSettingResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateAttributePassingSettingWithOptions(request as! UpdateAttributePassingSettingRequest, runtime as! TeaUtils.RuntimeOptions)
    }
