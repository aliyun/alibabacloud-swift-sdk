...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addCreditSeatsWithOptions(_ request: AddCreditSeatsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddCreditSeatsResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.seats)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddCreditSeatsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addCreditSeats(_ request: AddCreditSeatsRequest) async throws -> AddCreditSeatsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await addCreditSeatsWithOptions(request as! AddCreditSeatsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createCreditSeatWithOptions(_ request: CreateCreditSeatRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateCreditSeatResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.subscriptionConfigs)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateCreditSeatResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createCreditSeat(_ request: CreateCreditSeatRequest) async throws -> CreateCreditSeatResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createCreditSeatWithOptions(request as! CreateCreditSeatRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDeductLogsWithOptions(_ tmpReq: DescribeDeductLogsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeDeductLogsResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: DescribeDeductLogsShrinkRequest = DescribeDeductLogsShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.ecIdAccountIds)) {
            request.ecIdAccountIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.ecIdAccountIds, "EcIdAccountIds", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.relationAccountIds)) {
            request.relationAccountIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.relationAccountIds, "RelationAccountIds", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.billInstanceId)) {
        ...
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.billingCommodityCode)) {
            body["BillingCommodityCode"] = request.billingCommodityCode ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.billingEndTime)) {
            body["BillingEndTime"] = request.billingEndTime!;
        }
        if (!TeaUtils.Client.isUnset(request.billingStartTime)) {
        ...
        if (!TeaUtils.Client.isUnset(request.relationAccountIdsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeDeductLogsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDeductLogs(_ request: DescribeDeductLogsRequest) async throws -> DescribeDeductLogsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeDeductLogsWithOptions(request as! DescribeDeductLogsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeFrInstancesWithOptions(_ tmpReq: DescribeFrInstancesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeFrInstancesResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: DescribeFrInstancesShrinkRequest = DescribeFrInstancesShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.ecIdAccountIds)) {
            request.ecIdAccountIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.ecIdAccountIds, "EcIdAccountIds", "json")
        }
        ...
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.capacityType)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeFrInstancesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeFrInstances(_ request: DescribeFrInstancesRequest) async throws -> DescribeFrInstancesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeFrInstancesWithOptions(request as! DescribeFrInstancesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryMonthlySlaListWithOptions(_ request: QueryMonthlySlaListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryMonthlySlaListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.currentPage)) {
            query["CurrentPage"] = request.currentPage!;
        ...
        if (!TeaUtils.Client.isUnset(request.payStatuses)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryMonthlySlaListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryMonthlySlaList(_ request: QueryMonthlySlaListRequest) async throws -> QueryMonthlySlaListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryMonthlySlaListWithOptions(request as! QueryMonthlySlaListRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func reduceCreditSeatsWithOptions(_ request: ReduceCreditSeatsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ReduceCreditSeatsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
            query["ClientToken"] = request.clientToken ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ReduceCreditSeatsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func reduceCreditSeats(_ request: ReduceCreditSeatsRequest) async throws -> ReduceCreditSeatsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await reduceCreditSeatsWithOptions(request as! ReduceCreditSeatsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func renewCreditSeatWithOptions(_ request: RenewCreditSeatRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RenewCreditSeatResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.autoRenew)) {
            query["AutoRenew"] = request.autoRenew!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RenewCreditSeatResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func renewCreditSeat(_ request: RenewCreditSeatRequest) async throws -> RenewCreditSeatResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await renewCreditSeatWithOptions(request as! RenewCreditSeatRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSlaCouponApplyWithOptions(_ request: SubmitSlaCouponApplyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitSlaCouponApplyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.ecIdAccountIds)) {
            query["EcIdAccountIds"] = request.ecIdAccountIds ?? [];
        ...
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.damagedIds)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitSlaCouponApplyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSlaCouponApply(_ request: SubmitSlaCouponApplyRequest) async throws -> SubmitSlaCouponApplyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitSlaCouponApplyWithOptions(request as! SubmitSlaCouponApplyRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func upgradeCreditSeatWithOptions(_ request: UpgradeCreditSeatRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpgradeCreditSeatResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
            query["ClientToken"] = request.clientToken ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpgradeCreditSeatResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func upgradeCreditSeat(_ request: UpgradeCreditSeatRequest) async throws -> UpgradeCreditSeatResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await upgradeCreditSeatWithOptions(request as! UpgradeCreditSeatRequest, runtime as! TeaUtils.RuntimeOptions)
    }
}
