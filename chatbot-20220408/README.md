...
```ruby
pod 'AlibabacloudChatbot20220408', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/chatbot-20220408" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/chatbot-20220408.git", from: "1.0.0")
]
```
