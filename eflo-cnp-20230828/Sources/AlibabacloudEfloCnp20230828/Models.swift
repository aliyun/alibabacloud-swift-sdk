...
public class CheckServiceLinkedRoleEfloCnpForDeletingRequest : Tea.TeaModel {
...
public class CheckServiceLinkedRoleEfloCnpForDeletingResponseBody : Tea.TeaModel {
    ...
    public var resources: [CheckServiceLinkedRoleEfloCnpForDeletingResponseBody.Resources]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Resources"] as? [Any?] {
            var tmp : [CheckServiceLinkedRoleEfloCnpForDeletingResponseBody.Resources] = []
            for v in value {
                if v != nil {
                    var model = CheckServiceLinkedRoleEfloCnpForDeletingResponseBody.Resources()
                    if v != nil {
...
public class CheckServiceLinkedRoleEfloCnpForDeletingResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CheckServiceLinkedRoleEfloCnpForDeletingResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CheckServiceLinkedRoleEfloCnpForDeletingResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
