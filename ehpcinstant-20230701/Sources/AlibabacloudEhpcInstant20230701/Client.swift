...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func createActionPlanWithOptions(_ tmpReq: CreateActionPlanRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateActionPlanResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.intervalMinutes)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeJobResultsWithOptions(_ request: DescribeJobResultsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeJobResultsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.arrayIndex)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeJobResultsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeJobResults(_ request: DescribeJobResultsRequest) async throws -> DescribeJobResultsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeJobResultsWithOptions(request as! DescribeJobResultsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listExecutorEventsWithOptions(_ tmpReq: ListExecutorEventsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListExecutorEventsResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ListExecutorEventsShrinkRequest = ListExecutorEventsShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListExecutorEventsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listExecutorEvents(_ request: ListExecutorEventsRequest) async throws -> ListExecutorEventsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listExecutorEventsWithOptions(request as! ListExecutorEventsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
