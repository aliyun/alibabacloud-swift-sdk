...
let package = Package(
        name: "AlibabacloudEdsOfficeService20221125",
        ...
        products: [
            .library(
                    name: "AlibabacloudEdsOfficeService20221125",
                    targets: ["AlibabacloudEdsOfficeService20221125"])
        ],
        dependencies: [
            // Dependencies declare other packages that this package depends on.
            .package(url: "https://github.com/aliyun/tea-swift.git", from: "1.0.0"),
            .package(url: "https://github.com/alibabacloud-sdk-swift/tea-utils", from: "1.0.2"),
            .package(url: "https://github.com/alibabacloud-sdk-swift/darabonba-openapi", from: "1.0.1"),
