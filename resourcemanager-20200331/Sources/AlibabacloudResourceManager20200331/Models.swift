...
public class GetResourceGroupResponseBody : Tea.TeaModel {
    public class ResourceGroup : Tea.TeaModel {
        ...
        public class Tags : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("Tag") {
                    self.tag = dict["Tag"] as! [GetResourceGroupResponseBody.ResourceGroup.Tags.Tag]
                }
            }
        }
        public var accountId: String?
...
public class GetResourceGroupListAclModeResponseBody : Tea.TeaModel {
...
public class GetResourceGroupListAclModeResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetResourceGroupListAclModeResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("body") {
            var model = GetResourceGroupListAclModeResponseBody()
            model.fromMap(dict["body"] as! [String: Any])
            self.body = model
        }
    }
...
public class ListResourceGroupsRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tag") {
            self.tag = dict["Tag"] as! [ListResourceGroupsRequest.Tag]
        }
    }
}
    ...
    public class ResourceGroups : Tea.TeaModel {
        public class ResourceGroup : Tea.TeaModel {
            public class Tags : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Tag") {
                        self.tag = dict["Tag"] as! [ListResourceGroupsResponseBody.ResourceGroups.ResourceGroup.Tags.Tag]
                    }
                }
            }
            public var accountId: String?
...
public class ListResourcesResponseBody : Tea.TeaModel {
    public class Resources : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            if dict.keys.contains("Resource") {
                self.resource = dict["Resource"] as! [ListResourcesResponseBody.Resources.Resource]
            }
        }
    }
    public var pageNumber: Int32?
...
public class ListTagKeysResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tags") {
            self.tags = dict["Tags"] as! [ListTagKeysResponseBody.Tags]
        }
    }
}
...
public class ListTagValuesResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tags") {
            self.tags = dict["Tags"] as! [ListTagValuesResponseBody.Tags]
        }
    }
}
...
public class MoveResourcesRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Resources") {
            self.resources = dict["Resources"] as! [MoveResourcesRequest.Resources]
        }
    }
}
...
public class MoveResourcesResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Responses") {
            self.responses = dict["Responses"] as! [MoveResourcesResponseBody.Responses]
        }
    }
}
