...
```ogdl
github "alibabacloud-sdk-swift/emr-serverless-spark-20230808" "1.16.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/emr-serverless-spark-20230808.git", from: "1.16.1")
]
```
