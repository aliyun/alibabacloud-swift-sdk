...
```ruby
pod 'AlibabacloudResourceSharing20200110', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/resourcesharing-20200110" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/resourcesharing-20200110.git", from: "1.0.1")
]
```
