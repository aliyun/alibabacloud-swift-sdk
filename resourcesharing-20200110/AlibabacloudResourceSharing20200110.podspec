Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudResourceSharing20200110"
  spec.version      = "1.2.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ResourceSharing (20200110) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/resourcesharing-20200110" 
