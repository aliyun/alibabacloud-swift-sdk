...
public class CreateUserExclusiveCredentialHeaders : Tea.TeaModel {
    public var commonHeaders: [String: String]?
...
public class CreateUserExclusiveCredentialRequest : Tea.TeaModel {
    public class CredentialContent : Tea.TeaModel {
        public class ApiKeyContent : Tea.TeaModel {
        ...
        public var apiKeyContent: CreateUserExclusiveCredentialRequest.CredentialContent.ApiKeyContent?
        ...
        public override func validate() throws -> Void {
            try self.apiKeyContent?.validate()
        }

        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.apiKeyContent != nil {
                map["apiKeyContent"] = self.apiKeyContent?.toMap()
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["apiKeyContent"] as? [String: Any?] {
                var model = CreateUserExclusiveCredentialRequest.CredentialContent.ApiKeyContent()
                model.fromMap(value)
                self.apiKeyContent = model
            }
        }
    }
    ...
    public override func validate() throws -> Void {
        try self.credentialContent?.validate()
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["credentialContent"] as? [String: Any?] {
...
public class CreateUserExclusiveCredentialResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateUserExclusiveCredentialResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateUserExclusiveCredentialResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListOrganizationalUnitParentIdsRequest : Tea.TeaModel {
...
public class ObtainCloudAccountRoleAccessCredentialRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["durationSeconds"] as? Int32 {
...
public class ObtainCloudAccountRoleAccessCredentialResponseBody : Tea.TeaModel {
    public class CloudAccountRoleAccessCredential : Tea.TeaModel {
        ...
        public class AwsStsToken : Tea.TeaModel {
            public var accessKeyId: String?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["secretAccessKey"] as? String {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["awsStsToken"] as? [String: Any?] {
...
public class ObtainCredentialHeaders : Tea.TeaModel {
    public var commonHeaders: [String: String]?
...
public class ObtainCredentialRequest : Tea.TeaModel {
    public var credentialIdentifier: String?
...
public class ObtainCredentialResponseBody : Tea.TeaModel {
    public class CredentialContent : Tea.TeaModel {
        public class ApiKeyContent : Tea.TeaModel {
            public var apiKey: String?
        ...
        public class OauthClientContent : Tea.TeaModel {
            public var clientId: String?
        ...
        public var apiKeyContent: ObtainCredentialResponseBody.CredentialContent.ApiKeyContent?

        public var oauthClientContent: ObtainCredentialResponseBody.CredentialContent.OauthClientContent?
        ...
        public override func validate() throws -> Void {
            try self.apiKeyContent?.validate()
            try self.oauthClientContent?.validate()
        }
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.oauthClientContent != nil {
                map["oauthClientContent"] = self.oauthClientContent?.toMap()
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["apiKeyContent"] as? [String: Any?] {
                var model = ObtainCredentialResponseBody.CredentialContent.ApiKeyContent()
                model.fromMap(value)
                self.apiKeyContent = model
            }
            if let value = dict["oauthClientContent"] as? [String: Any?] {
                var model = ObtainCredentialResponseBody.CredentialContent.OauthClientContent()
                model.fromMap(value)
                self.oauthClientContent = model
            }
        }
    }
    public var createTime: Int64?

    public var credentialContent: ObtainCredentialResponseBody.CredentialContent?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.credentialSubjectType != nil {
            map["credentialSubjectType"] = self.credentialSubjectType!
        }
        if self.credentialType != nil {
            map["credentialType"] = self.credentialType!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["credentialContent"] as? [String: Any?] {
            var model = ObtainCredentialResponseBody.CredentialContent()
            model.fromMap(value)
            self.credentialContent = model
        }
        ...
        if let value = dict["credentialSubjectType"] as? String {
            self.credentialSubjectType = value
        }
        if let value = dict["credentialType"] as? String {
            self.credentialType = value
        }
...
public class ObtainCredentialResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ObtainCredentialResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ObtainCredentialResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ObtainJwtAuthenticationTokenHeaders : Tea.TeaModel {
    public var commonHeaders: [String: String]?
...
public class ObtainJwtAuthenticationTokenRequest : Tea.TeaModel {
    public var authenticationTokenId: String?
...
public class ObtainJwtAuthenticationTokenResponseBody : Tea.TeaModel {
    public class JwtContent : Tea.TeaModel {
        public var derivedShortToken: String?
    ...
    public var jwtContent: ObtainJwtAuthenticationTokenResponseBody.JwtContent?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["jwtContent"] as? [String: Any?] {
            var model = ObtainJwtAuthenticationTokenResponseBody.JwtContent()
            model.fromMap(value)
            self.jwtContent = model
        }
        if let value = dict["revoked"] as? Bool {
...
public class ObtainJwtAuthenticationTokenResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ObtainJwtAuthenticationTokenResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ObtainJwtAuthenticationTokenResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class PatchOrganizationalUnitParentIdHeaders : Tea.TeaModel {
    public var commonHeaders: [String: String]?
...
public class PatchOrganizationalUnitParentIdRequest : Tea.TeaModel {
    public var parentId: String?
...
public class PatchOrganizationalUnitParentIdResponse : Tea.TeaModel {
    public var headers: [String: String]?
