Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudResellerTrade20191227"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ResellerTrade (20191227) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/resellertrade-20191227" 
