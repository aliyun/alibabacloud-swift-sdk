...
```ruby
pod 'AlibabacloudEfloController20221215', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/eflo-controller-20221215" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/eflo-controller-20221215.git", from: "1.0.1")
]
```
