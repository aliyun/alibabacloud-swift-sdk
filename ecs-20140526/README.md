...
```ruby
pod 'AlibabacloudEcs20140526', '~> 1.0.6'
```
...
```ogdl
github "alibabacloud-sdk-swift/ecs-20140526" "1.0.6"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ecs-20140526.git", from: "1.0.6")
]
```
