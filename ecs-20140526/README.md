...
```ruby
pod 'AlibabacloudEcs20140526', '~> 1.0.5'
```
...
```ogdl
github "alibabacloud-sdk-swift/ecs-20140526" "1.0.5"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ecs-20140526.git", from: "1.0.5")
]
```
