Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudCdp20210402"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Data Integration (20210402) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/cdp-20210402" 
