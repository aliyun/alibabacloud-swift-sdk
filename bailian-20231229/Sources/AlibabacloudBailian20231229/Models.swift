...
public class AddChunkRequest : Tea.TeaModel {
    public var pipelineId: String?

    public var dataId: String?

    public var field: [String: Any]?
...
public class AddChunkShrinkRequest : Tea.TeaModel {
    public var pipelineId: String?

    public var dataId: String?

    public var fieldShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.fieldShrink != nil {
            map["field"] = self.fieldShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["field"] as? String {
            self.fieldShrink = value
        }
    }
}

public class AddChunkResponseBody : Tea.TeaModel {
    public var code: String?
...
public class AddChunkResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AddChunkResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AddChunkResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class AddFilesFromAuthorizedOssRequest : Tea.TeaModel {
    public class FileDetails : Tea.TeaModel {
        ...
        public var parserConfig: AddFilesFromAuthorizedOssRequest.FileDetails.ParserConfig?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ParserConfig"] as? [String: Any?] {
                var model = AddFilesFromAuthorizedOssRequest.FileDetails.ParserConfig()
                model.fromMap(value)
                self.parserConfig = model
            }
        }
...
public class AddTableRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["TableColumns"] as? [Any?] {
            var tmp : [AddTableRequest.TableColumns] = []
            for v in value {
                if v != nil {
                    var model = AddTableRequest.TableColumns()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class AddTableShrinkRequest : Tea.TeaModel {
    public var connectorId: String?
...
public class AddTableResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
    ...
    public var data: AddTableResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = AddTableResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class AddTableResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AddTableResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AddTableResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteConnectorRequest : Tea.TeaModel {
...
public class DeleteConnectorResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var connectorId: String?
    ...
    public var data: DeleteConnectorResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = DeleteConnectorResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class DeleteConnectorResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteConnectorResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteConnectorResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteFilesRequest : Tea.TeaModel {
...
public class DeleteFilesShrinkRequest : Tea.TeaModel {
...
public class DeleteFilesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var deleteFileResultList: [DeleteFilesResponseBody.Data.DeleteFileResultList]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["DeleteFileResultList"] as? [Any?] {
                var tmp : [DeleteFilesResponseBody.Data.DeleteFileResultList] = []
                for v in value {
                    if v != nil {
                        var model = DeleteFilesResponseBody.Data.DeleteFileResultList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: DeleteFilesResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = DeleteFilesResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class DeleteFilesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteFilesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteFilesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteMemoryNodeRequest : Tea.TeaModel {
...
public class DeletePromptTemplateRequest : Tea.TeaModel {
...
public class DescribeFileRequest : Tea.TeaModel {
...
public class GetMemoryRequest : Tea.TeaModel {
...
public class GetMemoryNodeRequest : Tea.TeaModel {
...
public class GetPromptTemplateRequest : Tea.TeaModel {
...
public class GetPublishedAgentRequest : Tea.TeaModel {
...
public class UpdateConnectorRequest : Tea.TeaModel {
    public var connectorName: String?
...
public class UpdateConnectorResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var connectorId: String?
    ...
    public var data: UpdateConnectorResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = UpdateConnectorResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class UpdateConnectorResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateConnectorResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateConnectorResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateIndexResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var id: String?
    ...
    public var data: UpdateIndexResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = UpdateIndexResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class UpdateIndexResponse : Tea.TeaModel {
    ...
    public var body: UpdateIndexResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateIndexResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateTableFromAuthorizedOssRequest : Tea.TeaModel {
...
public class UpdateTableFromAuthorizedOssResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var status: String?
    ...
    public var data: UpdateTableFromAuthorizedOssResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = UpdateTableFromAuthorizedOssResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class UpdateTableFromAuthorizedOssResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateTableFromAuthorizedOssResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateTableFromAuthorizedOssResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
