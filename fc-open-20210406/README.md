...
```ruby
pod 'AlibabacloudFCOpen20210406', '~> 2.0.9'
```
...
```ogdl
github "alibabacloud-sdk-swift/fc-open-20210406" "2.0.9"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/fc-open-20210406.git", from: "2.0.9")
]
```
