Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudSophonsoar20250903"
  spec.version      = "1.1.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud sophonsoar (20250903) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/sophonsoar-20250903" 
