...
public class AbortPlaybookExecutionRequest : Tea.TeaModel {
    public var lang: String?

    public var playbookExecutionUuid: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.playbookExecutionUuid != nil {
            map["PlaybookExecutionUuid"] = self.playbookExecutionUuid!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PlaybookExecutionUuid"] as? String {
            self.playbookExecutionUuid = value
        }
...
public class AbortPlaybookExecutionResponseBody : Tea.TeaModel {
...
public class AbortPlaybookExecutionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AbortPlaybookExecutionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AbortPlaybookExecutionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ExecuteComponentRequest : Tea.TeaModel {
    public var componentActionName: String?

    public var componentAssetUuid: String?

    public var componentInput: String?

    public var componentName: String?

    public var lang: String?

    public var playBookNodeName: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.componentInput != nil {
            map["ComponentInput"] = self.componentInput!
        }
        if self.componentName != nil {
            map["ComponentName"] = self.componentName!
        }
        ...
        if self.playBookNodeName != nil {
            map["PlayBookNodeName"] = self.playBookNodeName!
        }
        if self.playbookUuid != nil {
            map["PlaybookUuid"] = self.playbookUuid!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ComponentInput"] as? String {
            self.componentInput = value
        }
        if let value = dict["ComponentName"] as? String {
            self.componentName = value
        }
        ...
        if let value = dict["PlayBookNodeName"] as? String {
            self.playBookNodeName = value
        }
        if let value = dict["PlaybookUuid"] as? String {
            self.playbookUuid = value
        }
...
public class ExecuteComponentResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class ExecuteComponentResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ExecuteComponentResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ExecuteComponentResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
