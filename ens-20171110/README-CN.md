...
```ruby
pod 'AlibabacloudEns20171110', '~> 1.0.2'
```
...
```ogdl
github "alibabacloud-sdk-swift/ens-20171110" "1.0.2"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ens-20171110.git", from: "1.0.2")
]
```
