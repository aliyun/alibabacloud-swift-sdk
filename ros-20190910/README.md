...
```ruby
pod 'AlibabacloudROS20190910', '~> 1.0.3'
```
...
```ogdl
github "alibabacloud-sdk-swift/ros-20190910" "1.0.3"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ros-20190910.git", from: "1.0.3")
]
```
