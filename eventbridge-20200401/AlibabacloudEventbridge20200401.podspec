Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEventbridge20200401"
  spec.version      = "7.0.2"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud eventbridge (20200401) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/eventbridge-20200401" 
