...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func askLumaWithOptions(_ request: AskLumaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AskLumaResponse {
        ...
        return Tea.TeaConverter.fromMap(AskLumaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func askLuma(_ request: AskLumaRequest) async throws -> AskLumaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await askLumaWithOptions(request as! AskLumaRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createKnowledgeBaseWithOptions(_ tmpReq: CreateKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateKnowledgeBaseShrinkRequest = CreateKnowledgeBaseShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.chunkConfiguration)) {
            request.chunkConfigurationShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.chunkConfiguration, "ChunkConfiguration", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.metadataSchema)) {
            request.metadataSchemaShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.metadataSchema, "MetadataSchema", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.searchConfiguration)) {
            request.searchConfigurationShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.searchConfiguration, "SearchConfiguration", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.chunkConfigurationShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.metadataSchemaShrink)) {
            query["MetadataSchema"] = request.metadataSchemaShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.namespace)) {
            query["Namespace"] = request.namespace ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.searchConfigurationShrink)) {
    ...
    public func createKnowledgeBase(_ request: CreateKnowledgeBaseRequest) async throws -> CreateKnowledgeBaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createKnowledgeBaseWithOptions(request as! CreateKnowledgeBaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createTableWithOptions(_ tmpReq: CreateTableRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateTableResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateTableShrinkRequest = CreateTableShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.retentionPolicy)) {
            request.retentionPolicyShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.retentionPolicy, "RetentionPolicy", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.retentionPolicyShrink)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteKnowledgeBaseWithOptions(_ request: DeleteKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteKnowledgeBase(_ request: DeleteKnowledgeBaseRequest) async throws -> DeleteKnowledgeBaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteKnowledgeBaseWithOptions(request as! DeleteKnowledgeBaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getChunkWithOptions(_ request: GetChunkRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetChunkResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetChunkResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getChunk(_ request: GetChunkRequest) async throws -> GetChunkResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getChunkWithOptions(request as! GetChunkRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getKnowledgeBaseWithOptions(_ request: GetKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getKnowledgeBase(_ request: GetKnowledgeBaseRequest) async throws -> GetKnowledgeBaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getKnowledgeBaseWithOptions(request as! GetKnowledgeBaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listCatalogsWithOptions(_ request: ListCatalogsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListCatalogsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.limit)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listChunksWithOptions(_ request: ListChunksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListChunksResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listChunks(_ request: ListChunksRequest) async throws -> ListChunksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listChunksWithOptions(request as! ListChunksRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pollAskResultWithOptions(_ request: PollAskResultRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PollAskResultResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.agentName)) {
            body["AgentName"] = request.agentName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PollAskResultResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pollAskResult(_ request: PollAskResultRequest) async throws -> PollAskResultResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pollAskResultWithOptions(request as! PollAskResultRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAskLumaLogWithOptions(_ request: QueryAskLumaLogRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryAskLumaLogResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.after)) {
            body["After"] = request.after ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryAskLumaLogResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAskLumaLog(_ request: QueryAskLumaLogRequest) async throws -> QueryAskLumaLogResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryAskLumaLogWithOptions(request as! QueryAskLumaLogRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryEventHouseWithOptions(_ request: QueryEventHouseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryEventHouseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.limit)) {
            query["Limit"] = request.limit!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryEventHouseResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryEventHouse(_ request: QueryEventHouseRequest) async throws -> QueryEventHouseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryEventHouseWithOptions(request as! QueryEventHouseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryWithSQLWithOptions(_ request: QueryWithSQLRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryWithSQLResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.limit)) {
            query["Limit"] = request.limit!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryWithSQLResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryWithSQL(_ request: QueryWithSQLRequest) async throws -> QueryWithSQLResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryWithSQLWithOptions(request as! QueryWithSQLRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func searchKnowledgeBaseWithOptions(_ request: SearchKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SearchKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.catalog)) {
            query["Catalog"] = request.catalog ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func searchKnowledgeBase(_ request: SearchKnowledgeBaseRequest) async throws -> SearchKnowledgeBaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await searchKnowledgeBaseWithOptions(request as! SearchKnowledgeBaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateKnowledgeBaseWithOptions(_ tmpReq: UpdateKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateKnowledgeBaseShrinkRequest = UpdateKnowledgeBaseShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.chunkConfiguration)) {
            request.chunkConfigurationShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.chunkConfiguration, "ChunkConfiguration", "json")
        }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateTableWithOptions(_ tmpReq: UpdateTableRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateTableResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateTableShrinkRequest = UpdateTableShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.addColumn)) {
            request.addColumnShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.addColumn, "AddColumn", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.deleteColumn)) {
            request.deleteColumnShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.deleteColumn, "DeleteColumn", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.renameColumn)) {
            request.renameColumnShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.renameColumn, "RenameColumn", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.updateColumnComment)) {
            request.updateColumnCommentShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.updateColumnComment, "UpdateColumnComment", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.updateColumnType)) {
            request.updateColumnTypeShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.updateColumnType, "UpdateColumnType", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.updateRetentionPolicy)) {
            request.updateRetentionPolicyShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.updateRetentionPolicy, "UpdateRetentionPolicy", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.addColumnShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.deleteColumnShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.renameColumnShrink)) {
            query["RenameColumn"] = request.renameColumnShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.updateColumnCommentShrink)) {
            query["UpdateColumnComment"] = request.updateColumnCommentShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.updateColumnTypeShrink)) {
            query["UpdateColumnType"] = request.updateColumnTypeShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.updateComment)) {
            query["UpdateComment"] = request.updateComment ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.updateRetentionPolicyShrink)) {
