...
public class AuthorizeInstanceGroupRequest : Tea.TeaModel {
    ...
    public var appInstanceGroupSetId: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.appInstanceGroupSetId != nil {
            map["AppInstanceGroupSetId"] = self.appInstanceGroupSetId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["AppInstanceGroupSetId"] as? String {
            self.appInstanceGroupSetId = value
        }
...
public class AuthorizeUsersForAppRequest : Tea.TeaModel {
    public class UserMeta : Tea.TeaModel {
        public var adDomain: String?
    ...
    public var userMeta: AuthorizeUsersForAppRequest.UserMeta?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["UserMeta"] as? [String: Any?] {
            var model = AuthorizeUsersForAppRequest.UserMeta()
            model.fromMap(value)
            self.userMeta = model
        }
    }
...
public class AuthorizeUsersForAppShrinkRequest : Tea.TeaModel {
    public var appId: String?
...
public class AuthorizeUsersForAppResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class AuthorizeUsersForAppResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AuthorizeUsersForAppResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AuthorizeUsersForAppResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class BatchCreateLlmTemplatesRequest : Tea.TeaModel {
    public class LlmTemplateItems : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.isDefaultModel != nil {
                map["IsDefaultModel"] = self.isDefaultModel!
            }
            if self.llmCode != nil {
                map["LlmCode"] = self.llmCode!
            }
            if self.name != nil {
                map["Name"] = self.name!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["IsDefaultModel"] as? Bool {
                self.isDefaultModel = value
            }
            if let value = dict["LlmCode"] as? String {
                self.llmCode = value
            }
    ...
    public var llmTemplateItems: [BatchCreateLlmTemplatesRequest.LlmTemplateItems]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.llmTemplateItems != nil {
            var tmp : [Any] = []
            for k in self.llmTemplateItems! {
                tmp.append(k.toMap())
            }
            map["LlmTemplateItems"] = tmp
        }
        if self.modelTemplateId != nil {
            map["ModelTemplateId"] = self.modelTemplateId!
        }
        if self.providerTemplateId != nil {
            map["ProviderTemplateId"] = self.providerTemplateId!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["LlmTemplateItems"] as? [Any?] {
            var tmp : [BatchCreateLlmTemplatesRequest.LlmTemplateItems] = []
            for v in value {
                if v != nil {
                    var model = BatchCreateLlmTemplatesRequest.LlmTemplateItems()
                    if v != nil {
            ...
            self.llmTemplateItems = tmp
        }
        if let value = dict["ModelTemplateId"] as? String {
            self.modelTemplateId = value
        }
        if let value = dict["ProviderTemplateId"] as? String {
            self.providerTemplateId = value
        }
    }
}

public class BatchCreateLlmTemplatesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class SkippedItems : Tea.TeaModel {
            public var llmCode: String?
        ...
        public var llmTemplateIds: [String]?

        public var skippedItems: [BatchCreateLlmTemplatesResponseBody.Data.SkippedItems]?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.llmTemplateIds != nil {
                map["LlmTemplateIds"] = self.llmTemplateIds!
            }
            if self.skippedItems != nil {
                var tmp : [Any] = []
                for k in self.skippedItems! {
                    tmp.append(k.toMap())
                }
                map["SkippedItems"] = tmp
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["LlmTemplateIds"] as? [String] {
                self.llmTemplateIds = value
            }
            if let value = dict["SkippedItems"] as? [Any?] {
                var tmp : [BatchCreateLlmTemplatesResponseBody.Data.SkippedItems] = []
                for v in value {
                    if v != nil {
                        var model = BatchCreateLlmTemplatesResponseBody.Data.SkippedItems()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: BatchCreateLlmTemplatesResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = BatchCreateLlmTemplatesResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class BatchCreateLlmTemplatesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: BatchCreateLlmTemplatesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = BatchCreateLlmTemplatesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ConfigResourceGroupModelTemplateRequest : Tea.TeaModel {
    public var modelTemplateId: String?
...
public class ConfigResourceGroupModelTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class ConfigResourceGroupModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ConfigResourceGroupModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ConfigResourceGroupModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ConfigRuntimeChannelRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.runtimeIds != nil {
            map["RuntimeIds"] = self.runtimeIds!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RuntimeIds"] as? [String] {
            self.runtimeIds = value
        }
...
public class ConfigRuntimeChannelResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class ConfigRuntimeChannelResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ConfigRuntimeChannelResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ConfigRuntimeChannelResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ConfigRuntimeModelTemplateRequest : Tea.TeaModel {
    public var modelTemplateId: String?
...
public class ConfigRuntimeModelTemplateResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var code: String?
    ...
    public var data: [ConfigRuntimeModelTemplateResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ConfigRuntimeModelTemplateResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ConfigRuntimeModelTemplateResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ConfigRuntimeModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ConfigRuntimeModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ConfigRuntimeModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateBrowserInstanceGroupRequest : Tea.TeaModel {
    public class BrowserConfig : Tea.TeaModel {
        ...
        public var bookmarks: [CreateBrowserInstanceGroupRequest.BrowserConfig.Bookmarks]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Bookmarks"] as? [Any?] {
                var tmp : [CreateBrowserInstanceGroupRequest.BrowserConfig.Bookmarks] = []
                for v in value {
                    if v != nil {
                        var model = CreateBrowserInstanceGroupRequest.BrowserConfig.Bookmarks()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public class Network : Tea.TeaModel {
        ...
        public var restrictedURLs: [CreateBrowserInstanceGroupRequest.Network.RestrictedURLs]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["RestrictedURLs"] as? [Any?] {
                var tmp : [CreateBrowserInstanceGroupRequest.Network.RestrictedURLs] = []
                for v in value {
                    if v != nil {
                        var model = CreateBrowserInstanceGroupRequest.Network.RestrictedURLs()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public class Policy : Tea.TeaModel {
        ...
        public var authorizeAccessPolicyRules: [CreateBrowserInstanceGroupRequest.Policy.AuthorizeAccessPolicyRules]?

        public var clientTypes: [CreateBrowserInstanceGroupRequest.Policy.ClientTypes]?

        public var clipboardPolicy: CreateBrowserInstanceGroupRequest.Policy.ClipboardPolicy?
        ...
        public var videoPolicy: CreateBrowserInstanceGroupRequest.Policy.VideoPolicy?

        public var watermarkPolicy: CreateBrowserInstanceGroupRequest.Policy.WatermarkPolicy?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["AuthorizeAccessPolicyRules"] as? [Any?] {
                var tmp : [CreateBrowserInstanceGroupRequest.Policy.AuthorizeAccessPolicyRules] = []
                for v in value {
                    if v != nil {
                        var model = CreateBrowserInstanceGroupRequest.Policy.AuthorizeAccessPolicyRules()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["ClientTypes"] as? [Any?] {
                var tmp : [CreateBrowserInstanceGroupRequest.Policy.ClientTypes] = []
                for v in value {
                    if v != nil {
                        var model = CreateBrowserInstanceGroupRequest.Policy.ClientTypes()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["ClipboardPolicy"] as? [String: Any?] {
                var model = CreateBrowserInstanceGroupRequest.Policy.ClipboardPolicy()
                model.fromMap(value)
            ...
            if let value = dict["VideoPolicy"] as? [String: Any?] {
                var model = CreateBrowserInstanceGroupRequest.Policy.VideoPolicy()
                model.fromMap(value)
                self.videoPolicy = model
            }
            if let value = dict["WatermarkPolicy"] as? [String: Any?] {
                var model = CreateBrowserInstanceGroupRequest.Policy.WatermarkPolicy()
                model.fromMap(value)
    ...
    public class StoragePolicy : Tea.TeaModel {
        public class UserProfile : Tea.TeaModel {
            public var userProfileSize: Int64?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.userProfileSize != nil {
                    map["UserProfileSize"] = self.userProfileSize!
                }
                if self.userProfileSwitch != nil {
                    map["UserProfileSwitch"] = self.userProfileSwitch!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["UserProfileSize"] as? Int64 {
                    self.userProfileSize = value
                }
                if let value = dict["UserProfileSwitch"] as? Bool {
                    self.userProfileSwitch = value
                }
        ...
        public var userProfile: CreateBrowserInstanceGroupRequest.StoragePolicy.UserProfile?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["UserProfile"] as? [String: Any?] {
                var model = CreateBrowserInstanceGroupRequest.StoragePolicy.UserProfile()
                model.fromMap(value)
                self.userProfile = model
            }
        }
    ...
    public var authNotificationEnabled: Bool?
    ...
    public var browserConfig: CreateBrowserInstanceGroupRequest.BrowserConfig?
    ...
    public var network: CreateBrowserInstanceGroupRequest.Network?

    public var nodePool: CreateBrowserInstanceGroupRequest.NodePool?
    ...
    public var policy: CreateBrowserInstanceGroupRequest.Policy?

    public var promotionId: String?

    public var securityPolicy: CreateBrowserInstanceGroupRequest.SecurityPolicy?

    public var storagePolicy: CreateBrowserInstanceGroupRequest.StoragePolicy?

    public var subPayType: String?

    public var tag: [CreateBrowserInstanceGroupRequest.Tag]?

    public var timers: [CreateBrowserInstanceGroupRequest.Timers]?

    public var userGroupIds: [String]?

    public var userInfo: CreateBrowserInstanceGroupRequest.UserInfo?

    public var users: [CreateBrowserInstanceGroupRequest.Users]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.authNotificationEnabled != nil {
            map["AuthNotificationEnabled"] = self.authNotificationEnabled!
        }
        if self.autoPay != nil {
            map["AutoPay"] = self.autoPay!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["AuthNotificationEnabled"] as? Bool {
            self.authNotificationEnabled = value
        }
        if let value = dict["AutoPay"] as? Bool {
            self.autoPay = value
        }
        ...
        if let value = dict["BrowserConfig"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.BrowserConfig()
            model.fromMap(value)
        ...
        if let value = dict["Network"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.Network()
            model.fromMap(value)
            self.network = model
        }
        if let value = dict["NodePool"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.NodePool()
            model.fromMap(value)
            self.nodePool = model
        }
        ...
        if let value = dict["Policy"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.Policy()
            model.fromMap(value)
            self.policy = model
        }
        if let value = dict["PromotionId"] as? String {
        ...
        if let value = dict["SecurityPolicy"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.SecurityPolicy()
            model.fromMap(value)
            self.securityPolicy = model
        }
        if let value = dict["StoragePolicy"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.StoragePolicy()
            model.fromMap(value)
            self.storagePolicy = model
        }
        if let value = dict["SubPayType"] as? String {
        ...
        if let value = dict["Tag"] as? [Any?] {
            var tmp : [CreateBrowserInstanceGroupRequest.Tag] = []
            for v in value {
                if v != nil {
                    var model = CreateBrowserInstanceGroupRequest.Tag()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["Timers"] as? [Any?] {
            var tmp : [CreateBrowserInstanceGroupRequest.Timers] = []
            for v in value {
                if v != nil {
                    var model = CreateBrowserInstanceGroupRequest.Timers()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["UserInfo"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupRequest.UserInfo()
            model.fromMap(value)
            self.userInfo = model
        }
        if let value = dict["Users"] as? [Any?] {
            var tmp : [CreateBrowserInstanceGroupRequest.Users] = []
            for v in value {
                if v != nil {
                    var model = CreateBrowserInstanceGroupRequest.Users()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class CreateBrowserInstanceGroupShrinkRequest : Tea.TeaModel {
    public var appPackageType: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.usersShrink != nil {
            map["Users"] = self.usersShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Users"] as? String {
            self.usersShrink = value
        }
    }
}

public class CreateBrowserInstanceGroupResponseBody : Tea.TeaModel {
    public class BrowserInstanceGroupModel : Tea.TeaModel {
    ...
    public var browserInstanceGroupModel: CreateBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel?
    ...
    public override func validate() throws -> Void {
        try self.browserInstanceGroupModel?.validate()
    }

    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.browserInstanceGroupModel != nil {
            map["BrowserInstanceGroupModel"] = self.browserInstanceGroupModel?.toMap()
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["BrowserInstanceGroupModel"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel()
            model.fromMap(value)
            self.browserInstanceGroupModel = model
        }
        if let value = dict["RequestId"] as? String {
            self.requestId = value
        }
...
public class CreateBrowserInstanceGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateBrowserInstanceGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateBrowserInstanceGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateModelProviderTemplateRequest : Tea.TeaModel {
    public var agentPlatform: String?
    ...
    public var enableWuyingProxy: Bool?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.enableWuyingProxy != nil {
            map["EnableWuyingProxy"] = self.enableWuyingProxy!
        }
        if self.modelTemplateId != nil {
            map["ModelTemplateId"] = self.modelTemplateId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["EnableWuyingProxy"] as? Bool {
            self.enableWuyingProxy = value
        }
        if let value = dict["ModelTemplateId"] as? String {
            self.modelTemplateId = value
        }
...
public class CreateModelProviderTemplateResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var providerTemplateId: String?
    ...
    public var data: CreateModelProviderTemplateResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = CreateModelProviderTemplateResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class CreateModelProviderTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateModelProviderTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateModelProviderTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateModelTemplateRequest : Tea.TeaModel {
    public var agentPlatform: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.refScope != nil {
            map["RefScope"] = self.refScope!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RefScope"] as? String {
            self.refScope = value
        }
    }
}

public class CreateModelTemplateResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var modelTemplateId: String?
    ...
    public var data: CreateModelTemplateResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = CreateModelTemplateResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class CreateModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateWuyingServerRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.erdmaEnabled != nil {
            map["ErdmaEnabled"] = self.erdmaEnabled!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ErdmaEnabled"] as? Bool {
            self.erdmaEnabled = value
        }
...
public class DeleteLlmTemplateRequest : Tea.TeaModel {
    public var llmTemplateId: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.llmTemplateId != nil {
            map["LlmTemplateId"] = self.llmTemplateId!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["LlmTemplateId"] as? String {
            self.llmTemplateId = value
        }
    }
}

public class DeleteLlmTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteLlmTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteLlmTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteLlmTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteModelProviderTemplateRequest : Tea.TeaModel {
    public var providerTemplateId: String?
...
public class DeleteModelProviderTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteModelProviderTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteModelProviderTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteModelProviderTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteModelTemplateRequest : Tea.TeaModel {
    public var modelTemplateId: String?
...
public class DeleteModelTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeWuyingServerResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.supportASP != nil {
                map["SupportASP"] = self.supportASP!
            }
            if self.systemDiskCategory != nil {
                map["SystemDiskCategory"] = self.systemDiskCategory!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["SupportASP"] as? Bool {
                self.supportASP = value
            }
            if let value = dict["SystemDiskCategory"] as? String {
                self.systemDiskCategory = value
            }
...
public class GetBrowserInstanceGroupRequest : Tea.TeaModel {
    public var browserInstanceGroupId: String?
...
public class GetBrowserInstanceGroupResponseBody : Tea.TeaModel {
    public class BrowserInstanceGroupModel : Tea.TeaModel {
        public class AuthorizedUserInfo : Tea.TeaModel {
            public var totalCount: Int32?

            public var totalUserGroupCount: Int32?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.totalUserGroupCount != nil {
                    map["TotalUserGroupCount"] = self.totalUserGroupCount!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["TotalUserGroupCount"] as? Int32 {
                    self.totalUserGroupCount = value
                }
            }
        }
        public class BrowserConfig : Tea.TeaModel {
            ...
            public var bookmarks: [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.BrowserConfig.Bookmarks]?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["Bookmarks"] as? [Any?] {
                    var tmp : [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.BrowserConfig.Bookmarks] = []
                    for v in value {
                        if v != nil {
                            var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.BrowserConfig.Bookmarks()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
        ...
        public class Duration : Tea.TeaModel {
            public var currentPayStage: String?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.currentPayStage != nil {
                    map["CurrentPayStage"] = self.currentPayStage!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["CurrentPayStage"] as? String {
                    self.currentPayStage = value
                }
                ...
                if let value = dict["TotalDuration"] as? Int32 {
                    self.totalDuration = value
                }
                if let value = dict["UsedDuration"] as? Int32 {
        ...
        public class Network : Tea.TeaModel {
            ...
            public var restrictedURLs: [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Network.RestrictedURLs]?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["RestrictedURLs"] as? [Any?] {
                    var tmp : [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Network.RestrictedURLs] = []
                    for v in value {
                        if v != nil {
                            var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Network.RestrictedURLs()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
        ...
        public class NodeInstanceType : Tea.TeaModel {
        ...
        public class NodePool : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["NodeAmount"] as? String {
                    self.nodeAmount = value
                }
                if let value = dict["NodeUsed"] as? String {
                    self.nodeUsed = value
                }
            }
        }
        public class Policy : Tea.TeaModel {
            ...
            public var authorizeAccessPolicyRules: [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.AuthorizeAccessPolicyRules]?

            public var clientTypes: [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.ClientTypes]?

            public var clipboardPolicy: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.ClipboardPolicy?
            ...
            public var videoPolicy: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.VideoPolicy?

            public var watermarkPolicy: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.WatermarkPolicy?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["AuthorizeAccessPolicyRules"] as? [Any?] {
                    var tmp : [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.AuthorizeAccessPolicyRules] = []
                    for v in value {
                        if v != nil {
                            var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.AuthorizeAccessPolicyRules()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["ClientTypes"] as? [Any?] {
                    var tmp : [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.ClientTypes] = []
                    for v in value {
                        if v != nil {
                            var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.ClientTypes()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["ClipboardPolicy"] as? [String: Any?] {
                    var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.ClipboardPolicy()
                    model.fromMap(value)
                    self.clipboardPolicy = model
                }
                if let value = dict["DisconnectKeepSession"] as? String {
                ...
                if let value = dict["VideoPolicy"] as? [String: Any?] {
                    var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.VideoPolicy()
                    model.fromMap(value)
                    self.videoPolicy = model
                }
                if let value = dict["WatermarkPolicy"] as? [String: Any?] {
                    var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy.WatermarkPolicy()
                    model.fromMap(value)
                    self.watermarkPolicy = model
                }
            }
        ...
        public class UserLimit : Tea.TeaModel {
        ...
        public var authorizedUserInfo: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.AuthorizedUserInfo?

        public var bizRegionId: String?

        public var browserConfig: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.BrowserConfig?

        public var browserInstanceGroupId: String?

        public var browserInstanceGroupName: String?

        public var browserInstanceGroupSetId: String?

        public var chargeType: String?

        public var defaultAccessUrl: String?

        public var duration: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Duration?
        ...
        public var network: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Network?

        public var nodeInstanceType: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.NodeInstanceType?

        public var nodePool: [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.NodePool]?

        public var osType: String?

        public var policy: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy?
        ...
        public var timers: [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Timers]?

        public var userGroupAuthMode: String?

        public var userLimit: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.UserLimit?
        ...
        public override func validate() throws -> Void {
            try self.authorizedUserInfo?.validate()
            try self.browserConfig?.validate()
            try self.duration?.validate()
            try self.network?.validate()
            try self.nodeInstanceType?.validate()
            try self.policy?.validate()
            try self.userLimit?.validate()
        }
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.authorizedUserInfo != nil {
                map["AuthorizedUserInfo"] = self.authorizedUserInfo?.toMap()
            }
            if self.bizRegionId != nil {
                map["BizRegionId"] = self.bizRegionId!
            }
            ...
            if self.browserInstanceGroupName != nil {
                map["BrowserInstanceGroupName"] = self.browserInstanceGroupName!
            }
            if self.browserInstanceGroupSetId != nil {
                map["BrowserInstanceGroupSetId"] = self.browserInstanceGroupSetId!
            }
            if self.chargeType != nil {
                map["ChargeType"] = self.chargeType!
            }
            if self.defaultAccessUrl != nil {
                map["DefaultAccessUrl"] = self.defaultAccessUrl!
            }
            ...
            if self.nodeInstanceType != nil {
                map["NodeInstanceType"] = self.nodeInstanceType?.toMap()
            }
            if self.nodePool != nil {
                var tmp : [Any] = []
                for k in self.nodePool! {
            ...
            if self.userLimit != nil {
                map["UserLimit"] = self.userLimit?.toMap()
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["AuthorizedUserInfo"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.AuthorizedUserInfo()
                model.fromMap(value)
                self.authorizedUserInfo = model
            }
            if let value = dict["BizRegionId"] as? String {
                self.bizRegionId = value
            }
            if let value = dict["BrowserConfig"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.BrowserConfig()
                model.fromMap(value)
                self.browserConfig = model
            }
            if let value = dict["BrowserInstanceGroupId"] as? String {
            ...
            if let value = dict["BrowserInstanceGroupName"] as? String {
                self.browserInstanceGroupName = value
            }
            if let value = dict["BrowserInstanceGroupSetId"] as? String {
                self.browserInstanceGroupSetId = value
            }
            if let value = dict["ChargeType"] as? String {
                self.chargeType = value
            }
            if let value = dict["DefaultAccessUrl"] as? String {
                self.defaultAccessUrl = value
            }
            if let value = dict["Duration"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Duration()
                model.fromMap(value)
                self.duration = model
            }
            if let value = dict["ExpiredTime"] as? String {
            ...
            if let value = dict["Network"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Network()
                model.fromMap(value)
                self.network = model
            }
            if let value = dict["NodeInstanceType"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.NodeInstanceType()
                model.fromMap(value)
                self.nodeInstanceType = model
            }
            if let value = dict["NodePool"] as? [Any?] {
                var tmp : [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.NodePool] = []
                for v in value {
                    if v != nil {
                        var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.NodePool()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["Policy"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Policy()
                model.fromMap(value)
                self.policy = model
            }
            if let value = dict["Status"] as? String {
            ...
            if let value = dict["Tier"] as? String {
                self.tier = value
            }
            if let value = dict["Timers"] as? [Any?] {
                var tmp : [GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Timers] = []
                for v in value {
                    if v != nil {
                        var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.Timers()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["UserLimit"] as? [String: Any?] {
                var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel.UserLimit()
                model.fromMap(value)
                self.userLimit = model
            }
        }
    }
    public var browserInstanceGroupModel: GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["BrowserInstanceGroupModel"] as? [String: Any?] {
            var model = GetBrowserInstanceGroupResponseBody.BrowserInstanceGroupModel()
            model.fromMap(value)
            self.browserInstanceGroupModel = model
        }
        if let value = dict["RequestId"] as? String {
...
public class GetBrowserInstanceGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetBrowserInstanceGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetBrowserInstanceGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetModelProviderTemplateResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var config: String?
    ...
    public var data: GetModelProviderTemplateResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = GetModelProviderTemplateResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class GetModelProviderTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetModelProviderTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetModelProviderTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetRuntimeChannelRequest : Tea.TeaModel {
    public var agentPlatform: String?
...
public class GetRuntimeChannelResponseBody : Tea.TeaModel {
    ...
    public var data: [GetRuntimeChannelResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [GetRuntimeChannelResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = GetRuntimeChannelResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetRuntimeChannelResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetRuntimeChannelResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetRuntimeChannelResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetRuntimeModelConfigRequest : Tea.TeaModel {
    public var agentPlatform: String?
...
public class GetRuntimeModelConfigResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class ModelProviderList : Tea.TeaModel {
            public class LlmInfoList : Tea.TeaModel {
                public class CreditMultiplier : Tea.TeaModel {
                ...
                public class InferenceMetadata : Tea.TeaModel {
                    public var requestModality: [String]?

                    public var responseModality: [String]?
                    ...
                    public override func toMap() -> [String : Any] {
                        var map = super.toMap()
                        if self.requestModality != nil {
                            map["RequestModality"] = self.requestModality!
                        }
                        if self.responseModality != nil {
                            map["ResponseModality"] = self.responseModality!
                        }
                        return map
                    }
                    ...
                    public override func fromMap(_ dict: [String: Any?]?) -> Void {
                        guard let dict else { return }
                        if let value = dict["RequestModality"] as? [String] {
                            self.requestModality = value
                        }
                        if let value = dict["ResponseModality"] as? [String] {
                            self.responseModality = value
                        }
                    }
                }
                public var creditMultiplier: GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList.CreditMultiplier?

                public var description_: String?

                public var features: [String]?

                public var inferenceMetadata: GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList.InferenceMetadata?
                ...
                public override func validate() throws -> Void {
                    try self.creditMultiplier?.validate()
                    try self.inferenceMetadata?.validate()
                }

                public override func toMap() -> [String : Any] {
                    var map = super.toMap()
                    if self.creditMultiplier != nil {
                        map["CreditMultiplier"] = self.creditMultiplier?.toMap()
                    }
                    if self.description_ != nil {
                        map["Description"] = self.description_!
                    }
                    ...
                    if self.inferenceMetadata != nil {
                        map["InferenceMetadata"] = self.inferenceMetadata?.toMap()
                    }
                    if self.llmCode != nil {
                        map["LlmCode"] = self.llmCode!
                    }
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    guard let dict else { return }
                    if let value = dict["CreditMultiplier"] as? [String: Any?] {
                        var model = GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList.CreditMultiplier()
                        model.fromMap(value)
                        self.creditMultiplier = model
                    }
                    if let value = dict["Description"] as? String {
                        self.description_ = value
                    }
                    ...
                    if let value = dict["InferenceMetadata"] as? [String: Any?] {
                        var model = GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList.InferenceMetadata()
                        model.fromMap(value)
                        self.inferenceMetadata = model
                    }
                    if let value = dict["LlmCode"] as? String {
                        self.llmCode = value
                    }
            ...
            public var llmInfoList: [GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList]?

            public var modelProviderTemplateId: String?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.llmInfoList != nil {
                    var tmp : [Any] = []
                    for k in self.llmInfoList! {
                        tmp.append(k.toMap())
                    }
                    map["LlmInfoList"] = tmp
                }
                if self.modelProviderTemplateId != nil {
                    map["ModelProviderTemplateId"] = self.modelProviderTemplateId!
                }
                if self.name != nil {
                    map["Name"] = self.name!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["LlmInfoList"] as? [Any?] {
                    var tmp : [GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList] = []
                    for v in value {
                        if v != nil {
                            var model = GetRuntimeModelConfigResponseBody.Data.ModelProviderList.LlmInfoList()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                    ...
                    self.llmInfoList = tmp
                }
                if let value = dict["ModelProviderTemplateId"] as? String {
                    self.modelProviderTemplateId = value
                }
                if let value = dict["Name"] as? String {
                    self.name = value
                }
        ...
        public var modelProviderList: [GetRuntimeModelConfigResponseBody.Data.ModelProviderList]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.defaultModel != nil {
                map["DefaultModel"] = self.defaultModel!
            }
            if self.modelProviderList != nil {
                var tmp : [Any] = []
                for k in self.modelProviderList! {
                    tmp.append(k.toMap())
                }
                map["ModelProviderList"] = tmp
            }
            if self.modelTemplateId != nil {
                map["ModelTemplateId"] = self.modelTemplateId!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["DefaultModel"] as? String {
                self.defaultModel = value
            }
            if let value = dict["ModelProviderList"] as? [Any?] {
                var tmp : [GetRuntimeModelConfigResponseBody.Data.ModelProviderList] = []
                for v in value {
                    if v != nil {
                        var model = GetRuntimeModelConfigResponseBody.Data.ModelProviderList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: GetRuntimeModelConfigResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = GetRuntimeModelConfigResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class GetRuntimeModelConfigResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetRuntimeModelConfigResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetRuntimeModelConfigResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListAppsByAppInstanceGroupIdRequest : Tea.TeaModel {
    public var appInstanceGroupId: String?
...
public class ListAppsByAppInstanceGroupIdResponseBody : Tea.TeaModel {
    public class Apps : Tea.TeaModel {
        public var appIcon: String?
        ...
        public var authorizedUserCount: Int32?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.authorizedUserCount != nil {
                map["AuthorizedUserCount"] = self.authorizedUserCount!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["AuthorizedUserCount"] as? Int32 {
                self.authorizedUserCount = value
            }
        }
    }
    public var apps: [ListAppsByAppInstanceGroupIdResponseBody.Apps]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Apps"] as? [Any?] {
            var tmp : [ListAppsByAppInstanceGroupIdResponseBody.Apps] = []
            for v in value {
                if v != nil {
                    var model = ListAppsByAppInstanceGroupIdResponseBody.Apps()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListAppsByAppInstanceGroupIdResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListAppsByAppInstanceGroupIdResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListAppsByAppInstanceGroupIdResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListAuthorizedAppInstanceGroupByUserRequest : Tea.TeaModel {
    public var appId: String?
...
public class ListAuthorizedAppInstanceGroupByUserResponseBody : Tea.TeaModel {
    public class AppInstanceGroupModels : Tea.TeaModel {
        public class Apps : Tea.TeaModel {
            public var appIcon: String?
        ...
        public var apps: [ListAuthorizedAppInstanceGroupByUserResponseBody.AppInstanceGroupModels.Apps]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Apps"] as? [Any?] {
                var tmp : [ListAuthorizedAppInstanceGroupByUserResponseBody.AppInstanceGroupModels.Apps] = []
                for v in value {
                    if v != nil {
                        var model = ListAuthorizedAppInstanceGroupByUserResponseBody.AppInstanceGroupModels.Apps()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var appInstanceGroupModels: [ListAuthorizedAppInstanceGroupByUserResponseBody.AppInstanceGroupModels]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AppInstanceGroupModels"] as? [Any?] {
            var tmp : [ListAuthorizedAppInstanceGroupByUserResponseBody.AppInstanceGroupModels] = []
            for v in value {
                if v != nil {
                    var model = ListAuthorizedAppInstanceGroupByUserResponseBody.AppInstanceGroupModels()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListAuthorizedAppInstanceGroupByUserResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListAuthorizedAppInstanceGroupByUserResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListAuthorizedAppInstanceGroupByUserResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListAuthorizedAppsByUserRequest : Tea.TeaModel {
    public var appId: String?
...
public class ListAuthorizedAppsByUserResponseBody : Tea.TeaModel {
    public class Apps : Tea.TeaModel {
        public var appIcon: String?
    ...
    public var apps: [ListAuthorizedAppsByUserResponseBody.Apps]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Apps"] as? [Any?] {
            var tmp : [ListAuthorizedAppsByUserResponseBody.Apps] = []
            for v in value {
                if v != nil {
                    var model = ListAuthorizedAppsByUserResponseBody.Apps()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListAuthorizedAppsByUserResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListAuthorizedAppsByUserResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListAuthorizedAppsByUserResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListAuthorizedUsersRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.userIdFuzzy != nil {
            map["UserIdFuzzy"] = self.userIdFuzzy!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["UserIdFuzzy"] as? String {
            self.userIdFuzzy = value
        }
    }
}
...
public class ListAuthorizedUsersResponseBody : Tea.TeaModel {
    public class Users : Tea.TeaModel {
        ...
        public var isAuthAllApps: String?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.isAuthAllApps != nil {
                map["IsAuthAllApps"] = self.isAuthAllApps!
            }
            if self.phone != nil {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["IsAuthAllApps"] as? String {
                self.isAuthAllApps = value
            }
    ...
    public var users: [ListAuthorizedUsersResponseBody.Users]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Users"] as? [Any?] {
            var tmp : [ListAuthorizedUsersResponseBody.Users] = []
            for v in value {
                if v != nil {
                    var model = ListAuthorizedUsersResponseBody.Users()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListBrowserInstanceGroupRequest : Tea.TeaModel {
    public class Tag : Tea.TeaModel {
        public var key: String?
    ...
    public var tag: [ListBrowserInstanceGroupRequest.Tag]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Tag"] as? [Any?] {
            var tmp : [ListBrowserInstanceGroupRequest.Tag] = []
            for v in value {
                if v != nil {
                    var model = ListBrowserInstanceGroupRequest.Tag()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListBrowserInstanceGroupResponseBody : Tea.TeaModel {
    public class BrowserInstanceGroupModels : Tea.TeaModel {
        public class AuthorizedUserInfo : Tea.TeaModel {
            public var totalCount: Int32?
        ...
        public class Policy : Tea.TeaModel {
            ...
            public var authorizeAccessPolicyRules: [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.AuthorizeAccessPolicyRules]?

            public var clientTypes: [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.ClientTypes]?

            public var clipboardPolicy: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.ClipboardPolicy?

            public var videoPolicy: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.VideoPolicy?

            public var watermarkPolicy: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.WatermarkPolicy?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["AuthorizeAccessPolicyRules"] as? [Any?] {
                    var tmp : [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.AuthorizeAccessPolicyRules] = []
                    for v in value {
                        if v != nil {
                            var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.AuthorizeAccessPolicyRules()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["ClientTypes"] as? [Any?] {
                    var tmp : [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.ClientTypes] = []
                    for v in value {
                        if v != nil {
                            var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.ClientTypes()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["ClipboardPolicy"] as? [String: Any?] {
                    var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.ClipboardPolicy()
                    model.fromMap(value)
                    self.clipboardPolicy = model
                }
                if let value = dict["VideoPolicy"] as? [String: Any?] {
                    var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.VideoPolicy()
                    model.fromMap(value)
                    self.videoPolicy = model
                }
                if let value = dict["WatermarkPolicy"] as? [String: Any?] {
                    var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy.WatermarkPolicy()
                    model.fromMap(value)
                    self.watermarkPolicy = model
                }
            }
        ...
        public var authorizedUserInfo: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.AuthorizedUserInfo?

        public var bizRegionId: String?

        public var browserConfig: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.BrowserConfig?
        ...
        public var duration: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Duration?
        ...
        public var network: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Network?

        public var osType: String?

        public var policy: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy?
        ...
        public var tags: [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Tags]?

        public var tier: String?

        public var timers: [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Timers]?

        public var userGroupAuthMode: String?

        public var userLimit: ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.UserLimit?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["AuthorizedUserInfo"] as? [String: Any?] {
                var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.AuthorizedUserInfo()
                model.fromMap(value)
                self.authorizedUserInfo = model
            }
            if let value = dict["BizRegionId"] as? String {
            ...
            if let value = dict["BrowserConfig"] as? [String: Any?] {
                var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.BrowserConfig()
                model.fromMap(value)
                self.browserConfig = model
            }
            if let value = dict["BrowserInstanceGroupId"] as? String {
            ...
            if let value = dict["Duration"] as? [String: Any?] {
                var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Duration()
                model.fromMap(value)
                self.duration = model
            }
            if let value = dict["ExpiredTime"] as? String {
            ...
            if let value = dict["Network"] as? [String: Any?] {
                var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Network()
                model.fromMap(value)
                self.network = model
            }
            if let value = dict["OsType"] as? String {
            ...
            if let value = dict["Policy"] as? [String: Any?] {
                var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Policy()
                model.fromMap(value)
                self.policy = model
            }
            if let value = dict["Status"] as? String {
            ...
            if let value = dict["Tags"] as? [Any?] {
                var tmp : [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Tags] = []
                for v in value {
                    if v != nil {
                        var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Tags()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["Timers"] as? [Any?] {
                var tmp : [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Timers] = []
                for v in value {
                    if v != nil {
                        var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.Timers()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["UserLimit"] as? [String: Any?] {
                var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels.UserLimit()
                model.fromMap(value)
                self.userLimit = model
            }
        }
    }
    public var browserInstanceGroupModels: [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.browserInstanceGroupModels != nil {
            var tmp : [Any] = []
            for k in self.browserInstanceGroupModels! {
                tmp.append(k.toMap())
            }
            map["BrowserInstanceGroupModels"] = tmp
        }
        if self.pageNumber != nil {
            map["PageNumber"] = self.pageNumber!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["BrowserInstanceGroupModels"] as? [Any?] {
            var tmp : [ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels] = []
            for v in value {
                if v != nil {
                    var model = ListBrowserInstanceGroupResponseBody.BrowserInstanceGroupModels()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
            ...
            self.browserInstanceGroupModels = tmp
        }
        if let value = dict["PageNumber"] as? Int32 {
            self.pageNumber = value
        }
...
public class ListBrowserInstanceGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListBrowserInstanceGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListBrowserInstanceGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListDesktopAgentRuntimeRequest : Tea.TeaModel {
    public var agentImOnlineStatus: String?

    public var agentInstanceStatuses: [String]?

    public var agentInstanceVersions: [String]?

    public var agentPlatform: String?

    public var agentPlatformList: [String]?

    public var agentProvider: String?

    public var agentProviderList: [String]?

    public var agentTemplateIds: [String]?
    ...
    public var deploymentSource: String?

    public var desktopIds: [String]?

    public var desktopNames: [String]?

    public var desktopStatuses: [String]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.agentImOnlineStatus != nil {
            map["AgentImOnlineStatus"] = self.agentImOnlineStatus!
        }
        if self.agentInstanceStatuses != nil {
            map["AgentInstanceStatuses"] = self.agentInstanceStatuses!
        }
        if self.agentInstanceVersions != nil {
            map["AgentInstanceVersions"] = self.agentInstanceVersions!
        }
        if self.agentPlatform != nil {
            map["AgentPlatform"] = self.agentPlatform!
        }
        if self.agentPlatformList != nil {
            map["AgentPlatformList"] = self.agentPlatformList!
        }
        if self.agentProvider != nil {
            map["AgentProvider"] = self.agentProvider!
        }
        ...
        if self.agentTemplateIds != nil {
            map["AgentTemplateIds"] = self.agentTemplateIds!
        }
        ...
        if self.deploymentSource != nil {
            map["DeploymentSource"] = self.deploymentSource!
        }
        if self.desktopIds != nil {
            map["DesktopIds"] = self.desktopIds!
        }
        if self.desktopNames != nil {
            map["DesktopNames"] = self.desktopNames!
        }
        if self.desktopStatuses != nil {
            map["DesktopStatuses"] = self.desktopStatuses!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AgentImOnlineStatus"] as? String {
            self.agentImOnlineStatus = value
        }
        if let value = dict["AgentInstanceStatuses"] as? [String] {
            self.agentInstanceStatuses = value
        }
        if let value = dict["AgentInstanceVersions"] as? [String] {
            self.agentInstanceVersions = value
        }
        if let value = dict["AgentPlatform"] as? String {
            self.agentPlatform = value
        }
        if let value = dict["AgentPlatformList"] as? [String] {
            self.agentPlatformList = value
        }
        if let value = dict["AgentProvider"] as? String {
            self.agentProvider = value
        }
        ...
        if let value = dict["AgentTemplateIds"] as? [String] {
            self.agentTemplateIds = value
        }
        ...
        if let value = dict["DeploymentSource"] as? String {
            self.deploymentSource = value
        }
        if let value = dict["DesktopIds"] as? [String] {
            self.desktopIds = value
        }
        if let value = dict["DesktopNames"] as? [String] {
            self.desktopNames = value
        }
        if let value = dict["DesktopStatuses"] as? [String] {
            self.desktopStatuses = value
        }
        if let value = dict["HasAuthUser"] as? Bool {
            self.hasAuthUser = value
        }
        if let value = dict["HasRisk"] as? Bool {
            self.hasRisk = value
        }
        if let value = dict["IncludeRiskInfo"] as? Bool {
            self.includeRiskInfo = value
...
public class ListDesktopAgentRuntimeResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class AgentImInfo : Tea.TeaModel {
            public var agentImOnlineStatus: String?

            public var agentImStatus: String?

            public var cloudSpaceStatus: String?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.agentImStatus != nil {
                    map["AgentImStatus"] = self.agentImStatus!
                }
                if self.cloudSpaceStatus != nil {
                    map["CloudSpaceStatus"] = self.cloudSpaceStatus!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["AgentImStatus"] as? String {
                    self.agentImStatus = value
                }
                if let value = dict["CloudSpaceStatus"] as? String {
                    self.cloudSpaceStatus = value
                }
            }
        }
        public class AgentInstanceInfoList : Tea.TeaModel {
            public var agentInstanceStatus: String?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.agentInstanceStatus != nil {
                    map["AgentInstanceStatus"] = self.agentInstanceStatus!
                }
                ...
                if self.channelConfiguredList != nil {
                    map["ChannelConfiguredList"] = self.channelConfiguredList!
                }
                if self.deploymentSource != nil {
                    map["DeploymentSource"] = self.deploymentSource!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["AgentInstanceStatus"] as? String {
                    self.agentInstanceStatus = value
                }
                ...
                if let value = dict["ChannelConfiguredList"] as? [String] {
                    self.channelConfiguredList = value
                }
                if let value = dict["DeploymentSource"] as? String {
                    self.deploymentSource = value
                }
        ...
        public class RiskInfo : Tea.TeaModel {
            public var agentUninstalled: Bool?

            public var channelModified: Bool?

            public var modelModified: Bool?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.agentUninstalled != nil {
                    map["AgentUninstalled"] = self.agentUninstalled!
                }
                if self.channelModified != nil {
                    map["ChannelModified"] = self.channelModified!
                }
                if self.modelModified != nil {
                    map["ModelModified"] = self.modelModified!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["AgentUninstalled"] as? Bool {
                    self.agentUninstalled = value
                }
                if let value = dict["ChannelModified"] as? Bool {
                    self.channelModified = value
                }
                if let value = dict["ModelModified"] as? Bool {
                    self.modelModified = value
                }
            }
        }
        public var agentImInfo: ListDesktopAgentRuntimeResponseBody.Data.AgentImInfo?

        public var agentInstanceInfoList: [ListDesktopAgentRuntimeResponseBody.Data.AgentInstanceInfoList]?
        ...
        public var riskInfo: ListDesktopAgentRuntimeResponseBody.Data.RiskInfo?
        ...
        public override func validate() throws -> Void {
            try self.agentImInfo?.validate()
            try self.resourceGroup?.validate()
            try self.riskInfo?.validate()
        }

        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.agentImInfo != nil {
                map["AgentImInfo"] = self.agentImInfo?.toMap()
            }
            if self.agentInstanceInfoList != nil {
                var tmp : [Any] = []
                for k in self.agentInstanceInfoList! {
                    tmp.append(k.toMap())
                }
                map["AgentInstanceInfoList"] = tmp
            }
            if self.authUsers != nil {
                map["AuthUsers"] = self.authUsers!
            }
            ...
            if self.riskInfo != nil {
                map["RiskInfo"] = self.riskInfo?.toMap()
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["AgentImInfo"] as? [String: Any?] {
                var model = ListDesktopAgentRuntimeResponseBody.Data.AgentImInfo()
                model.fromMap(value)
                self.agentImInfo = model
            }
            if let value = dict["AgentInstanceInfoList"] as? [Any?] {
                var tmp : [ListDesktopAgentRuntimeResponseBody.Data.AgentInstanceInfoList] = []
                for v in value {
                    if v != nil {
                        var model = ListDesktopAgentRuntimeResponseBody.Data.AgentInstanceInfoList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
                ...
                self.agentInstanceInfoList = tmp
            }
            if let value = dict["AuthUsers"] as? [String] {
                self.authUsers = value
            }
            ...
            if let value = dict["RiskInfo"] as? [String: Any?] {
                var model = ListDesktopAgentRuntimeResponseBody.Data.RiskInfo()
                model.fromMap(value)
                self.riskInfo = model
            }
        }
    }
    public var data: [ListDesktopAgentRuntimeResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListDesktopAgentRuntimeResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListDesktopAgentRuntimeResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListDesktopAgentRuntimeResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListDesktopAgentRuntimeResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListDesktopAgentRuntimeResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListLlmTemplatesRequest : Tea.TeaModel {
    public var bizType: Int32?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.smartModel != nil {
            map["SmartModel"] = self.smartModel!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["SmartModel"] as? Bool {
            self.smartModel = value
        }
    }
}

public class ListLlmTemplatesShrinkRequest : Tea.TeaModel {
    public var bizType: Int32?

    public var llmCode: String?

    public var llmTemplateIdsShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.llmTemplateIdsShrink != nil {
            map["LlmTemplateIds"] = self.llmTemplateIdsShrink!
        }
        if self.modelTemplateId != nil {
            map["ModelTemplateId"] = self.modelTemplateId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["LlmTemplateIds"] as? String {
            self.llmTemplateIdsShrink = value
        }
        if let value = dict["ModelTemplateId"] as? String {
            self.modelTemplateId = value
        }
...
public class ListLlmTemplatesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class CreditMultiplier : Tea.TeaModel {
            public var max: Double?
        ...
        public class Prices : Tea.TeaModel {
            public class Prices : Tea.TeaModel {
                ...
                public override func toMap() -> [String : Any] {
                    ...
                    if self.priceName != nil {
                        map["PriceName"] = self.priceName!
                    }
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    ...
                    if let value = dict["PriceName"] as? String {
                        self.priceName = value
                    }
            ...
            public var prices: [ListLlmTemplatesResponseBody.Data.Prices.Prices]?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.rangeName != nil {
                    map["RangeName"] = self.rangeName!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["Prices"] as? [Any?] {
                    var tmp : [ListLlmTemplatesResponseBody.Data.Prices.Prices] = []
                    for v in value {
                        if v != nil {
                            var model = ListLlmTemplatesResponseBody.Data.Prices.Prices()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["RangeName"] as? String {
        ...
        public var creditMultiplier: ListLlmTemplatesResponseBody.Data.CreditMultiplier?

        public var description_: String?

        public var features: [String]?

        public var inferenceMetadata: ListLlmTemplatesResponseBody.Data.InferenceMetadata?
        ...
        public var prices: [ListLlmTemplatesResponseBody.Data.Prices]?
        ...
        public var routePolicyCount: Int32?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.routePolicyCount != nil {
                map["RoutePolicyCount"] = self.routePolicyCount!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CreditMultiplier"] as? [String: Any?] {
                var model = ListLlmTemplatesResponseBody.Data.CreditMultiplier()
                model.fromMap(value)
                self.creditMultiplier = model
            }
            if let value = dict["Description"] as? String {
            ...
            if let value = dict["InferenceMetadata"] as? [String: Any?] {
                var model = ListLlmTemplatesResponseBody.Data.InferenceMetadata()
                model.fromMap(value)
                self.inferenceMetadata = model
            }
            if let value = dict["IsDefaultModel"] as? Bool {
            ...
            if let value = dict["ModelInfo"] as? [String: Any] {
            ...
            if let value = dict["Prices"] as? [Any?] {
                var tmp : [ListLlmTemplatesResponseBody.Data.Prices] = []
                for v in value {
                    if v != nil {
                        var model = ListLlmTemplatesResponseBody.Data.Prices()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["RoutePolicyCount"] as? Int32 {
                self.routePolicyCount = value
            }
        }
    }
    public var data: [ListLlmTemplatesResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListLlmTemplatesResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListLlmTemplatesResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListLlmTemplatesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListLlmTemplatesResponseBody?
...
public class ListModelProviderTemplatesRequest : Tea.TeaModel {
    public var agentPlatform: String?
    ...
    public var providerTemplateIds: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.providerTemplateIds != nil {
            map["ProviderTemplateIds"] = self.providerTemplateIds!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ProviderTemplateIds"] as? [String] {
            self.providerTemplateIds = value
        }
    }
}

public class ListModelProviderTemplatesShrinkRequest : Tea.TeaModel {
    public var agentPlatform: String?
    ...
    public var providerTemplateIdsShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.providerTemplateIdsShrink != nil {
            map["ProviderTemplateIds"] = self.providerTemplateIdsShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ProviderTemplateIds"] as? String {
            self.providerTemplateIdsShrink = value
        }
    }
}

public class ListModelProviderTemplatesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var config: String?
    ...
    public var data: [ListModelProviderTemplatesResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListModelProviderTemplatesResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListModelProviderTemplatesResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListModelProviderTemplatesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListModelProviderTemplatesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListModelProviderTemplatesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListModelTemplateResourceGroupRequest : Tea.TeaModel {
    public var modelTemplateId: String?
...
public class ListModelTemplateResourceGroupResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var resourceGroupId: String?
    ...
    public var data: [ListModelTemplateResourceGroupResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListModelTemplateResourceGroupResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListModelTemplateResourceGroupResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListModelTemplateResourceGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListModelTemplateResourceGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListModelTemplateResourceGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListModelTemplatesRequest : Tea.TeaModel {
    public var agentPlatform: String?
    ...
    public var modelTemplateIdList: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.hasModel != nil {
            map["HasModel"] = self.hasModel!
        }
        if self.modelTemplateIdList != nil {
            map["ModelTemplateIdList"] = self.modelTemplateIdList!
        }
        if self.name != nil {
            map["Name"] = self.name!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["HasModel"] as? Bool {
            self.hasModel = value
        }
        if let value = dict["ModelTemplateIdList"] as? [String] {
            self.modelTemplateIdList = value
        }
        if let value = dict["Name"] as? String {
            self.name = value
        }
...
public class ListModelTemplatesShrinkRequest : Tea.TeaModel {
    public var agentPlatform: String?
    ...
    public var modelTemplateIdListShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.modelTemplateIdListShrink != nil {
            map["ModelTemplateIdList"] = self.modelTemplateIdListShrink!
        }
        if self.name != nil {
            map["Name"] = self.name!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ModelTemplateIdList"] as? String {
            self.modelTemplateIdListShrink = value
        }
        if let value = dict["Name"] as? String {
            self.name = value
        }
...
public class ListModelTemplatesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var agentPlatform: String?
        ...
        public var userGroupCount: Int32?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.userGroupCount != nil {
                map["UserGroupCount"] = self.userGroupCount!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["UserGroupCount"] as? Int32 {
                self.userGroupCount = value
            }
        }
    }
    public var data: [ListModelTemplatesResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListModelTemplatesResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListModelTemplatesResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListModelTemplatesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListModelTemplatesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListModelTemplatesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListPublishedAppInstanceGroupRequest : Tea.TeaModel {
    public var appId: String?
    ...
    public var excludeUserId: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.excludeUserId != nil {
            map["ExcludeUserId"] = self.excludeUserId!
        }
        if self.pageNumber != nil {
            map["PageNumber"] = self.pageNumber!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ExcludeUserId"] as? String {
            self.excludeUserId = value
        }
        if let value = dict["PageNumber"] as? Int32 {
            self.pageNumber = value
        }
...
public class ListPublishedAppInstanceGroupResponseBody : Tea.TeaModel {
    public class AppInstanceGroupModels : Tea.TeaModel {
        public class Apps : Tea.TeaModel {
            public var appIcon: String?
        ...
        public var apps: [ListPublishedAppInstanceGroupResponseBody.AppInstanceGroupModels.Apps]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Apps"] as? [Any?] {
                var tmp : [ListPublishedAppInstanceGroupResponseBody.AppInstanceGroupModels.Apps] = []
                for v in value {
                    if v != nil {
                        var model = ListPublishedAppInstanceGroupResponseBody.AppInstanceGroupModels.Apps()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var appInstanceGroupModels: [ListPublishedAppInstanceGroupResponseBody.AppInstanceGroupModels]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AppInstanceGroupModels"] as? [Any?] {
            var tmp : [ListPublishedAppInstanceGroupResponseBody.AppInstanceGroupModels] = []
            for v in value {
                if v != nil {
                    var model = ListPublishedAppInstanceGroupResponseBody.AppInstanceGroupModels()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListPublishedAppInstanceGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListPublishedAppInstanceGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListPublishedAppInstanceGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListPublishedAppsRequest : Tea.TeaModel {
    public var appId: String?
...
public class ListPublishedAppsResponseBody : Tea.TeaModel {
    public class Apps : Tea.TeaModel {
        public var appIcon: String?
    ...
    public var apps: [ListPublishedAppsResponseBody.Apps]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Apps"] as? [Any?] {
            var tmp : [ListPublishedAppsResponseBody.Apps] = []
            for v in value {
                if v != nil {
                    var model = ListPublishedAppsResponseBody.Apps()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListPublishedAppsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListPublishedAppsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListPublishedAppsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListWuyingServerRequest : Tea.TeaModel {
    ...
    public var expiredTimeEnd: String?

    public var expiredTimeStart: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.expiredTimeEnd != nil {
            map["ExpiredTimeEnd"] = self.expiredTimeEnd!
        }
        if self.expiredTimeStart != nil {
            map["ExpiredTimeStart"] = self.expiredTimeStart!
        }
        if self.imageId != nil {
            map["ImageId"] = self.imageId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ExpiredTimeEnd"] as? String {
            self.expiredTimeEnd = value
        }
        if let value = dict["ExpiredTimeStart"] as? String {
            self.expiredTimeStart = value
        }
        if let value = dict["ImageId"] as? String {
            self.imageId = value
        }
...
public class ListWuyingServerResponseBody : Tea.TeaModel {
    public class WuyingServerList : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.erdmaStatus != nil {
                map["ErdmaStatus"] = self.erdmaStatus!
            }
            if self.expiredTime != nil {
                map["ExpiredTime"] = self.expiredTime!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ErdmaStatus"] as? String {
                self.erdmaStatus = value
            }
            if let value = dict["ExpiredTime"] as? String {
                self.expiredTime = value
            }
...
public class ListZonesResponseBody : Tea.TeaModel {
    public class ListZonesModel : Tea.TeaModel {
    ...
    public var listZonesModel: ListZonesResponseBody.ListZonesModel?
    ...
    public override func validate() throws -> Void {
        try self.listZonesModel?.validate()
    }

    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.listZonesModel != nil {
            map["ListZonesModel"] = self.listZonesModel?.toMap()
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["ListZonesModel"] as? [String: Any?] {
            var model = ListZonesResponseBody.ListZonesModel()
            model.fromMap(value)
            self.listZonesModel = model
        }
        if let value = dict["RequestId"] as? String {
            self.requestId = value
        }
...
public class ModifyBrowserInstanceGroupRequest : Tea.TeaModel {
    ...
    public class Policy : Tea.TeaModel {
        ...
        public var authorizeAccessPolicyRules: [ModifyBrowserInstanceGroupRequest.Policy.AuthorizeAccessPolicyRules]?

        public var clientTypes: [ModifyBrowserInstanceGroupRequest.Policy.ClientTypes]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["AuthorizeAccessPolicyRules"] as? [Any?] {
                var tmp : [ModifyBrowserInstanceGroupRequest.Policy.AuthorizeAccessPolicyRules] = []
                for v in value {
                    if v != nil {
                        var model = ModifyBrowserInstanceGroupRequest.Policy.AuthorizeAccessPolicyRules()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["ClientTypes"] as? [Any?] {
                var tmp : [ModifyBrowserInstanceGroupRequest.Policy.ClientTypes] = []
                for v in value {
                    if v != nil {
                        var model = ModifyBrowserInstanceGroupRequest.Policy.ClientTypes()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class RemoveResourceGroupModelTemplateRequest : Tea.TeaModel {
    public var modelTemplateId: String?
...
public class RemoveResourceGroupModelTemplateResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var code: String?
    ...
    public var data: [RemoveResourceGroupModelTemplateResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [RemoveResourceGroupModelTemplateResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = RemoveResourceGroupModelTemplateResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class RemoveResourceGroupModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RemoveResourceGroupModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RemoveResourceGroupModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class RemoveRuntimeChannelRequest : Tea.TeaModel {
    public var agentPlatform: String?
...
public class RemoveRuntimeChannelResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class RemoveRuntimeChannelResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RemoveRuntimeChannelResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RemoveRuntimeChannelResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class RemoveRuntimeModelTemplateRequest : Tea.TeaModel {
    public var modelTemplateId: String?
...
public class RemoveRuntimeModelTemplateResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var code: String?
    ...
    public var data: [RemoveRuntimeModelTemplateResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [RemoveRuntimeModelTemplateResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = RemoveRuntimeModelTemplateResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class RemoveRuntimeModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RemoveRuntimeModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RemoveRuntimeModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateModelProviderTemplateRequest : Tea.TeaModel {
    ...
    public var config: UpdateModelProviderTemplateRequest.Config?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Config"] as? [String: Any?] {
            var model = UpdateModelProviderTemplateRequest.Config()
            model.fromMap(value)
            self.config = model
        }
        if let value = dict["Description"] as? String {
...
public class UpdateModelProviderTemplateShrinkRequest : Tea.TeaModel {
...
public class UpdateModelProviderTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class UpdateModelProviderTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateModelProviderTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateModelProviderTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateModelTemplateRequest : Tea.TeaModel {
    public var config: String?
...
public class UpdateModelTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class UpdateModelTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateModelTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateModelTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
