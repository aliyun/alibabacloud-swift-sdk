...
```ruby
pod 'AlibabacloudAppstreamCenter20210901', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/appstream-center-20210901" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/appstream-center-20210901.git", from: "1.0.0")
]
```
