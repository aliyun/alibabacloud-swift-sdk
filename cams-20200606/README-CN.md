...
```ruby
pod 'AlibabacloudCams20200606', '~> 1.0.6'
```
...
```ogdl
github "alibabacloud-sdk-swift/cams-20200606" "1.0.6"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/cams-20200606.git", from: "1.0.6")
]
```
