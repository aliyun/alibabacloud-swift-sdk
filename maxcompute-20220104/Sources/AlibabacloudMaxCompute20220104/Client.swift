...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteProjectWithOptions(_ projectName: String, _ request: DeleteProjectRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteProjectResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.isLogical)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteProject(_ projectName: String, _ request: DeleteProjectRequest) async throws -> DeleteProjectResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await deleteProjectWithOptions(projectName as! String, request as! DeleteProjectRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func getProjectWithOptions(_ projectName: String, _ request: GetProjectRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> GetProjectResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.withQuotaProductType)) {
            query["withQuotaProductType"] = request.withQuotaProductType!;
        }
        if (!TeaUtils.Client.isUnset(request.withStorageTierInfo)) {
    ...
    public func listJobInfosWithOptions(_ request: ListJobInfosRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListJobInfosResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.extNodeNameList)) {
        ...
        if (!TeaUtils.Client.isUnset(request.taskNameList)) {
    ...
    public func listMmsJobsWithOptions(_ sourceId: String, _ request: ListMmsJobsRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListMmsJobsResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.timerId)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateProjectModelTierWithOptions(_ projectName: String, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateProjectModelTierResponse {
        var req: AlibabacloudOpenApi.OpenApiRequest = AlibabacloudOpenApi.OpenApiRequest([
            "headers": headers as! [String: String]
        ])
        var params: AlibabacloudOpenApi.Params = AlibabacloudOpenApi.Params([
            ...
            "version": "2022-01-04",
            "protocol": "HTTPS",
            "pathname": "/api/v1/projects/" + (AlibabaCloudOpenApiUtil.Client.getEncodeParam(projectName)) + "/modelTier",
            "method": "PUT",
            "authType": "AK",
            "style": "ROA",
            "reqBodyType": "json",
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateProjectModelTierResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateProjectModelTier(_ projectName: String) async throws -> UpdateProjectModelTierResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await updateProjectModelTierWithOptions(projectName as! String, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
