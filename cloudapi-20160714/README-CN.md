...
```ruby
pod 'AlibabacloudCloudAPI20160714', '~> 2.2.15'
```
...
```ogdl
github "alibabacloud-sdk-swift/cloudapi-20160714" "2.2.15"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/cloudapi-20160714.git", from: "2.2.15")
]
```
