...
```ruby
pod 'AlibabacloudCloudAPI20160714', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/cloudapi-20160714" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/cloudapi-20160714.git", from: "1.0.0")
]
```
