...
public class MobileRecycledMetaVerifyRequest : Tea.TeaModel {
    public var mobile: String?
...
public class MobileRecycledMetaVerifyResponseBody : Tea.TeaModel {
    public class ResultObject : Tea.TeaModel {
        public var bizCode: String?
    ...
    public var resultObject: MobileRecycledMetaVerifyResponseBody.ResultObject?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ResultObject"] as? [String: Any?] {
            var model = MobileRecycledMetaVerifyResponseBody.ResultObject()
            model.fromMap(value)
            self.resultObject = model
        }
    }
...
public class MobileRecycledMetaVerifyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: MobileRecycledMetaVerifyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = MobileRecycledMetaVerifyResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
