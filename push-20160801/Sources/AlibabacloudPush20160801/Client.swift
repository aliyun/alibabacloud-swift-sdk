...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func pushWithOptions(_ tmpReq: PushRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PushResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.androidMeizuNoticeMsgType)) {
        ...
        if (!TeaUtils.Client.isUnset(request.androidMessageOppoCategory)) {
            query["AndroidMessageOppoCategory"] = request.androidMessageOppoCategory ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.androidMessageOppoNotifyLevel)) {
        ...
        if (!TeaUtils.Client.isUnset(request.androidXiaomiFocusParam)) {
            query["AndroidXiaomiFocusParam"] = request.androidXiaomiFocusParam ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.androidXiaomiFocusPics)) {
