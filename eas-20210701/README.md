...
```ruby
pod 'AlibabacloudEas20210701', '~> 2.0.2'
```
...
```ogdl
github "alibabacloud-sdk-swift/eas-20210701" "2.0.2"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/eas-20210701.git", from: "2.0.2")
]
```
