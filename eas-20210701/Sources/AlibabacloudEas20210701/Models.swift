...
public class Artifact : Tea.TeaModel {
    ...
    public var versions: [Artifact.Versions]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Versions"] as? [Any?] {
            var tmp : [Artifact.Versions] = []
            for v in value {
                if v != nil {
                    var model = Artifact.Versions()
                    if v != nil {
...
public class ArtifactRelease : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.artifactRef != nil {
            map["ArtifactRef"] = self.artifactRef!
        }
        if self.createdAt != nil {
            map["CreatedAt"] = self.createdAt!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["ArtifactRef"] as? String {
...
public class Group : Tea.TeaModel {
    ...
    public var labels: [Group.Labels]?

    public var name: String?

    public var network: Group.Network?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Labels"] as? [Any?] {
            var tmp : [Group.Labels] = []
            for v in value {
                if v != nil {
                    var model = Group.Labels()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class Instance : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.detached != nil {
            map["Detached"] = self.detached!
        }
        ...
        if self.isReplica != nil {
            map["IsReplica"] = self.isReplica!
        }
        if self.isSpot != nil {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Detached"] as? Bool {
            self.detached = value
        }
        ...
        if let value = dict["IsReplica"] as? Bool {
...
public class CreateFaultInjectionRequest : Tea.TeaModel {
    public var faultArgs: Any?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.faultArgs != nil {
            map["FaultArgs"] = self.faultArgs!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["FaultArgs"] as? Any {
            self.faultArgs = value
        }
        if let value = dict["FaultType"] as? String {
            self.faultType = value
        }
    }
}

public class CreateFaultInjectionResponseBody : Tea.TeaModel {
    public var message: String?
...
public class CreateFaultInjectionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateFaultInjectionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateFaultInjectionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateGroupRequest : Tea.TeaModel {
    ...
    public var network: CreateGroupRequest.Network?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Network"] as? [String: Any?] {
            var model = CreateGroupRequest.Network()
            model.fromMap(value)
            self.network = model
        }
        if let value = dict["WorkSpaceId"] as? String {
...
public class CreateServiceRolloutRequest : Tea.TeaModel {
    public class Batch : Tea.TeaModel {
    ...
    public var batch: CreateServiceRolloutRequest.Batch?

    public var partition: CreateServiceRolloutRequest.Partition?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Batch"] as? [String: Any?] {
            var model = CreateServiceRolloutRequest.Batch()
            model.fromMap(value)
            self.batch = model
        }
        if let value = dict["Partition"] as? [String: Any?] {
            var model = CreateServiceRolloutRequest.Partition()
            model.fromMap(value)
...
public class CreateServiceRolloutResponseBody : Tea.TeaModel {
    public var message: String?
...
public class CreateServiceRolloutResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateServiceRolloutResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateServiceRolloutResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteFaultInjectionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteFaultInjectionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteFaultInjectionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteGatewayLabelRequest : Tea.TeaModel {
...
public class DeleteGatewayLabelShrinkRequest : Tea.TeaModel {
...
public class DeleteGatewayLabelResponseBody : Tea.TeaModel {
    public var message: String?
...
public class DeleteGatewayLabelResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteGatewayLabelResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteGatewayLabelResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteGroupRequest : Tea.TeaModel {
    public var cascadeDelete: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.cascadeDelete != nil {
            map["CascadeDelete"] = self.cascadeDelete!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["CascadeDelete"] as? String {
...
public class DeleteServiceRolloutRequest : Tea.TeaModel {
...
public class DeleteServiceRolloutResponseBody : Tea.TeaModel {
    public var message: String?
...
public class DeleteServiceRolloutResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteServiceRolloutResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteServiceRolloutResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeArtifactRequest : Tea.TeaModel {
...
public class DescribeArtifactResponse : Tea.TeaModel {
    public var headers: [String: String]?
...
public class DescribeServiceRolloutRequest : Tea.TeaModel {
...
public class DescribeServiceRolloutResponseBody : Tea.TeaModel {
    public class Rollout : Tea.TeaModel {
        public class Status : Tea.TeaModel {
            public var currentRevision: String?

            public var nextBatchStartTime: String?

            public var phase: String?

            public var totalReplicas: Int32?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.currentRevision != nil {
                    map["CurrentRevision"] = self.currentRevision!
                }
                if self.nextBatchStartTime != nil {
                    map["NextBatchStartTime"] = self.nextBatchStartTime!
                }
                if self.phase != nil {
                    map["Phase"] = self.phase!
                }
                if self.totalReplicas != nil {
                    map["TotalReplicas"] = self.totalReplicas!
                }
                if self.updateRevision != nil {
                    map["UpdateRevision"] = self.updateRevision!
                }
                if self.updatedReplicas != nil {
                    map["UpdatedReplicas"] = self.updatedReplicas!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["CurrentRevision"] as? String {
                    self.currentRevision = value
                }
                if let value = dict["NextBatchStartTime"] as? String {
                    self.nextBatchStartTime = value
                }
                if let value = dict["Phase"] as? String {
                    self.phase = value
                }
                if let value = dict["TotalReplicas"] as? Int32 {
                    self.totalReplicas = value
                }
                if let value = dict["UpdateRevision"] as? String {
                    self.updateRevision = value
                }
                if let value = dict["UpdatedReplicas"] as? Int32 {
        ...
        public class Strategy : Tea.TeaModel {
            ...
            public var batch: DescribeServiceRolloutResponseBody.Rollout.Strategy.Batch?

            public var partition: DescribeServiceRolloutResponseBody.Rollout.Strategy.Partition?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["Batch"] as? [String: Any?] {
                    var model = DescribeServiceRolloutResponseBody.Rollout.Strategy.Batch()
                    model.fromMap(value)
                    self.batch = model
                }
                if let value = dict["Partition"] as? [String: Any?] {
                    var model = DescribeServiceRolloutResponseBody.Rollout.Strategy.Partition()
                    model.fromMap(value)
                    self.partition = model
                }
            }
        }
        public var status: DescribeServiceRolloutResponseBody.Rollout.Status?

        public var strategy: DescribeServiceRolloutResponseBody.Rollout.Strategy?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Status"] as? [String: Any?] {
                var model = DescribeServiceRolloutResponseBody.Rollout.Status()
                model.fromMap(value)
                self.status = model
            }
            if let value = dict["Strategy"] as? [String: Any?] {
                var model = DescribeServiceRolloutResponseBody.Rollout.Strategy()
                model.fromMap(value)
                self.strategy = model
            }
        }
    ...
    public var rollout: DescribeServiceRolloutResponseBody.Rollout?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.rollout != nil {
            map["Rollout"] = self.rollout?.toMap()
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Rollout"] as? [String: Any?] {
            var model = DescribeServiceRolloutResponseBody.Rollout()
            model.fromMap(value)
            self.rollout = model
        }
    }
...
public class DescribeServiceRolloutResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeServiceRolloutResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeServiceRolloutResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListGroupsShrinkRequest : Tea.TeaModel {
    public var filter: String?
...
public class ListServiceInstanceFaultInjectionInfoResponseBody : Tea.TeaModel {
    public class FaultInfoList : Tea.TeaModel {
        public class FaultStatus : Tea.TeaModel {
            public var faultStatus: String?

            public var faultStatusMessage: String?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.faultStatus != nil {
                    map["FaultStatus"] = self.faultStatus!
                }
                if self.faultStatusMessage != nil {
                    map["FaultStatusMessage"] = self.faultStatusMessage!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["FaultStatus"] as? String {
                    self.faultStatus = value
                }
                if let value = dict["FaultStatusMessage"] as? String {
                    self.faultStatusMessage = value
                }
            }
        }
        public var faultArgs: Any?

        public var faultStatus: ListServiceInstanceFaultInjectionInfoResponseBody.FaultInfoList.FaultStatus?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.faultStatus != nil {
                map["FaultStatus"] = self.faultStatus?.toMap()
            }
            if self.faultType != nil {
                map["FaultType"] = self.faultType!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["FaultStatus"] as? [String: Any?] {
                var model = ListServiceInstanceFaultInjectionInfoResponseBody.FaultInfoList.FaultStatus()
                model.fromMap(value)
                self.faultStatus = model
            }
            if let value = dict["FaultType"] as? String {
                self.faultType = value
            }
    ...
    public var faultInfoList: [ListServiceInstanceFaultInjectionInfoResponseBody.FaultInfoList]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.faultInfoList != nil {
            var tmp : [Any] = []
            for k in self.faultInfoList! {
                tmp.append(k.toMap())
            }
            map["FaultInfoList"] = tmp
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["FaultInfoList"] as? [Any?] {
            var tmp : [ListServiceInstanceFaultInjectionInfoResponseBody.FaultInfoList] = []
            for v in value {
                if v != nil {
                    var model = ListServiceInstanceFaultInjectionInfoResponseBody.FaultInfoList()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListServiceInstanceFaultInjectionInfoResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListServiceInstanceFaultInjectionInfoResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListServiceInstanceFaultInjectionInfoResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListServiceInstancesRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.listReplica != nil {
            map["ListReplica"] = self.listReplica!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ListReplica"] as? Bool {
            self.listReplica = value
        }
...
public class UpdateGatewayLabelRequest : Tea.TeaModel {
    public var labels: [String: String]?
...
public class UpdateGatewayLabelResponseBody : Tea.TeaModel {
    public var message: String?
...
public class UpdateGatewayLabelResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateGatewayLabelResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateGatewayLabelResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateGroupRequest : Tea.TeaModel {
    ...
    public var network: UpdateGroupRequest.Network?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Network"] as? [String: Any?] {
            var model = UpdateGroupRequest.Network()
            model.fromMap(value)
            self.network = model
        }
        if let value = dict["TrafficMode"] as? String {
...
public class UpdateServiceInstanceRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Detach"] as? Bool {
            self.detach = value
        }
...
public class UpdateServiceRolloutRequest : Tea.TeaModel {
    public class Batch : Tea.TeaModel {
        public var batchSize: String?
    ...
    public var batch: UpdateServiceRolloutRequest.Batch?

    public var partition: UpdateServiceRolloutRequest.Partition?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Batch"] as? [String: Any?] {
            var model = UpdateServiceRolloutRequest.Batch()
            model.fromMap(value)
            self.batch = model
        }
        if let value = dict["Partition"] as? [String: Any?] {
            var model = UpdateServiceRolloutRequest.Partition()
            model.fromMap(value)
            self.partition = model
        }
        if let value = dict["Paused"] as? Bool {
...
public class UpdateServiceRolloutResponseBody : Tea.TeaModel {
    public var message: String?
...
public class UpdateServiceRolloutResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateServiceRolloutResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateServiceRolloutResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
