Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudStatus20200117"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Status (20200117) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/status-20200117" 
