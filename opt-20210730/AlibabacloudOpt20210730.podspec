Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudOpt20210730"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud opt (20210730) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/opt-20210730" 
