Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudElasticsearch20190422"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Elasticsearch (20190422) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/elasticsearch-20190422" 
