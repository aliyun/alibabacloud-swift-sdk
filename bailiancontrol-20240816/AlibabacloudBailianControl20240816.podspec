Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudBailianControl20240816"
  spec.version      = "1.0.2"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud BailianControl (20240816) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/bailiancontrol-20240816" 
