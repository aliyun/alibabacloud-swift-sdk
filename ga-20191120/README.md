...
```ruby
pod 'AlibabacloudGa20191120', '~> 1.0.4'
```
...
```ogdl
github "alibabacloud-sdk-swift/ga-20191120" "1.0.4"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ga-20191120.git", from: "1.0.4")
]
```
