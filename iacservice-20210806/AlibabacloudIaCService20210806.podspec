Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudIaCService20210806"
  spec.version      = "2.1.3"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud IaCService (20210806) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/iacservice-20210806" 
