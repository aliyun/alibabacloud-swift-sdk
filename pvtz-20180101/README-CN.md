...
```ruby
pod 'AlibabacloudPvtz20180101', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/pvtz-20180101" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/pvtz-20180101.git", from: "1.0.0")
]
```
