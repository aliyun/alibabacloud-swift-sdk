Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudAccountCrm20160606"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud account-crm (20160606) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/account-crm-20160606" 
