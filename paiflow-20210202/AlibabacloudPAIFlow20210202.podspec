Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudPAIFlow20210202"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud PAIFlow (20210202) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/paiflow-20210202" 
