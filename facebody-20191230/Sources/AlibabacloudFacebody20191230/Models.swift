...
public class DetectPedestrianIntrusionRequest : Tea.TeaModel {
    public class DetectRegion : Tea.TeaModel {
        public class Line : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["X1"] as? Int64 {
                    self.x1 = value
                }
                if let value = dict["X2"] as? Int64 {
                    self.x2 = value
                }
                if let value = dict["Y1"] as? Int64 {
                    self.y1 = value
                }
                if let value = dict["Y2"] as? Int64 {
                    self.y2 = value
                }
            }
        }
        ...
        public var line: DetectPedestrianIntrusionRequest.DetectRegion.Line?

        public var rect: DetectPedestrianIntrusionRequest.DetectRegion.Rect?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Line"] as? [String: Any?] {
                var model = DetectPedestrianIntrusionRequest.DetectRegion.Line()
                model.fromMap(value)
                self.line = model
            }
            if let value = dict["Rect"] as? [String: Any?] {
                var model = DetectPedestrianIntrusionRequest.DetectRegion.Rect()
                model.fromMap(value)
                self.rect = model
            }
        }
    }
    public var detectRegion: [DetectPedestrianIntrusionRequest.DetectRegion]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.detectRegion != nil {
            var tmp : [Any] = []
            for k in self.detectRegion! {
                tmp.append(k.toMap())
            }
            map["DetectRegion"] = tmp
        }
        if self.imageURL != nil {
            map["ImageURL"] = self.imageURL!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["DetectRegion"] as? [Any?] {
            var tmp : [DetectPedestrianIntrusionRequest.DetectRegion] = []
            for v in value {
                if v != nil {
                    var model = DetectPedestrianIntrusionRequest.DetectRegion()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DetectPedestrianIntrusionAdvanceRequest : Tea.TeaModel {
    public class DetectRegion : Tea.TeaModel {
        public class Line : Tea.TeaModel {
            public var x1: Int64?
        ...
        public var line: DetectPedestrianIntrusionAdvanceRequest.DetectRegion.Line?

        public var rect: DetectPedestrianIntrusionAdvanceRequest.DetectRegion.Rect?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["Line"] as? [String: Any?] {
                var model = DetectPedestrianIntrusionAdvanceRequest.DetectRegion.Line()
                model.fromMap(value)
                self.line = model
            }
            if let value = dict["Rect"] as? [String: Any?] {
                var model = DetectPedestrianIntrusionAdvanceRequest.DetectRegion.Rect()
                model.fromMap(value)
                self.rect = model
            }
        }
    }
    public var detectRegion: [DetectPedestrianIntrusionAdvanceRequest.DetectRegion]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["DetectRegion"] as? [Any?] {
            var tmp : [DetectPedestrianIntrusionAdvanceRequest.DetectRegion] = []
            for v in value {
                if v != nil {
                    var model = DetectPedestrianIntrusionAdvanceRequest.DetectRegion()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DetectPedestrianIntrusionShrinkRequest : Tea.TeaModel {
    public var detectRegionShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.detectRegionShrink != nil {
            map["DetectRegion"] = self.detectRegionShrink!
        }
        if self.imageURL != nil {
            map["ImageURL"] = self.imageURL!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["DetectRegion"] as? String {
            self.detectRegionShrink = value
        }
        if let value = dict["ImageURL"] as? String {
            self.imageURL = value
        }
...
public class DetectPedestrianIntrusionResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class Elements : Tea.TeaModel {
            ...
            public var box: DetectPedestrianIntrusionResponseBody.Data.Elements.Box?

            public var boxId: Int64?

            public var isIntrude: Bool?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.boxId != nil {
                    map["BoxId"] = self.boxId!
                }
                if self.isIntrude != nil {
                    map["IsIntrude"] = self.isIntrude!
                }
                if self.score != nil {
                    map["Score"] = self.score!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["Box"] as? [String: Any?] {
                    var model = DetectPedestrianIntrusionResponseBody.Data.Elements.Box()
                    model.fromMap(value)
                    self.box = model
                }
                if let value = dict["BoxId"] as? Int64 {
                    self.boxId = value
                }
                if let value = dict["IsIntrude"] as? Bool {
                    self.isIntrude = value
                }
        ...
        public var elements: [DetectPedestrianIntrusionResponseBody.Data.Elements]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["Elements"] as? [Any?] {
                var tmp : [DetectPedestrianIntrusionResponseBody.Data.Elements] = []
                for v in value {
                    if v != nil {
                        var model = DetectPedestrianIntrusionResponseBody.Data.Elements()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: DetectPedestrianIntrusionResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = DetectPedestrianIntrusionResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class DetectPedestrianIntrusionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DetectPedestrianIntrusionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DetectPedestrianIntrusionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class FaceMakeupRequest : Tea.TeaModel {
    public var imageURL: String?

    public var makeupType: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.makeupType != nil {
            map["MakeupType"] = self.makeupType!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["MakeupType"] as? String {
...
public class FaceMakeupAdvanceRequest : Tea.TeaModel {
    public var imageURLObject: InputStream?
...
public class FaceMakeupResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var imageURL: String?
    ...
    public var data: FaceMakeupResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = FaceMakeupResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class FaceMakeupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: FaceMakeupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = FaceMakeupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class FaceTidyupRequest : Tea.TeaModel {
    public var imageURL: String?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ShapeType"] as? Int32 {
...
public class FaceTidyupAdvanceRequest : Tea.TeaModel {
    public var imageURLObject: InputStream?
...
public class FaceTidyupResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var imageURL: String?
    ...
    public var data: FaceTidyupResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = FaceTidyupResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class FaceTidyupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: FaceTidyupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = FaceTidyupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class HandPostureRequest : Tea.TeaModel {
    public var imageURL: String?
...
public class HandPostureAdvanceRequest : Tea.TeaModel {
    public var imageURLObject: InputStream?
...
public class HandPostureResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class MetaObject : Tea.TeaModel {
            public var height: Int32?
        ...
        public class Outputs : Tea.TeaModel {
            public class Results : Tea.TeaModel {
                public class Box : Tea.TeaModel {
                    ...
                    public var positions: [HandPostureResponseBody.Data.Outputs.Results.Box.Positions]?
                    ...
                    public override func fromMap(_ dict: [String: Any?]?) -> Void {
                        ...
                        if let value = dict["Positions"] as? [Any?] {
                            var tmp : [HandPostureResponseBody.Data.Outputs.Results.Box.Positions] = []
                            for v in value {
                                if v != nil {
                                    var model = HandPostureResponseBody.Data.Outputs.Results.Box.Positions()
                                    if v != nil {
                                        model.fromMap(v as? [String: Any?])
                                    }
                                    tmp.append(model)
                ...
                public class Hands : Tea.TeaModel {
                    public class KeyPoints : Tea.TeaModel {
                        ...
                        public var positions: [HandPostureResponseBody.Data.Outputs.Results.Hands.KeyPoints.Positions]?
                        ...
                        public override func fromMap(_ dict: [String: Any?]?) -> Void {
                            ...
                            if let value = dict["Positions"] as? [Any?] {
                                var tmp : [HandPostureResponseBody.Data.Outputs.Results.Hands.KeyPoints.Positions] = []
                                for v in value {
                                    if v != nil {
                                        var model = HandPostureResponseBody.Data.Outputs.Results.Hands.KeyPoints.Positions()
                                        if v != nil {
                                            model.fromMap(v as? [String: Any?])
                                        }
                                        tmp.append(model)
                    ...
                    public var keyPoints: [HandPostureResponseBody.Data.Outputs.Results.Hands.KeyPoints]?
                    ...
                    public override func fromMap(_ dict: [String: Any?]?) -> Void {
                        ...
                        if let value = dict["KeyPoints"] as? [Any?] {
                            var tmp : [HandPostureResponseBody.Data.Outputs.Results.Hands.KeyPoints] = []
                            for v in value {
                                if v != nil {
                                    var model = HandPostureResponseBody.Data.Outputs.Results.Hands.KeyPoints()
                                    if v != nil {
                                        model.fromMap(v as? [String: Any?])
                                    }
                                    tmp.append(model)
                ...
                public var box: HandPostureResponseBody.Data.Outputs.Results.Box?

                public var hands: HandPostureResponseBody.Data.Outputs.Results.Hands?
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    guard let dict else { return }
                    if let value = dict["Box"] as? [String: Any?] {
                        var model = HandPostureResponseBody.Data.Outputs.Results.Box()
                        model.fromMap(value)
                        self.box = model
                    }
                    if let value = dict["Hands"] as? [String: Any?] {
                        var model = HandPostureResponseBody.Data.Outputs.Results.Hands()
                        model.fromMap(value)
                        self.hands = model
                    }
                }
            }
            public var handCount: Int32?

            public var results: [HandPostureResponseBody.Data.Outputs.Results]?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.handCount != nil {
                    map["HandCount"] = self.handCount!
                }
                if self.results != nil {
                    var tmp : [Any] = []
                    for k in self.results! {
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["HandCount"] as? Int32 {
                    self.handCount = value
                }
                if let value = dict["Results"] as? [Any?] {
                    var tmp : [HandPostureResponseBody.Data.Outputs.Results] = []
                    for v in value {
                        if v != nil {
                            var model = HandPostureResponseBody.Data.Outputs.Results()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
        ...
        public var metaObject: HandPostureResponseBody.Data.MetaObject?

        public var outputs: [HandPostureResponseBody.Data.Outputs]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["MetaObject"] as? [String: Any?] {
                var model = HandPostureResponseBody.Data.MetaObject()
                model.fromMap(value)
                self.metaObject = model
            }
            if let value = dict["Outputs"] as? [Any?] {
                var tmp : [HandPostureResponseBody.Data.Outputs] = []
                for v in value {
                    if v != nil {
                        var model = HandPostureResponseBody.Data.Outputs()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: HandPostureResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = HandPostureResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class HandPostureResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: HandPostureResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = HandPostureResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class RecognizeHandGestureRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.gestureType != nil {
            map["GestureType"] = self.gestureType!
        }
        if self.imageURL != nil {
            map["ImageURL"] = self.imageURL!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["GestureType"] as? String {
            self.gestureType = value
        }
        if let value = dict["ImageURL"] as? String {
            self.imageURL = value
        }
...
public class RecognizeHandGestureAdvanceRequest : Tea.TeaModel {
    public var appId: String?
...
public class RecognizeHandGestureResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var height: Int64?
    ...
    public var data: RecognizeHandGestureResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = RecognizeHandGestureResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class RecognizeHandGestureResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RecognizeHandGestureResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RecognizeHandGestureResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
