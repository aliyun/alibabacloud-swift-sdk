Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEsServerless20220822"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud es-serverless (20220822) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/es-serverless-20220822" 
