...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func activeAiRtcLicenseWithOptions(_ request: ActiveAiRtcLicenseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ActiveAiRtcLicenseResponse {
        ...
        return Tea.TeaConverter.fromMap(ActiveAiRtcLicenseResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func activeAiRtcLicense(_ request: ActiveAiRtcLicenseRequest) async throws -> ActiveAiRtcLicenseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await activeAiRtcLicenseWithOptions(request as! ActiveAiRtcLicenseRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addAdInsertionWithOptions(_ request: AddAdInsertionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddAdInsertionResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.adMarkerPassthrough)) {
            body["AdMarkerPassthrough"] = request.adMarkerPassthrough ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.adsUrl)) {
            body["AdsUrl"] = request.adsUrl ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.cdnAdSegmentUrlPrefix)) {
            body["CdnAdSegmentUrlPrefix"] = request.cdnAdSegmentUrlPrefix ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.cdnContentSegmentUrlPrefix)) {
            body["CdnContentSegmentUrlPrefix"] = request.cdnContentSegmentUrlPrefix ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
            body["ClientToken"] = request.clientToken ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.configAliases)) {
            body["ConfigAliases"] = request.configAliases ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.contentUrlPrefix)) {
            body["ContentUrlPrefix"] = request.contentUrlPrefix ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.name)) {
            body["Name"] = request.name ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.personalizationThreshold)) {
            body["PersonalizationThreshold"] = request.personalizationThreshold!;
        }
        if (!TeaUtils.Client.isUnset(request.slateAdUrl)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddAdInsertionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addAdInsertion(_ request: AddAdInsertionRequest) async throws -> AddAdInsertionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await addAdInsertionWithOptions(request as! AddAdInsertionRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func addMediaConnectFlowInputWithOptions(_ request: AddMediaConnectFlowInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddMediaConnectFlowInputResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.withInternalVip)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addStreamTagToSearchLibWithOptions(_ request: AddStreamTagToSearchLibRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddStreamTagToSearchLibResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.mediaId)) {
            query["MediaId"] = request.mediaId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddStreamTagToSearchLibResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addStreamTagToSearchLib(_ request: AddStreamTagToSearchLibRequest) async throws -> AddStreamTagToSearchLibResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await addStreamTagToSearchLibWithOptions(request as! AddStreamTagToSearchLibRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func batchCreateVodPackagingAssetWithOptions(_ tmpReq: BatchCreateVodPackagingAssetRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> BatchCreateVodPackagingAssetResponse {
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.assets)) {
            request.assetsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.assets, "Assets", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.assetsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(BatchCreateVodPackagingAssetResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchCreateVodPackagingAsset(_ request: BatchCreateVodPackagingAssetRequest) async throws -> BatchCreateVodPackagingAssetResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await batchCreateVodPackagingAssetWithOptions(request as! BatchCreateVodPackagingAssetRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func cancelIProductionJobWithOptions(_ request: CancelIProductionJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CancelIProductionJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CancelIProductionJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func cancelIProductionJob(_ request: CancelIProductionJobRequest) async throws -> CancelIProductionJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await cancelIProductionJobWithOptions(request as! CancelIProductionJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func clearAIAgentVoiceprintWithOptions(_ request: ClearAIAgentVoiceprintRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ClearAIAgentVoiceprintResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ClearAIAgentVoiceprintResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func clearAIAgentVoiceprint(_ request: ClearAIAgentVoiceprintRequest) async throws -> ClearAIAgentVoiceprintResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await clearAIAgentVoiceprintWithOptions(request as! ClearAIAgentVoiceprintRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func closeMediaConnectFlowFailoverWithOptions(_ request: CloseMediaConnectFlowFailoverRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CloseMediaConnectFlowFailoverResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CloseMediaConnectFlowFailoverResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func closeMediaConnectFlowFailover(_ request: CloseMediaConnectFlowFailoverRequest) async throws -> CloseMediaConnectFlowFailoverResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await closeMediaConnectFlowFailoverWithOptions(request as! CloseMediaConnectFlowFailoverRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func closeStreamToSearchLibWithOptions(_ request: CloseStreamToSearchLibRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CloseStreamToSearchLibResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.mediaId)) {
            query["MediaId"] = request.mediaId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CloseStreamToSearchLibResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func closeStreamToSearchLib(_ request: CloseStreamToSearchLibRequest) async throws -> CloseStreamToSearchLibResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await closeStreamToSearchLibWithOptions(request as! CloseStreamToSearchLibRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createIpcOrderWithOptions(_ request: CreateIpcOrderRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateIpcOrderResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateIpcOrderResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createIpcOrder(_ request: CreateIpcOrderRequest) async throws -> CreateIpcOrderResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createIpcOrderWithOptions(request as! CreateIpcOrderRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMediaLiveChannelWithOptions(_ tmpReq: CreateMediaLiveChannelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateMediaLiveChannelResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateMediaLiveChannelShrinkRequest = CreateMediaLiveChannelShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.audioSettings)) {
            request.audioSettingsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.audioSettings, "AudioSettings", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.inputAttachments)) {
            request.inputAttachmentsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.inputAttachments, "InputAttachments", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.outputGroups)) {
            request.outputGroupsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.outputGroups, "OutputGroups", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.videoSettings)) {
            request.videoSettingsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.videoSettings, "VideoSettings", "json")
        }
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.audioSettingsShrink)) {
            body["AudioSettings"] = request.audioSettingsShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.inputAttachmentsShrink)) {
            body["InputAttachments"] = request.inputAttachmentsShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.name)) {
            body["Name"] = request.name ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.outputGroupsShrink)) {
            body["OutputGroups"] = request.outputGroupsShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.videoSettingsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateMediaLiveChannelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMediaLiveChannel(_ request: CreateMediaLiveChannelRequest) async throws -> CreateMediaLiveChannelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createMediaLiveChannelWithOptions(request as! CreateMediaLiveChannelRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMediaLiveInputWithOptions(_ tmpReq: CreateMediaLiveInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateMediaLiveInputResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateMediaLiveInputShrinkRequest = CreateMediaLiveInputShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.inputSettings)) {
            request.inputSettingsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.inputSettings, "InputSettings", "json")
        }
        ...
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.inputSettingsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateMediaLiveInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMediaLiveInput(_ request: CreateMediaLiveInputRequest) async throws -> CreateMediaLiveInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createMediaLiveInputWithOptions(request as! CreateMediaLiveInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMediaLiveInputSecurityGroupWithOptions(_ tmpReq: CreateMediaLiveInputSecurityGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateMediaLiveInputSecurityGroupResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateMediaLiveInputSecurityGroupShrinkRequest = CreateMediaLiveInputSecurityGroupShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.whitelistRules)) {
            request.whitelistRulesShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.whitelistRules, "WhitelistRules", "json")
        }
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.name)) {
            body["Name"] = request.name ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.whitelistRulesShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateMediaLiveInputSecurityGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMediaLiveInputSecurityGroup(_ request: CreateMediaLiveInputSecurityGroupRequest) async throws -> CreateMediaLiveInputSecurityGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createMediaLiveInputSecurityGroupWithOptions(request as! CreateMediaLiveInputSecurityGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createRecognitionEntityWithOptions(_ request: CreateRecognitionEntityRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateRecognitionEntityResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.entityInfo)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateRecognitionEntityResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createRecognitionEntity(_ request: CreateRecognitionEntityRequest) async throws -> CreateRecognitionEntityResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createRecognitionEntityWithOptions(request as! CreateRecognitionEntityRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createRecognitionLibWithOptions(_ request: CreateRecognitionLibRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateRecognitionLibResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.libDescription)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateRecognitionLibResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createRecognitionLib(_ request: CreateRecognitionLibRequest) async throws -> CreateRecognitionLibResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createRecognitionLibWithOptions(request as! CreateRecognitionLibRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createRecognitionSampleWithOptions(_ request: CreateRecognitionSampleRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateRecognitionSampleResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateRecognitionSampleResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createRecognitionSample(_ request: CreateRecognitionSampleRequest) async throws -> CreateRecognitionSampleResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createRecognitionSampleWithOptions(request as! CreateRecognitionSampleRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createStreamToSearchLibWithOptions(_ request: CreateStreamToSearchLibRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateStreamToSearchLibResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateStreamToSearchLibResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createStreamToSearchLib(_ request: CreateStreamToSearchLibRequest) async throws -> CreateStreamToSearchLibResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createStreamToSearchLibWithOptions(request as! CreateStreamToSearchLibRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createVodPackagingAssetWithOptions(_ tmpReq: CreateVodPackagingAssetRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateVodPackagingAssetResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateVodPackagingAssetShrinkRequest = CreateVodPackagingAssetShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateVodPackagingAssetResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createVodPackagingAsset(_ request: CreateVodPackagingAssetRequest) async throws -> CreateVodPackagingAssetResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createVodPackagingAssetWithOptions(request as! CreateVodPackagingAssetRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createVodPackagingConfigurationWithOptions(_ tmpReq: CreateVodPackagingConfigurationRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateVodPackagingConfigurationResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateVodPackagingConfigurationShrinkRequest = CreateVodPackagingConfigurationShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.packageConfig)) {
            request.packageConfigShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.packageConfig, "PackageConfig", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.configurationName)) {
        ...
        if (!TeaUtils.Client.isUnset(request.packageConfigShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateVodPackagingConfigurationResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createVodPackagingConfiguration(_ request: CreateVodPackagingConfigurationRequest) async throws -> CreateVodPackagingConfigurationResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createVodPackagingConfigurationWithOptions(request as! CreateVodPackagingConfigurationRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createVodPackagingGroupWithOptions(_ request: CreateVodPackagingGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateVodPackagingGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateVodPackagingGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createVodPackagingGroup(_ request: CreateVodPackagingGroupRequest) async throws -> CreateVodPackagingGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createVodPackagingGroupWithOptions(request as! CreateVodPackagingGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAIAgentDialogueWithOptions(_ request: DeleteAIAgentDialogueRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteAIAgentDialogueResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.dialogueId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteAIAgentDialogueResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAIAgentDialogue(_ request: DeleteAIAgentDialogueRequest) async throws -> DeleteAIAgentDialogueResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteAIAgentDialogueWithOptions(request as! DeleteAIAgentDialogueRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAdInsertionWithOptions(_ request: DeleteAdInsertionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteAdInsertionResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.name)) {
            body["Name"] = request.name ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteAdInsertionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAdInsertion(_ request: DeleteAdInsertionRequest) async throws -> DeleteAdInsertionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteAdInsertionWithOptions(request as! DeleteAdInsertionRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaConnectFlowInputWithOptions(_ request: DeleteMediaConnectFlowInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteMediaConnectFlowInputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteMediaConnectFlowInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaConnectFlowInput(_ request: DeleteMediaConnectFlowInputRequest) async throws -> DeleteMediaConnectFlowInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteMediaConnectFlowInputWithOptions(request as! DeleteMediaConnectFlowInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaConnectFlowOutputWithOptions(_ request: DeleteMediaConnectFlowOutputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteMediaConnectFlowOutputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteMediaConnectFlowOutputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaConnectFlowOutput(_ request: DeleteMediaConnectFlowOutputRequest) async throws -> DeleteMediaConnectFlowOutputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteMediaConnectFlowOutputWithOptions(request as! DeleteMediaConnectFlowOutputRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaLiveChannelWithOptions(_ request: DeleteMediaLiveChannelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteMediaLiveChannelResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteMediaLiveChannelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaLiveChannel(_ request: DeleteMediaLiveChannelRequest) async throws -> DeleteMediaLiveChannelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteMediaLiveChannelWithOptions(request as! DeleteMediaLiveChannelRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaLiveInputWithOptions(_ request: DeleteMediaLiveInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteMediaLiveInputResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteMediaLiveInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaLiveInput(_ request: DeleteMediaLiveInputRequest) async throws -> DeleteMediaLiveInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteMediaLiveInputWithOptions(request as! DeleteMediaLiveInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaLiveInputSecurityGroupWithOptions(_ request: DeleteMediaLiveInputSecurityGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteMediaLiveInputSecurityGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteMediaLiveInputSecurityGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMediaLiveInputSecurityGroup(_ request: DeleteMediaLiveInputSecurityGroupRequest) async throws -> DeleteMediaLiveInputSecurityGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteMediaLiveInputSecurityGroupWithOptions(request as! DeleteMediaLiveInputSecurityGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteRecognitionEntityWithOptions(_ request: DeleteRecognitionEntityRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteRecognitionEntityResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteRecognitionEntityResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteRecognitionEntity(_ request: DeleteRecognitionEntityRequest) async throws -> DeleteRecognitionEntityResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteRecognitionEntityWithOptions(request as! DeleteRecognitionEntityRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteRecognitionLibWithOptions(_ request: DeleteRecognitionLibRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteRecognitionLibResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteRecognitionLibResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteRecognitionLib(_ request: DeleteRecognitionLibRequest) async throws -> DeleteRecognitionLibResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteRecognitionLibWithOptions(request as! DeleteRecognitionLibRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteRecognitionSampleWithOptions(_ request: DeleteRecognitionSampleRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteRecognitionSampleResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteRecognitionSampleResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteRecognitionSample(_ request: DeleteRecognitionSampleRequest) async throws -> DeleteRecognitionSampleResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteRecognitionSampleWithOptions(request as! DeleteRecognitionSampleRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteVodPackagingAssetWithOptions(_ request: DeleteVodPackagingAssetRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteVodPackagingAssetResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.assetName)) {
            query["AssetName"] = request.assetName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteVodPackagingAssetResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteVodPackagingAsset(_ request: DeleteVodPackagingAssetRequest) async throws -> DeleteVodPackagingAssetResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteVodPackagingAssetWithOptions(request as! DeleteVodPackagingAssetRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteVodPackagingConfigurationWithOptions(_ request: DeleteVodPackagingConfigurationRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteVodPackagingConfigurationResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.configurationName)) {
            query["ConfigurationName"] = request.configurationName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteVodPackagingConfigurationResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteVodPackagingConfiguration(_ request: DeleteVodPackagingConfigurationRequest) async throws -> DeleteVodPackagingConfigurationResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteVodPackagingConfigurationWithOptions(request as! DeleteVodPackagingConfigurationRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteVodPackagingGroupWithOptions(_ request: DeleteVodPackagingGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteVodPackagingGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.groupName)) {
            query["GroupName"] = request.groupName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteVodPackagingGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteVodPackagingGroup(_ request: DeleteVodPackagingGroupRequest) async throws -> DeleteVodPackagingGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteVodPackagingGroupWithOptions(request as! DeleteVodPackagingGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func forbidMediaConnectFlowOutputWithOptions(_ request: ForbidMediaConnectFlowOutputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ForbidMediaConnectFlowOutputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ForbidMediaConnectFlowOutputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func forbidMediaConnectFlowOutput(_ request: ForbidMediaConnectFlowOutputRequest) async throws -> ForbidMediaConnectFlowOutputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await forbidMediaConnectFlowOutputWithOptions(request as! ForbidMediaConnectFlowOutputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func forwardAIAgentCallWithOptions(_ request: ForwardAIAgentCallRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ForwardAIAgentCallResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.errorPrompt)) {
            query["ErrorPrompt"] = request.errorPrompt ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.instanceId)) {
            query["InstanceId"] = request.instanceId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.transferPrompt)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ForwardAIAgentCallResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func forwardAIAgentCall(_ request: ForwardAIAgentCallRequest) async throws -> ForwardAIAgentCallResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await forwardAIAgentCallWithOptions(request as! ForwardAIAgentCallRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func generateMessageChatTokenWithOptions(_ request: GenerateMessageChatTokenRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GenerateMessageChatTokenResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.AIAgentId)) {
            query["AIAgentId"] = request.AIAgentId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GenerateMessageChatTokenResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func generateMessageChatToken(_ request: GenerateMessageChatTokenRequest) async throws -> GenerateMessageChatTokenResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await generateMessageChatTokenWithOptions(request as! GenerateMessageChatTokenRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func getAIWorkflowTaskWithOptions(_ request: GetAIWorkflowTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAIWorkflowTaskResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAIWorkflowTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAIWorkflowTask(_ request: GetAIWorkflowTaskRequest) async throws -> GetAIWorkflowTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAIWorkflowTaskWithOptions(request as! GetAIWorkflowTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAdInsertionWithOptions(_ request: GetAdInsertionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAdInsertionResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.name)) {
            query["Name"] = request.name ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAdInsertionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAdInsertion(_ request: GetAdInsertionRequest) async throws -> GetAdInsertionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAdInsertionWithOptions(request as! GetAdInsertionRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAiRtcAuthCodeListWithOptions(_ request: GetAiRtcAuthCodeListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAiRtcAuthCodeListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.licenseItemId)) {
            query["LicenseItemId"] = request.licenseItemId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAiRtcAuthCodeListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAiRtcAuthCodeList(_ request: GetAiRtcAuthCodeListRequest) async throws -> GetAiRtcAuthCodeListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAiRtcAuthCodeListWithOptions(request as! GetAiRtcAuthCodeListRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAiRtcLicenseInfoListWithOptions(_ request: GetAiRtcLicenseInfoListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAiRtcLicenseInfoListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.licenseItemId)) {
            query["LicenseItemId"] = request.licenseItemId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAiRtcLicenseInfoListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAiRtcLicenseInfoList(_ request: GetAiRtcLicenseInfoListRequest) async throws -> GetAiRtcLicenseInfoListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAiRtcLicenseInfoListWithOptions(request as! GetAiRtcLicenseInfoListRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getIpcDeviceInfoWithOptions(_ request: GetIpcDeviceInfoRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetIpcDeviceInfoResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.capability)) {
            query["Capability"] = request.capability ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetIpcDeviceInfoResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getIpcDeviceInfo(_ request: GetIpcDeviceInfoRequest) async throws -> GetIpcDeviceInfoResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getIpcDeviceInfoWithOptions(request as! GetIpcDeviceInfoRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectAvailableRegionWithOptions(_ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaConnectAvailableRegionResponse {
        var req: AlibabacloudOpenApi.OpenApiRequest = AlibabacloudOpenApi.OpenApiRequest([:])
        var params: AlibabacloudOpenApi.Params = AlibabacloudOpenApi.Params([
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaConnectAvailableRegionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectAvailableRegion() async throws -> GetMediaConnectAvailableRegionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaConnectAvailableRegionWithOptions(runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectFlowAllOutputNameWithOptions(_ request: GetMediaConnectFlowAllOutputNameRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaConnectFlowAllOutputNameResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaConnectFlowAllOutputNameResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectFlowAllOutputName(_ request: GetMediaConnectFlowAllOutputNameRequest) async throws -> GetMediaConnectFlowAllOutputNameResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaConnectFlowAllOutputNameWithOptions(request as! GetMediaConnectFlowAllOutputNameRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectFlowInputWithOptions(_ request: GetMediaConnectFlowInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaConnectFlowInputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaConnectFlowInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectFlowInput(_ request: GetMediaConnectFlowInputRequest) async throws -> GetMediaConnectFlowInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaConnectFlowInputWithOptions(request as! GetMediaConnectFlowInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectFlowOutputWithOptions(_ request: GetMediaConnectFlowOutputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaConnectFlowOutputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaConnectFlowOutputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaConnectFlowOutput(_ request: GetMediaConnectFlowOutputRequest) async throws -> GetMediaConnectFlowOutputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaConnectFlowOutputWithOptions(request as! GetMediaConnectFlowOutputRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaLiveChannelWithOptions(_ request: GetMediaLiveChannelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaLiveChannelResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.channelId)) {
            body["ChannelId"] = request.channelId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaLiveChannelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaLiveChannel(_ request: GetMediaLiveChannelRequest) async throws -> GetMediaLiveChannelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaLiveChannelWithOptions(request as! GetMediaLiveChannelRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaLiveInputWithOptions(_ request: GetMediaLiveInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaLiveInputResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.inputId)) {
            body["InputId"] = request.inputId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaLiveInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaLiveInput(_ request: GetMediaLiveInputRequest) async throws -> GetMediaLiveInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaLiveInputWithOptions(request as! GetMediaLiveInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaLiveInputSecurityGroupWithOptions(_ request: GetMediaLiveInputSecurityGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetMediaLiveInputSecurityGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.securityGroupId)) {
            body["SecurityGroupId"] = request.securityGroupId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetMediaLiveInputSecurityGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getMediaLiveInputSecurityGroup(_ request: GetMediaLiveInputSecurityGroupRequest) async throws -> GetMediaLiveInputSecurityGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getMediaLiveInputSecurityGroupWithOptions(request as! GetMediaLiveInputSecurityGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getStreamTagListWithOptions(_ request: GetStreamTagListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetStreamTagListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.endTime)) {
            query["EndTime"] = request.endTime ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetStreamTagListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getStreamTagList(_ request: GetStreamTagListRequest) async throws -> GetStreamTagListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getStreamTagListWithOptions(request as! GetStreamTagListRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getVodPackagingAssetWithOptions(_ request: GetVodPackagingAssetRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetVodPackagingAssetResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.assetName)) {
            query["AssetName"] = request.assetName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetVodPackagingAssetResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getVodPackagingAsset(_ request: GetVodPackagingAssetRequest) async throws -> GetVodPackagingAssetResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getVodPackagingAssetWithOptions(request as! GetVodPackagingAssetRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getVodPackagingConfigurationWithOptions(_ request: GetVodPackagingConfigurationRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetVodPackagingConfigurationResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.configurationName)) {
            query["ConfigurationName"] = request.configurationName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetVodPackagingConfigurationResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getVodPackagingConfiguration(_ request: GetVodPackagingConfigurationRequest) async throws -> GetVodPackagingConfigurationResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getVodPackagingConfigurationWithOptions(request as! GetVodPackagingConfigurationRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getVodPackagingGroupWithOptions(_ request: GetVodPackagingGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetVodPackagingGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.groupName)) {
            query["GroupName"] = request.groupName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetVodPackagingGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getVodPackagingGroup(_ request: GetVodPackagingGroupRequest) async throws -> GetVodPackagingGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getVodPackagingGroupWithOptions(request as! GetVodPackagingGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAIAgentDialoguesWithOptions(_ request: ListAIAgentDialoguesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListAIAgentDialoguesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.endTime)) {
            query["EndTime"] = request.endTime!;
        ...
        if (!TeaUtils.Client.isUnset(request.roundLimit)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListAIAgentDialoguesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAIAgentDialogues(_ request: ListAIAgentDialoguesRequest) async throws -> ListAIAgentDialoguesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listAIAgentDialoguesWithOptions(request as! ListAIAgentDialoguesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAIAgentVoiceprintsWithOptions(_ request: ListAIAgentVoiceprintsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListAIAgentVoiceprintsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.pageNumber)) {
            query["PageNumber"] = request.pageNumber!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListAIAgentVoiceprintsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAIAgentVoiceprints(_ request: ListAIAgentVoiceprintsRequest) async throws -> ListAIAgentVoiceprintsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listAIAgentVoiceprintsWithOptions(request as! ListAIAgentVoiceprintsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func listAdInsertionsWithOptions(_ request: ListAdInsertionsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListAdInsertionsResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListAdInsertionsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAdInsertions(_ request: ListAdInsertionsRequest) async throws -> ListAdInsertionsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listAdInsertionsWithOptions(request as! ListAdInsertionsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listMediaLiveChannelsWithOptions(_ request: ListMediaLiveChannelsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListMediaLiveChannelsResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.keyword)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListMediaLiveChannelsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listMediaLiveChannels(_ request: ListMediaLiveChannelsRequest) async throws -> ListMediaLiveChannelsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listMediaLiveChannelsWithOptions(request as! ListMediaLiveChannelsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listMediaLiveInputSecurityGroupsWithOptions(_ request: ListMediaLiveInputSecurityGroupsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListMediaLiveInputSecurityGroupsResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.keyword)) {
            body["Keyword"] = request.keyword ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListMediaLiveInputSecurityGroupsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listMediaLiveInputSecurityGroups(_ request: ListMediaLiveInputSecurityGroupsRequest) async throws -> ListMediaLiveInputSecurityGroupsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listMediaLiveInputSecurityGroupsWithOptions(request as! ListMediaLiveInputSecurityGroupsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listMediaLiveInputsWithOptions(_ request: ListMediaLiveInputsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListMediaLiveInputsResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.keyword)) {
            body["Keyword"] = request.keyword ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListMediaLiveInputsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listMediaLiveInputs(_ request: ListMediaLiveInputsRequest) async throws -> ListMediaLiveInputsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listMediaLiveInputsWithOptions(request as! ListMediaLiveInputsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listRecognitionEntitiesWithOptions(_ request: ListRecognitionEntitiesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListRecognitionEntitiesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListRecognitionEntitiesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listRecognitionEntities(_ request: ListRecognitionEntitiesRequest) async throws -> ListRecognitionEntitiesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listRecognitionEntitiesWithOptions(request as! ListRecognitionEntitiesRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listRecognitionLibsWithOptions(_ request: ListRecognitionLibsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListRecognitionLibsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListRecognitionLibsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listRecognitionLibs(_ request: ListRecognitionLibsRequest) async throws -> ListRecognitionLibsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listRecognitionLibsWithOptions(request as! ListRecognitionLibsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listRecognitionSamplesWithOptions(_ request: ListRecognitionSamplesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListRecognitionSamplesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.algorithm)) {
            query["Algorithm"] = request.algorithm ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListRecognitionSamplesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listRecognitionSamples(_ request: ListRecognitionSamplesRequest) async throws -> ListRecognitionSamplesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listRecognitionSamplesWithOptions(request as! ListRecognitionSamplesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listVodPackagingAssetsWithOptions(_ request: ListVodPackagingAssetsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListVodPackagingAssetsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.groupName)) {
            query["GroupName"] = request.groupName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListVodPackagingAssetsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listVodPackagingAssets(_ request: ListVodPackagingAssetsRequest) async throws -> ListVodPackagingAssetsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listVodPackagingAssetsWithOptions(request as! ListVodPackagingAssetsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listVodPackagingConfigurationsWithOptions(_ request: ListVodPackagingConfigurationsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListVodPackagingConfigurationsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.groupName)) {
            query["GroupName"] = request.groupName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListVodPackagingConfigurationsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listVodPackagingConfigurations(_ request: ListVodPackagingConfigurationsRequest) async throws -> ListVodPackagingConfigurationsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listVodPackagingConfigurationsWithOptions(request as! ListVodPackagingConfigurationsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listVodPackagingGroupsWithOptions(_ request: ListVodPackagingGroupsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListVodPackagingGroupsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.keyword)) {
            query["Keyword"] = request.keyword ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListVodPackagingGroupsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listVodPackagingGroups(_ request: ListVodPackagingGroupsRequest) async throws -> ListVodPackagingGroupsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listVodPackagingGroupsWithOptions(request as! ListVodPackagingGroupsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listWorkflowTasksWithOptions(_ request: ListWorkflowTasksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListWorkflowTasksResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.endOfCreateTime)) {
            query["EndOfCreateTime"] = request.endOfCreateTime ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.keyText)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListWorkflowTasksResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listWorkflowTasks(_ request: ListWorkflowTasksRequest) async throws -> ListWorkflowTasksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listWorkflowTasksWithOptions(request as! ListWorkflowTasksRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func openMediaConnectFlowFailoverWithOptions(_ request: OpenMediaConnectFlowFailoverRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> OpenMediaConnectFlowFailoverResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(OpenMediaConnectFlowFailoverResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func openMediaConnectFlowFailover(_ request: OpenMediaConnectFlowFailoverRequest) async throws -> OpenMediaConnectFlowFailoverResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await openMediaConnectFlowFailoverWithOptions(request as! OpenMediaConnectFlowFailoverRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryIpcQuotaWithOptions(_ request: QueryIpcQuotaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryIpcQuotaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.capability)) {
            query["Capability"] = request.capability ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryIpcQuotaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryIpcQuota(_ request: QueryIpcQuotaRequest) async throws -> QueryIpcQuotaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryIpcQuotaWithOptions(request as! QueryIpcQuotaRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryVideoCognitionJobWithOptions(_ tmpReq: QueryVideoCognitionJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryVideoCognitionJobResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: QueryVideoCognitionJobShrinkRequest = QueryVideoCognitionJobShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.includeResults)) {
            request.includeResultsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.includeResults, "IncludeResults", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.includeResultsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryVideoCognitionJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryVideoCognitionJob(_ request: QueryVideoCognitionJobRequest) async throws -> QueryVideoCognitionJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryVideoCognitionJobWithOptions(request as! QueryVideoCognitionJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func registerMediaStreamWithOptions(_ request: RegisterMediaStreamRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RegisterMediaStreamResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.streamTags)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeMediaConnectFlowOutputWithOptions(_ request: ResumeMediaConnectFlowOutputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResumeMediaConnectFlowOutputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.flowId)) {
            query["FlowId"] = request.flowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ResumeMediaConnectFlowOutputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeMediaConnectFlowOutput(_ request: ResumeMediaConnectFlowOutputRequest) async throws -> ResumeMediaConnectFlowOutputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await resumeMediaConnectFlowOutputWithOptions(request as! ResumeMediaConnectFlowOutputRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func searchMediaByAILabelWithOptions(_ request: SearchMediaByAILabelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SearchMediaByAILabelResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.utcCreate)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func sendAIAgentTextWithOptions(_ request: SendAIAgentTextRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SendAIAgentTextResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceId)) {
            query["InstanceId"] = request.instanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SendAIAgentTextResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func sendAIAgentText(_ request: SendAIAgentTextRequest) async throws -> SendAIAgentTextResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await sendAIAgentTextWithOptions(request as! SendAIAgentTextRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func sendMessageChatTextWithOptions(_ request: SendMessageChatTextRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SendMessageChatTextResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.AIAgentId)) {
            query["AIAgentId"] = request.AIAgentId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.needArchiving)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SendMessageChatTextResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func sendMessageChatText(_ request: SendMessageChatTextRequest) async throws -> SendMessageChatTextResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await sendMessageChatTextWithOptions(request as! SendMessageChatTextRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setAIAgentVoiceprintWithOptions(_ tmpReq: SetAIAgentVoiceprintRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SetAIAgentVoiceprintResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: SetAIAgentVoiceprintShrinkRequest = SetAIAgentVoiceprintShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.input)) {
            request.inputShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.input, "Input", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SetAIAgentVoiceprintResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setAIAgentVoiceprint(_ request: SetAIAgentVoiceprintRequest) async throws -> SetAIAgentVoiceprintResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await setAIAgentVoiceprintWithOptions(request as! SetAIAgentVoiceprintRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func startAIAgentOutboundCallWithOptions(_ tmpReq: StartAIAgentOutboundCallRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StartAIAgentOutboundCallResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.imsAIAgentFreeObCall)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startAIWorkflowWithOptions(_ request: StartAIWorkflowRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StartAIWorkflowResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.dispatchTag)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StartAIWorkflowResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startAIWorkflow(_ request: StartAIWorkflowRequest) async throws -> StartAIWorkflowResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await startAIWorkflowWithOptions(request as! StartAIWorkflowRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startMediaLiveChannelWithOptions(_ request: StartMediaLiveChannelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StartMediaLiveChannelResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.channelId)) {
            body["ChannelId"] = request.channelId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StartMediaLiveChannelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startMediaLiveChannel(_ request: StartMediaLiveChannelRequest) async throws -> StartMediaLiveChannelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await startMediaLiveChannelWithOptions(request as! StartMediaLiveChannelRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopAIWorkflowTaskWithOptions(_ request: StopAIWorkflowTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StopAIWorkflowTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.taskId)) {
            query["TaskId"] = request.taskId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StopAIWorkflowTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopAIWorkflowTask(_ request: StopAIWorkflowTaskRequest) async throws -> StopAIWorkflowTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await stopAIWorkflowTaskWithOptions(request as! StopAIWorkflowTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopMediaLiveChannelWithOptions(_ request: StopMediaLiveChannelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StopMediaLiveChannelResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.channelId)) {
            body["ChannelId"] = request.channelId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StopMediaLiveChannelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopMediaLiveChannel(_ request: StopMediaLiveChannelRequest) async throws -> StopMediaLiveChannelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await stopMediaLiveChannelWithOptions(request as! StopMediaLiveChannelRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitHighlightExtractionJobWithOptions(_ request: SubmitHighlightExtractionJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitHighlightExtractionJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
            query["ClientToken"] = request.clientToken ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitHighlightExtractionJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitHighlightExtractionJob(_ request: SubmitHighlightExtractionJobRequest) async throws -> SubmitHighlightExtractionJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitHighlightExtractionJobWithOptions(request as! SubmitHighlightExtractionJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSceneBatchEditingJobWithOptions(_ request: SubmitSceneBatchEditingJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitSceneBatchEditingJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.outputConfig)) {
            query["OutputConfig"] = request.outputConfig ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitSceneBatchEditingJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSceneBatchEditingJob(_ request: SubmitSceneBatchEditingJobRequest) async throws -> SubmitSceneBatchEditingJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitSceneBatchEditingJobWithOptions(request as! SubmitSceneBatchEditingJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSceneMediaSelectionJobWithOptions(_ request: SubmitSceneMediaSelectionJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitSceneMediaSelectionJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.jobType)) {
            query["JobType"] = request.jobType ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitSceneMediaSelectionJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSceneMediaSelectionJob(_ request: SubmitSceneMediaSelectionJobRequest) async throws -> SubmitSceneMediaSelectionJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitSceneMediaSelectionJobWithOptions(request as! SubmitSceneMediaSelectionJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSceneTimelineOrganizationJobWithOptions(_ request: SubmitSceneTimelineOrganizationJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitSceneTimelineOrganizationJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.jobType)) {
            query["JobType"] = request.jobType ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.mediaSelectResult)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitSceneTimelineOrganizationJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSceneTimelineOrganizationJob(_ request: SubmitSceneTimelineOrganizationJobRequest) async throws -> SubmitSceneTimelineOrganizationJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitSceneTimelineOrganizationJobWithOptions(request as! SubmitSceneTimelineOrganizationJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSegmentationJobWithOptions(_ request: SubmitSegmentationJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitSegmentationJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
            query["ClientToken"] = request.clientToken ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitSegmentationJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitSegmentationJob(_ request: SubmitSegmentationJobRequest) async throws -> SubmitSegmentationJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitSegmentationJobWithOptions(request as! SubmitSegmentationJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitVideoCognitionJobWithOptions(_ tmpReq: SubmitVideoCognitionJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitVideoCognitionJobResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: SubmitVideoCognitionJobShrinkRequest = SubmitVideoCognitionJobShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.input)) {
            request.inputShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.input, "Input", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SubmitVideoCognitionJobResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func submitVideoCognitionJob(_ request: SubmitVideoCognitionJobRequest) async throws -> SubmitVideoCognitionJobResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await submitVideoCognitionJobWithOptions(request as! SubmitVideoCognitionJobRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateAdInsertionWithOptions(_ request: UpdateAdInsertionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateAdInsertionResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.adMarkerPassthrough)) {
            body["AdMarkerPassthrough"] = request.adMarkerPassthrough ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateAdInsertionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateAdInsertion(_ request: UpdateAdInsertionRequest) async throws -> UpdateAdInsertionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateAdInsertionWithOptions(request as! UpdateAdInsertionRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaConnectFlowInputWithOptions(_ request: UpdateMediaConnectFlowInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateMediaConnectFlowInputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.cidrs)) {
            query["Cidrs"] = request.cidrs ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateMediaConnectFlowInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaConnectFlowInput(_ request: UpdateMediaConnectFlowInputRequest) async throws -> UpdateMediaConnectFlowInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateMediaConnectFlowInputWithOptions(request as! UpdateMediaConnectFlowInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaConnectFlowOutputWithOptions(_ request: UpdateMediaConnectFlowOutputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateMediaConnectFlowOutputResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.cidrs)) {
            query["Cidrs"] = request.cidrs ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateMediaConnectFlowOutputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaConnectFlowOutput(_ request: UpdateMediaConnectFlowOutputRequest) async throws -> UpdateMediaConnectFlowOutputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateMediaConnectFlowOutputWithOptions(request as! UpdateMediaConnectFlowOutputRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaLiveChannelWithOptions(_ tmpReq: UpdateMediaLiveChannelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateMediaLiveChannelResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateMediaLiveChannelShrinkRequest = UpdateMediaLiveChannelShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.audioSettings)) {
            request.audioSettingsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.audioSettings, "AudioSettings", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateMediaLiveChannelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaLiveChannel(_ request: UpdateMediaLiveChannelRequest) async throws -> UpdateMediaLiveChannelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateMediaLiveChannelWithOptions(request as! UpdateMediaLiveChannelRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaLiveInputWithOptions(_ tmpReq: UpdateMediaLiveInputRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateMediaLiveInputResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateMediaLiveInputShrinkRequest = UpdateMediaLiveInputShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.inputSettings)) {
            request.inputSettingsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.inputSettings, "InputSettings", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateMediaLiveInputResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaLiveInput(_ request: UpdateMediaLiveInputRequest) async throws -> UpdateMediaLiveInputResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateMediaLiveInputWithOptions(request as! UpdateMediaLiveInputRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaLiveInputSecurityGroupWithOptions(_ tmpReq: UpdateMediaLiveInputSecurityGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateMediaLiveInputSecurityGroupResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateMediaLiveInputSecurityGroupShrinkRequest = UpdateMediaLiveInputSecurityGroupShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.whitelistRules)) {
            request.whitelistRulesShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.whitelistRules, "WhitelistRules", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateMediaLiveInputSecurityGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateMediaLiveInputSecurityGroup(_ request: UpdateMediaLiveInputSecurityGroupRequest) async throws -> UpdateMediaLiveInputSecurityGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateMediaLiveInputSecurityGroupWithOptions(request as! UpdateMediaLiveInputSecurityGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
