...
```ruby
pod 'AlibabacloudICE20201109', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/ice-20201109" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ice-20201109.git", from: "1.0.0")
]
```
