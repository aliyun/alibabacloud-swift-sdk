...
```ruby
pod 'AlibabacloudICE20201109', '~> 1.3.5'
```
...
```ogdl
github "alibabacloud-sdk-swift/ice-20201109" "1.3.5"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ice-20201109.git", from: "1.3.5")
]
```
