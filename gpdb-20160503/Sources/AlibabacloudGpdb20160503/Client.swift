...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func checkSaasServiceVersionWithOptions(_ request: CheckSaasServiceVersionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CheckSaasServiceVersionResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CheckSaasServiceVersionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func checkSaasServiceVersion(_ request: CheckSaasServiceVersionRequest) async throws -> CheckSaasServiceVersionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await checkSaasServiceVersionWithOptions(request as! CheckSaasServiceVersionRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createAIServiceWithOptions(_ request: CreateAIServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateAIServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBInstanceId)) {
            query["DBInstanceId"] = request.DBInstanceId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.serviceAccountPassword)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateAIServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createAIService(_ request: CreateAIServiceRequest) async throws -> CreateAIServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createAIServiceWithOptions(request as! CreateAIServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createApiKeyWithOptions(_ tmpReq: CreateApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateApiKeyResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateApiKeyShrinkRequest = CreateApiKeyShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.serviceIds)) {
            request.serviceIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.serviceIds, "ServiceIds", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.serviceIdsShrink)) {
    ...
    public func createApiKey(_ request: CreateApiKeyRequest) async throws -> CreateApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createApiKeyWithOptions(request as! CreateApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createBranchWithOptions(_ request: CreateBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.expiresAt)) {
            query["ExpiresAt"] = request.expiresAt ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.initSource)) {
            query["InitSource"] = request.initSource ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.parentBranchId)) {
            query["ParentBranchId"] = request.parentBranchId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.parentLsn)) {
            query["ParentLsn"] = request.parentLsn ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.parentTimestamp)) {
            query["ParentTimestamp"] = request.parentTimestamp ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.projectId)) {
            query["ProjectId"] = request.projectId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.protected)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createBranch(_ request: CreateBranchRequest) async throws -> CreateBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createBranchWithOptions(request as! CreateBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func createCollectionWithOptions(_ tmpReq: CreateCollectionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateCollectionResponse {
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.vectorIndexConfig)) {
            request.vectorIndexConfigShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.vectorIndexConfig, "VectorIndexConfig", "json")
        }
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.vectorIndexConfigShrink)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createModelOperatorApiKeyWithOptions(_ request: CreateModelOperatorApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateModelOperatorApiKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateModelOperatorApiKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createModelOperatorApiKey(_ request: CreateModelOperatorApiKeyRequest) async throws -> CreateModelOperatorApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createModelOperatorApiKeyWithOptions(request as! CreateModelOperatorApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createSaasServiceWithOptions(_ request: CreateSaasServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateSaasServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateSaasServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createSaasService(_ request: CreateSaasServiceRequest) async throws -> CreateSaasServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createSaasServiceWithOptions(request as! CreateSaasServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func createSnapshotWithOptions(_ request: CreateSnapshotRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateSnapshotResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.lsn)) {
        ...
        if (!TeaUtils.Client.isUnset(request.snapshotTimestamp)) {
    ...
    public func createSupabaseProjectWithOptions(_ request: CreateSupabaseProjectRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateSupabaseProjectResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.lightweight)) {
    ...
    public func createVectorIndexWithOptions(_ request: CreateVectorIndexRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateVectorIndexResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.nlist)) {
        ...
        if (!TeaUtils.Client.isUnset(request.rabitqBits)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAIServiceWithOptions(_ request: DeleteAIServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteAIServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBInstanceId)) {
            query["DBInstanceId"] = request.DBInstanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteAIServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAIService(_ request: DeleteAIServiceRequest) async throws -> DeleteAIServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteAIServiceWithOptions(request as! DeleteAIServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteApiKeyWithOptions(_ request: DeleteApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteApiKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
    ...
    public func deleteApiKey(_ request: DeleteApiKeyRequest) async throws -> DeleteApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteApiKeyWithOptions(request as! DeleteApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteBranchWithOptions(_ request: DeleteBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteBranch(_ request: DeleteBranchRequest) async throws -> DeleteBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteBranchWithOptions(request as! DeleteBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteChunksWithOptions(_ tmpReq: DeleteChunksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteChunksResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: DeleteChunksShrinkRequest = DeleteChunksShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.chunkIds)) {
            request.chunkIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.chunkIds, "ChunkIds", "simple")
        }
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteChunksResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteChunks(_ request: DeleteChunksRequest) async throws -> DeleteChunksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteChunksWithOptions(request as! DeleteChunksRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteSaasServiceWithOptions(_ request: DeleteSaasServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteSaasServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteSaasServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteSaasService(_ request: DeleteSaasServiceRequest) async throws -> DeleteSaasServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteSaasServiceWithOptions(request as! DeleteSaasServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeAIServiceWithOptions(_ request: DescribeAIServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeAIServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBInstanceId)) {
            query["DBInstanceId"] = request.DBInstanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeAIServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeAIService(_ request: DescribeAIServiceRequest) async throws -> DescribeAIServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeAIServiceWithOptions(request as! DescribeAIServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeBranchWithOptions(_ request: DescribeBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.branchId)) {
            query["BranchId"] = request.branchId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeBranchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeBranch(_ request: DescribeBranchRequest) async throws -> DescribeBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeBranchWithOptions(request as! DescribeBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDBVersionWithOptions(_ request: DescribeDBVersionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeDBVersionResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBInstanceId)) {
            query["DBInstanceId"] = request.DBInstanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeDBVersionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDBVersion(_ request: DescribeDBVersionRequest) async throws -> DescribeDBVersionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeDBVersionWithOptions(request as! DescribeDBVersionRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeModelOperatorApiKeyWithOptions(_ request: DescribeModelOperatorApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeModelOperatorApiKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeModelOperatorApiKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeModelOperatorApiKey(_ request: DescribeModelOperatorApiKeyRequest) async throws -> DescribeModelOperatorApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeModelOperatorApiKeyWithOptions(request as! DescribeModelOperatorApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeModelOperatorUsageWithOptions(_ tmpReq: DescribeModelOperatorUsageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeModelOperatorUsageResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: DescribeModelOperatorUsageShrinkRequest = DescribeModelOperatorUsageShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.apiKeyIds)) {
            request.apiKeyIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.apiKeyIds, "ApiKeyIds", "simple")
        }
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.modelNames)) {
            request.modelNamesShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.modelNames, "ModelNames", "simple")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.apiKeyIdsShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.modelNamesShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeModelOperatorUsageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeModelOperatorUsage(_ request: DescribeModelOperatorUsageRequest) async throws -> DescribeModelOperatorUsageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeModelOperatorUsageWithOptions(request as! DescribeModelOperatorUsageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getApiEndpointsWithOptions(_ request: GetApiEndpointsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetApiEndpointsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetApiEndpointsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getApiEndpoints(_ request: GetApiEndpointsRequest) async throws -> GetApiEndpointsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getApiEndpointsWithOptions(request as! GetApiEndpointsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getApiKeyWithOptions(_ request: GetApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetApiKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.keyId)) {
            query["KeyId"] = request.keyId ?? "";
    ...
    public func getApiKey(_ request: GetApiKeyRequest) async throws -> GetApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getApiKeyWithOptions(request as! GetApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getBranchSchemaWithOptions(_ request: GetBranchSchemaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetBranchSchemaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.branchId)) {
            query["BranchId"] = request.branchId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetBranchSchemaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getBranchSchema(_ request: GetBranchSchemaRequest) async throws -> GetBranchSchemaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getBranchSchemaWithOptions(request as! GetBranchSchemaRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getSaasServiceWithOptions(_ request: GetSaasServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetSaasServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetSaasServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getSaasService(_ request: GetSaasServiceRequest) async throws -> GetSaasServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getSaasServiceWithOptions(request as! GetSaasServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getServiceAccessInfoWithOptions(_ request: GetServiceAccessInfoRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetServiceAccessInfoResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetServiceAccessInfoResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getServiceAccessInfo(_ request: GetServiceAccessInfoRequest) async throws -> GetServiceAccessInfoResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getServiceAccessInfoWithOptions(request as! GetServiceAccessInfoRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func grantApiKeyWithOptions(_ tmpReq: GrantApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GrantApiKeyResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: GrantApiKeyShrinkRequest = GrantApiKeyShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.serviceIds)) {
            request.serviceIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.serviceIds, "ServiceIds", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GrantApiKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func grantApiKey(_ request: GrantApiKeyRequest) async throws -> GrantApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await grantApiKeyWithOptions(request as! GrantApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAIServicesWithOptions(_ request: ListAIServicesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListAIServicesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBInstanceId)) {
            query["DBInstanceId"] = request.DBInstanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListAIServicesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAIServices(_ request: ListAIServicesRequest) async throws -> ListAIServicesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listAIServicesWithOptions(request as! ListAIServicesRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listApiKeysWithOptions(_ request: ListApiKeysRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListApiKeysResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.keyName)) {
            query["KeyName"] = request.keyName ?? "";
    ...
    public func listApiKeys(_ request: ListApiKeysRequest) async throws -> ListApiKeysResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listApiKeysWithOptions(request as! ListApiKeysRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listBranchesWithOptions(_ request: ListBranchesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListBranchesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.maxResults)) {
            query["MaxResults"] = request.maxResults!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListBranchesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listBranches(_ request: ListBranchesRequest) async throws -> ListBranchesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listBranchesWithOptions(request as! ListBranchesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listModelOperatorApiKeysWithOptions(_ request: ListModelOperatorApiKeysRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListModelOperatorApiKeysResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.pageNumber)) {
            query["PageNumber"] = request.pageNumber!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListModelOperatorApiKeysResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listModelOperatorApiKeys(_ request: ListModelOperatorApiKeysRequest) async throws -> ListModelOperatorApiKeysResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listModelOperatorApiKeysWithOptions(request as! ListModelOperatorApiKeysRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listModelOperatorServicesWithOptions(_ request: ListModelOperatorServicesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListModelOperatorServicesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.pageNumber)) {
            query["PageNumber"] = request.pageNumber!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListModelOperatorServicesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listModelOperatorServices(_ request: ListModelOperatorServicesRequest) async throws -> ListModelOperatorServicesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listModelOperatorServicesWithOptions(request as! ListModelOperatorServicesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listSaasServiceWithOptions(_ request: ListSaasServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListSaasServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.maxResults)) {
            query["MaxResults"] = request.maxResults!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListSaasServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listSaasService(_ request: ListSaasServiceRequest) async throws -> ListSaasServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listSaasServiceWithOptions(request as! ListSaasServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func listSupabaseProjectsWithOptions(_ request: ListSupabaseProjectsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListSupabaseProjectsResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.searchField)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyAIServiceSecurityIpsWithOptions(_ request: ModifyAIServiceSecurityIpsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyAIServiceSecurityIpsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBInstanceId)) {
            query["DBInstanceId"] = request.DBInstanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyAIServiceSecurityIpsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyAIServiceSecurityIps(_ request: ModifyAIServiceSecurityIpsRequest) async throws -> ModifyAIServiceSecurityIpsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyAIServiceSecurityIpsWithOptions(request as! ModifyAIServiceSecurityIpsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifySaasServiceDeletionProtectionWithOptions(_ request: ModifySaasServiceDeletionProtectionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifySaasServiceDeletionProtectionResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifySaasServiceDeletionProtectionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifySaasServiceDeletionProtection(_ request: ModifySaasServiceDeletionProtectionRequest) async throws -> ModifySaasServiceDeletionProtectionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifySaasServiceDeletionProtectionWithOptions(request as! ModifySaasServiceDeletionProtectionRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pauseSaasServiceWithOptions(_ request: PauseSaasServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PauseSaasServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PauseSaasServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pauseSaasService(_ request: PauseSaasServiceRequest) async throws -> PauseSaasServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pauseSaasServiceWithOptions(request as! PauseSaasServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pauseSupabaseProjectWithOptions(_ request: PauseSupabaseProjectRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PauseSupabaseProjectResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.projectId)) {
            query["ProjectId"] = request.projectId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PauseSupabaseProjectResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pauseSupabaseProject(_ request: PauseSupabaseProjectRequest) async throws -> PauseSupabaseProjectResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pauseSupabaseProjectWithOptions(request as! PauseSupabaseProjectRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func queryContentWithOptions(_ tmpReq: QueryContentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryContentResponse {
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.rerankModel)) {
            request.rerankModelShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.rerankModel, "RerankModel", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.collection)) {
            query["Collection"] = request.collection ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.rerankModelShrink)) {
    ...
    public func rerankWithOptions(_ tmpReq: RerankRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RerankResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.instruct)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resetBranchWithOptions(_ request: ResetBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResetBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.branchId)) {
            query["BranchId"] = request.branchId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ResetBranchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resetBranch(_ request: ResetBranchRequest) async throws -> ResetBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await resetBranchWithOptions(request as! ResetBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func restartSupabaseProjectWithOptions(_ request: RestartSupabaseProjectRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RestartSupabaseProjectResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.projectId)) {
            query["ProjectId"] = request.projectId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RestartSupabaseProjectResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func restartSupabaseProject(_ request: RestartSupabaseProjectRequest) async throws -> RestartSupabaseProjectResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await restartSupabaseProjectWithOptions(request as! RestartSupabaseProjectRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func restoreBranchWithOptions(_ request: RestoreBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RestoreBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.branchId)) {
            query["BranchId"] = request.branchId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.preserveUnderName)) {
        ...
        if (!TeaUtils.Client.isUnset(request.sourceBranchId)) {
            query["SourceBranchId"] = request.sourceBranchId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.sourceBranchLsn)) {
            query["SourceBranchLsn"] = request.sourceBranchLsn ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.sourceBranchTimestamp)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RestoreBranchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func restoreBranch(_ request: RestoreBranchRequest) async throws -> RestoreBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await restoreBranchWithOptions(request as! RestoreBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func restoreSnapshotWithOptions(_ request: RestoreSnapshotRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RestoreSnapshotResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.clientToken)) {
            query["ClientToken"] = request.clientToken ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.finalizeRestore)) {
        ...
        if (!TeaUtils.Client.isUnset(request.restoredBranchName)) {
            query["RestoredBranchName"] = request.restoredBranchName ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.restoredLsn)) {
            query["RestoredLsn"] = request.restoredLsn ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.targetBranchId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RestoreSnapshotResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func restoreSnapshot(_ request: RestoreSnapshotRequest) async throws -> RestoreSnapshotResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await restoreSnapshotWithOptions(request as! RestoreSnapshotRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeSaasServiceWithOptions(_ request: ResumeSaasServiceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResumeSaasServiceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ResumeSaasServiceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeSaasService(_ request: ResumeSaasServiceRequest) async throws -> ResumeSaasServiceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await resumeSaasServiceWithOptions(request as! ResumeSaasServiceRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeSupabaseProjectWithOptions(_ request: ResumeSupabaseProjectRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResumeSupabaseProjectResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.projectId)) {
            query["ProjectId"] = request.projectId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ResumeSupabaseProjectResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeSupabaseProject(_ request: ResumeSupabaseProjectRequest) async throws -> ResumeSupabaseProjectResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await resumeSupabaseProjectWithOptions(request as! ResumeSupabaseProjectRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func revokeApiKeyWithOptions(_ tmpReq: RevokeApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RevokeApiKeyResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: RevokeApiKeyShrinkRequest = RevokeApiKeyShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.serviceIds)) {
            request.serviceIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.serviceIds, "ServiceIds", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RevokeApiKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func revokeApiKey(_ request: RevokeApiKeyRequest) async throws -> RevokeApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await revokeApiKeyWithOptions(request as! RevokeApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setAsDefaultBranchWithOptions(_ request: SetAsDefaultBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SetAsDefaultBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.branchId)) {
            query["BranchId"] = request.branchId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SetAsDefaultBranchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setAsDefaultBranch(_ request: SetAsDefaultBranchRequest) async throws -> SetAsDefaultBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await setAsDefaultBranchWithOptions(request as! SetAsDefaultBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateBranchWithOptions(_ request: UpdateBranchRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateBranchResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.branchId)) {
            query["BranchId"] = request.branchId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.clearExpiresAt)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateBranchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateBranch(_ request: UpdateBranchRequest) async throws -> UpdateBranchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateBranchWithOptions(request as! UpdateBranchRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateSaasServiceVersionWithOptions(_ request: UpdateSaasServiceVersionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateSaasServiceVersionResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.regionId)) {
            query["RegionId"] = request.regionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateSaasServiceVersionResponse(), tmp)
    }
