...
```ruby
pod 'AlibabacloudLinkcard20210520', '~> 1.0.4'
```
...
```ogdl
github "alibabacloud-sdk-swift/linkcard-20210520" "1.0.4"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/linkcard-20210520.git", from: "1.0.4")
]
```
