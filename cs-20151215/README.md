...
```ruby
pod 'AlibabacloudCS20151215', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/cs-20151215" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/cs-20151215.git", from: "1.0.0")
]
```
