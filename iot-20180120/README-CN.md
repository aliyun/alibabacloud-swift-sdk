...
```ruby
pod 'AlibabacloudIot20180120', '~> 1.0.2'
```
...
```ogdl
github "alibabacloud-sdk-swift/iot-20180120" "1.0.2"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/iot-20180120.git", from: "1.0.2")
]
```
