...
```ruby
pod 'AlibabacloudQuickbi_public20220101', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/quickbi-public-20220101" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/quickbi-public-20220101.git", from: "1.0.0")
]
```
