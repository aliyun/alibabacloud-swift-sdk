Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDyiotapi20171111"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Dyiotapi (20171111) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/dyiotapi-20171111" 
