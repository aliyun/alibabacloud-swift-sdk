...
```ruby
pod 'AlibabacloudIms20190815', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/ims-20190815" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ims-20190815.git", from: "1.0.0")
]
```
