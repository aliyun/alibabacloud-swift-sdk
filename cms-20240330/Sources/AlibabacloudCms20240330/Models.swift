...
public class AlertRuleQuery : Tea.TeaModel {
    public class EntityFields : Tea.TeaModel {
    ...
    public class EntityFilter : Tea.TeaModel {
        ...
        public var filters: [AlertRuleQuery.EntityFilter.Filters]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["filters"] as? [Any?] {
                var tmp : [AlertRuleQuery.EntityFilter.Filters] = []
                for v in value {
                    if v != nil {
                        var model = AlertRuleQuery.EntityFilter.Filters()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public class LabelFilters : Tea.TeaModel {
        public var name: String?
    ...
    public var entityFields: [AlertRuleQuery.EntityFields]?

    public var entityFilter: AlertRuleQuery.EntityFilter?
    ...
    public override func validate() throws -> Void {
        try self.entityFilter?.validate()
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.entityFields != nil {
            var tmp : [Any] = []
            for k in self.entityFields! {
                tmp.append(k.toMap())
            }
            map["entityFields"] = tmp
        }
        if self.entityFilter != nil {
            map["entityFilter"] = self.entityFilter?.toMap()
        }
        if self.expr != nil {
            map["expr"] = self.expr!
        }
        ...
        if self.labelFilters != nil {
            var tmp : [Any] = []
            for k in self.labelFilters! {
                tmp.append(k.toMap())
            }
        ...
        if self.metricSet != nil {
            map["metricSet"] = self.metricSet!
        }
        if self.namespace != nil {
            map["namespace"] = self.namespace!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["entityFields"] as? [Any?] {
            var tmp : [AlertRuleQuery.EntityFields] = []
            for v in value {
                if v != nil {
                    var model = AlertRuleQuery.EntityFields()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
            ...
            self.entityFields = tmp
        }
        if let value = dict["entityFilter"] as? [String: Any?] {
            var model = AlertRuleQuery.EntityFilter()
            model.fromMap(value)
            self.entityFilter = model
        }
        if let value = dict["expr"] as? String {
            self.expr = value
        }
        ...
        if let value = dict["labelFilters"] as? [Any?] {
            var tmp : [AlertRuleQuery.LabelFilters] = []
            for v in value {
                if v != nil {
                    var model = AlertRuleQuery.LabelFilters()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["metricSet"] as? String {
            self.metricSet = value
        }
        if let value = dict["namespace"] as? String {
            self.namespace = value
        }
...
public class CmsEventForView : Tea.TeaModel {
    ...
    public var integrationUuid: String?

    public var labels: [String: Any]?

    public var receiveTime: Int64?

    public var resource: EventResourceForEventView?
    ...
    public var workspaceTags: [String: Any]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.datacontenttype != nil {
            map["datacontenttype"] = self.datacontenttype!
        }
        ...
        if self.integrationUuid != nil {
            map["integrationUuid"] = self.integrationUuid!
        }
        if self.labels != nil {
            map["labels"] = self.labels!
        }
        ...
        if self.workspaceTags != nil {
            map["workspaceTags"] = self.workspaceTags!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["datacontenttype"] as? String {
        ...
        if let value = dict["integrationUuid"] as? String {
            self.integrationUuid = value
        }
        if let value = dict["labels"] as? [String: Any] {
            self.labels = value
        }
        if let value = dict["receiveTime"] as? Int64 {
            self.receiveTime = value
        }
        if let value = dict["resource"] as? [String: Any?] {
            var model = EventResourceForEventView()
            model.fromMap(value)
            self.resource = model
        }
        ...
        if let value = dict["sysId"] as? String {
            self.sysId = value
        }
        ...
        if let value = dict["workspaceTags"] as? [String: Any] {
            self.workspaceTags = value
        }
    }
}

public class ContactForIncidentView : Tea.TeaModel {
...
public class EventResourceForEventView : Tea.TeaModel {
    public class Entity : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["prop"] as? [String: Any] {
                self.prop = value
            }
        }
    }
    public var entity: EventResourceForEventView.Entity?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["entity"] as? [String: Any?] {
            var model = EventResourceForEventView.Entity()
            model.fromMap(value)
            self.entity = model
        }
...
public class EventResourceForIncidentView : Tea.TeaModel {
    public var domain: String?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["probs"] as? String {
            self.probs = value
        }
...
public class IncidentEscalationPolicyForModify : Tea.TeaModel {
    public var description_: String?

    public var enable: Bool?

    public var escalationStageList: [IncidentEscalationStageForView]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.escalationStageList != nil {
            var tmp : [Any] = []
            for k in self.escalationStageList! {
                tmp.append(k.toMap())
            }
            map["escalationStageList"] = tmp
        }
        if self.name != nil {
            map["name"] = self.name!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["escalationStageList"] as? [Any?] {
            var tmp : [IncidentEscalationStageForView] = []
            for v in value {
                if v != nil {
                    var model = IncidentEscalationStageForView()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class IncidentEscalationPolicyForView : Tea.TeaModel {
    public var createTime: String?
    ...
    public var syncFromType: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.syncFromType != nil {
            map["syncFromType"] = self.syncFromType!
        }
        if self.updateTime != nil {
            map["updateTime"] = self.updateTime!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["syncFromType"] as? String {
            self.syncFromType = value
        }
        if let value = dict["updateTime"] as? String {
            self.updateTime = value
        }
...
public class IncidentEscalationStageForView : Tea.TeaModel {
    public var cycleNotifyCount: Int32?

    public var cycleNotifyInterval: Int32?

    public var effectTimeRange: EffectTimeRange?

    public var index: Int32?

    public var notifyChannels: [NotifyChannel]?

    public var targetIncidentState: String?

    public var triggerDelay: Int32?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.cycleNotifyInterval != nil {
            map["cycleNotifyInterval"] = self.cycleNotifyInterval!
        }
        ...
        if self.notifyChannels != nil {
            var tmp : [Any] = []
            for k in self.notifyChannels! {
                tmp.append(k.toMap())
            }
            map["notifyChannels"] = tmp
        }
        if self.targetIncidentState != nil {
            map["targetIncidentState"] = self.targetIncidentState!
        }
        if self.triggerDelay != nil {
            map["triggerDelay"] = self.triggerDelay!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["cycleNotifyInterval"] as? Int32 {
            self.cycleNotifyInterval = value
        }
        if let value = dict["effectTimeRange"] as? [String: Any?] {
            var model = EffectTimeRange()
            model.fromMap(value)
        ...
        if let value = dict["notifyChannels"] as? [Any?] {
            var tmp : [NotifyChannel] = []
            for v in value {
                if v != nil {
                    var model = NotifyChannel()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
            ...
            self.notifyChannels = tmp
        }
        if let value = dict["targetIncidentState"] as? String {
            self.targetIncidentState = value
        }
        if let value = dict["triggerDelay"] as? Int32 {
...
public class IncidentEventForView : Tea.TeaModel {
    public var autoRecoverTime: Int64?

    public var content: CmsEventForView?

    public var count: Int32?

    public var dimension: [String: Any]?

    public var eventResource: EventResourceForIncidentView?

    public var groupBy: [String: Any]?

    public var incidentEventUuid: String?
    ...
    public var severityCountMap: [String: Any]?

    public var state: Int32?

    public var textIndex: String?
    ...
    public override func validate() throws -> Void {
        ...
        try self.eventResource?.validate()
    }
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.eventResource != nil {
            map["eventResource"] = self.eventResource?.toMap()
        }
        if self.groupBy != nil {
            map["groupBy"] = self.groupBy!
        }
        if self.incidentEventUuid != nil {
            map["incidentEventUuid"] = self.incidentEventUuid!
        }
        ...
        if self.searchIndex != nil {
            map["searchIndex"] = self.searchIndex!
        }
        if self.severity != nil {
            map["severity"] = self.severity!
        }
        if self.severityCountMap != nil {
            map["severityCountMap"] = self.severityCountMap!
        }
        if self.state != nil {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["eventResource"] as? [String: Any?] {
            var model = EventResourceForIncidentView()
            model.fromMap(value)
            self.eventResource = model
        }
        if let value = dict["groupBy"] as? [String: Any] {
            self.groupBy = value
        }
        if let value = dict["incidentEventUuid"] as? String {
            self.incidentEventUuid = value
        }
        ...
        if let value = dict["searchIndex"] as? [String] {
            self.searchIndex = value
        }
        if let value = dict["severity"] as? String {
            self.severity = value
        }
        if let value = dict["severityCountMap"] as? [String: Any] {
            self.severityCountMap = value
        }
        if let value = dict["state"] as? Int32 {
            self.state = value
        }
        if let value = dict["textIndex"] as? String {
            self.textIndex = value
        }
...
public class IncidentForView : Tea.TeaModel {
    public var content: String?

    public var escalations: [IncidentEscalationPolicyForView]?

    public var groupUuid: String?

    public var groupingKeys: [String: String]?
    ...
    public var operator_: ContactForIncidentView?

    public var owners: [ContactForIncidentView]?

    public var participants: [ContactForIncidentView]?

    public var plan: IncidentResponsePlanForView?

    public var relatedResources: [EventResourceForIncidentView]?
    ...
    public var subscriptionUuid: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.notifyStrategyUuid != nil {
            map["notifyStrategyUuid"] = self.notifyStrategyUuid!
        }
        if self.operator_ != nil {
        ...
        if self.rootCauseCategory != nil {
            map["rootCauseCategory"] = self.rootCauseCategory!
        }
        if self.severity != nil {
            map["severity"] = self.severity!
        }
        ...
        if self.subscriptionUuid != nil {
            map["subscriptionUuid"] = self.subscriptionUuid!
        }
        if self.time != nil {
            map["time"] = self.time!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["escalations"] as? [Any?] {
            var tmp : [IncidentEscalationPolicyForView] = []
            for v in value {
                if v != nil {
                    var model = IncidentEscalationPolicyForView()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["groupingKeys"] as? [String: String] {
        ...
        if let value = dict["notifyStrategyUuid"] as? String {
            self.notifyStrategyUuid = value
        }
        if let value = dict["operator"] as? [String: Any?] {
            var model = ContactForIncidentView()
            model.fromMap(value)
            self.operator_ = model
        }
        if let value = dict["owners"] as? [Any?] {
            var tmp : [ContactForIncidentView] = []
            for v in value {
                if v != nil {
                    var model = ContactForIncidentView()
                    if v != nil {
        ...
        if let value = dict["participants"] as? [Any?] {
            var tmp : [ContactForIncidentView] = []
            for v in value {
                if v != nil {
                    var model = ContactForIncidentView()
        ...
        if let value = dict["plan"] as? [String: Any?] {
            var model = IncidentResponsePlanForView()
            model.fromMap(value)
            self.plan = model
        }
        if let value = dict["relatedResources"] as? [Any?] {
            var tmp : [EventResourceForIncidentView] = []
            for v in value {
                if v != nil {
                    var model = EventResourceForIncidentView()
                    if v != nil {
        ...
        if let value = dict["rootCauseCategory"] as? String {
            self.rootCauseCategory = value
        }
        if let value = dict["severity"] as? String {
            self.severity = value
        }
        ...
        if let value = dict["subscriptionUuid"] as? String {
            self.subscriptionUuid = value
        }
        if let value = dict["time"] as? Int64 {
            self.time = value
        }
...
public class IncidentResponsePlanForView : Tea.TeaModel {
    ...
    public var pushingSetting: PushingSetting?

    public var repeatNotifySetting: RepeatNotifySetting?
...
public class IncidentTimelineForView : Tea.TeaModel {
    ...
    public var timelineUuid: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.timelineUuid != nil {
            map["timelineUuid"] = self.timelineUuid!
        }
        if self.title != nil {
            map["title"] = self.title!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["timelineUuid"] as? String {
            self.timelineUuid = value
        }
        if let value = dict["title"] as? String {
            self.title = value
        }
...
public class NotifyChannel : Tea.TeaModel {
...
public class NotifyStrategyForModify : Tea.TeaModel {
    ...
    public var enableIncidentManagement: Bool?
    ...
    public var pushingSetting: NotifyStrategyForModify.PushingSetting?

    public var repeatNotifySetting: NotifyStrategyForModify.RepeatNotifySetting?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.enableIncidentManagement != nil {
            map["enableIncidentManagement"] = self.enableIncidentManagement!
        }
        if self.escalationId != nil {
            map["escalationId"] = self.escalationId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["enableIncidentManagement"] as? Bool {
            self.enableIncidentManagement = value
        }
        if let value = dict["escalationId"] as? [String] {
            self.escalationId = value
        }
        ...
        if let value = dict["pushingSetting"] as? [String: Any?] {
            var model = NotifyStrategyForModify.PushingSetting()
            model.fromMap(value)
            self.pushingSetting = model
        }
        if let value = dict["repeatNotifySetting"] as? [String: Any?] {
            var model = NotifyStrategyForModify.RepeatNotifySetting()
            model.fromMap(value)
            self.repeatNotifySetting = model
        }
...
public class NotifyStrategyForView : Tea.TeaModel {
    ...
    public var incidentEscalationPolicies: [Any]?

    public var notifyStrategyId: String?

    public var notifyStrategyName: String?

    public var pushingSetting: NotifyStrategyForView.PushingSetting?

    public var receiverNames: [String]?

    public var repeatNotifySetting: NotifyStrategyForView.RepeatNotifySetting?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.incidentEscalationPolicies != nil {
            map["incidentEscalationPolicies"] = self.incidentEscalationPolicies!
        }
        ...
        if self.receiverNames != nil {
            map["receiverNames"] = self.receiverNames!
        }
        if self.repeatNotifySetting != nil {
            map["repeatNotifySetting"] = self.repeatNotifySetting?.toMap()
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["incidentEscalationPolicies"] as? [Any] {
            self.incidentEscalationPolicies = value
        }
        ...
        if let value = dict["pushingSetting"] as? [String: Any?] {
            var model = NotifyStrategyForView.PushingSetting()
            model.fromMap(value)
            self.pushingSetting = model
        }
        if let value = dict["receiverNames"] as? [String] {
            self.receiverNames = value
        }
        if let value = dict["repeatNotifySetting"] as? [String: Any?] {
            var model = NotifyStrategyForView.RepeatNotifySetting()
            model.fromMap(value)
            self.repeatNotifySetting = model
        }
        if let value = dict["routes"] as? [Any?] {
...
public class WorkspaceFilterSetting : Tea.TeaModel {
    public var tagSelector: FilterSetting?
    ...
    public override func validate() throws -> Void {
        try self.tagSelector?.validate()
    }

    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.tagSelector != nil {
            map["tagSelector"] = self.tagSelector?.toMap()
        }
        if self.workspaceUuids != nil {
            map["workspaceUuids"] = self.workspaceUuids!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["tagSelector"] as? [String: Any?] {
            var model = FilterSetting()
            model.fromMap(value)
            self.tagSelector = model
        }
        if let value = dict["workspaceUuids"] as? [String] {
            self.workspaceUuids = value
        }
    }
}
...
public class CreateBizTraceResponseBody : Tea.TeaModel {
    public var bizTraceId: String?
...
public class CreateBizTraceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateBizTraceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateBizTraceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteBizTraceResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteBizTraceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteBizTraceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteBizTraceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteUmodelCommonSchemaRefRequest : Tea.TeaModel {
    public var group: String?
...
public class DeleteUmodelCommonSchemaRefResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteUmodelCommonSchemaRefResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteUmodelCommonSchemaRefResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteUmodelCommonSchemaRefResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetAddonResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public class Environments : Tea.TeaModel {
            ...
            public class Policies : Tea.TeaModel {
                ...
                public var metricCheckRule: GetAddonResponseBody.Data.Environments.Policies.MetricCheckRule?

                public var needRestartAfterIntegration: Bool?

                public var protocols: [GetAddonResponseBody.Data.Environments.Policies.Protocols]?
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    ...
                    if let value = dict["metricCheckRule"] as? [String: Any?] {
                        var model = GetAddonResponseBody.Data.Environments.Policies.MetricCheckRule()
                        model.fromMap(value)
                        self.metricCheckRule = model
                    }
                    if let value = dict["needRestartAfterIntegration"] as? Bool {
                    ...
                    if let value = dict["protocols"] as? [Any?] {
                        var tmp : [GetAddonResponseBody.Data.Environments.Policies.Protocols] = []
                        for v in value {
                            if v != nil {
                                var model = GetAddonResponseBody.Data.Environments.Policies.Protocols()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
            ...
            public var commonSchemaRefs: [GetAddonResponseBody.Data.Environments.CommonSchemaRefs]?

            public var dependencies: GetAddonResponseBody.Data.Environments.Dependencies?
            ...
            public var policies: GetAddonResponseBody.Data.Environments.Policies?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["commonSchemaRefs"] as? [Any?] {
                    var tmp : [GetAddonResponseBody.Data.Environments.CommonSchemaRefs] = []
                    for v in value {
                        if v != nil {
                            var model = GetAddonResponseBody.Data.Environments.CommonSchemaRefs()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["dependencies"] as? [String: Any?] {
                    var model = GetAddonResponseBody.Data.Environments.Dependencies()
                    model.fromMap(value)
                    self.dependencies = model
                }
                if let value = dict["description"] as? String {
                ...
                if let value = dict["policies"] as? [String: Any?] {
                    var model = GetAddonResponseBody.Data.Environments.Policies()
                    model.fromMap(value)
                    self.policies = model
                }
                if let value = dict["policyType"] as? String {
        ...
        public var dashboards: [GetAddonResponseBody.Data.Dashboards]?

        public var description_: String?

        public var environments: [GetAddonResponseBody.Data.Environments]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["dashboards"] as? [Any?] {
                var tmp : [GetAddonResponseBody.Data.Dashboards] = []
                for v in value {
                    if v != nil {
                        var model = GetAddonResponseBody.Data.Dashboards()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["environments"] as? [Any?] {
                var tmp : [GetAddonResponseBody.Data.Environments] = []
                for v in value {
                    if v != nil {
                        var model = GetAddonResponseBody.Data.Environments()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: GetAddonResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = GetAddonResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["requestId"] as? String {
...
public class GetAddonCodeTemplateRequest : Tea.TeaModel {
    public var aliyunLang: String?
...
public class GetAddonCodeTemplateResponseBody : Tea.TeaModel {
    public class Codes : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.codeTemplate != nil {
                map["codeTemplate"] = self.codeTemplate!
            }
            if self.name != nil {
                map["name"] = self.name!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["codeTemplate"] as? String {
                self.codeTemplate = value
            }
            if let value = dict["name"] as? String {
                self.name = value
            }
    ...
    public var codes: [GetAddonCodeTemplateResponseBody.Codes]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["codes"] as? [Any?] {
            var tmp : [GetAddonCodeTemplateResponseBody.Codes] = []
            for v in value {
                if v != nil {
                    var model = GetAddonCodeTemplateResponseBody.Codes()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetAddonCodeTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetAddonCodeTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetAddonCodeTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetAddonSchemaRequest : Tea.TeaModel {
    public var aliyunLang: String?
...
public class GetAddonSchemaResponseBody : Tea.TeaModel {
    public class Fields : Tea.TeaModel {
        ...
        public class Props : Tea.TeaModel {
            ...
            public var dataSource: [GetAddonSchemaResponseBody.Fields.Props.DataSource]?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.selectMode != nil {
                    map["selectMode"] = self.selectMode!
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["dataSource"] as? [Any?] {
                    var tmp : [GetAddonSchemaResponseBody.Fields.Props.DataSource] = []
                    for v in value {
                        if v != nil {
                            var model = GetAddonSchemaResponseBody.Fields.Props.DataSource()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["selectMode"] as? String {
                    self.selectMode = value
                }
            }
        }
        public class Validation : Tea.TeaModel {
        ...
        public var conditions: [GetAddonSchemaResponseBody.Fields.Conditions]?
        ...
        public var props: GetAddonSchemaResponseBody.Fields.Props?

        public var type: String?

        public var validation: GetAddonSchemaResponseBody.Fields.Validation?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.validation != nil {
                map["validation"] = self.validation?.toMap()
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["conditions"] as? [Any?] {
                var tmp : [GetAddonSchemaResponseBody.Fields.Conditions] = []
                for v in value {
                    if v != nil {
                        var model = GetAddonSchemaResponseBody.Fields.Conditions()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["defaultValue"] as? Any {
            ...
            if let value = dict["props"] as? [String: Any?] {
                var model = GetAddonSchemaResponseBody.Fields.Props()
                model.fromMap(value)
                self.props = model
            }
            if let value = dict["type"] as? String {
            ...
            if let value = dict["validation"] as? [String: Any?] {
                var model = GetAddonSchemaResponseBody.Fields.Validation()
                model.fromMap(value)
                self.validation = model
            }
        }
    }
    public var fields: [GetAddonSchemaResponseBody.Fields]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["fields"] as? [Any?] {
            var tmp : [GetAddonSchemaResponseBody.Fields] = []
            for v in value {
                if v != nil {
                    var model = GetAddonSchemaResponseBody.Fields()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetAddonSchemaResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetAddonSchemaResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetAddonSchemaResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetBizTraceResponseBody : Tea.TeaModel {
    public var item: BizTraceConfig?
...
public class GetBizTraceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetBizTraceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetBizTraceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetCloudResourceDataRequest : Tea.TeaModel {
...
public class GetCloudResourceDataResponseBody : Tea.TeaModel {
...
public class GetCloudResourceDataResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetCloudResourceDataResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetCloudResourceDataResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetCmsServiceRequest : Tea.TeaModel {
...
public class GetCmsServiceResponseBody : Tea.TeaModel {
    public var enabled: Bool?
...
public class GetCmsServiceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetCmsServiceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetCmsServiceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetIntegrationVersionForCSRequest : Tea.TeaModel {
    public var clusterId: String?
...
public class GetIntegrationVersionForCSResponseBody : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.integrationVersion != nil {
            map["integrationVersion"] = self.integrationVersion!
        }
        if self.requestId != nil {
            map["requestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["integrationVersion"] as? String {
            self.integrationVersion = value
        }
        if let value = dict["requestId"] as? String {
            self.requestId = value
        }
...
public class GetIntegrationVersionForCSResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetIntegrationVersionForCSResponseBody?
...
public class GetPrometheusUserSettingRequest : Tea.TeaModel {
    public var aliyunLang: String?
...
public class GetPrometheusUserSettingResponseBody : Tea.TeaModel {
    public var prometheusUserSetting: [String: String]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.prometheusUserSetting != nil {
            map["prometheusUserSetting"] = self.prometheusUserSetting!
        }
        if self.requestId != nil {
            map["requestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["prometheusUserSetting"] as? [String: String] {
            self.prometheusUserSetting = value
        }
        if let value = dict["requestId"] as? String {
            self.requestId = value
        }
...
public class GetPrometheusUserSettingResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetPrometheusUserSettingResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetPrometheusUserSettingResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetUmodelCommonSchemaRefResponseBody : Tea.TeaModel {
    public class CommonSchemaRef : Tea.TeaModel {
        public var group: String?
    ...
    public var commonSchemaRef: [GetUmodelCommonSchemaRefResponseBody.CommonSchemaRef]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["commonSchemaRef"] as? [Any?] {
            var tmp : [GetUmodelCommonSchemaRefResponseBody.CommonSchemaRef] = []
            for v in value {
                if v != nil {
                    var model = GetUmodelCommonSchemaRefResponseBody.CommonSchemaRef()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetUmodelCommonSchemaRefResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetUmodelCommonSchemaRefResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetUmodelCommonSchemaRefResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
    ...
    public class Addons : Tea.TeaModel {
        ...
        public class Environments : Tea.TeaModel {
            ...
            public class Policies : Tea.TeaModel {
                ...
                public var metricCheckRule: ListAddonsResponseBody.Addons.Environments.Policies.MetricCheckRule?

                public var needRestartAfterIntegration: Bool?

                public var protocols: [ListAddonsResponseBody.Addons.Environments.Policies.Protocols]?
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    ...
                    if let value = dict["metricCheckRule"] as? [String: Any?] {
                        var model = ListAddonsResponseBody.Addons.Environments.Policies.MetricCheckRule()
                        model.fromMap(value)
                        self.metricCheckRule = model
                    }
                    if let value = dict["needRestartAfterIntegration"] as? Bool {
                    ...
                    if let value = dict["protocols"] as? [Any?] {
                        var tmp : [ListAddonsResponseBody.Addons.Environments.Policies.Protocols] = []
                        for v in value {
                            if v != nil {
                                var model = ListAddonsResponseBody.Addons.Environments.Policies.Protocols()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
            ...
            public var commonSchemaRefs: [ListAddonsResponseBody.Addons.Environments.CommonSchemaRefs]?

            public var dependencies: ListAddonsResponseBody.Addons.Environments.Dependencies?
            ...
            public var policies: ListAddonsResponseBody.Addons.Environments.Policies?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["commonSchemaRefs"] as? [Any?] {
                    var tmp : [ListAddonsResponseBody.Addons.Environments.CommonSchemaRefs] = []
                    for v in value {
                        if v != nil {
                            var model = ListAddonsResponseBody.Addons.Environments.CommonSchemaRefs()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["dependencies"] as? [String: Any?] {
                    var model = ListAddonsResponseBody.Addons.Environments.Dependencies()
                    model.fromMap(value)
                    self.dependencies = model
                }
                if let value = dict["description"] as? String {
                ...
                if let value = dict["policies"] as? [String: Any?] {
                    var model = ListAddonsResponseBody.Addons.Environments.Policies()
                    model.fromMap(value)
                    self.policies = model
                }
                if let value = dict["policyType"] as? String {
        ...
        public var dashboards: [ListAddonsResponseBody.Addons.Dashboards]?

        public var description_: String?

        public var environments: [ListAddonsResponseBody.Addons.Environments]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["dashboards"] as? [Any?] {
                var tmp : [ListAddonsResponseBody.Addons.Dashboards] = []
                for v in value {
                    if v != nil {
                        var model = ListAddonsResponseBody.Addons.Dashboards()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["environments"] as? [Any?] {
                var tmp : [ListAddonsResponseBody.Addons.Environments] = []
                for v in value {
                    if v != nil {
                        var model = ListAddonsResponseBody.Addons.Environments()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class ListBizTracesResponseBody : Tea.TeaModel {
    public var items: [BizTraceConfig]?
...
public class ListBizTracesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListBizTracesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListBizTracesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListIntegrationPoliciesRequest : Tea.TeaModel {
    public class Tag : Tea.TeaModel {
        public var key: String?
    ...
    public var tag: [ListIntegrationPoliciesRequest.Tag]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["tag"] as? [Any?] {
            var tmp : [ListIntegrationPoliciesRequest.Tag] = []
            for v in value {
                if v != nil {
                    var model = ListIntegrationPoliciesRequest.Tag()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListIntegrationPoliciesResponseBody : Tea.TeaModel {
    public class Policies : Tea.TeaModel {
        public class BindResource : Tea.TeaModel {
            public var clusterId: String?
        ...
        public class EntityGroup : Tea.TeaModel {
            public class EntityRules : Tea.TeaModel {
                ...
                public var annotations: [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Annotations]?

                public var entityTypes: [String]?

                public var fieldRules: [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.FieldRules]?

                public var instanceIds: [String]?

                public var ipMatchRule: ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.IpMatchRule?

                public var labels: [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Labels]?

                public var regionIds: [String]?

                public var resourceGroupId: String?

                public var tags: [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Tags]?
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    guard let dict else { return }
                    if let value = dict["annotations"] as? [Any?] {
                        var tmp : [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Annotations] = []
                        for v in value {
                            if v != nil {
                                var model = ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Annotations()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
                    ...
                    if let value = dict["fieldRules"] as? [Any?] {
                        var tmp : [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.FieldRules] = []
                        for v in value {
                            if v != nil {
                                var model = ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.FieldRules()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
                    ...
                    if let value = dict["ipMatchRule"] as? [String: Any?] {
                        var model = ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.IpMatchRule()
                        model.fromMap(value)
                        self.ipMatchRule = model
                    }
                    if let value = dict["labels"] as? [Any?] {
                        var tmp : [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Labels] = []
                        for v in value {
                            if v != nil {
                                var model = ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Labels()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
                    ...
                    if let value = dict["tags"] as? [Any?] {
                        var tmp : [ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Tags] = []
                        for v in value {
                            if v != nil {
                                var model = ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules.Tags()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
            ...
            public var entityRules: ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["entityRules"] as? [String: Any?] {
                    var model = ListIntegrationPoliciesResponseBody.Policies.EntityGroup.EntityRules()
                    model.fromMap(value)
                    self.entityRules = model
                }
                if let value = dict["query"] as? String {
        ...
        public var subAddonRelease: ListIntegrationPoliciesResponseBody.Policies.SubAddonRelease?

        public var tags: [ListIntegrationPoliciesResponseBody.Policies.Tags]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["subAddonRelease"] as? [String: Any?] {
                var model = ListIntegrationPoliciesResponseBody.Policies.SubAddonRelease()
                model.fromMap(value)
                self.subAddonRelease = model
            }
            if let value = dict["tags"] as? [Any?] {
                var tmp : [ListIntegrationPoliciesResponseBody.Policies.Tags] = []
                for v in value {
                    if v != nil {
                        var model = ListIntegrationPoliciesResponseBody.Policies.Tags()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var policies: [ListIntegrationPoliciesResponseBody.Policies]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["policies"] as? [Any?] {
            var tmp : [ListIntegrationPoliciesResponseBody.Policies] = []
            for v in value {
                if v != nil {
                    var model = ListIntegrationPoliciesResponseBody.Policies()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListIntegrationPoliciesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListIntegrationPoliciesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListIntegrationPoliciesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListIntegrationPolicyAddonsResponseBody : Tea.TeaModel {
    public class Addons : Tea.TeaModel {
        public class Dashboards : Tea.TeaModel {
            public var description_: String?
        ...
        public class Environments : Tea.TeaModel {
            ...
            public class Policies : Tea.TeaModel {
                ...
                public var metricCheckRule: ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies.MetricCheckRule?

                public var needRestartAfterIntegration: Bool?

                public var protocols: [ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies.Protocols]?
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    ...
                    if let value = dict["metricCheckRule"] as? [String: Any?] {
                        var model = ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies.MetricCheckRule()
                        model.fromMap(value)
                        self.metricCheckRule = model
                    }
                    if let value = dict["needRestartAfterIntegration"] as? Bool {
                    ...
                    if let value = dict["protocols"] as? [Any?] {
                        var tmp : [ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies.Protocols] = []
                        for v in value {
                            if v != nil {
                                var model = ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies.Protocols()
                                if v != nil {
                                    model.fromMap(v as? [String: Any?])
                                }
                                tmp.append(model)
            ...
            public var dependencies: ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Dependencies?
            ...
            public var policies: ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["dependencies"] as? [String: Any?] {
                    var model = ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Dependencies()
                    model.fromMap(value)
                    self.dependencies = model
                }
                if let value = dict["description"] as? String {
                ...
                if let value = dict["policies"] as? [String: Any?] {
                    var model = ListIntegrationPolicyAddonsResponseBody.Addons.Environments.Policies()
                    model.fromMap(value)
                    self.policies = model
                }
            }
        ...
        public var dashboards: [ListIntegrationPolicyAddonsResponseBody.Addons.Dashboards]?

        public var description_: String?

        public var environments: [ListIntegrationPolicyAddonsResponseBody.Addons.Environments]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["dashboards"] as? [Any?] {
                var tmp : [ListIntegrationPolicyAddonsResponseBody.Addons.Dashboards] = []
                for v in value {
                    if v != nil {
                        var model = ListIntegrationPolicyAddonsResponseBody.Addons.Dashboards()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["environments"] as? [Any?] {
                var tmp : [ListIntegrationPolicyAddonsResponseBody.Addons.Environments] = []
                for v in value {
                    if v != nil {
                        var model = ListIntegrationPolicyAddonsResponseBody.Addons.Environments()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var addons: [ListIntegrationPolicyAddonsResponseBody.Addons]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["addons"] as? [Any?] {
            var tmp : [ListIntegrationPolicyAddonsResponseBody.Addons] = []
            for v in value {
                if v != nil {
                    var model = ListIntegrationPolicyAddonsResponseBody.Addons()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListIntegrationPolicyAddonsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListIntegrationPolicyAddonsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListIntegrationPolicyAddonsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListIntegrationPolicyCollectorsRequest : Tea.TeaModel {
    public var addonReleaseName: String?

    public var collectorType: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.collectorType != nil {
            map["collectorType"] = self.collectorType!
        }
        if self.language != nil {
            map["language"] = self.language!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["collectorType"] as? String {
            self.collectorType = value
        }
        if let value = dict["language"] as? String {
            self.language = value
        }
...
public class ListIntegrationPolicyCollectorsResponseBody : Tea.TeaModel {
    public class Collectors : Tea.TeaModel {
        ...
        public class Workloads : Tea.TeaModel {
            ...
            public var managedInfo: ListIntegrationPolicyCollectorsResponseBody.Collectors.Workloads.ManagedInfo?
            ...
            public var ownerReferenceKind: String?

            public var ownerReferenceName: String?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.ownerReferenceKind != nil {
                    map["ownerReferenceKind"] = self.ownerReferenceKind!
                }
                if self.ownerReferenceName != nil {
                    map["ownerReferenceName"] = self.ownerReferenceName!
                }
                if self.startTime != nil {
                    map["startTime"] = self.startTime!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["managedInfo"] as? [String: Any?] {
                    var model = ListIntegrationPolicyCollectorsResponseBody.Collectors.Workloads.ManagedInfo()
                    model.fromMap(value)
                    self.managedInfo = model
                }
                if let value = dict["message"] as? String {
                ...
                if let value = dict["ownerReferenceKind"] as? String {
                    self.ownerReferenceKind = value
                }
                if let value = dict["ownerReferenceName"] as? String {
                    self.ownerReferenceName = value
                }
                if let value = dict["startTime"] as? String {
                    self.startTime = value
                }
        ...
        public var addonMeta: AddonMeta?

        public var collectorName: String?

        public var collectorType: String?

        public var conditions: [ListIntegrationPolicyCollectorsResponseBody.Collectors.Conditions]?
        ...
        public var workloads: [ListIntegrationPolicyCollectorsResponseBody.Collectors.Workloads]?
        ...
        public override func validate() throws -> Void {
            try self.addonMeta?.validate()
        }

        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.addonMeta != nil {
                map["addonMeta"] = self.addonMeta?.toMap()
            }
            if self.collectorName != nil {
                map["collectorName"] = self.collectorName!
            }
            if self.collectorType != nil {
                map["collectorType"] = self.collectorType!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["addonMeta"] as? [String: Any?] {
                var model = AddonMeta()
                model.fromMap(value)
                self.addonMeta = model
            }
            if let value = dict["collectorName"] as? String {
                self.collectorName = value
            }
            if let value = dict["collectorType"] as? String {
                self.collectorType = value
            }
            if let value = dict["conditions"] as? [Any?] {
                var tmp : [ListIntegrationPolicyCollectorsResponseBody.Collectors.Conditions] = []
                for v in value {
                    if v != nil {
                        var model = ListIntegrationPolicyCollectorsResponseBody.Collectors.Conditions()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["workloads"] as? [Any?] {
                var tmp : [ListIntegrationPolicyCollectorsResponseBody.Collectors.Workloads] = []
                for v in value {
                    if v != nil {
                        var model = ListIntegrationPolicyCollectorsResponseBody.Collectors.Workloads()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var collectors: [ListIntegrationPolicyCollectorsResponseBody.Collectors]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["collectors"] as? [Any?] {
            var tmp : [ListIntegrationPolicyCollectorsResponseBody.Collectors] = []
            for v in value {
                if v != nil {
                    var model = ListIntegrationPolicyCollectorsResponseBody.Collectors()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListIntegrationPolicyCollectorsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListIntegrationPolicyCollectorsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListIntegrationPolicyCollectorsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListIntegrationPolicyDashboardsResponseBody : Tea.TeaModel {
    ...
    public var dashboards: [ListIntegrationPolicyDashboardsResponseBody.Dashboards]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["dashboards"] as? [Any?] {
            var tmp : [ListIntegrationPolicyDashboardsResponseBody.Dashboards] = []
            for v in value {
                if v != nil {
                    var model = ListIntegrationPolicyDashboardsResponseBody.Dashboards()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListIntegrationPolicyDashboardsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListIntegrationPolicyDashboardsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListIntegrationPolicyDashboardsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListIntegrationPolicyServiceMonitorsResponseBody : Tea.TeaModel {
    public class ServiceMonitors : Tea.TeaModel {
        public class Endpoints : Tea.TeaModel {
            public var interval: String?
        ...
        public var endpoints: [ListIntegrationPolicyServiceMonitorsResponseBody.ServiceMonitors.Endpoints]?

        public var matchedServiceCount: Int64?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["endpoints"] as? [Any?] {
                var tmp : [ListIntegrationPolicyServiceMonitorsResponseBody.ServiceMonitors.Endpoints] = []
                for v in value {
                    if v != nil {
                        var model = ListIntegrationPolicyServiceMonitorsResponseBody.ServiceMonitors.Endpoints()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["matchedServiceCount"] as? Int64 {
    ...
    public var serviceMonitors: [ListIntegrationPolicyServiceMonitorsResponseBody.ServiceMonitors]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.serviceMonitors != nil {
            var tmp : [Any] = []
            for k in self.serviceMonitors! {
                tmp.append(k.toMap())
            }
            map["serviceMonitors"] = tmp
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["serviceMonitors"] as? [Any?] {
            var tmp : [ListIntegrationPolicyServiceMonitorsResponseBody.ServiceMonitors] = []
            for v in value {
                if v != nil {
                    var model = ListIntegrationPolicyServiceMonitorsResponseBody.ServiceMonitors()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
            ...
            self.serviceMonitors = tmp
        }
    }
}

public class ListIntegrationPolicyServiceMonitorsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListIntegrationPolicyServiceMonitorsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListIntegrationPolicyServiceMonitorsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateBizTraceRequest : Tea.TeaModel {
    public var advancedConfig: String?
...
public class UpdateBizTraceResponseBody : Tea.TeaModel {
    public var bizTraceId: String?
...
public class UpdateBizTraceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateBizTraceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateBizTraceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateNotifyStrategyRequest : Tea.TeaModel {
    public var body: NotifyStrategyForModify?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["body"] as? [String: Any?] {
            var model = NotifyStrategyForModify()
            model.fromMap(value)
            self.body = model
        }
        if let value = dict["workspace"] as? String {
...
public class UpdateNotifyStrategyResponseBody : Tea.TeaModel {
    public var notifyStrategyId: String?
...
public class UpdateNotifyStrategyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateNotifyStrategyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateNotifyStrategyResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdatePrometheusUserSettingRequest : Tea.TeaModel {
...
public class UpdatePrometheusUserSettingResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class UpdatePrometheusUserSettingResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdatePrometheusUserSettingResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdatePrometheusUserSettingResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateSubscriptionRequest : Tea.TeaModel {
    public var body: SubscriptionForModify?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["body"] as? [String: Any?] {
            var model = SubscriptionForModify()
            model.fromMap(value)
            self.body = model
        }
        if let value = dict["workspace"] as? String {
...
public class UpsertUmodelCommonSchemaRefRequest : Tea.TeaModel {
    public var group: String?
...
public class UpsertUmodelCommonSchemaRefResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class UpsertUmodelCommonSchemaRefResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpsertUmodelCommonSchemaRefResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpsertUmodelCommonSchemaRefResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
