...
public class GenerateDynamicImageRequest : Tea.TeaModel {
...
public class GenerateDynamicImageAdvanceRequest : Tea.TeaModel {
    public var operation: String?
...
public class GenerateDynamicImageResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var url: String?
    ...
    public var data: GenerateDynamicImageResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = GenerateDynamicImageResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["RequestId"] as? String {
...
public class GenerateDynamicImageResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GenerateDynamicImageResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GenerateDynamicImageResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GenerateImageWithTextRequest : Tea.TeaModel {
...
public class GenerateImageWithTextResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
    ...
    public var data: GenerateImageWithTextResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = GenerateImageWithTextResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class GenerateImageWithTextResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GenerateImageWithTextResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GenerateImageWithTextResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GenerateImageWithTextAndImageRequest : Tea.TeaModel {
    public var aspectRatioMode: String?

    public var number: Int32?

    public var refImageUrl: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.aspectRatioMode != nil {
            map["AspectRatioMode"] = self.aspectRatioMode!
        }
        if self.number != nil {
            map["Number"] = self.number!
        }
        if self.refImageUrl != nil {
            map["RefImageUrl"] = self.refImageUrl!
        }
        if self.resolution != nil {
            map["Resolution"] = self.resolution!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AspectRatioMode"] as? String {
            self.aspectRatioMode = value
        }
        if let value = dict["Number"] as? Int32 {
            self.number = value
        }
        if let value = dict["RefImageUrl"] as? String {
            self.refImageUrl = value
        }
        if let value = dict["Resolution"] as? String {
            self.resolution = value
        }
...
public class GenerateImageWithTextAndImageAdvanceRequest : Tea.TeaModel {
    public var aspectRatioMode: String?

    public var number: Int32?

    public var refImageUrlObject: InputStream?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.refImageUrlObject != nil {
            map["RefImageUrl"] = self.refImageUrlObject!
        }
        if self.resolution != nil {
            map["Resolution"] = self.resolution!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RefImageUrl"] as? InputStream {
            self.refImageUrlObject = value
        }
        if let value = dict["Resolution"] as? String {
            self.resolution = value
        }
...
public class GenerateImageWithTextAndImageResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var imageUrls: [String]?
    ...
    public var data: GenerateImageWithTextAndImageResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = GenerateImageWithTextAndImageResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class GenerateImageWithTextAndImageResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GenerateImageWithTextAndImageResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GenerateImageWithTextAndImageResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
