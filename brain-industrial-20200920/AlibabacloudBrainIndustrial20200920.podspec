Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudBrainIndustrial20200920"
  spec.version      = "2.1.2"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud brain-industrial (20200920) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/brain-industrial-20200920" 
