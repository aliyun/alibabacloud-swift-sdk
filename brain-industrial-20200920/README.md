...
```ogdl
github "alibabacloud-sdk-swift/brain-industrial-20200920" "2.1.3"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/brain-industrial-20200920.git", from: "2.1.3")
]
```
