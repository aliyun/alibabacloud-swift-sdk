Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudImageSearch20180319"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud image search (20180319) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/imagesearch-20180319" 
