Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudAgentLoop20260520"
  spec.version      = "2.2.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud AgentLoop (20260520) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/agentloop-20260520" 
