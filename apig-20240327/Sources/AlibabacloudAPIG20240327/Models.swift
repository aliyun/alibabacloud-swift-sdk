...
public class RiskCheckResults : Tea.TeaModel {
    ...
    public class RiskDetails : Tea.TeaModel {
        public var checkModule: String?

        public var data: [String: String]?

        public var description_: String?

        public var isNoticeMute: Bool?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.checkModule != nil {
                map["checkModule"] = self.checkModule!
            }
            if self.data != nil {
                map["data"] = self.data!
            }
            ...
            if self.isNoticeMute != nil {
                map["isNoticeMute"] = self.isNoticeMute!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["checkModule"] as? String {
                self.checkModule = value
            }
            ...
            if let value = dict["isNoticeMute"] as? Bool {
                self.isNoticeMute = value
            }
            ...
            if let value = dict["situation"] as? String {
    ...
    public var metadata: RiskCheckResults.Metadata?

    public var riskDetails: [RiskCheckResults.RiskDetails]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["metadata"] as? [String: Any?] {
            var model = RiskCheckResults.Metadata()
            model.fromMap(value)
            self.metadata = model
        }
        if let value = dict["riskDetails"] as? [Any?] {
            var tmp : [RiskCheckResults.RiskDetails] = []
            for v in value {
                if v != nil {
                    var model = RiskCheckResults.RiskDetails()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["totalRisk"] as? Int32 {
            self.totalRisk = value
        }
    }
}
...
public class CreateServiceVersionRequest : Tea.TeaModel {
    ...
    public var labels: [CreateServiceVersionRequest.Labels]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["labels"] as? [Any?] {
            var tmp : [CreateServiceVersionRequest.Labels] = []
            for v in value {
                if v != nil {
                    var model = CreateServiceVersionRequest.Labels()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class CreateServiceVersionResponseBody : Tea.TeaModel {
    public var code: String?
...
public class CreateServiceVersionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateServiceVersionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateServiceVersionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateSourceRequest : Tea.TeaModel {
    public class K8sSourceConfig : Tea.TeaModel {
        ...
        public var authorizeSecurityGroupRules: [CreateSourceRequest.K8sSourceConfig.AuthorizeSecurityGroupRules]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["authorizeSecurityGroupRules"] as? [Any?] {
                var tmp : [CreateSourceRequest.K8sSourceConfig.AuthorizeSecurityGroupRules] = []
                for v in value {
                    if v != nil {
                        var model = CreateSourceRequest.K8sSourceConfig.AuthorizeSecurityGroupRules()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public class NacosSourceConfig : Tea.TeaModel {
        public var instanceId: String?
    ...
    public var k8sSourceConfig: CreateSourceRequest.K8sSourceConfig?

    public var nacosSourceConfig: CreateSourceRequest.NacosSourceConfig?
    ...
    public override func validate() throws -> Void {
        try self.k8sSourceConfig?.validate()
        try self.nacosSourceConfig?.validate()
    }
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.k8sSourceConfig != nil {
            map["k8sSourceConfig"] = self.k8sSourceConfig?.toMap()
        }
        if self.nacosSourceConfig != nil {
            map["nacosSourceConfig"] = self.nacosSourceConfig?.toMap()
        }
        if self.resourceGroupId != nil {
            map["resourceGroupId"] = self.resourceGroupId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["k8sSourceConfig"] as? [String: Any?] {
            var model = CreateSourceRequest.K8sSourceConfig()
            model.fromMap(value)
            self.k8sSourceConfig = model
        }
        if let value = dict["nacosSourceConfig"] as? [String: Any?] {
            var model = CreateSourceRequest.NacosSourceConfig()
            model.fromMap(value)
            self.nacosSourceConfig = model
        }
        if let value = dict["resourceGroupId"] as? String {
            self.resourceGroupId = value
        }
...
public class CreateSourceResponseBody : Tea.TeaModel {
    ...
    public var data: CreateSourceResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = CreateSourceResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class DeleteServiceVersionResponseBody : Tea.TeaModel {
    public var code: String?
...
public class DeleteServiceVersionResponse : Tea.TeaModel {
    ...
    public var body: DeleteServiceVersionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteServiceVersionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetResourceOverviewResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public class RiskOverview : Tea.TeaModel {
            public class RiskDetails : Tea.TeaModel {
                public var gatewayId: String?
                ...
                public override func toMap() -> [String : Any] {
                    ...
                    if self.riskNames != nil {
                        map["riskNames"] = self.riskNames!
                    }
                    if self.score != nil {
                        map["score"] = self.score!
                    }
                ...
                public override func fromMap(_ dict: [String: Any?]?) -> Void {
                    ...
                    if let value = dict["riskNames"] as? [String] {
                        self.riskNames = value
                    }
            ...
            public var riskDetails: [GetResourceOverviewResponseBody.Data.RiskOverview.RiskDetails]?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["riskDetails"] as? [Any?] {
                    var tmp : [GetResourceOverviewResponseBody.Data.RiskOverview.RiskDetails] = []
                    for v in value {
                        if v != nil {
                            var model = GetResourceOverviewResponseBody.Data.RiskOverview.RiskDetails()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
        ...
        public var riskOverview: [GetResourceOverviewResponseBody.Data.RiskOverview]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.riskOverview != nil {
                var tmp : [Any] = []
                for k in self.riskOverview! {
                    tmp.append(k.toMap())
                }
                map["riskOverview"] = tmp
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["riskOverview"] as? [Any?] {
                var tmp : [GetResourceOverviewResponseBody.Data.RiskOverview] = []
                for v in value {
                    if v != nil {
                        var model = GetResourceOverviewResponseBody.Data.RiskOverview()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class GetSourceResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class K8SSourceInfo : Tea.TeaModel {
            public var clusterId: String?
        ...
        public class NacosSourceInfo : Tea.TeaModel {
            public var address: String?
        ...
        public var k8SSourceInfo: GetSourceResponseBody.Data.K8SSourceInfo?

        public var nacosSourceInfo: GetSourceResponseBody.Data.NacosSourceInfo?
        ...
        public override func validate() throws -> Void {
            try self.k8SSourceInfo?.validate()
            try self.nacosSourceInfo?.validate()
        }
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.k8SSourceInfo != nil {
                map["k8SSourceInfo"] = self.k8SSourceInfo?.toMap()
            }
            if self.nacosSourceInfo != nil {
                map["nacosSourceInfo"] = self.nacosSourceInfo?.toMap()
            }
            if self.name != nil {
                map["name"] = self.name!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["k8SSourceInfo"] as? [String: Any?] {
                var model = GetSourceResponseBody.Data.K8SSourceInfo()
                model.fromMap(value)
                self.k8SSourceInfo = model
            }
            if let value = dict["nacosSourceInfo"] as? [String: Any?] {
                var model = GetSourceResponseBody.Data.NacosSourceInfo()
                model.fromMap(value)
                self.nacosSourceInfo = model
            }
            if let value = dict["name"] as? String {
                self.name = value
            }
    ...
    public var data: GetSourceResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = GetSourceResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class ListConsumerAuthorizationRulesRequest : Tea.TeaModel {
...
public class ListConsumerAuthorizationRulesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class Items : Tea.TeaModel {
            public var apiInfo: HttpApiApiInfo?
        ...
        public var items: [ListConsumerAuthorizationRulesResponseBody.Data.Items]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["items"] as? [Any?] {
                var tmp : [ListConsumerAuthorizationRulesResponseBody.Data.Items] = []
                for v in value {
                    if v != nil {
                        var model = ListConsumerAuthorizationRulesResponseBody.Data.Items()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: ListConsumerAuthorizationRulesResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = ListConsumerAuthorizationRulesResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class ListConsumerAuthorizationRulesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListConsumerAuthorizationRulesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListConsumerAuthorizationRulesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListPluginClassesRequest : Tea.TeaModel {
    public var aliasLike: String?

    public var direction: String?

    public var excludeBuiltinAiProxy: Bool?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.excludeBuiltinAiProxy != nil {
            map["excludeBuiltinAiProxy"] = self.excludeBuiltinAiProxy!
        }
        if self.gatewayId != nil {
            map["gatewayId"] = self.gatewayId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["excludeBuiltinAiProxy"] as? Bool {
            self.excludeBuiltinAiProxy = value
        }
        if let value = dict["gatewayId"] as? String {
            self.gatewayId = value
        }
        ...
        if let value = dict["installed"] as? Bool {
...
public class ListPluginClassesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class Items : Tea.TeaModel {
            public var alias: String?
        ...
        public var items: [ListPluginClassesResponseBody.Data.Items]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["items"] as? [Any?] {
                var tmp : [ListPluginClassesResponseBody.Data.Items] = []
                for v in value {
                    if v != nil {
                        var model = ListPluginClassesResponseBody.Data.Items()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: ListPluginClassesResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = ListPluginClassesResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class ListPluginClassesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListPluginClassesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListPluginClassesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class SyncMCPServersRequest : Tea.TeaModel {
    public class NacosMcpServers : Tea.TeaModel {
        public var exposedUriPath: String?
    ...
    public var nacosMcpServers: [SyncMCPServersRequest.NacosMcpServers]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.nacosMcpServers != nil {
            var tmp : [Any] = []
            for k in self.nacosMcpServers! {
                tmp.append(k.toMap())
            }
            map["nacosMcpServers"] = tmp
        }
        if self.namespace != nil {
            map["namespace"] = self.namespace!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["nacosMcpServers"] as? [Any?] {
            var tmp : [SyncMCPServersRequest.NacosMcpServers] = []
            for v in value {
                if v != nil {
                    var model = SyncMCPServersRequest.NacosMcpServers()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class SyncMCPServersResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class FailedMcpServers : Tea.TeaModel {
            public var mcpServerName: String?
        ...
        public class SucceedMcpServers : Tea.TeaModel {
            public var mcpServerName: String?
        ...
        public var failedMcpServers: [SyncMCPServersResponseBody.Data.FailedMcpServers]?

        public var succeedMcpServers: [SyncMCPServersResponseBody.Data.SucceedMcpServers]?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.failedMcpServers != nil {
                var tmp : [Any] = []
                for k in self.failedMcpServers! {
                    tmp.append(k.toMap())
                }
                map["failedMcpServers"] = tmp
            }
            if self.succeedMcpServers != nil {
                var tmp : [Any] = []
                for k in self.succeedMcpServers! {
                    tmp.append(k.toMap())
                }
                map["succeedMcpServers"] = tmp
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["failedMcpServers"] as? [Any?] {
                var tmp : [SyncMCPServersResponseBody.Data.FailedMcpServers] = []
                for v in value {
                    if v != nil {
                        var model = SyncMCPServersResponseBody.Data.FailedMcpServers()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
                ...
                self.failedMcpServers = tmp
            }
            if let value = dict["succeedMcpServers"] as? [Any?] {
                var tmp : [SyncMCPServersResponseBody.Data.SucceedMcpServers] = []
                for v in value {
                    if v != nil {
                        var model = SyncMCPServersResponseBody.Data.SucceedMcpServers()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
                ...
                self.succeedMcpServers = tmp
            }
        }
    }
    public var code: String?

    public var data: SyncMCPServersResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = SyncMCPServersResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class SyncMCPServersResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: SyncMCPServersResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = SyncMCPServersResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateServiceRequest : Tea.TeaModel {
    public class HealthCheckConfig : Tea.TeaModel {
        ...
        public var expectedStatuses: [String]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["expectedStatuses"] as? [String] {
                self.expectedStatuses = value
            }
            if let value = dict["healthyThreshold"] as? Int32 {
                self.healthyThreshold = value
            }
    ...
    public class OutlierDetectionConfig : Tea.TeaModel {
    ...
    public var healthCheckConfig: UpdateServiceRequest.HealthCheckConfig?

    public var healthyPanicThreshold: Double?

    public var outlierDetectionConfig: UpdateServiceRequest.OutlierDetectionConfig?

    public var ports: [UpdateServiceRequest.Ports]?
    ...
    public override func validate() throws -> Void {
        ...
        try self.outlierDetectionConfig?.validate()
    }
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.outlierDetectionConfig != nil {
            map["outlierDetectionConfig"] = self.outlierDetectionConfig?.toMap()
        }
        if self.ports != nil {
            var tmp : [Any] = []
            for k in self.ports! {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["healthCheckConfig"] as? [String: Any?] {
            var model = UpdateServiceRequest.HealthCheckConfig()
            model.fromMap(value)
        ...
        if let value = dict["outlierDetectionConfig"] as? [String: Any?] {
            var model = UpdateServiceRequest.OutlierDetectionConfig()
            model.fromMap(value)
            self.outlierDetectionConfig = model
        }
        if let value = dict["ports"] as? [Any?] {
            var tmp : [UpdateServiceRequest.Ports] = []
            for v in value {
                if v != nil {
                    var model = UpdateServiceRequest.Ports()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdateServiceVersionRequest : Tea.TeaModel {
    ...
    public var labels: [UpdateServiceVersionRequest.Labels]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["labels"] as? [Any?] {
            var tmp : [UpdateServiceVersionRequest.Labels] = []
            for v in value {
                if v != nil {
                    var model = UpdateServiceVersionRequest.Labels()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
