Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEdas20160816"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Enterprise Distributed Application Service (20160816) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/edas-20160816" 
