...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func copyBroadcastSceneFromTemplateWithOptions(_ request: CopyBroadcastSceneFromTemplateRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> CopyBroadcastSceneFromTemplateResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CopyBroadcastSceneFromTemplateResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func copyBroadcastSceneFromTemplate(_ request: CopyBroadcastSceneFromTemplateRequest) async throws -> CopyBroadcastSceneFromTemplateResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await copyBroadcastSceneFromTemplateWithOptions(request as! CopyBroadcastSceneFromTemplateRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createBroadcastAudioWithOptions(_ request: CreateBroadcastAudioRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateBroadcastAudioResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.fileName)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateBroadcastAudioResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createBroadcastAudio(_ request: CreateBroadcastAudioRequest) async throws -> CreateBroadcastAudioResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await createBroadcastAudioWithOptions(request as! CreateBroadcastAudioRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getTTSVoiceByIdCustomWithOptions(_ request: GetTTSVoiceByIdCustomRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> GetTTSVoiceByIdCustomResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetTTSVoiceByIdCustomResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getTTSVoiceByIdCustom(_ request: GetTTSVoiceByIdCustomRequest) async throws -> GetTTSVoiceByIdCustomResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await getTTSVoiceByIdCustomWithOptions(request as! GetTTSVoiceByIdCustomRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listBroadcastAudiosByIdWithOptions(_ tmpReq: ListBroadcastAudiosByIdRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListBroadcastAudiosByIdResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ListBroadcastAudiosByIdShrinkRequest = ListBroadcastAudiosByIdShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.audioIds)) {
            request.audioIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.audioIds, "audioIds", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.audioIdsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListBroadcastAudiosByIdResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listBroadcastAudiosById(_ request: ListBroadcastAudiosByIdRequest) async throws -> ListBroadcastAudiosByIdResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await listBroadcastAudiosByIdWithOptions(request as! ListBroadcastAudiosByIdRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listPublicBroadcastSceneTemplatesWithOptions(_ request: ListPublicBroadcastSceneTemplatesRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListPublicBroadcastSceneTemplatesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.maxResults)) {
            query["maxResults"] = request.maxResults!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListPublicBroadcastSceneTemplatesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listPublicBroadcastSceneTemplates(_ request: ListPublicBroadcastSceneTemplatesRequest) async throws -> ListPublicBroadcastSceneTemplatesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await listPublicBroadcastSceneTemplatesWithOptions(request as! ListPublicBroadcastSceneTemplatesRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
