...
public class BroadcastAudio : Tea.TeaModel {
    public var audioLength: Int32?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.audioLength != nil {
            map["audioLength"] = self.audioLength!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["audioLength"] as? Int32 {
            self.audioLength = value
        }
...
public class BroadcastScene : Tea.TeaModel {
    ...
    public var shortVideoURL: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.shortVideoURL != nil {
            map["shortVideoURL"] = self.shortVideoURL!
        }
        if self.status != nil {
            map["status"] = self.status!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["clipInfo"] as? String {
            self.clipInfo = value
        }
        ...
        if let value = dict["shortVideoURL"] as? String {
            self.shortVideoURL = value
        }
        if let value = dict["status"] as? String {
            self.status = value
        }
...
public class BroadcastSceneTemplate : Tea.TeaModel {
    public var coverURL: String?
...
public class CopyBroadcastSceneFromTemplateRequest : Tea.TeaModel {
    public var name: String?
...
public class CopyBroadcastSceneFromTemplateResponseBody : Tea.TeaModel {
    public var code: String?

    public var data: BroadcastScene?
...
public class CopyBroadcastSceneFromTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CopyBroadcastSceneFromTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CopyBroadcastSceneFromTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateBroadcastAudioRequest : Tea.TeaModel {
    public var fileName: String?
...
public class CreateBroadcastAudioResponseBody : Tea.TeaModel {
    public var code: String?

    public var data: BroadcastAudio?
...
public class CreateBroadcastAudioResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateBroadcastAudioResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateBroadcastAudioResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteBroadcastStickerRequest : Tea.TeaModel {
...
public class DeleteBroadcastStickerResponseBody : Tea.TeaModel {
    public var code: String?
...
public class DeleteBroadcastStickerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteBroadcastStickerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteBroadcastStickerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListBroadcastAudiosByIdRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["audioIds"] as? [String] {
            self.audioIds = value
        }
    }
}

public class ListBroadcastAudiosByIdShrinkRequest : Tea.TeaModel {
    public var audioIdsShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.audioIdsShrink != nil {
            map["audioIds"] = self.audioIdsShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["audioIds"] as? String {
            self.audioIdsShrink = value
        }
    }
}

public class ListBroadcastAudiosByIdResponseBody : Tea.TeaModel {
    public var code: String?
...
public class ListBroadcastAudiosByIdResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListBroadcastAudiosByIdResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListBroadcastAudiosByIdResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListPublicBroadcastSceneTemplatesRequest : Tea.TeaModel {
    public var maxResults: Int32?
...
public class ListPublicBroadcastSceneTemplatesResponseBody : Tea.TeaModel {
    public var code: String?

    public var data: [BroadcastSceneTemplate]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [Any?] {
            var tmp : [BroadcastSceneTemplate] = []
            for v in value {
                if v != nil {
                    var model = BroadcastSceneTemplate()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListPublicBroadcastSceneTemplatesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListPublicBroadcastSceneTemplatesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListPublicBroadcastSceneTemplatesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
