...
```ruby
pod 'AlibabacloudPolardb20170801', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/polardb-20170801" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/polardb-20170801.git", from: "1.0.0")
]
```
