...
public class GetPurchaseControlRecordRequest : Tea.TeaModel {
    public var customerUID: Int64?
...
public class GetPurchaseControlRecordResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.operationPath != nil {
                map["OperationPath"] = self.operationPath!
            }
            if self.operationTime != nil {
                map["OperationTime"] = self.operationTime!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["OperationPath"] as? String {
                self.operationPath = value
            }
            if let value = dict["OperationTime"] as? String {
                self.operationTime = value
            }
    ...
    public var data: [GetPurchaseControlRecordResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [Any?] {
            var tmp : [GetPurchaseControlRecordResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = GetPurchaseControlRecordResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetPurchaseControlRecordResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetPurchaseControlRecordResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetPurchaseControlRecordResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetShutdownPolicyRecordRequest : Tea.TeaModel {
    public var customerUID: Int64?
...
public class GetShutdownPolicyRecordResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var previousPolicy: String?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.currentPolicy != nil {
                map["CurrentPolicy"] = self.currentPolicy!
            }
            if self.operationPath != nil {
                map["OperationPath"] = self.operationPath!
            }
            ...
            if self.previousPolicy != nil {
                map["PreviousPolicy"] = self.previousPolicy!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["CurrentPolicy"] as? String {
                self.currentPolicy = value
            }
            if let value = dict["OperationPath"] as? String {
                self.operationPath = value
            }
            ...
            if let value = dict["PreviousPolicy"] as? String {
                self.previousPolicy = value
            }
        }
    }
    public var code: String?

    public var data: [GetShutdownPolicyRecordResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [Any?] {
            var tmp : [GetShutdownPolicyRecordResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = GetShutdownPolicyRecordResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetShutdownPolicyRecordResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetShutdownPolicyRecordResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetShutdownPolicyRecordResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetTier2CouponApprovalDetailRequest : Tea.TeaModel {
    public var applicationSheetId: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.applicationSheetId != nil {
            map["ApplicationSheetId"] = self.applicationSheetId!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["ApplicationSheetId"] as? String {
            self.applicationSheetId = value
        }
    }
}

public class GetTier2CouponApprovalDetailResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class ApplicantInfo : Tea.TeaModel {
            public var applicableProducts: String?

            public var applicationTime: String?

            public var orderType: String?

            public var t2PartnerName: String?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.applicationTime != nil {
                    map["ApplicationTime"] = self.applicationTime!
                }
                if self.orderType != nil {
                    map["OrderType"] = self.orderType!
                }
                if self.t2PartnerName != nil {
                    map["T2PartnerName"] = self.t2PartnerName!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["ApplicationTime"] as? String {
                    self.applicationTime = value
                }
                if let value = dict["OrderType"] as? String {
                    self.orderType = value
                }
                if let value = dict["T2PartnerName"] as? String {
                    self.t2PartnerName = value
                }
        ...
        public class CouponReceiptUidList : Tea.TeaModel {
        ...
        public var applicantInfo: GetTier2CouponApprovalDetailResponseBody.Data.ApplicantInfo?
        ...
        public var couponReceiptUidList: [GetTier2CouponApprovalDetailResponseBody.Data.CouponReceiptUidList]?

        public var remainingQuota: String?
        ...
        public override func validate() throws -> Void {
            try self.applicantInfo?.validate()
        }

        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.applicantInfo != nil {
                map["ApplicantInfo"] = self.applicantInfo?.toMap()
            }
            ...
            if self.couponReceiptUidList != nil {
                var tmp : [Any] = []
                for k in self.couponReceiptUidList! {
                    tmp.append(k.toMap())
                }
                map["CouponReceiptUidList"] = tmp
            }
            if self.remainingQuota != nil {
                map["RemainingQuota"] = self.remainingQuota!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["ApplicantInfo"] as? [String: Any?] {
                var model = GetTier2CouponApprovalDetailResponseBody.Data.ApplicantInfo()
                model.fromMap(value)
                self.applicantInfo = model
            }
            ...
            if let value = dict["CouponReceiptUidList"] as? [Any?] {
                var tmp : [GetTier2CouponApprovalDetailResponseBody.Data.CouponReceiptUidList] = []
                for v in value {
                    if v != nil {
                        var model = GetTier2CouponApprovalDetailResponseBody.Data.CouponReceiptUidList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
                ...
                self.couponReceiptUidList = tmp
            }
            if let value = dict["RemainingQuota"] as? String {
                self.remainingQuota = value
            }
    ...
    public var data: GetTier2CouponApprovalDetailResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = GetTier2CouponApprovalDetailResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class GetTier2CouponApprovalDetailResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetTier2CouponApprovalDetailResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetTier2CouponApprovalDetailResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class InviteSubResellerRequest : Tea.TeaModel {
    public class AccountInfoList : Tea.TeaModel {
        public var accountNickname: String?

        public var creditLine: String?

        public var crossScopeRemark: String?
        ...
        public var registerNation: String?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.crossScopeRemark != nil {
                map["CrossScopeRemark"] = self.crossScopeRemark!
            }
            if self.customerBd != nil {
                map["CustomerBd"] = self.customerBd!
            }
            ...
            if self.registerNation != nil {
                map["RegisterNation"] = self.registerNation!
            }
            if self.remark != nil {
                map["Remark"] = self.remark!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CrossScopeRemark"] as? String {
                self.crossScopeRemark = value
            }
            if let value = dict["CustomerBd"] as? String {
                self.customerBd = value
            }
            ...
            if let value = dict["RegisterNation"] as? String {
                self.registerNation = value
            }
            if let value = dict["Remark"] as? String {
                self.remark = value
            }
    ...
    public var accountInfoList: [InviteSubResellerRequest.AccountInfoList]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AccountInfoList"] as? [Any?] {
            var tmp : [InviteSubResellerRequest.AccountInfoList] = []
            for v in value {
                if v != nil {
                    var model = InviteSubResellerRequest.AccountInfoList()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class InviteSubResellerResponseBody : Tea.TeaModel {
    public class Results : Tea.TeaModel {
        public class Result : Tea.TeaModel {
            public var days: Int32?
        ...
        public var result: InviteSubResellerResponseBody.Results.Result?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Result"] as? [String: Any?] {
                var model = InviteSubResellerResponseBody.Results.Result()
                model.fromMap(value)
                self.result = model
            }
            if let value = dict["Success"] as? Bool {
    ...
    public var results: [InviteSubResellerResponseBody.Results]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Results"] as? [Any?] {
            var tmp : [InviteSubResellerResponseBody.Results] = []
            for v in value {
                if v != nil {
                    var model = InviteSubResellerResponseBody.Results()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class InviteSubResellerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: InviteSubResellerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = InviteSubResellerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListTier2CouponApprovalRequest : Tea.TeaModel {
    public var applicationSheetId: String?
...
public class ListTier2CouponApprovalResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var applicationSheetId: String?
    ...
    public var data: [ListTier2CouponApprovalResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListTier2CouponApprovalResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListTier2CouponApprovalResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListTier2CouponApprovalResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListTier2CouponApprovalResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListTier2CouponApprovalResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ProcessApprovalRequest : Tea.TeaModel {
    public var applicationSheetId: String?

    public var approvalAction: String?

    public var approvalComments: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.approvalComments != nil {
            map["ApprovalComments"] = self.approvalComments!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ApprovalComments"] as? String {
            self.approvalComments = value
        }
    }
}

public class ProcessApprovalResponseBody : Tea.TeaModel {
    public var code: String?
...
public class ProcessApprovalResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ProcessApprovalResponseBody?
