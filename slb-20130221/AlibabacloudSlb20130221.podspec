Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudSlb20130221"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Server Load Balancer (20130221) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/slb-20130221" 
