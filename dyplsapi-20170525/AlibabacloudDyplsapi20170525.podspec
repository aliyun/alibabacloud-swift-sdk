Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDyplsapi20170525"
  spec.version      = "2.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Dyplsapi (20170525) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/dyplsapi-20170525" 
