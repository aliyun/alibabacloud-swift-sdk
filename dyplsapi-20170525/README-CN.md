...
```ruby
pod 'AlibabacloudDyplsapi20170525', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/dyplsapi-20170525" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dyplsapi-20170525.git", from: "1.0.0")
]
```
