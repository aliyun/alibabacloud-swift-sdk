...
```ruby
pod 'AlibabacloudDyplsapi20170525', '~> 1.0.2'
```
...
```ogdl
github "alibabacloud-sdk-swift/dyplsapi-20170525" "1.0.2"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dyplsapi-20170525.git", from: "1.0.2")
]
```
