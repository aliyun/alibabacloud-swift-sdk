...
```ruby
pod 'AlibabacloudCsas20230120', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/csas-20230120" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/csas-20230120.git", from: "1.0.1")
]
```
