...
public class AppendCasesRequest : Tea.TeaModel {
    public class Cases : Tea.TeaModel {
    ...
    public var cases: [AppendCasesRequest.Cases]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Cases"] as? [Any?] {
            var tmp : [AppendCasesRequest.Cases] = []
            for v in value {
                if v != nil {
                    var model = AppendCasesRequest.Cases()
                    if v != nil {
...
public class AppendCasesShrinkRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.casesShrink != nil {
            map["Cases"] = self.casesShrink!
        }
        if self.instanceId != nil {
            map["InstanceId"] = self.instanceId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Cases"] as? String {
            self.casesShrink = value
        }
        if let value = dict["InstanceId"] as? String {
            self.instanceId = value
        }
...
public class CreateCampaignRequest : Tea.TeaModel {
    ...
    public var attemptOrder: String?

    public var callableTime: String?

    public var caseFileKey: String?

    public var cases: [CreateCampaignRequest.Cases]?

    public var dialingTimeoutSeconds: Int32?

    public var endTime: Int64?

    public var fixedQuota: Int32?

    public var flashSmsParameters: String?

    public var holidayRestricted: Bool?

    public var instanceId: String?

    public var maxAttemptCount: Int32?
    ...
    public var redialRestrictions: String?

    public var runUntilEndTime: Bool?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.attemptOrder != nil {
            map["AttemptOrder"] = self.attemptOrder!
        }
        ...
        if self.dialingTimeoutSeconds != nil {
            map["DialingTimeoutSeconds"] = self.dialingTimeoutSeconds!
        }
        if self.endTime != nil {
            map["EndTime"] = self.endTime!
        }
        if self.fixedQuota != nil {
            map["FixedQuota"] = self.fixedQuota!
        }
        if self.flashSmsParameters != nil {
            map["FlashSmsParameters"] = self.flashSmsParameters!
        }
        if self.holidayRestricted != nil {
            map["HolidayRestricted"] = self.holidayRestricted!
        }
        if self.instanceId != nil {
            map["InstanceId"] = self.instanceId!
        }
        ...
        if self.redialRestrictions != nil {
            map["RedialRestrictions"] = self.redialRestrictions!
        }
        if self.runUntilEndTime != nil {
            map["RunUntilEndTime"] = self.runUntilEndTime!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AttemptOrder"] as? String {
            self.attemptOrder = value
        }
        ...
        if let value = dict["Cases"] as? [Any?] {
            var tmp : [CreateCampaignRequest.Cases] = []
            for v in value {
                if v != nil {
                    var model = CreateCampaignRequest.Cases()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["DialingTimeoutSeconds"] as? Int32 {
            self.dialingTimeoutSeconds = value
        }
        if let value = dict["EndTime"] as? Int64 {
            self.endTime = value
        }
        if let value = dict["FixedQuota"] as? Int32 {
            self.fixedQuota = value
        }
        if let value = dict["FlashSmsParameters"] as? String {
            self.flashSmsParameters = value
        }
        if let value = dict["HolidayRestricted"] as? Bool {
            self.holidayRestricted = value
        }
        if let value = dict["InstanceId"] as? String {
            self.instanceId = value
        }
        if let value = dict["MaxAttemptCount"] as? Int32 {
            self.maxAttemptCount = value
        }
        if let value = dict["MinAttemptInterval"] as? Int32 {
        ...
        if let value = dict["RedialRestrictions"] as? String {
            self.redialRestrictions = value
        }
        if let value = dict["RunUntilEndTime"] as? Bool {
            self.runUntilEndTime = value
        }
    ...
    public class Data : Tea.TeaModel {
        public class Labels : Tea.TeaModel {
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.matchedValue != nil {
                    map["MatchedValue"] = self.matchedValue!
                }
                if self.name != nil {
                    map["Name"] = self.name!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["Collected"] as? Bool {
                    self.collected = value
                }
                if let value = dict["Description"] as? String {
                    self.description_ = value
                }
                if let value = dict["MatchedValue"] as? String {
                    self.matchedValue = value
                }
                if let value = dict["Name"] as? String {
                    self.name = value
                }
        ...
        public class Transcripts : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["PlayedWords"] as? String {
        ...
        public var labels: [GetCallDetailRecordResponseBody.Data.Labels]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Labels"] as? [Any?] {
                var tmp : [GetCallDetailRecordResponseBody.Data.Labels] = []
                for v in value {
                    if v != nil {
                        var model = GetCallDetailRecordResponseBody.Data.Labels()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["TalkTurns"] as? Int64 {
...
public class GetCampaignResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var casesAborted: Int32?

        public var casesConnected: Int32?

        public var casesUncompleted: Int32?

        public var casesUncompletedAfterAttempted: Int32?

        public var completedRate: Double?
        ...
        public var plannedEndTime: Int64?

        public var plannedStartTime: Int64?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CasesAborted"] as? Int32 {
                self.casesAborted = value
            }
            if let value = dict["CasesConnected"] as? Int32 {
                self.casesConnected = value
            }
            if let value = dict["CasesUncompleted"] as? Int32 {
                self.casesUncompleted = value
            }
            if let value = dict["CasesUncompletedAfterAttempted"] as? Int32 {
                self.casesUncompletedAfterAttempted = value
            }
            if let value = dict["CompletedRate"] as? Double {
            ...
            if let value = dict["PlannedEndTime"] as? Int64 {
                self.plannedEndTime = value
            }
            if let value = dict["PlannedStartTime"] as? Int64 {
            ...
            if let value = dict["TotalCases"] as? Int32 {
...
public class GetCaseDetailRequest : Tea.TeaModel {
    public var caseId: String?
...
public class GetCaseDetailResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public class Case_ : Tea.TeaModel {
            public class Labels : Tea.TeaModel {
                public var candidateValues: [String]?
            ...
            public var attemptedCount: Int32?
            ...
            public var labels: [GetCaseDetailResponseBody.Data.Case_.Labels]?

            public var lastAttemptedTime: Int64?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.attemptedCount != nil {
                    map["AttemptedCount"] = self.attemptedCount!
                }
                ...
                if self.campaignName != nil {
                    map["CampaignName"] = self.campaignName!
                }
                if self.caseId != nil {
                    map["CaseId"] = self.caseId!
                }
                ...
                if self.lastAttemptedTime != nil {
                    map["LastAttemptedTime"] = self.lastAttemptedTime!
                }
                if self.phoneNumber != nil {
                    map["PhoneNumber"] = self.phoneNumber!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["AttemptedCount"] as? Int32 {
                    self.attemptedCount = value
                }
                ...
                if let value = dict["CampaignName"] as? String {
                ...
                if let value = dict["Labels"] as? [Any?] {
                    var tmp : [GetCaseDetailResponseBody.Data.Case_.Labels] = []
                    for v in value {
                        if v != nil {
                            var model = GetCaseDetailResponseBody.Data.Case_.Labels()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["LastAttemptedTime"] as? Int64 {
                    self.lastAttemptedTime = value
                }
                if let value = dict["PhoneNumber"] as? String {
                    self.phoneNumber = value
                }
                ...
                if let value = dict["RingingDuration"] as? Int64 {
                    self.ringingDuration = value
                }
                if let value = dict["RingingTime"] as? Int64 {
        ...
        public var callDetailRecords: [GetCaseDetailResponseBody.Data.CallDetailRecords]?

        public var case_: GetCaseDetailResponseBody.Data.Case_?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CallDetailRecords"] as? [Any?] {
                var tmp : [GetCaseDetailResponseBody.Data.CallDetailRecords] = []
                for v in value {
                    if v != nil {
                        var model = GetCaseDetailResponseBody.Data.CallDetailRecords()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["Case"] as? [String: Any?] {
                var model = GetCaseDetailResponseBody.Data.Case_()
                model.fromMap(value)
                self.case_ = model
            }
        }
    ...
    public var data: GetCaseDetailResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = GetCaseDetailResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["HttpStatusCode"] as? Int32 {
...
public class GetCaseDetailResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetCaseDetailResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetCaseDetailResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListCampaignsRequest : Tea.TeaModel {
    ...
    public var plannedStartTimeFrom: String?

    public var plannedStartTimeTo: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.plannedStartTimeFrom != nil {
            map["PlannedStartTimeFrom"] = self.plannedStartTimeFrom!
        }
        if self.plannedStartTimeTo != nil {
            map["PlannedStartTimeTo"] = self.plannedStartTimeTo!
        }
        if self.state != nil {
            map["State"] = self.state!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PlannedStartTimeFrom"] as? String {
            self.plannedStartTimeFrom = value
        }
        if let value = dict["PlannedStartTimeTo"] as? String {
            self.plannedStartTimeTo = value
        }
        if let value = dict["State"] as? String {
            self.state = value
        }
...
public class ListCasesRequest : Tea.TeaModel {
    ...
    public var labelSearch: [String: String]?

    public var maxRingingDuration: Int64?

    public var maxTalkTime: Int64?

    public var maxTalkTurns: Int64?

    public var minRingingDuration: Int64?

    public var minTalkTime: Int64?

    public var minTalkTurns: Int64?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.caseCompleted != nil {
            map["CaseCompleted"] = self.caseCompleted!
        }
        if self.caseIds != nil {
            map["CaseIds"] = self.caseIds!
        }
        ...
        if self.labelSearch != nil {
            map["LabelSearch"] = self.labelSearch!
        }
        if self.maxRingingDuration != nil {
            map["MaxRingingDuration"] = self.maxRingingDuration!
        }
        ...
        if self.minRingingDuration != nil {
            map["MinRingingDuration"] = self.minRingingDuration!
        }
        if self.minTalkTime != nil {
            map["MinTalkTime"] = self.minTalkTime!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["CaseCompleted"] as? Bool {
            self.caseCompleted = value
        }
        if let value = dict["CaseIds"] as? [String] {
            self.caseIds = value
        }
        ...
        if let value = dict["LabelSearch"] as? [String: String] {
            self.labelSearch = value
        }
        if let value = dict["MaxRingingDuration"] as? Int64 {
            self.maxRingingDuration = value
        }
        if let value = dict["MaxTalkTime"] as? Int64 {
            self.maxTalkTime = value
        }
        if let value = dict["MaxTalkTurns"] as? Int64 {
            self.maxTalkTurns = value
        }
        if let value = dict["MinRingingDuration"] as? Int64 {
            self.minRingingDuration = value
        }
        if let value = dict["MinTalkTime"] as? Int64 {
            self.minTalkTime = value
        }
        if let value = dict["MinTalkTurns"] as? Int64 {
...
public class ListCasesShrinkRequest : Tea.TeaModel {
    public var accessChannelId: String?
    ...
    public var caseIdsShrink: String?
    ...
    public var labelSearchShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.caseIdsShrink != nil {
            map["CaseIds"] = self.caseIdsShrink!
        }
        ...
        if self.labelSearchShrink != nil {
            map["LabelSearch"] = self.labelSearchShrink!
        }
        if self.maxRingingDuration != nil {
            map["MaxRingingDuration"] = self.maxRingingDuration!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["LabelSearch"] as? String {
            self.labelSearchShrink = value
        }
        if let value = dict["MaxRingingDuration"] as? Int64 {
            self.maxRingingDuration = value
        }
...
public class ListCasesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class List : Tea.TeaModel {
            ...
            public var labels: [ListCasesResponseBody.Data.List.Labels]?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["Labels"] as? [Any?] {
                    var tmp : [ListCasesResponseBody.Data.List.Labels] = []
                    for v in value {
                        if v != nil {
                            var model = ListCasesResponseBody.Data.List.Labels()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
