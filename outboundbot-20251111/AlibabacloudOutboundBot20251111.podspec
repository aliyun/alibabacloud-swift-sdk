Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudOutboundBot20251111"
  spec.version      = "1.3.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud OutboundBot (20251111) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/outboundbot-20251111" 
