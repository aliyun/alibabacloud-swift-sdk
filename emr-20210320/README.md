...
```ruby
pod 'AlibabacloudEmr20210320', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/emr-20210320" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/emr-20210320.git", from: "1.0.1")
]
```
