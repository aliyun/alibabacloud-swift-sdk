Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudLiveInteraction20201214"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud live-interaction (20201214) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/live-interaction-20201214" 
