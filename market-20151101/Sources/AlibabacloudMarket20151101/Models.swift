...
public class PushTimesUsageResponseBody : Tea.TeaModel {
    ...
    public var httpStateCode: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.httpStateCode != nil {
            map["HttpStateCode"] = self.httpStateCode!
        }
        if self.message != nil {
            map["Message"] = self.message!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["HttpStateCode"] as? String {
            self.httpStateCode = value
        }
        if let value = dict["Message"] as? String {
            self.message = value
        }
...
public class PushTimesUsageResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: PushTimesUsageResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = PushTimesUsageResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
