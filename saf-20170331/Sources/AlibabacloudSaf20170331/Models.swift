...
public class ExecuteRequestRequest : Tea.TeaModel {
...
public class ExecuteRequestResponseBody : Tea.TeaModel {
...
public class ExecuteRequestResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ExecuteRequestResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("body") {
            var model = ExecuteRequestResponseBody()
