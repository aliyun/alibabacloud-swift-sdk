...
```ruby
pod 'AlibabacloudAlidns20150109', '~> 3.0.3'
```
...
```ogdl
github "alibabacloud-sdk-swift/alidns-20150109" "3.0.3"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/alidns-20150109.git", from: "3.0.3")
]
```
