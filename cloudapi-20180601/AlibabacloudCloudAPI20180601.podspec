Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudCloudAPI20180601"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud CloudAPI (20180601) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/cloudapi-20180601" 
