Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudTrustedServer20200613"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud trusted-server (20200613) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/trusted-server-20200613" 
