...
```ruby
pod 'AlibabacloudAdcp20220101', '~> 1.0.9'
```
...
```ogdl
github "alibabacloud-sdk-swift/adcp-20220101" "1.0.9"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/adcp-20220101.git", from: "1.0.9")
]
```
