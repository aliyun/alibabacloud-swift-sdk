...
```ruby
pod 'AlibabacloudEbs20210730', '~> 1.3.13'
```
...
```ogdl
github "alibabacloud-sdk-swift/ebs-20210730" "1.3.13"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ebs-20210730.git", from: "1.3.13")
]
```
