Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudSgxDcapServer20200726"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud sgx-dcap-server (20200726) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/sgx-dcap-server-20200726" 
