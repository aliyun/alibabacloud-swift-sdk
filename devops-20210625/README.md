...
```ruby
pod 'AlibabacloudDevops20210625', '~> 2.1.8'
```
...
```ogdl
github "alibabacloud-sdk-swift/devops-20210625" "2.1.8"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/devops-20210625.git", from: "2.1.8")
]
```
