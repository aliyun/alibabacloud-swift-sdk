...
```ruby
pod 'AlibabacloudDevops20210625', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/devops-20210625" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/devops-20210625.git", from: "1.0.0")
]
```
