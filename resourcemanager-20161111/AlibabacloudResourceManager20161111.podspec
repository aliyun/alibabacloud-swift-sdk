Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudResourceManager20161111"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ResourceManager (20161111) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/resourcemanager-20161111" 
