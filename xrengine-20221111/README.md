...
```ruby
pod 'AlibabacloudXrEngine20221111', '~> 1.0.5'
```
...
```ogdl
github "alibabacloud-sdk-swift/xrengine-20221111" "1.0.5"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/xrengine-20221111.git", from: "1.0.5")
]
```
