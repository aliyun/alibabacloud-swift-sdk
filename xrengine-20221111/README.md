...
```ruby
pod 'AlibabacloudXrEngine20221111', '~> 1.0.6'
```
...
```ogdl
github "alibabacloud-sdk-swift/xrengine-20221111" "1.0.6"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/xrengine-20221111.git", from: "1.0.6")
]
```
