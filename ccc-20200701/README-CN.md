...
```ruby
pod 'AlibabacloudCCC20200701', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/ccc-20200701" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ccc-20200701.git", from: "1.0.0")
]
```
