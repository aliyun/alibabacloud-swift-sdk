...
```ogdl
github "alibabacloud-sdk-swift/dms-enterprise-20181101" "1.15.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dms-enterprise-20181101.git", from: "1.15.0")
]
```
