Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudModelService20220614"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud modelService (20220614) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/modelservice-20220614" 
