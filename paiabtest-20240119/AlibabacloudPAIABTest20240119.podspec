Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudPAIABTest20240119"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud PAIABTest (20240119) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/paiabtest-20240119" 
