...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addInboundNumberWithOptions(_ tmpReq: AddInboundNumberRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddInboundNumberResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: AddInboundNumberShrinkRequest = AddInboundNumberShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.inboundNumbers)) {
            request.inboundNumbersShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.inboundNumbers, "InboundNumbers", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.applicationCode)) {
            query["ApplicationCode"] = request.applicationCode ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.inboundNumbersShrink)) {
            query["InboundNumbers"] = request.inboundNumbersShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.inboundType)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddInboundNumberResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addInboundNumber(_ request: AddInboundNumberRequest) async throws -> AddInboundNumberResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await addInboundNumberWithOptions(request as! AddInboundNumberRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addLargeModelWithOptions(_ tmpReq: AddLargeModelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddLargeModelResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: AddLargeModelShrinkRequest = AddLargeModelShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.baseModel)) {
            request.baseModelShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.baseModel, "BaseModel", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.authCode)) {
            query["AuthCode"] = request.authCode ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.baseModelShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddLargeModelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addLargeModel(_ request: AddLargeModelRequest) async throws -> AddLargeModelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await addLargeModelWithOptions(request as! AddLargeModelRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addModelApplicationWithOptions(_ tmpReq: AddModelApplicationRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddModelApplicationResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: AddModelApplicationShrinkRequest = AddModelApplicationShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.applicationCps)) {
            query["ApplicationCps"] = request.applicationCps!;
        }
        if (!TeaUtils.Client.isUnset(request.applicationName)) {
            query["ApplicationName"] = request.applicationName ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.callConnectedTriggerModel)) {
        ...
        if (!TeaUtils.Client.isUnset(request.muteActive)) {
            query["MuteActive"] = request.muteActive!;
        }
        if (!TeaUtils.Client.isUnset(request.muteDuration)) {
        ...
        if (!TeaUtils.Client.isUnset(request.recordingFile)) {
        ...
        if (!TeaUtils.Client.isUnset(request.usageDesc)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddModelApplicationResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addModelApplication(_ request: AddModelApplicationRequest) async throws -> AddModelApplicationResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await addModelApplicationWithOptions(request as! AddModelApplicationRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func importOneTaskPhoneNumberWithOptions(_ tmpReq: ImportOneTaskPhoneNumberRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ImportOneTaskPhoneNumberResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ImportOneTaskPhoneNumberShrinkRequest = ImportOneTaskPhoneNumberShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ImportOneTaskPhoneNumberResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func importOneTaskPhoneNumber(_ request: ImportOneTaskPhoneNumberRequest) async throws -> ImportOneTaskPhoneNumberResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await importOneTaskPhoneNumberWithOptions(request as! ImportOneTaskPhoneNumberRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pageQueryAgentListWithOptions(_ request: PageQueryAgentListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PageQueryAgentListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.agentId)) {
            query["AgentId"] = request.agentId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PageQueryAgentListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pageQueryAgentList(_ request: PageQueryAgentListRequest) async throws -> PageQueryAgentListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pageQueryAgentListWithOptions(request as! PageQueryAgentListRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pageQueryAgentListNewWithOptions(_ request: PageQueryAgentListNewRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PageQueryAgentListNewResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.agentId)) {
            query["AgentId"] = request.agentId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.inboundConfigurableOnly)) {
            query["InboundConfigurableOnly"] = request.inboundConfigurableOnly!;
        }
        if (!TeaUtils.Client.isUnset(request.isAvailable)) {
        ...
        if (!TeaUtils.Client.isUnset(request.serviceDirection)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PageQueryAgentListNewResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pageQueryAgentListNew(_ request: PageQueryAgentListNewRequest) async throws -> PageQueryAgentListNewResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pageQueryAgentListNewWithOptions(request as! PageQueryAgentListNewRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAiCallDetailPageWithOptions(_ tmpReq: QueryAiCallDetailPageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryAiCallDetailPageResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: QueryAiCallDetailPageShrinkRequest = QueryAiCallDetailPageShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.detailIds)) {
            request.detailIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.detailIds, "DetailIds", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.batchId)) {
            query["BatchId"] = request.batchId ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAiVoiceAgentDetailWithOptions(_ request: QueryAiVoiceAgentDetailRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryAiVoiceAgentDetailResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.agentId)) {
            query["AgentId"] = request.agentId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryAiVoiceAgentDetailResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAiVoiceAgentDetail(_ request: QueryAiVoiceAgentDetailRequest) async throws -> QueryAiVoiceAgentDetailResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryAiVoiceAgentDetailWithOptions(request as! QueryAiVoiceAgentDetailRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAiVoiceAgentDetailNewWithOptions(_ request: QueryAiVoiceAgentDetailNewRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryAiVoiceAgentDetailNewResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.agentId)) {
            query["AgentId"] = request.agentId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryAiVoiceAgentDetailNewResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryAiVoiceAgentDetailNew(_ request: QueryAiVoiceAgentDetailNewRequest) async throws -> QueryAiVoiceAgentDetailNewResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryAiVoiceAgentDetailNewWithOptions(request as! QueryAiVoiceAgentDetailNewRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryConversationDetailInfoNewWithOptions(_ request: QueryConversationDetailInfoNewRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryConversationDetailInfoNewResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.callId)) {
            query["CallId"] = request.callId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryConversationDetailInfoNewResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryConversationDetailInfoNew(_ request: QueryConversationDetailInfoNewRequest) async throws -> QueryConversationDetailInfoNewResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryConversationDetailInfoNewWithOptions(request as! QueryConversationDetailInfoNewRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryInboundCallIdWithOptions(_ request: QueryInboundCallIdRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryInboundCallIdResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.callDate)) {
            query["CallDate"] = request.callDate ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryInboundCallIdResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryInboundCallId(_ request: QueryInboundCallIdRequest) async throws -> QueryInboundCallIdResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryInboundCallIdWithOptions(request as! QueryInboundCallIdRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func testLargeModelWithOptions(_ tmpReq: TestLargeModelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> TestLargeModelResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: TestLargeModelShrinkRequest = TestLargeModelShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.baseModel)) {
            request.baseModelShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.baseModel, "BaseModel", "json")
        }
        ...
        if (!TeaUtils.Client.isUnset(request.userDialogContent)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TestLargeModelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func testLargeModel(_ request: TestLargeModelRequest) async throws -> TestLargeModelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await testLargeModelWithOptions(request as! TestLargeModelRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateLargeModelWithOptions(_ tmpReq: UpdateLargeModelRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateLargeModelResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateLargeModelShrinkRequest = UpdateLargeModelShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.baseModel)) {
            request.baseModelShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.baseModel, "BaseModel", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateLargeModelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateLargeModel(_ request: UpdateLargeModelRequest) async throws -> UpdateLargeModelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateLargeModelWithOptions(request as! UpdateLargeModelRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateModelApplicationWithOptions(_ tmpReq: UpdateModelApplicationRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateModelApplicationResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UpdateModelApplicationShrinkRequest = UpdateModelApplicationShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        if (!TeaUtils.Client.isUnset(request.callAssistantHangup)) {
            query["CallAssistantHangup"] = request.callAssistantHangup!;
        }
        if (!TeaUtils.Client.isUnset(request.callAssistantRecognize)) {
            query["CallAssistantRecognize"] = request.callAssistantRecognize!;
        }
        if (!TeaUtils.Client.isUnset(request.callConnectedTriggerModel)) {
            query["CallConnectedTriggerModel"] = request.callConnectedTriggerModel!;
        }
        if (!TeaUtils.Client.isUnset(request.dtmfAllowedDigits)) {
            query["DtmfAllowedDigits"] = request.dtmfAllowedDigits ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.dtmfAutoValidateEnable)) {
            query["DtmfAutoValidateEnable"] = request.dtmfAutoValidateEnable!;
        }
        if (!TeaUtils.Client.isUnset(request.dtmfDigitCount)) {
            query["DtmfDigitCount"] = request.dtmfDigitCount!;
        }
        if (!TeaUtils.Client.isUnset(request.dtmfInputTimeout)) {
            query["DtmfInputTimeout"] = request.dtmfInputTimeout!;
        }
        if (!TeaUtils.Client.isUnset(request.dtmfOutOfRangeAction)) {
            query["DtmfOutOfRangeAction"] = request.dtmfOutOfRangeAction ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.dtmfRetryPlayTimes)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateModelApplicationResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateModelApplication(_ request: UpdateModelApplicationRequest) async throws -> UpdateModelApplicationResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateModelApplicationWithOptions(request as! UpdateModelApplicationRequest, runtime as! TeaUtils.RuntimeOptions)
    }
