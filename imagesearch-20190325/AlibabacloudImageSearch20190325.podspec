Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudImageSearch20190325"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud image search (20190325) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/imagesearch-20190325" 
