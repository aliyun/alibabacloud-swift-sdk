Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudWorkorder20210610"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Workorder (20210610) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/workorder-20210610" 
