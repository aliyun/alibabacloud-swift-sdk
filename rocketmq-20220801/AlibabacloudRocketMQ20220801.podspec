Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudRocketMQ20220801"
  spec.version      = "5.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud RocketMQ (20220801) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/rocketmq-20220801" 
