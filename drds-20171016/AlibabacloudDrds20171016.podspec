Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDrds20171016"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Distributed Relational Database Service (20171016) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/drds-20171016" 
