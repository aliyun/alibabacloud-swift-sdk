...
```ruby
pod 'AlibabacloudImm20200930', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/imm-20200930" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/imm-20200930.git", from: "1.0.0")
]
```
