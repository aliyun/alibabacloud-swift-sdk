...
```ruby
pod 'AlibabacloudImm20200930', '~> 2.1.3'
```
...
```ogdl
github "alibabacloud-sdk-swift/imm-20200930" "2.1.3"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/imm-20200930.git", from: "2.1.3")
]
```
