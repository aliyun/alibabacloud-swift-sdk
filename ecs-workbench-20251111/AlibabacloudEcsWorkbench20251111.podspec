Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEcsWorkbench20251111"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ecs-workbench (20251111) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/ecs-workbench-20251111" 
