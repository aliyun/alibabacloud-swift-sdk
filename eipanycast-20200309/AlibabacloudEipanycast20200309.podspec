Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEipanycast20200309"
  spec.version      = "1.2.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Eipanycast (20200309) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/eipanycast-20200309" 
