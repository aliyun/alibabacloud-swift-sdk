Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudComposer20181212"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Logic Composer (20181212) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/composer-20181212" 
