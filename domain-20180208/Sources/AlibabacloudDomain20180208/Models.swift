...
public class AcceptPushRequest : Tea.TeaModel {
    public var contactTemplateId: Int64?

    public var pushNo: String?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PushNo"] as? String {
            self.pushNo = value
        }
    }
}

public class AcceptPushResponseBody : Tea.TeaModel {
    ...
    public var module: AcceptPushResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Module"] as? [String: Any?] {
            var model = AcceptPushResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class AcceptPushResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AcceptPushResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AcceptPushResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class BatchQueryPushStatusRequest : Tea.TeaModel {
    public var maxResults: Int32?

    public var nextToken: String?

    public var outBizIds: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.outBizIds != nil {
            map["OutBizIds"] = self.outBizIds!
        }
        if self.pageNum != nil {
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["OutBizIds"] as? [String] {
            self.outBizIds = value
        }
...
public class BatchQueryPushStatusShrinkRequest : Tea.TeaModel {
    public var maxResults: Int32?

    public var nextToken: String?

    public var outBizIdsShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.outBizIdsShrink != nil {
            map["OutBizIds"] = self.outBizIdsShrink!
        }
        if self.pageNum != nil {
            map["PageNum"] = self.pageNum!
        }
...
public class BatchQueryPushStatusResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        ...
        public var pushResults: [BatchQueryPushStatusResponseBody.Module.PushResults]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["PushResults"] as? [Any?] {
                var tmp : [BatchQueryPushStatusResponseBody.Module.PushResults] = []
                for v in value {
                    if v != nil {
                        var model = BatchQueryPushStatusResponseBody.Module.PushResults()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var module: BatchQueryPushStatusResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Module"] as? [String: Any?] {
            var model = BatchQueryPushStatusResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["NextToken"] as? String {
...
public class BatchQueryPushStatusResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: BatchQueryPushStatusResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = BatchQueryPushStatusResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class BatchQueryReceivedPushStatusRequest : Tea.TeaModel {
    public var maxResults: Int32?

    public var nextToken: String?

    public var pushNos: [String]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PushNos"] as? [String] {
            self.pushNos = value
        }
    }
}

public class BatchQueryReceivedPushStatusShrinkRequest : Tea.TeaModel {
    public var maxResults: Int32?

    public var nextToken: String?

    public var pushNosShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.pushNosShrink != nil {
            map["PushNos"] = self.pushNosShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PushNos"] as? String {
            self.pushNosShrink = value
        }
    }
}

public class BatchQueryReceivedPushStatusResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public class PushResults : Tea.TeaModel {
        ...
        public var pushResults: [BatchQueryReceivedPushStatusResponseBody.Module.PushResults]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["PushResults"] as? [Any?] {
                var tmp : [BatchQueryReceivedPushStatusResponseBody.Module.PushResults] = []
                for v in value {
                    if v != nil {
                        var model = BatchQueryReceivedPushStatusResponseBody.Module.PushResults()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var module: BatchQueryReceivedPushStatusResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Module"] as? [String: Any?] {
            var model = BatchQueryReceivedPushStatusResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["NextToken"] as? String {
...
public class BatchQueryReceivedPushStatusResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: BatchQueryReceivedPushStatusResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = BatchQueryReceivedPushStatusResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class BatchRecallPushRequest : Tea.TeaModel {
    public var outBizIds: [String]?
...
public class BatchRecallPushShrinkRequest : Tea.TeaModel {
    public var outBizIdsShrink: String?
...
public class BatchRecallPushResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        ...
        public var recallResults: [BatchRecallPushResponseBody.Module.RecallResults]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["RecallResults"] as? [Any?] {
                var tmp : [BatchRecallPushResponseBody.Module.RecallResults] = []
                for v in value {
                    if v != nil {
                        var model = BatchRecallPushResponseBody.Module.RecallResults()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var module: BatchRecallPushResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Module"] as? [String: Any?] {
            var model = BatchRecallPushResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class BatchRecallPushResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: BatchRecallPushResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = BatchRecallPushResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CheckPushReceiverRequest : Tea.TeaModel {
    public var receiverAccount: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.receiverAccount != nil {
            map["ReceiverAccount"] = self.receiverAccount!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["ReceiverAccount"] as? String {
            self.receiverAccount = value
        }
    }
}

public class CheckPushReceiverResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public var canReceivePush: Bool?

        public var maskedMobile: String?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.canReceivePush != nil {
                map["CanReceivePush"] = self.canReceivePush!
            }
            if self.maskedMobile != nil {
                map["MaskedMobile"] = self.maskedMobile!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["CanReceivePush"] as? Bool {
                self.canReceivePush = value
            }
            if let value = dict["MaskedMobile"] as? String {
                self.maskedMobile = value
            }
    ...
    public var module: CheckPushReceiverResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Module"] as? [String: Any?] {
            var model = CheckPushReceiverResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class CheckPushReceiverResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CheckPushReceiverResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CheckPushReceiverResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateCloseoutOrderRequest : Tea.TeaModel {
...
public class CreateCloseoutOrderResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public var bizIds: [String: String]?

        public var buyerBlockTrade: [String]?

        public var domainBlockTrade: [String]?

        public var domainName: String?

        public var domainTradeRiskWarn: [String]?

        public var extend: [String: String]?

        public var ignoredDomains: [[String: String]]?

        public var needPay: Bool?

        public var orderNo: String?

        public var orderSumMoney: Double?

        public var outOrderNo: String?

        public var payMoney: Double?

        public var payUrl: String?

        public var realNameTemplate: [Int64]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.buyerBlockTrade != nil {
                map["BuyerBlockTrade"] = self.buyerBlockTrade!
            }
            ...
            if self.domainTradeRiskWarn != nil {
                map["DomainTradeRiskWarn"] = self.domainTradeRiskWarn!
            }
            if self.extend != nil {
                map["Extend"] = self.extend!
            }
            if self.ignoredDomains != nil {
                map["IgnoredDomains"] = self.ignoredDomains!
            }
            if self.needPay != nil {
                map["NeedPay"] = self.needPay!
            }
            if self.orderNo != nil {
                map["OrderNo"] = self.orderNo!
            }
            if self.orderSumMoney != nil {
                map["OrderSumMoney"] = self.orderSumMoney!
            }
            if self.outOrderNo != nil {
                map["OutOrderNo"] = self.outOrderNo!
            }
            if self.payMoney != nil {
                map["PayMoney"] = self.payMoney!
            }
            if self.payUrl != nil {
                map["PayUrl"] = self.payUrl!
            }
            if self.realNameTemplate != nil {
                map["RealNameTemplate"] = self.realNameTemplate!
            }
            if self.requestId != nil {
                map["RequestId"] = self.requestId!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["BizIds"] as? [String: String] {
                self.bizIds = value
            }
            if let value = dict["BuyerBlockTrade"] as? [String] {
                self.buyerBlockTrade = value
            }
            ...
            if let value = dict["DomainTradeRiskWarn"] as? [String] {
                self.domainTradeRiskWarn = value
            }
            if let value = dict["Extend"] as? [String: String] {
                self.extend = value
            }
            if let value = dict["IgnoredDomains"] as? [[String: String]] {
                self.ignoredDomains = value
            }
            if let value = dict["NeedPay"] as? Bool {
                self.needPay = value
            }
            if let value = dict["OrderNo"] as? String {
                self.orderNo = value
            }
            if let value = dict["OrderSumMoney"] as? Double {
                self.orderSumMoney = value
            }
            if let value = dict["OutOrderNo"] as? String {
                self.outOrderNo = value
            }
            if let value = dict["PayMoney"] as? Double {
                self.payMoney = value
            }
            if let value = dict["PayUrl"] as? String {
                self.payUrl = value
            }
            if let value = dict["RealNameTemplate"] as? [Int64] {
                self.realNameTemplate = value
            }
            if let value = dict["RequestId"] as? String {
                self.requestId = value
            }
    ...
    public var module: CreateCloseoutOrderResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Module"] as? [String: Any?] {
            var model = CreateCloseoutOrderResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class CreateCloseoutOrderResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateCloseoutOrderResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateCloseoutOrderResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class PushDomainsRequest : Tea.TeaModel {
    public var domainList: [String]?

    public var outBizId: String?

    public var publishRemark: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.publishRemark != nil {
            map["PublishRemark"] = self.publishRemark!
        }
        if self.receiverAccount != nil {
            map["ReceiverAccount"] = self.receiverAccount!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PublishRemark"] as? String {
            self.publishRemark = value
        }
        if let value = dict["ReceiverAccount"] as? String {
            self.receiverAccount = value
        }
...
public class PushDomainsShrinkRequest : Tea.TeaModel {
    public var domainListShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.domainListShrink != nil {
            map["DomainList"] = self.domainListShrink!
        }
        if self.outBizId != nil {
            map["OutBizId"] = self.outBizId!
        }
...
public class PushDomainsResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public class FailedResults : Tea.TeaModel {
            public var domainName: String?
        ...
        public var failedResults: [PushDomainsResponseBody.Module.FailedResults]?
        ...
        public var successDomains: [String]?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.failedResults != nil {
                var tmp : [Any] = []
                for k in self.failedResults! {
                    tmp.append(k.toMap())
                }
                map["FailedResults"] = tmp
            }
            if self.outBizId != nil {
                map["OutBizId"] = self.outBizId!
            }
            ...
            if self.successDomains != nil {
                map["SuccessDomains"] = self.successDomains!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["FailedResults"] as? [Any?] {
                var tmp : [PushDomainsResponseBody.Module.FailedResults] = []
                for v in value {
                    if v != nil {
                        var model = PushDomainsResponseBody.Module.FailedResults()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["SuccessDomains"] as? [String] {
                self.successDomains = value
            }
        }
    }
    public var module: PushDomainsResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Module"] as? [String: Any?] {
            var model = PushDomainsResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class PushDomainsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: PushDomainsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = PushDomainsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class QueryBuyerDomainTradeRecordsRequest : Tea.TeaModel {
    public var bizIdList: [String]?
    ...
    public var tradeTypeList: [String]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.bizIdList != nil {
            map["BizIdList"] = self.bizIdList!
        }
        ...
        if self.endPrice != nil {
            map["EndPrice"] = self.endPrice!
        }
        if self.pageNum != nil {
            map["PageNum"] = self.pageNum!
        }
        ...
        if self.tradeTypeList != nil {
            map["TradeTypeList"] = self.tradeTypeList!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["BizIdList"] as? [String] {
            self.bizIdList = value
        }
        ...
        if let value = dict["EndPrice"] as? Double {
            self.endPrice = value
        }
        if let value = dict["PageNum"] as? Int64 {
            self.pageNum = value
        ...
        if let value = dict["Sorter"] as? String {
            self.sorter = value
        }
        if let value = dict["StartDate"] as? String {
            self.startDate = value
        }
        if let value = dict["StartPrice"] as? Double {
            self.startPrice = value
        }
        ...
        if let value = dict["TradeTypeList"] as? [String] {
            self.tradeTypeList = value
        }
    }
}

public class QueryBuyerDomainTradeRecordsShrinkRequest : Tea.TeaModel {
    public var bizIdListShrink: String?
    ...
    public var tradeTypeListShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.bizIdListShrink != nil {
            map["BizIdList"] = self.bizIdListShrink!
        }
        ...
        if self.tradeTypeListShrink != nil {
            map["TradeTypeList"] = self.tradeTypeListShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["TradeTypeList"] as? String {
            self.tradeTypeListShrink = value
        }
    }
}

public class QueryBuyerDomainTradeRecordsResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public class Data : Tea.TeaModel {
            public var bizId: String?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["TradeId"] as? String {
                    self.tradeId = value
                }
        ...
        public var data: [QueryBuyerDomainTradeRecordsResponseBody.Module.Data]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Data"] as? [Any?] {
                var tmp : [QueryBuyerDomainTradeRecordsResponseBody.Module.Data] = []
                for v in value {
                    if v != nil {
                        var model = QueryBuyerDomainTradeRecordsResponseBody.Module.Data()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var module: QueryBuyerDomainTradeRecordsResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Module"] as? [String: Any?] {
            var model = QueryBuyerDomainTradeRecordsResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class QueryBuyerDomainTradeRecordsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: QueryBuyerDomainTradeRecordsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = QueryBuyerDomainTradeRecordsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class QueryCloseoutDomainInfoRequest : Tea.TeaModel {
    public var domainName: String?
...
public class QueryCloseoutDomainInfoResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
    ...
    public var module: QueryCloseoutDomainInfoResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Module"] as? [String: Any?] {
            var model = QueryCloseoutDomainInfoResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class QueryCloseoutDomainInfoResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: QueryCloseoutDomainInfoResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = QueryCloseoutDomainInfoResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class QueryCloseoutDomainListRequest : Tea.TeaModel {
...
public class QueryCloseoutDomainListResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var auctionEndTime: String?
    ...
    public var data: [QueryCloseoutDomainListResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [QueryCloseoutDomainListResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = QueryCloseoutDomainListResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class QueryCloseoutDomainListResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: QueryCloseoutDomainListResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = QueryCloseoutDomainListResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class QueryPendingPushListRequest : Tea.TeaModel {
    public var maxResults: Int32?
...
public class QueryPendingPushListResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public class PushList : Tea.TeaModel {
            ...
            public var sellerRemark: String?

            public var tradeMoney: String?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.sellerRemark != nil {
                    map["SellerRemark"] = self.sellerRemark!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["SellerRemark"] as? String {
                    self.sellerRemark = value
                }
                if let value = dict["TradeMoney"] as? String {
        ...
        public var pushList: [QueryPendingPushListResponseBody.Module.PushList]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.pushList != nil {
                var tmp : [Any] = []
                for k in self.pushList! {
                    tmp.append(k.toMap())
                }
                map["PushList"] = tmp
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["PushList"] as? [Any?] {
                var tmp : [QueryPendingPushListResponseBody.Module.PushList] = []
                for v in value {
                    if v != nil {
                        var model = QueryPendingPushListResponseBody.Module.PushList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var module: QueryPendingPushListResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Module"] as? [String: Any?] {
            var model = QueryPendingPushListResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["NextToken"] as? String {
...
public class QueryPendingPushListResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: QueryPendingPushListResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = QueryPendingPushListResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class RejectPushRequest : Tea.TeaModel {
    public var pushNo: String?
...
public class RejectPushResponseBody : Tea.TeaModel {
    public class Module : Tea.TeaModel {
        public var code: String?
    ...
    public var module: RejectPushResponseBody.Module?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Module"] as? [String: Any?] {
            var model = RejectPushResponseBody.Module()
            model.fromMap(value)
            self.module = model
        }
        if let value = dict["RequestId"] as? String {
...
public class RejectPushResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RejectPushResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RejectPushResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateProxyPriceRequest : Tea.TeaModel {
    public var auctionId: String?
...
public class UpdateProxyPriceResponseBody : Tea.TeaModel {
    public var auctionId: String?
...
public class UpdateProxyPriceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateProxyPriceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateProxyPriceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class WebsiteAddDnsRecordRequest : Tea.TeaModel {
    public var domainName: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.websiteNo != nil {
            map["WebsiteNo"] = self.websiteNo!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["WebsiteNo"] as? String {
            self.websiteNo = value
        }
    }
}

public class WebsiteAddDnsRecordResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class WebsiteAddDnsRecordResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: WebsiteAddDnsRecordResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = WebsiteAddDnsRecordResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class WebsiteDeleteDnsRecordRequest : Tea.TeaModel {
    public var domainName: String?
...
public class WebsiteDeleteDnsRecordResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class WebsiteDeleteDnsRecordResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: WebsiteDeleteDnsRecordResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = WebsiteDeleteDnsRecordResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
