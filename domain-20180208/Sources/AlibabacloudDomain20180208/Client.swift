...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func acceptPushWithOptions(_ request: AcceptPushRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> AcceptPushResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.contactTemplateId)) {
            query["ContactTemplateId"] = request.contactTemplateId!;
        }
        if (!TeaUtils.Client.isUnset(request.pushNo)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AcceptPushResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func acceptPush(_ request: AcceptPushRequest) async throws -> AcceptPushResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await acceptPushWithOptions(request as! AcceptPushRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchQueryPushStatusWithOptions(_ tmpReq: BatchQueryPushStatusRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> BatchQueryPushStatusResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: BatchQueryPushStatusShrinkRequest = BatchQueryPushStatusShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.outBizIds)) {
            request.outBizIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.outBizIds, "OutBizIds", "json")
        }
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.outBizIdsShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(BatchQueryPushStatusResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchQueryPushStatus(_ request: BatchQueryPushStatusRequest) async throws -> BatchQueryPushStatusResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await batchQueryPushStatusWithOptions(request as! BatchQueryPushStatusRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchQueryReceivedPushStatusWithOptions(_ tmpReq: BatchQueryReceivedPushStatusRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> BatchQueryReceivedPushStatusResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: BatchQueryReceivedPushStatusShrinkRequest = BatchQueryReceivedPushStatusShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.pushNos)) {
            request.pushNosShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.pushNos, "PushNos", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.maxResults)) {
            query["MaxResults"] = request.maxResults!;
        ...
        if (!TeaUtils.Client.isUnset(request.pushNosShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(BatchQueryReceivedPushStatusResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchQueryReceivedPushStatus(_ request: BatchQueryReceivedPushStatusRequest) async throws -> BatchQueryReceivedPushStatusResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await batchQueryReceivedPushStatusWithOptions(request as! BatchQueryReceivedPushStatusRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchRecallPushWithOptions(_ tmpReq: BatchRecallPushRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> BatchRecallPushResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: BatchRecallPushShrinkRequest = BatchRecallPushShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.outBizIds)) {
            request.outBizIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.outBizIds, "OutBizIds", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(BatchRecallPushResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchRecallPush(_ request: BatchRecallPushRequest) async throws -> BatchRecallPushResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await batchRecallPushWithOptions(request as! BatchRecallPushRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func checkPushReceiverWithOptions(_ request: CheckPushReceiverRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CheckPushReceiverResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.receiverAccount)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CheckPushReceiverResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func checkPushReceiver(_ request: CheckPushReceiverRequest) async throws -> CheckPushReceiverResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await checkPushReceiverWithOptions(request as! CheckPushReceiverRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createCloseoutOrderWithOptions(_ request: CreateCloseoutOrderRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateCloseoutOrderResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateCloseoutOrderResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createCloseoutOrder(_ request: CreateCloseoutOrderRequest) async throws -> CreateCloseoutOrderResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createCloseoutOrderWithOptions(request as! CreateCloseoutOrderRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pushDomainsWithOptions(_ tmpReq: PushDomainsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PushDomainsResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: PushDomainsShrinkRequest = PushDomainsShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.domainList)) {
            request.domainListShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.domainList, "DomainList", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.domainListShrink)) {
            query["DomainList"] = request.domainListShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.outBizId)) {
            query["OutBizId"] = request.outBizId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.publishRemark)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PushDomainsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pushDomains(_ request: PushDomainsRequest) async throws -> PushDomainsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pushDomainsWithOptions(request as! PushDomainsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryCloseoutDomainInfoWithOptions(_ request: QueryCloseoutDomainInfoRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryCloseoutDomainInfoResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.domainName)) {
            query["DomainName"] = request.domainName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryCloseoutDomainInfoResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryCloseoutDomainInfo(_ request: QueryCloseoutDomainInfoRequest) async throws -> QueryCloseoutDomainInfoResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryCloseoutDomainInfoWithOptions(request as! QueryCloseoutDomainInfoRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryCloseoutDomainListWithOptions(_ request: QueryCloseoutDomainListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryCloseoutDomainListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryCloseoutDomainListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryCloseoutDomainList(_ request: QueryCloseoutDomainListRequest) async throws -> QueryCloseoutDomainListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryCloseoutDomainListWithOptions(request as! QueryCloseoutDomainListRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func queryExportDomainExpireSnatchsWithOptions(_ tmpReq: QueryExportDomainExpireSnatchsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryExportDomainExpireSnatchsResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryExportDomainExpireSnatchsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryExportDomainExpireSnatchs(_ request: QueryExportDomainExpireSnatchsRequest) async throws -> QueryExportDomainExpireSnatchsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryExportDomainExpireSnatchsWithOptions(request as! QueryExportDomainExpireSnatchsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryPendingPushListWithOptions(_ request: QueryPendingPushListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryPendingPushListResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.maxResults)) {
            query["MaxResults"] = request.maxResults!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryPendingPushListResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryPendingPushList(_ request: QueryPendingPushListRequest) async throws -> QueryPendingPushListResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await queryPendingPushListWithOptions(request as! QueryPendingPushListRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func rejectPushWithOptions(_ request: RejectPushRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RejectPushResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.pushNo)) {
            query["PushNo"] = request.pushNo ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RejectPushResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func rejectPush(_ request: RejectPushRequest) async throws -> RejectPushResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await rejectPushWithOptions(request as! RejectPushRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateProxyPriceWithOptions(_ request: UpdateProxyPriceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateProxyPriceResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.auctionId)) {
            body["AuctionId"] = request.auctionId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateProxyPriceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateProxyPrice(_ request: UpdateProxyPriceRequest) async throws -> UpdateProxyPriceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateProxyPriceWithOptions(request as! UpdateProxyPriceRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func websiteAddDnsRecordWithOptions(_ request: WebsiteAddDnsRecordRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> WebsiteAddDnsRecordResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.domainName)) {
            query["DomainName"] = request.domainName ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.websiteNo)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(WebsiteAddDnsRecordResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func websiteAddDnsRecord(_ request: WebsiteAddDnsRecordRequest) async throws -> WebsiteAddDnsRecordResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await websiteAddDnsRecordWithOptions(request as! WebsiteAddDnsRecordRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func websiteDeleteDnsRecordWithOptions(_ request: WebsiteDeleteDnsRecordRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> WebsiteDeleteDnsRecordResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.domainName)) {
            query["DomainName"] = request.domainName ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(WebsiteDeleteDnsRecordResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func websiteDeleteDnsRecord(_ request: WebsiteDeleteDnsRecordRequest) async throws -> WebsiteDeleteDnsRecordResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await websiteDeleteDnsRecordWithOptions(request as! WebsiteDeleteDnsRecordRequest, runtime as! TeaUtils.RuntimeOptions)
    }
}
