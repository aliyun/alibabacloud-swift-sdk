Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudServerless20210924"
  spec.version      = "1.1.2"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud serverless (20210924) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/serverless-20210924" 
