...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyGrantInstanceToTransitRouterWithOptions(_ request: ModifyGrantInstanceToTransitRouterRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyGrantInstanceToTransitRouterResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.cenId)) {
            query["CenId"] = request.cenId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyGrantInstanceToTransitRouterResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyGrantInstanceToTransitRouter(_ request: ModifyGrantInstanceToTransitRouterRequest) async throws -> ModifyGrantInstanceToTransitRouterResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyGrantInstanceToTransitRouterWithOptions(request as! ModifyGrantInstanceToTransitRouterRequest, runtime as! TeaUtils.RuntimeOptions)
    }
