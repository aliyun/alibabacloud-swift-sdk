Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudGpdb20190620"
  spec.version      = "1.0.2"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud AnalyticDB for PostgreSQL (20190620) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/gpdb-20190620" 
