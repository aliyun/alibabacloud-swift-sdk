...
public class CreateMultiModelKnowledgeBaseResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateMultiModelKnowledgeBaseResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateMultiModelKnowledgeBaseResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteAgentPlatformRequest : Tea.TeaModel {
    public var DBClusterId: String?
...
public class DeleteAgentPlatformResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteAgentPlatformResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteAgentPlatformResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteAgentPlatformResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteMultiModalKnowledgeBaseResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteMultiModalKnowledgeBaseResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteMultiModalKnowledgeBaseResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteMultiModalKnowledgeBaseResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class LockEmbodiedAIPlatformRequest : Tea.TeaModel {
    public var DBClusterId: String?
...
public class LockEmbodiedAIPlatformResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class LockEmbodiedAIPlatformResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: LockEmbodiedAIPlatformResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = LockEmbodiedAIPlatformResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ModifyAgentPlatformRequest : Tea.TeaModel {
    public class AiPlatformConfig : Tea.TeaModel {
        public var serveApiKey: String?
    ...
    public var aiPlatformConfig: ModifyAgentPlatformRequest.AiPlatformConfig?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AiPlatformConfig"] as? [String: Any?] {
            var model = ModifyAgentPlatformRequest.AiPlatformConfig()
            model.fromMap(value)
            self.aiPlatformConfig = model
        }
        if let value = dict["DBClusterId"] as? String {
...
public class ModifyAgentPlatformShrinkRequest : Tea.TeaModel {
    public var aiPlatformConfigShrink: String?
...
public class ModifyAgentPlatformResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class ModifyAgentPlatformResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ModifyAgentPlatformResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ModifyAgentPlatformResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ModifyEmbodiedAIPlatformRequest : Tea.TeaModel {
    public class RayConfig : Tea.TeaModel {
        public class WorkerGroups : Tea.TeaModel {
            public var allocateUnit: String?
        ...
        public var workerGroups: [ModifyEmbodiedAIPlatformRequest.RayConfig.WorkerGroups]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["WorkerGroups"] as? [Any?] {
                var tmp : [ModifyEmbodiedAIPlatformRequest.RayConfig.WorkerGroups] = []
                for v in value {
                    if v != nil {
                        var model = ModifyEmbodiedAIPlatformRequest.RayConfig.WorkerGroups()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RayConfig"] as? [String: Any?] {
            var model = ModifyEmbodiedAIPlatformRequest.RayConfig()
            model.fromMap(value)
            self.rayConfig = model
        }
        if let value = dict["RayTrainConfig"] as? [String: Any?] {
...
public class ModifyEmbodiedAIPlatformResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class ModifyEmbodiedAIPlatformResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ModifyEmbodiedAIPlatformResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ModifyEmbodiedAIPlatformResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UnlockEmbodiedAIPlatformRequest : Tea.TeaModel {
    public var DBClusterId: String?
...
public class UnlockEmbodiedAIPlatformResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class UnlockEmbodiedAIPlatformResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UnlockEmbodiedAIPlatformResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UnlockEmbodiedAIPlatformResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
