...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func deleteAgentPlatformWithOptions(_ request: DeleteAgentPlatformRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteAgentPlatformResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteAgentPlatformResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAgentPlatform(_ request: DeleteAgentPlatformRequest) async throws -> DeleteAgentPlatformResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteAgentPlatformWithOptions(request as! DeleteAgentPlatformRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeChatMessageWithOptions(_ request: DescribeChatMessageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeChatMessageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeChatMessageResponse(), tmp)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func lockEmbodiedAIPlatformWithOptions(_ request: LockEmbodiedAIPlatformRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> LockEmbodiedAIPlatformResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBClusterId)) {
            query["DBClusterId"] = request.DBClusterId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(LockEmbodiedAIPlatformResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func lockEmbodiedAIPlatform(_ request: LockEmbodiedAIPlatformRequest) async throws -> LockEmbodiedAIPlatformResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await lockEmbodiedAIPlatformWithOptions(request as! LockEmbodiedAIPlatformRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyAgentPlatformWithOptions(_ tmpReq: ModifyAgentPlatformRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyAgentPlatformResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ModifyAgentPlatformShrinkRequest = ModifyAgentPlatformShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.aiPlatformConfig)) {
            request.aiPlatformConfigShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.aiPlatformConfig, "AiPlatformConfig", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyAgentPlatformResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyAgentPlatform(_ request: ModifyAgentPlatformRequest) async throws -> ModifyAgentPlatformResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyAgentPlatformWithOptions(request as! ModifyAgentPlatformRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyEmbodiedAIPlatformWithOptions(_ tmpReq: ModifyEmbodiedAIPlatformRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyEmbodiedAIPlatformResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ModifyEmbodiedAIPlatformShrinkRequest = ModifyEmbodiedAIPlatformShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.rayConfig)) {
            request.rayConfigShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.rayConfig, "RayConfig", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyEmbodiedAIPlatformResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyEmbodiedAIPlatform(_ request: ModifyEmbodiedAIPlatformRequest) async throws -> ModifyEmbodiedAIPlatformResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyEmbodiedAIPlatformWithOptions(request as! ModifyEmbodiedAIPlatformRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func unlockEmbodiedAIPlatformWithOptions(_ request: UnlockEmbodiedAIPlatformRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UnlockEmbodiedAIPlatformResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DBClusterId)) {
            query["DBClusterId"] = request.DBClusterId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UnlockEmbodiedAIPlatformResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func unlockEmbodiedAIPlatform(_ request: UnlockEmbodiedAIPlatformRequest) async throws -> UnlockEmbodiedAIPlatformResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await unlockEmbodiedAIPlatformWithOptions(request as! UnlockEmbodiedAIPlatformRequest, runtime as! TeaUtils.RuntimeOptions)
    }
}
