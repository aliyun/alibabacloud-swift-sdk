...
[CocoaPods](https://cocoapods.org) is a dependency manager for Cocoa projects. For usage and installation instructions, visit their website. To integrate `AlibabacloudSmc20190601` into your Xcode project using CocoaPods, specify it in your `Podfile`:

```ruby
pod 'AlibabacloudSmc20190601', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/smc-20190601" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/smc-20190601.git", from: "1.0.0")
]
```
