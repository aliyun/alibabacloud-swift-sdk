Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudUmengVerifyAgent20240131"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud umeng-verify-agent (20240131) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/umeng-verify-agent-20240131" 
