...
```ruby
pod 'AlibabacloudElasticsearch20170613', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/elasticsearch-20170613" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/elasticsearch-20170613.git", from: "1.0.1")
]
```
