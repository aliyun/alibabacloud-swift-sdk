Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudElasticsearch20170613"
  spec.version      = "3.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Elasticsearch (20170613) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/elasticsearch-20170613" 
