...
public class CreateAlertDestinationRequest : Tea.TeaModel {
    public class Params : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["sec"] as? String {
                self.sec = value
            }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["params"] as? [String: Any?] {
            var model = CreateAlertDestinationRequest.Params()
            model.fromMap(value)
            self.params = model
        }
...
public class CreateAlertDestinationResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class Params : Tea.TeaModel {
            public var email: String?
        ...
        public var params: CreateAlertDestinationResponseBody.Data.Params?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["params"] as? [String: Any?] {
                var model = CreateAlertDestinationResponseBody.Data.Params()
                model.fromMap(value)
                self.params = model
            }
            if let value = dict["source"] as? String {
    ...
    public var data: CreateAlertDestinationResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = CreateAlertDestinationResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class CreateAlertDestinationResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateAlertDestinationResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateAlertDestinationResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateInstanceInspectionResponseBody : Tea.TeaModel {
    public var code: String?
...
public class CreateInstanceInspectionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateInstanceInspectionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateInstanceInspectionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateVmcoreDiagnosisTaskRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.debuginfoUrl != nil {
            map["debuginfoUrl"] = self.debuginfoUrl!
        }
        if self.dmesgUrl != nil {
            map["dmesgUrl"] = self.dmesgUrl!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["debuginfoUrl"] as? String {
            self.debuginfoUrl = value
        }
        if let value = dict["dmesgUrl"] as? String {
            self.dmesgUrl = value
        }
...
public class CreateVmcoreDiagnosisTaskResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
    ...
    public var data: CreateVmcoreDiagnosisTaskResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = CreateVmcoreDiagnosisTaskResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class CreateVmcoreDiagnosisTaskResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateVmcoreDiagnosisTaskResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateVmcoreDiagnosisTaskResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteAlertDestinationResponseBody : Tea.TeaModel {
    public var code: String?
...
public class DeleteAlertDestinationResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteAlertDestinationResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteAlertDestinationResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetAlertDestinationResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var createdAt: String?
    ...
    public var data: GetAlertDestinationResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = GetAlertDestinationResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class GetAlertDestinationResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetAlertDestinationResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetAlertDestinationResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetVmcoreDiagnosisTaskResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var diagnoseResult: String?
        ...
        public var urls: GetVmcoreDiagnosisTaskResponseBody.Data.Urls?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["diagnoseResult"] as? String {
                self.diagnoseResult = value
            }
            ...
            if let value = dict["urls"] as? [String: Any?] {
                var model = GetVmcoreDiagnosisTaskResponseBody.Data.Urls()
                model.fromMap(value)
                self.urls = model
            }
        }
    ...
    public var data: GetVmcoreDiagnosisTaskResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = GetVmcoreDiagnosisTaskResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class GetVmcoreDiagnosisTaskResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetVmcoreDiagnosisTaskResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetVmcoreDiagnosisTaskResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListAlertDestinationsResponseBody : Tea.TeaModel {
    public var code: String?
...
public class ListAlertDestinationsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListAlertDestinationsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListAlertDestinationsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListVmcoreDiagnosisTaskResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var createdAt: String?
    ...
    public var data: [ListVmcoreDiagnosisTaskResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [Any?] {
            var tmp : [ListVmcoreDiagnosisTaskResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListVmcoreDiagnosisTaskResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListVmcoreDiagnosisTaskResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListVmcoreDiagnosisTaskResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListVmcoreDiagnosisTaskResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UninstallAgentWithTypeRequest : Tea.TeaModel {
    public class Instances : Tea.TeaModel {
        public var instance: String?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["instances"] as? [Any?] {
            var tmp : [UninstallAgentWithTypeRequest.Instances] = []
            for v in value {
                if v != nil {
                    var model = UninstallAgentWithTypeRequest.Instances()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UninstallAgentWithTypeResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var taskId: String?
    ...
    public var data: UninstallAgentWithTypeResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = UninstallAgentWithTypeResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class UninstallAgentWithTypeResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UninstallAgentWithTypeResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UninstallAgentWithTypeResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateAlertDestinationRequest : Tea.TeaModel {
    public class Params : Tea.TeaModel {
        public var email: String?
    ...
    public var params: UpdateAlertDestinationRequest.Params?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["params"] as? [String: Any?] {
            var model = UpdateAlertDestinationRequest.Params()
            model.fromMap(value)
            self.params = model
        }
        if let value = dict["source"] as? String {
...
public class UpdateAlertDestinationResponseBody : Tea.TeaModel {
    public var code: String?
...
public class UpdateAlertDestinationResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateAlertDestinationResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateAlertDestinationResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpgradeAgentWithTypeRequest : Tea.TeaModel {
    public class Instances : Tea.TeaModel {
        public var instance: String?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["instances"] as? [Any?] {
            var tmp : [UpgradeAgentWithTypeRequest.Instances] = []
            for v in value {
                if v != nil {
                    var model = UpgradeAgentWithTypeRequest.Instances()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpgradeAgentWithTypeResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var taskId: String?
    ...
    public var data: UpgradeAgentWithTypeResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["data"] as? [String: Any?] {
            var model = UpgradeAgentWithTypeResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["message"] as? String {
...
public class UpgradeAgentWithTypeResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpgradeAgentWithTypeResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpgradeAgentWithTypeResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
