Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDybaseapi20170525"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Dybaseapi (20170525) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/dybaseapi-20170525" 
