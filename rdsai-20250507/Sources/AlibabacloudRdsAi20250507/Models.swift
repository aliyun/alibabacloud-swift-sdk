...
public class ChatMessagesRequest : Tea.TeaModel {
    public class Files : Tea.TeaModel {
        ...
        public var uploadFileId: String?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.transferMethod != nil {
                map["TransferMethod"] = self.transferMethod!
            }
            if self.type != nil {
                map["Type"] = self.type!
            }
            if self.uploadFileId != nil {
                map["UploadFileId"] = self.uploadFileId!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["TransferMethod"] as? String {
                self.transferMethod = value
            }
            if let value = dict["Type"] as? String {
                self.type = value
            }
            if let value = dict["UploadFileId"] as? String {
                self.uploadFileId = value
            }
        }
    }
    public class Inputs : Tea.TeaModel {
        ...
        public var resumeCallId: String?

        public var thinkEffort: String?

        public var timezone: String?

        public var toolApprovalMode: String?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.resumeCallId != nil {
                map["ResumeCallId"] = self.resumeCallId!
            }
            if self.thinkEffort != nil {
                map["ThinkEffort"] = self.thinkEffort!
            }
            if self.timezone != nil {
                map["Timezone"] = self.timezone!
            }
            if self.toolApprovalMode != nil {
                map["ToolApprovalMode"] = self.toolApprovalMode!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["EnableThinking"] as? String {
            ...
            if let value = dict["ResumeCallId"] as? String {
                self.resumeCallId = value
            }
            if let value = dict["ThinkEffort"] as? String {
                self.thinkEffort = value
            }
            if let value = dict["Timezone"] as? String {
                self.timezone = value
            }
            if let value = dict["ToolApprovalMode"] as? String {
                self.toolApprovalMode = value
            }
    ...
    public var files: [ChatMessagesRequest.Files]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Files"] as? [Any?] {
            var tmp : [ChatMessagesRequest.Files] = []
            for v in value {
                if v != nil {
                    var model = ChatMessagesRequest.Files()
                    if v != nil {
...
public class ChatMessagesResponseBody : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.toolArguments != nil {
            map["ToolArguments"] = self.toolArguments!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ToolArguments"] as? [String: Any] {
            self.toolArguments = value
        }
...
public class CreateApiKeyRequest : Tea.TeaModel {
    public var dailyTokenQuota: Int64?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.dailyTokenQuota != nil {
            map["DailyTokenQuota"] = self.dailyTokenQuota!
        }
        ...
        if self.limitRate != nil {
            map["LimitRate"] = self.limitRate!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["DailyTokenQuota"] as? Int64 {
            self.dailyTokenQuota = value
        }
        ...
        if let value = dict["LimitRate"] as? Double {
            self.limitRate = value
        }
...
public class CreateApiKeyResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class CustomKeyList : Tea.TeaModel {
        ...
        public var customKeyList: [CreateApiKeyResponseBody.Data.CustomKeyList]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.customKeyList != nil {
                var tmp : [Any] = []
                for k in self.customKeyList! {
                    tmp.append(k.toMap())
                }
                map["CustomKeyList"] = tmp
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CustomKeyList"] as? [Any?] {
                var tmp : [CreateApiKeyResponseBody.Data.CustomKeyList] = []
                for v in value {
                    if v != nil {
                        var model = CreateApiKeyResponseBody.Data.CustomKeyList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: CreateApiKeyResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = CreateApiKeyResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
...
public class CreateContextDatabaseApiKeyRequest : Tea.TeaModel {
...
public class CreateContextDatabaseApiKeyResponseBody : Tea.TeaModel {
    public class Key : Tea.TeaModel {
        ...
        public var keyDisplaySuffix: String?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.keyDisplaySuffix != nil {
                map["KeyDisplaySuffix"] = self.keyDisplaySuffix!
            }
            if self.keyId != nil {
            ...
            if self.lastUsedAt != nil {
                map["LastUsedAt"] = self.lastUsedAt!
            }
            if self.name != nil {
                map["Name"] = self.name!
            }
            if self.revokedAt != nil {
                map["RevokedAt"] = self.revokedAt!
            }
            if self.status != nil {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["KeyDisplaySuffix"] as? String {
                self.keyDisplaySuffix = value
            }
            ...
            if let value = dict["LastUsedAt"] as? String {
                self.lastUsedAt = value
            }
            if let value = dict["Name"] as? String {
                self.name = value
            }
            if let value = dict["RevokedAt"] as? String {
                self.revokedAt = value
            }
    ...
    public var key: CreateContextDatabaseApiKeyResponseBody.Key?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Key"] as? [String: Any?] {
            var model = CreateContextDatabaseApiKeyResponseBody.Key()
            model.fromMap(value)
            self.key = model
        }
        if let value = dict["RequestId"] as? String {
...
public class CreateContextDatabaseApiKeyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateContextDatabaseApiKeyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateContextDatabaseApiKeyResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateContextDatabaseMemberRequest : Tea.TeaModel {
    public var generateInitialKey: Bool?

    public var initialKeyName: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.generateInitialKey != nil {
            map["GenerateInitialKey"] = self.generateInitialKey!
        }
        if self.initialKeyName != nil {
            map["InitialKeyName"] = self.initialKeyName!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["GenerateInitialKey"] as? Bool {
            self.generateInitialKey = value
        }
        if let value = dict["InitialKeyName"] as? String {
            self.initialKeyName = value
        }
...
public class CreateContextDatabaseMemberResponseBody : Tea.TeaModel {
    public class Member : Tea.TeaModel {
        ...
        public var keys: [CreateContextDatabaseMemberResponseBody.Member.Keys]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Keys"] as? [Any?] {
                var tmp : [CreateContextDatabaseMemberResponseBody.Member.Keys] = []
                for v in value {
                    if v != nil {
                        var model = CreateContextDatabaseMemberResponseBody.Member.Keys()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var member: CreateContextDatabaseMemberResponseBody.Member?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Member"] as? [String: Any?] {
            var model = CreateContextDatabaseMemberResponseBody.Member()
            model.fromMap(value)
            self.member = model
        }
        if let value = dict["RequestId"] as? String {
...
public class CreateContextDatabaseMemberResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateContextDatabaseMemberResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateContextDatabaseMemberResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateContextDatabaseWorkspaceRequest : Tea.TeaModel {
    public var memberName: String?
...
public class CreateContextDatabaseWorkspaceResponseBody : Tea.TeaModel {
    public var apiKey: String?
...
public class CreateContextDatabaseWorkspaceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateContextDatabaseWorkspaceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateContextDatabaseWorkspaceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateMOUsageDetailExportRequest : Tea.TeaModel {
    public var apiKey: String?
...
public class CreateMOUsageDetailExportResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var filters: CreateMOUsageDetailExportResponseBody.Data.Filters?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Filters"] as? [String: Any?] {
                var model = CreateMOUsageDetailExportResponseBody.Data.Filters()
                model.fromMap(value)
                self.filters = model
            }
    ...
    public var data: CreateMOUsageDetailExportResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = CreateMOUsageDetailExportResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class CreateMOUsageDetailExportResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateMOUsageDetailExportResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateMOUsageDetailExportResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateSandboxTemplateRequest : Tea.TeaModel {
...
public class CreateSandboxTemplateResponseBody : Tea.TeaModel {
    public var instanceName: String?
...
public class CreateSandboxTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateSandboxTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateSandboxTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateSkillRequest : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.uploadToken != nil {
            map["UploadToken"] = self.uploadToken!
        }
        if self.workspaceId != nil {
            map["WorkspaceId"] = self.workspaceId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Dbtypes"] as? [String] {
            self.dbtypes = value
        }
        if let value = dict["Description"] as? String {
            self.description_ = value
        ...
        if let value = dict["UploadToken"] as? String {
            self.uploadToken = value
        }
        if let value = dict["WorkspaceId"] as? String {
            self.workspaceId = value
        }
...
public class CreateSkillShrinkRequest : Tea.TeaModel {
    public var contentShrink: String?

    public var dbtypesShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.dbtypesShrink != nil {
            map["Dbtypes"] = self.dbtypesShrink!
        }
        if self.description_ != nil {
            map["Description"] = self.description_!
        }
...
public class CreateSkillResponseBody : Tea.TeaModel {
    public class Skill : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.activeVersionId != nil {
                map["ActiveVersionId"] = self.activeVersionId!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["ActiveVersionId"] as? String {
                self.activeVersionId = value
            }
    ...
    public class Version : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.activatedAt != nil {
                map["ActivatedAt"] = self.activatedAt!
            }
            if self.createdAt != nil {
                map["CreatedAt"] = self.createdAt!
            }
            if self.credentialRequired != nil {
                map["CredentialRequired"] = self.credentialRequired!
            }
            if self.id != nil {
                map["Id"] = self.id!
            }
            ...
            if self.revokeReason != nil {
                map["RevokeReason"] = self.revokeReason!
            }
            if self.revokedAt != nil {
                map["RevokedAt"] = self.revokedAt!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["ActivatedAt"] as? String {
                self.activatedAt = value
            }
            if let value = dict["CreatedAt"] as? String {
                self.createdAt = value
            }
            if let value = dict["CredentialRequired"] as? Bool {
                self.credentialRequired = value
            }
            if let value = dict["Id"] as? String {
                self.id = value
            }
            if let value = dict["PackageSize"] as? Int64 {
                self.packageSize = value
            }
            if let value = dict["RevokeReason"] as? String {
                self.revokeReason = value
            }
            if let value = dict["RevokedAt"] as? String {
                self.revokedAt = value
            }
    ...
    public var skill: CreateSkillResponseBody.Skill?

    public var skillType: String?

    public var version: CreateSkillResponseBody.Version?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.catalogRevision != nil {
            map["CatalogRevision"] = self.catalogRevision!
        }
        if self.content != nil {
            map["Content"] = self.content!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["CatalogRevision"] as? Int64 {
            self.catalogRevision = value
        }
        if let value = dict["Content"] as? [String: Any] {
            self.content = value
        }
        ...
        if let value = dict["Skill"] as? [String: Any?] {
            var model = CreateSkillResponseBody.Skill()
            model.fromMap(value)
            self.skill = model
        }
        if let value = dict["SkillType"] as? String {
        ...
        if let value = dict["Version"] as? [String: Any?] {
            var model = CreateSkillResponseBody.Version()
            model.fromMap(value)
            self.version = model
        }
    }
...
public class DeleteAppInstanceRequest : Tea.TeaModel {
    ...
    public var deleteDBInstance: Bool?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.deleteDBInstance != nil {
            map["DeleteDBInstance"] = self.deleteDBInstance!
        }
        if self.instanceName != nil {
            map["InstanceName"] = self.instanceName!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["DeleteDBInstance"] as? Bool {
            self.deleteDBInstance = value
        }
        if let value = dict["InstanceName"] as? String {
            self.instanceName = value
        }
...
public class DeleteContextDatabaseMemberRequest : Tea.TeaModel {
    public var memberId: String?
...
public class DeleteContextDatabaseMemberResponseBody : Tea.TeaModel {
    public class Keys : Tea.TeaModel {
        public var createdAt: String?
    ...
    public var keys: [DeleteContextDatabaseMemberResponseBody.Keys]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Keys"] as? [Any?] {
            var tmp : [DeleteContextDatabaseMemberResponseBody.Keys] = []
            for v in value {
                if v != nil {
                    var model = DeleteContextDatabaseMemberResponseBody.Keys()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DeleteContextDatabaseMemberResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteContextDatabaseMemberResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteContextDatabaseMemberResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteContextDatabaseWorkspaceRequest : Tea.TeaModel {
    public var workspaceId: String?
...
public class DeleteContextDatabaseWorkspaceResponseBody : Tea.TeaModel {
    public var createdAt: String?
...
public class DeleteContextDatabaseWorkspaceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteContextDatabaseWorkspaceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteContextDatabaseWorkspaceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteSandboxTemplateRequest : Tea.TeaModel {
    public var instanceName: String?
...
public class DeleteSandboxTemplateResponseBody : Tea.TeaModel {
    public var instanceName: String?
...
public class DeleteSandboxTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteSandboxTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteSandboxTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeAppInstanceAttributeResponseBody : Tea.TeaModel {
    ...
    public class UploadKeyList : Tea.TeaModel {
        public var isSystemKey: Bool?

        public var remark: String?

        public var slsStorageBytes: Int64?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.isSystemKey != nil {
                map["IsSystemKey"] = self.isSystemKey!
            }
            if self.remark != nil {
                map["Remark"] = self.remark!
            }
            if self.slsStorageBytes != nil {
                map["SlsStorageBytes"] = self.slsStorageBytes!
            }
            if self.status != nil {
                map["Status"] = self.status!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["IsSystemKey"] as? Bool {
                self.isSystemKey = value
            }
            if let value = dict["Remark"] as? String {
                self.remark = value
            }
            if let value = dict["SlsStorageBytes"] as? Int64 {
                self.slsStorageBytes = value
            }
            if let value = dict["Status"] as? String {
                self.status = value
            }
    ...
    public var branchingEnabled: String?
    ...
    public var instanceLatestVersion: String?
    ...
    public var minorVersionDetail: String?
    ...
    public var retentionHours: String?

    public var sqlExtendMoInstanceId: String?

    public var status: String?

    public var uploadKey: String?

    public var uploadKeyList: [DescribeAppInstanceAttributeResponseBody.UploadKeyList]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.branchingEnabled != nil {
            map["BranchingEnabled"] = self.branchingEnabled!
        }
        if self.components != nil {
            var tmp : [Any] = []
            for k in self.components! {
        ...
        if self.instanceLatestVersion != nil {
            map["InstanceLatestVersion"] = self.instanceLatestVersion!
        }
        ...
        if self.minorVersionDetail != nil {
            map["MinorVersionDetail"] = self.minorVersionDetail!
        }
        ...
        if self.retentionHours != nil {
            map["RetentionHours"] = self.retentionHours!
        }
        if self.sqlExtendMoInstanceId != nil {
            map["SqlExtendMoInstanceId"] = self.sqlExtendMoInstanceId!
        }
        if self.status != nil {
            map["Status"] = self.status!
        }
        ...
        if self.uploadKeyList != nil {
            var tmp : [Any] = []
            for k in self.uploadKeyList! {
                tmp.append(k.toMap())
            }
            map["UploadKeyList"] = tmp
        }
        if self.vSwitchId != nil {
            map["VSwitchId"] = self.vSwitchId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["BranchingEnabled"] as? String {
            self.branchingEnabled = value
        }
        if let value = dict["Components"] as? [Any?] {
        ...
        if let value = dict["InstanceLatestVersion"] as? String {
            self.instanceLatestVersion = value
        }
        ...
        if let value = dict["MinorVersionDetail"] as? String {
            self.minorVersionDetail = value
        }
        ...
        if let value = dict["RetentionHours"] as? String {
            self.retentionHours = value
        }
        if let value = dict["SqlExtendMoInstanceId"] as? String {
            self.sqlExtendMoInstanceId = value
        }
        if let value = dict["Status"] as? String {
            self.status = value
        }
        ...
        if let value = dict["UploadKeyList"] as? [Any?] {
            var tmp : [DescribeAppInstanceAttributeResponseBody.UploadKeyList] = []
            for v in value {
                if v != nil {
                    var model = DescribeAppInstanceAttributeResponseBody.UploadKeyList()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DescribeCommonSandboxTemplatesRequest : Tea.TeaModel {
...
public class DescribeCommonSandboxTemplatesResponseBody : Tea.TeaModel {
    public class Templates : Tea.TeaModel {
        public var defaultCpu: String?

        public var defaultMemory: String?

        public var defaultReplicas: Int64?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.defaultReplicas != nil {
                map["DefaultReplicas"] = self.defaultReplicas!
            }
            if self.description_ != nil {
                map["Description"] = self.description_!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["DefaultReplicas"] as? Int64 {
                self.defaultReplicas = value
            }
            if let value = dict["Description"] as? String {
                self.description_ = value
            }
    ...
    public var templates: [DescribeCommonSandboxTemplatesResponseBody.Templates]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Templates"] as? [Any?] {
            var tmp : [DescribeCommonSandboxTemplatesResponseBody.Templates] = []
            for v in value {
                if v != nil {
                    var model = DescribeCommonSandboxTemplatesResponseBody.Templates()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DescribeCommonSandboxTemplatesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeCommonSandboxTemplatesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeCommonSandboxTemplatesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeInstanceAuthInfoResponseBody : Tea.TeaModel {
    public class ApiKeys : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.e2bApiKey != nil {
                map["E2bApiKey"] = self.e2bApiKey!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["E2bApiKey"] as? String {
                self.e2bApiKey = value
            }
...
public class DescribeInstanceIpWhitelistResponseBody : Tea.TeaModel {
    public class DbIpWhiteListGroups : Tea.TeaModel {
        public var groupName: String?
    ...
    public var dbIpWhiteListGroups: [DescribeInstanceIpWhitelistResponseBody.DbIpWhiteListGroups]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.dbIpWhiteListGroups != nil {
            var tmp : [Any] = []
            for k in self.dbIpWhiteListGroups! {
                tmp.append(k.toMap())
            }
            map["DbIpWhiteListGroups"] = tmp
        }
        if self.instanceName != nil {
            map["InstanceName"] = self.instanceName!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["DbIpWhiteListGroups"] as? [Any?] {
            var tmp : [DescribeInstanceIpWhitelistResponseBody.DbIpWhiteListGroups] = []
            for v in value {
                if v != nil {
                    var model = DescribeInstanceIpWhitelistResponseBody.DbIpWhiteListGroups()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DescribeMOTokenUsageDetailResponseBody : Tea.TeaModel {
    public class Records : Tea.TeaModel {
        public var cacheTokens: Double?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.cacheTokens != nil {
                map["CacheTokens"] = self.cacheTokens!
            }
            if self.consumerName != nil {
                map["ConsumerName"] = self.consumerName!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["CacheTokens"] as? Double {
                self.cacheTokens = value
            }
            if let value = dict["ConsumerName"] as? String {
                self.consumerName = value
            }
    ...
    public var records: [DescribeMOTokenUsageDetailResponseBody.Records]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Records"] as? [Any?] {
            var tmp : [DescribeMOTokenUsageDetailResponseBody.Records] = []
            for v in value {
                if v != nil {
                    var model = DescribeMOTokenUsageDetailResponseBody.Records()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DescribeMOTokenUsageDetailResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeMOTokenUsageDetailResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeMOTokenUsageDetailResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeMOTokenUsageSummaryRequest : Tea.TeaModel {
    public var apiKey: String?
...
public class DescribeMOTokenUsageSummaryResponseBody : Tea.TeaModel {
    public class Records : Tea.TeaModel {
        public var apiKey: String?
    ...
    public var records: [DescribeMOTokenUsageSummaryResponseBody.Records]?

    public var requestId: String?

    public var success: Bool?

    public var summary: DescribeMOTokenUsageSummaryResponseBody.Summary?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Records"] as? [Any?] {
            var tmp : [DescribeMOTokenUsageSummaryResponseBody.Records] = []
            for v in value {
                if v != nil {
                    var model = DescribeMOTokenUsageSummaryResponseBody.Records()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
        ...
        if let value = dict["Summary"] as? [String: Any?] {
            var model = DescribeMOTokenUsageSummaryResponseBody.Summary()
            model.fromMap(value)
            self.summary = model
        }
        if let value = dict["UsageType"] as? String {
...
public class DescribeMOTokenUsageSummaryResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeMOTokenUsageSummaryResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeMOTokenUsageSummaryResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeMOUsageDetailExportRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class DescribeMOUsageDetailExportResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class Filters : Tea.TeaModel {
            public var apiKey: String?
        ...
        public var filters: DescribeMOUsageDetailExportResponseBody.Data.Filters?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Filters"] as? [String: Any?] {
                var model = DescribeMOUsageDetailExportResponseBody.Data.Filters()
                model.fromMap(value)
                self.filters = model
            }
            if let value = dict["Format"] as? String {
    ...
    public var data: DescribeMOUsageDetailExportResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = DescribeMOUsageDetailExportResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class DescribeMOUsageDetailExportResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeMOUsageDetailExportResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeMOUsageDetailExportResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeModelOperatorResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class DailyUsage : Tea.TeaModel {
            public var date: String?
        ...
        public class KeyUsageList : Tea.TeaModel {
            public class DailyUsage : Tea.TeaModel {
                public var date: String?
            ...
            public var dailyUsage: [DescribeModelOperatorResponseBody.Data.KeyUsageList.DailyUsage]?
            ...
            public var keyUsed: String?

            public var usedQuota: String?
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.dailyUsage != nil {
                    var tmp : [Any] = []
                    for k in self.dailyUsage! {
                        tmp.append(k.toMap())
                    }
                    map["DailyUsage"] = tmp
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["DailyUsage"] as? [Any?] {
                    var tmp : [DescribeModelOperatorResponseBody.Data.KeyUsageList.DailyUsage] = []
                    for v in value {
                        if v != nil {
                            var model = DescribeModelOperatorResponseBody.Data.KeyUsageList.DailyUsage()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
                ...
                if let value = dict["KeyUsed"] as? String {
                    self.keyUsed = value
                }
                if let value = dict["UsedQuota"] as? String {
        ...
        public var dailyUsage: [DescribeModelOperatorResponseBody.Data.DailyUsage]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.keyUsageList != nil {
                var tmp : [Any] = []
                for k in self.keyUsageList! {
                    tmp.append(k.toMap())
                }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["DailyUsage"] as? [Any?] {
                var tmp : [DescribeModelOperatorResponseBody.Data.DailyUsage] = []
                for v in value {
                    if v != nil {
                        var model = DescribeModelOperatorResponseBody.Data.DailyUsage()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
            ...
            if let value = dict["KeyUsageList"] as? [Any?] {
                var tmp : [DescribeModelOperatorResponseBody.Data.KeyUsageList] = []
                for v in value {
                    if v != nil {
                        var model = DescribeModelOperatorResponseBody.Data.KeyUsageList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: DescribeModelOperatorResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = DescribeModelOperatorResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class DescribeModelOperatorResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeModelOperatorResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeModelOperatorResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeMonitorDataShrinkRequest : Tea.TeaModel {
    public var apiKeyNameShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.apiKeyNameShrink != nil {
            map["ApiKeyName"] = self.apiKeyNameShrink!
        }
        if self.endTime != nil {
            map["EndTime"] = self.endTime!
        }
...
public class DescribeMonitorDataResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var value: [DescribeMonitorDataResponseBody.Data.Value]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Value"] as? [Any?] {
                var tmp : [DescribeMonitorDataResponseBody.Data.Value] = []
                for v in value {
                    if v != nil {
                        var model = DescribeMonitorDataResponseBody.Data.Value()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: [DescribeMonitorDataResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [Any?] {
            var tmp : [DescribeMonitorDataResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = DescribeMonitorDataResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class DescribeWhitelistIpsRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class DescribeWhitelistIpsResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var domain: String?
    ...
    public var data: DescribeWhitelistIpsResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = DescribeWhitelistIpsResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class DescribeWhitelistIpsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeWhitelistIpsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeWhitelistIpsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class EnableAgentRuntimeResponseBody : Tea.TeaModel {
    public var branchName: String?
...
public class EnableAgentRuntimeResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: EnableAgentRuntimeResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = EnableAgentRuntimeResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetConversationsResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["IsRunning"] as? Bool {
...
public class GetMessagesResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public class MessageFiles : Tea.TeaModel {
            public var id: String?
        ...
        public var messageFiles: [GetMessagesResponseBody.Data.MessageFiles]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.messageFiles != nil {
                var tmp : [Any] = []
                for k in self.messageFiles! {
                    tmp.append(k.toMap())
                }
                map["MessageFiles"] = tmp
            }
            if self.query != nil {
                map["Query"] = self.query!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["MessageFiles"] as? [Any?] {
                var tmp : [GetMessagesResponseBody.Data.MessageFiles] = []
                for v in value {
                    if v != nil {
                        var model = GetMessagesResponseBody.Data.MessageFiles()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class GetModelOperatorOrderResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var hasValidOrder: Bool?

        public var instanceList: [GetModelOperatorOrderResponseBody.Data.InstanceList]?
        ...
        public override func toMap() -> [String : Any] {
            var map = super.toMap()
            if self.hasValidOrder != nil {
                map["HasValidOrder"] = self.hasValidOrder!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["HasValidOrder"] as? Bool {
                self.hasValidOrder = value
            }
            if let value = dict["InstanceList"] as? [Any?] {
                var tmp : [GetModelOperatorOrderResponseBody.Data.InstanceList] = []
                for v in value {
                    if v != nil {
                        var model = GetModelOperatorOrderResponseBody.Data.InstanceList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: GetModelOperatorOrderResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = GetModelOperatorOrderResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class GetModelOperatorOrderResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetModelOperatorOrderResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetModelOperatorOrderResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetSkillResponseBody : Tea.TeaModel {
    public class Versions : Tea.TeaModel {
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.skillMarkdown != nil {
                map["SkillMarkdown"] = self.skillMarkdown!
            }
            if self.status != nil {
                map["Status"] = self.status!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["SkillMarkdown"] as? String {
                self.skillMarkdown = value
            }
            if let value = dict["Status"] as? String {
                self.status = value
            }
    ...
    public var versions: [GetSkillResponseBody.Versions]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Versions"] as? [Any?] {
            var tmp : [GetSkillResponseBody.Versions] = []
            for v in value {
                if v != nil {
                    var model = GetSkillResponseBody.Versions()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListApiKeysResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class CustomKeyList : Tea.TeaModel {
            ...
            public override func toMap() -> [String : Any] {
                ...
                if self.isRateLimited != nil {
                    map["IsRateLimited"] = self.isRateLimited!
                }
                if self.keyName != nil {
                    map["KeyName"] = self.keyName!
                }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["IsRateLimited"] as? Bool {
        ...
        public var customKeyList: [ListApiKeysResponseBody.Data.CustomKeyList]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CustomKeyList"] as? [Any?] {
                var tmp : [ListApiKeysResponseBody.Data.CustomKeyList] = []
                for v in value {
                    if v != nil {
                        var model = ListApiKeysResponseBody.Data.CustomKeyList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: ListApiKeysResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = ListApiKeysResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class ListContextDatabaseApiKeysRequest : Tea.TeaModel {
    public var maxResults: Int32?
...
public class ListContextDatabaseApiKeysResponseBody : Tea.TeaModel {
    public class Keys : Tea.TeaModel {
        public var createdAt: String?
    ...
    public var keys: [ListContextDatabaseApiKeysResponseBody.Keys]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Keys"] as? [Any?] {
            var tmp : [ListContextDatabaseApiKeysResponseBody.Keys] = []
            for v in value {
                if v != nil {
                    var model = ListContextDatabaseApiKeysResponseBody.Keys()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListContextDatabaseApiKeysResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListContextDatabaseApiKeysResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListContextDatabaseApiKeysResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListContextDatabaseMembersRequest : Tea.TeaModel {
    public var maxResults: Int32?
...
public class ListContextDatabaseMembersResponseBody : Tea.TeaModel {
    public class Members : Tea.TeaModel {
        ...
        public var keys: [ListContextDatabaseMembersResponseBody.Members.Keys]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Keys"] as? [Any?] {
                var tmp : [ListContextDatabaseMembersResponseBody.Members.Keys] = []
                for v in value {
                    if v != nil {
                        var model = ListContextDatabaseMembersResponseBody.Members.Keys()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var members: [ListContextDatabaseMembersResponseBody.Members]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Members"] as? [Any?] {
            var tmp : [ListContextDatabaseMembersResponseBody.Members] = []
            for v in value {
                if v != nil {
                    var model = ListContextDatabaseMembersResponseBody.Members()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListContextDatabaseMembersResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListContextDatabaseMembersResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListContextDatabaseMembersResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListContextDatabaseWorkspacesRequest : Tea.TeaModel {
    public var maxResults: Int32?
...
public class ListContextDatabaseWorkspacesResponseBody : Tea.TeaModel {
    ...
    public var workspaces: [ListContextDatabaseWorkspacesResponseBody.Workspaces]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Workspaces"] as? [Any?] {
            var tmp : [ListContextDatabaseWorkspacesResponseBody.Workspaces] = []
            for v in value {
                if v != nil {
                    var model = ListContextDatabaseWorkspacesResponseBody.Workspaces()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListContextDatabaseWorkspacesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListContextDatabaseWorkspacesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListContextDatabaseWorkspacesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListSkillRequest : Tea.TeaModel {
    public var language: String?
...
public class ListSkillResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var activeVersionId: String?
    ...
    public var data: [ListSkillResponseBody.Data]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [Any?] {
            var tmp : [ListSkillResponseBody.Data] = []
            for v in value {
                if v != nil {
                    var model = ListSkillResponseBody.Data()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListSkillResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListSkillResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListSkillResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ModifyAppInstanceRequest : Tea.TeaModel {
    public class Components : Tea.TeaModel {
        public var status: String?
    ...
    public var components: [ModifyAppInstanceRequest.Components]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Components"] as? [Any?] {
            var tmp : [ModifyAppInstanceRequest.Components] = []
            for v in value {
                if v != nil {
                    var model = ModifyAppInstanceRequest.Components()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ModifyAppInstanceShrinkRequest : Tea.TeaModel {
    public var branchName: String?
...
public class ModifyAppInstanceResponseBody : Tea.TeaModel {
    public class Components : Tea.TeaModel {
        public var status: String?
    ...
    public var components: [ModifyAppInstanceResponseBody.Components]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Components"] as? [Any?] {
            var tmp : [ModifyAppInstanceResponseBody.Components] = []
            for v in value {
                if v != nil {
                    var model = ModifyAppInstanceResponseBody.Components()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ModifyAppInstanceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ModifyAppInstanceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ModifyAppInstanceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ModifySandboxTemplateRequest : Tea.TeaModel {
    public var defaultCpu: String?
...
public class ModifySandboxTemplateResponseBody : Tea.TeaModel {
    public var instanceName: String?
...
public class ModifySandboxTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ModifySandboxTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ModifySandboxTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ModifyWhitelistIpsRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class ModifyWhitelistIpsResponseBody : Tea.TeaModel {
    public var message: String?
...
public class ModifyWhitelistIpsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ModifyWhitelistIpsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ModifyWhitelistIpsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class RenameApiKeyRequest : Tea.TeaModel {
    public var apiKey: String?
...
public class RenameApiKeyResponseBody : Tea.TeaModel {
    public var message: String?
...
public class RenameApiKeyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RenameApiKeyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RenameApiKeyResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ResetApiKeyResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var customKeyList: [ResetApiKeyResponseBody.Data.CustomKeyList]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["CustomKeyList"] as? [Any?] {
                var tmp : [ResetApiKeyResponseBody.Data.CustomKeyList] = []
                for v in value {
                    if v != nil {
                        var model = ResetApiKeyResponseBody.Data.CustomKeyList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: ResetApiKeyResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = ResetApiKeyResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class ResetInstanceKeysRequest : Tea.TeaModel {
    public var instanceName: String?
...
public class ResetInstanceKeysResponseBody : Tea.TeaModel {
    public var instanceName: String?
...
public class ResetInstanceKeysResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ResetInstanceKeysResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ResetInstanceKeysResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class RevokeContextDatabaseApiKeyRequest : Tea.TeaModel {
    public var keyId: Int64?
...
public class RevokeContextDatabaseApiKeyResponseBody : Tea.TeaModel {
    public var createdAt: String?
...
public class RevokeContextDatabaseApiKeyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: RevokeContextDatabaseApiKeyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = RevokeContextDatabaseApiKeyResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateApiKeyQuotaRequest : Tea.TeaModel {
    public class Keys : Tea.TeaModel {
        public var apiKey: String?
    ...
    public var keys: [UpdateApiKeyQuotaRequest.Keys]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Keys"] as? [Any?] {
            var tmp : [UpdateApiKeyQuotaRequest.Keys] = []
            for v in value {
                if v != nil {
                    var model = UpdateApiKeyQuotaRequest.Keys()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdateApiKeyQuotaShrinkRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class UpdateApiKeyQuotaResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class CustomKeyList : Tea.TeaModel {
            public var apiKey: String?
        ...
        public var customKeyList: [UpdateApiKeyQuotaResponseBody.Data.CustomKeyList]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["CustomKeyList"] as? [Any?] {
                var tmp : [UpdateApiKeyQuotaResponseBody.Data.CustomKeyList] = []
                for v in value {
                    if v != nil {
                        var model = UpdateApiKeyQuotaResponseBody.Data.CustomKeyList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var data: UpdateApiKeyQuotaResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = UpdateApiKeyQuotaResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class UpdateApiKeyQuotaResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateApiKeyQuotaResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateApiKeyQuotaResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateContextDatabaseApiKeyRequest : Tea.TeaModel {
    public var description_: String?
...
public class UpdateContextDatabaseApiKeyResponseBody : Tea.TeaModel {
    public var createdAt: String?
...
public class UpdateContextDatabaseApiKeyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateContextDatabaseApiKeyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateContextDatabaseApiKeyResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateContextDatabaseMemberRequest : Tea.TeaModel {
    public var memberId: String?
...
public class UpdateContextDatabaseMemberResponseBody : Tea.TeaModel {
    public class Keys : Tea.TeaModel {
        public var createdAt: String?
    ...
    public var keys: [UpdateContextDatabaseMemberResponseBody.Keys]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Keys"] as? [Any?] {
            var tmp : [UpdateContextDatabaseMemberResponseBody.Keys] = []
            for v in value {
                if v != nil {
                    var model = UpdateContextDatabaseMemberResponseBody.Keys()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class UpdateContextDatabaseMemberResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateContextDatabaseMemberResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateContextDatabaseMemberResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateContextDatabaseWorkspaceRequest : Tea.TeaModel {
    public var workspaceId: String?
...
public class UpdateContextDatabaseWorkspaceResponseBody : Tea.TeaModel {
    public var createdAt: String?
...
public class UpdateContextDatabaseWorkspaceResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateContextDatabaseWorkspaceResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateContextDatabaseWorkspaceResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateSkillShrinkRequest : Tea.TeaModel {
    public var contentShrink: String?
