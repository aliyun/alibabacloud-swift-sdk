Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDyvmsapiIntl20211015"
  spec.version      = "2.1.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Dyvmsapi-intl (20211015) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/dyvmsapi-intl-20211015" 
