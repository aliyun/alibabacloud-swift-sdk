...
```ruby
pod 'AlibabacloudFt20210101', '~> 1.0.15'
```
...
```ogdl
github "alibabacloud-sdk-swift/ft-20210101" "1.0.15"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ft-20210101.git", from: "1.0.15")
]
```
