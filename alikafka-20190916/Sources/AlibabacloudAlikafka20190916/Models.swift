...
public class AddUserDefinedSgRequest : Tea.TeaModel {
    public var instanceId: String?

    public var regionId: String?

    public var sgIdList: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.sgIdList != nil {
            map["SgIdList"] = self.sgIdList!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["SgIdList"] as? [String] {
            self.sgIdList = value
        }
    }
}

public class AddUserDefinedSgShrinkRequest : Tea.TeaModel {
    public var instanceId: String?

    public var regionId: String?

    public var sgIdListShrink: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.sgIdListShrink != nil {
            map["SgIdList"] = self.sgIdListShrink!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["SgIdList"] as? String {
            self.sgIdListShrink = value
        }
    }
}

public class AddUserDefinedSgResponseBody : Tea.TeaModel {
...
public class AddUserDefinedSgResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AddUserDefinedSgResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AddUserDefinedSgResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class BatchDeleteTopicsRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class BatchDeleteTopicsShrinkRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class BatchDeleteTopicsResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public class Results : Tea.TeaModel {
            public class TopicDeleteResultItemVO : Tea.TeaModel {
                public var code: Int32?
            ...
            public var topicDeleteResultItemVO: [BatchDeleteTopicsResponseBody.Data.Results.TopicDeleteResultItemVO]?
            ...
            public override func toMap() -> [String : Any] {
                var map = super.toMap()
                if self.topicDeleteResultItemVO != nil {
                    var tmp : [Any] = []
                    for k in self.topicDeleteResultItemVO! {
                        tmp.append(k.toMap())
                    }
                    map["TopicDeleteResultItemVO"] = tmp
                }
                return map
            }
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                guard let dict else { return }
                if let value = dict["TopicDeleteResultItemVO"] as? [Any?] {
                    var tmp : [BatchDeleteTopicsResponseBody.Data.Results.TopicDeleteResultItemVO] = []
                    for v in value {
                        if v != nil {
                            var model = BatchDeleteTopicsResponseBody.Data.Results.TopicDeleteResultItemVO()
                            if v != nil {
                    ...
                    self.topicDeleteResultItemVO = tmp
                }
            }
        }
        public var failedCount: Int32?

        public var results: BatchDeleteTopicsResponseBody.Data.Results?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Results"] as? [String: Any?] {
                var model = BatchDeleteTopicsResponseBody.Data.Results()
                model.fromMap(value)
                self.results = model
            }
    ...
    public var data: BatchDeleteTopicsResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = BatchDeleteTopicsResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class BatchDeleteTopicsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: BatchDeleteTopicsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = BatchDeleteTopicsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteUserDefinedSgRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class DeleteUserDefinedSgShrinkRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class DeleteUserDefinedSgResponseBody : Tea.TeaModel {
    public var code: Int32?
...
public class DeleteUserDefinedSgResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteUserDefinedSgResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteUserDefinedSgResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ModifyUserDefinedSgRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class ModifyUserDefinedSgShrinkRequest : Tea.TeaModel {
    public var instanceId: String?
...
public class ModifyUserDefinedSgResponseBody : Tea.TeaModel {
    public var code: Int32?
...
public class ModifyUserDefinedSgResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ModifyUserDefinedSgResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ModifyUserDefinedSgResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
