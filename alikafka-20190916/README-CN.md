...
```ruby
pod 'AlibabacloudAlikafka20190916', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/alikafka-20190916" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/alikafka-20190916.git", from: "1.0.1")
]
```
