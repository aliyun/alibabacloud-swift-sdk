Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEHPC20230701"
  spec.version      = "3.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Elastic High Performance Computing (20230701) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/ehpc-20230701" 
