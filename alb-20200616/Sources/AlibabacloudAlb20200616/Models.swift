...
public class AddServersToServerGroupRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Servers") {
            self.servers = dict["Servers"] as! [AddServersToServerGroupRequest.Servers]
        }
    }
}
...
public class CreateListenerRequest : Tea.TeaModel {
        ...
        public class ForwardGroupConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("ServerGroupTuples") {
                    self.serverGroupTuples = dict["ServerGroupTuples"] as! [CreateListenerRequest.DefaultActions.ForwardGroupConfig.ServerGroupTuples]
                }
            }
        }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("CaCertificates") {
            self.caCertificates = dict["CaCertificates"] as! [CreateListenerRequest.CaCertificates]
        }
        ...
        if dict.keys.contains("DefaultActions") {
            self.defaultActions = dict["DefaultActions"] as! [CreateListenerRequest.DefaultActions]
        }
        if dict.keys.contains("DryRun") {
            self.dryRun = dict["DryRun"] as! Bool
        }
...
public class CreateLoadBalancerRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("ZoneMappings") {
            self.zoneMappings = dict["ZoneMappings"] as! [CreateLoadBalancerRequest.ZoneMappings]
        }
    }
}
...
public class CreateRuleRequest : Tea.TeaModel {
    public class RuleActions : Tea.TeaModel {
        ...
        public class ForwardGroupConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                ...
                if dict.keys.contains("ServerGroupTuples") {
                    self.serverGroupTuples = dict["ServerGroupTuples"] as! [CreateRuleRequest.RuleActions.ForwardGroupConfig.ServerGroupTuples]
                }
            }
        }
        ...
        public class TrafficMirrorConfig : Tea.TeaModel {
            public class MirrorGroupConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("ServerGroupTuples") {
                        self.serverGroupTuples = dict["ServerGroupTuples"] as! [CreateRuleRequest.RuleActions.TrafficMirrorConfig.MirrorGroupConfig.ServerGroupTuples]
                    }
                }
            }
    ...
    public class RuleConditions : Tea.TeaModel {
        public class CookieConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("Values") {
                    self.values = dict["Values"] as! [CreateRuleRequest.RuleConditions.CookieConfig.Values]
                }
            }
        }
        ...
        public class QueryStringConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("Values") {
                    self.values = dict["Values"] as! [CreateRuleRequest.RuleConditions.QueryStringConfig.Values]
                }
            }
        }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("RuleActions") {
            self.ruleActions = dict["RuleActions"] as! [CreateRuleRequest.RuleActions]
        }
        if dict.keys.contains("RuleConditions") {
            self.ruleConditions = dict["RuleConditions"] as! [CreateRuleRequest.RuleConditions]
        }
...
public class CreateRulesRequest : Tea.TeaModel {
    public class Rules : Tea.TeaModel {
        public class RuleActions : Tea.TeaModel {
            ...
            public class ForwardGroupConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    ...
                    if dict.keys.contains("ServerGroupTuples") {
                        self.serverGroupTuples = dict["ServerGroupTuples"] as! [CreateRulesRequest.Rules.RuleActions.ForwardGroupConfig.ServerGroupTuples]
                    }
                }
            }
            public class InsertHeaderConfig : Tea.TeaModel {
            ...
            public class TrafficMirrorConfig : Tea.TeaModel {
                public class MirrorGroupConfig : Tea.TeaModel {
                    ...
                    public override func fromMap(_ dict: [String: Any]) -> Void {
                        if dict.keys.contains("ServerGroupTuples") {
                            self.serverGroupTuples = dict["ServerGroupTuples"] as! [CreateRulesRequest.Rules.RuleActions.TrafficMirrorConfig.MirrorGroupConfig.ServerGroupTuples]
                        }
                    }
                }
        ...
        public class RuleConditions : Tea.TeaModel {
            public class CookieConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Values") {
                        self.values = dict["Values"] as! [CreateRulesRequest.Rules.RuleConditions.CookieConfig.Values]
                    }
                }
            }
            public class HeaderConfig : Tea.TeaModel {
            ...
            public class QueryStringConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Values") {
                        self.values = dict["Values"] as! [CreateRulesRequest.Rules.RuleConditions.QueryStringConfig.Values]
                    }
                }
            }
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("RuleActions") {
                self.ruleActions = dict["RuleActions"] as! [CreateRulesRequest.Rules.RuleActions]
            }
            if dict.keys.contains("RuleConditions") {
                self.ruleConditions = dict["RuleConditions"] as! [CreateRulesRequest.Rules.RuleConditions]
            }
            if dict.keys.contains("RuleName") {
                self.ruleName = dict["RuleName"] as! String
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Rules") {
            self.rules = dict["Rules"] as! [CreateRulesRequest.Rules]
        }
    }
}
...
public class CreateRulesResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("RuleIds") {
            self.ruleIds = dict["RuleIds"] as! [CreateRulesResponseBody.RuleIds]
        }
    }
}
...
public class DissociateAdditionalCertificatesFromListenerRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("Certificates") {
            self.certificates = dict["Certificates"] as! [DissociateAdditionalCertificatesFromListenerRequest.Certificates]
        }
        if dict.keys.contains("ClientToken") {
            self.clientToken = dict["ClientToken"] as! String
        }
...
public class GetListenerAttributeResponseBody : Tea.TeaModel {
    public class AclConfig : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            if dict.keys.contains("AclRelations") {
                self.aclRelations = dict["AclRelations"] as! [GetListenerAttributeResponseBody.AclConfig.AclRelations]
            }
            if dict.keys.contains("AclType") {
                self.aclType = dict["AclType"] as! String
            }
    ...
    public class DefaultActions : Tea.TeaModel {
        public class ForwardGroupConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("ServerGroupTuples") {
                    self.serverGroupTuples = dict["ServerGroupTuples"] as! [GetListenerAttributeResponseBody.DefaultActions.ForwardGroupConfig.ServerGroupTuples]
                }
            }
        }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Certificates") {
            self.certificates = dict["Certificates"] as! [GetListenerAttributeResponseBody.Certificates]
        }
        if dict.keys.contains("DefaultActions") {
            self.defaultActions = dict["DefaultActions"] as! [GetListenerAttributeResponseBody.DefaultActions]
        }
        if dict.keys.contains("GzipEnabled") {
            self.gzipEnabled = dict["GzipEnabled"] as! Bool
        }
...
public class GetListenerHealthStatusResponseBody : Tea.TeaModel {
    public class ListenerHealthStatus : Tea.TeaModel {
        public class ServerGroupInfos : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                ...
                if dict.keys.contains("NonNormalServers") {
                    self.nonNormalServers = dict["NonNormalServers"] as! [GetListenerHealthStatusResponseBody.ListenerHealthStatus.ServerGroupInfos.NonNormalServers]
                }
                if dict.keys.contains("ServerGroupId") {
                    self.serverGroupId = dict["ServerGroupId"] as! String
                }
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("ServerGroupInfos") {
                self.serverGroupInfos = dict["ServerGroupInfos"] as! [GetListenerHealthStatusResponseBody.ListenerHealthStatus.ServerGroupInfos]
            }
        }
    }
    public class RuleHealthStatus : Tea.TeaModel {
        public class ServerGroupInfos : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                ...
                if dict.keys.contains("NonNormalServers") {
                    self.nonNormalServers = dict["NonNormalServers"] as! [GetListenerHealthStatusResponseBody.RuleHealthStatus.ServerGroupInfos.NonNormalServers]
                }
                if dict.keys.contains("ServerGroupId") {
                    self.serverGroupId = dict["ServerGroupId"] as! String
                }
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("ServerGroupInfos") {
                self.serverGroupInfos = dict["ServerGroupInfos"] as! [GetListenerHealthStatusResponseBody.RuleHealthStatus.ServerGroupInfos]
            }
        }
    }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("ListenerHealthStatus") {
            self.listenerHealthStatus = dict["ListenerHealthStatus"] as! [GetListenerHealthStatusResponseBody.ListenerHealthStatus]
        }
        if dict.keys.contains("NextToken") {
            self.nextToken = dict["NextToken"] as! String
        }
        ...
        if dict.keys.contains("RuleHealthStatus") {
            self.ruleHealthStatus = dict["RuleHealthStatus"] as! [GetListenerHealthStatusResponseBody.RuleHealthStatus]
        }
    }
}
...
public class GetLoadBalancerAttributeResponseBody : Tea.TeaModel {
    ...
    public class ZoneMappings : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            if dict.keys.contains("LoadBalancerAddresses") {
                self.loadBalancerAddresses = dict["LoadBalancerAddresses"] as! [GetLoadBalancerAttributeResponseBody.ZoneMappings.LoadBalancerAddresses]
            }
            if dict.keys.contains("VSwitchId") {
                self.vSwitchId = dict["VSwitchId"] as! String
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("LoadBalancerOperationLocks") {
            self.loadBalancerOperationLocks = dict["LoadBalancerOperationLocks"] as! [GetLoadBalancerAttributeResponseBody.LoadBalancerOperationLocks]
        }
        ...
        if dict.keys.contains("Tags") {
            self.tags = dict["Tags"] as! [GetLoadBalancerAttributeResponseBody.Tags]
        }
        if dict.keys.contains("VpcId") {
            self.vpcId = dict["VpcId"] as! String
        }
        if dict.keys.contains("ZoneMappings") {
            self.zoneMappings = dict["ZoneMappings"] as! [GetLoadBalancerAttributeResponseBody.ZoneMappings]
        }
    }
}
...
public class ListAclEntriesResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("AclEntries") {
            self.aclEntries = dict["AclEntries"] as! [ListAclEntriesResponseBody.AclEntries]
        }
        if dict.keys.contains("MaxResults") {
            self.maxResults = dict["MaxResults"] as! Int32
        }
...
public class ListAclRelationsResponseBody : Tea.TeaModel {
    public class AclRelations : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("RelatedListeners") {
                self.relatedListeners = dict["RelatedListeners"] as! [ListAclRelationsResponseBody.AclRelations.RelatedListeners]
            }
        }
    }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("AclRelations") {
            self.aclRelations = dict["AclRelations"] as! [ListAclRelationsResponseBody.AclRelations]
        }
        if dict.keys.contains("RequestId") {
            self.requestId = dict["RequestId"] as! String
        }
...
public class ListAsynJobsResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("Jobs") {
            self.jobs = dict["Jobs"] as! [ListAsynJobsResponseBody.Jobs]
        }
        if dict.keys.contains("MaxResults") {
            self.maxResults = dict["MaxResults"] as! Int64
        }
...
public class ListHealthCheckTemplatesResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("HealthCheckTemplates") {
            self.healthCheckTemplates = dict["HealthCheckTemplates"] as! [ListHealthCheckTemplatesResponseBody.HealthCheckTemplates]
        }
        if dict.keys.contains("MaxResults") {
            self.maxResults = dict["MaxResults"] as! Int32
        }
    ...
    public class Listeners : Tea.TeaModel {
        public class DefaultActions : Tea.TeaModel {
            public class ForwardGroupConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("ServerGroupTuples") {
                        self.serverGroupTuples = dict["ServerGroupTuples"] as! [ListListenersResponseBody.Listeners.DefaultActions.ForwardGroupConfig.ServerGroupTuples]
                    }
                }
            }
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            if dict.keys.contains("DefaultActions") {
                self.defaultActions = dict["DefaultActions"] as! [ListListenersResponseBody.Listeners.DefaultActions]
            }
            if dict.keys.contains("GzipEnabled") {
                self.gzipEnabled = dict["GzipEnabled"] as! Bool
            }
...
public class ListLoadBalancersRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tag") {
            self.tag = dict["Tag"] as! [ListLoadBalancersRequest.Tag]
        }
...
public class ListLoadBalancersResponseBody : Tea.TeaModel {
    public class LoadBalancers : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("LoadBalancerOperationLocks") {
                self.loadBalancerOperationLocks = dict["LoadBalancerOperationLocks"] as! [ListLoadBalancersResponseBody.LoadBalancers.LoadBalancerOperationLocks]
            }
            if dict.keys.contains("LoadBalancerStatus") {
                self.loadBalancerStatus = dict["LoadBalancerStatus"] as! String
            }
            ...
            if dict.keys.contains("Tags") {
                self.tags = dict["Tags"] as! [ListLoadBalancersResponseBody.LoadBalancers.Tags]
            }
            if dict.keys.contains("VpcId") {
                self.vpcId = dict["VpcId"] as! String
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("LoadBalancers") {
            self.loadBalancers = dict["LoadBalancers"] as! [ListLoadBalancersResponseBody.LoadBalancers]
        }
        if dict.keys.contains("MaxResults") {
            self.maxResults = dict["MaxResults"] as! Int32
        }
...
public class ListRulesResponseBody : Tea.TeaModel {
    public class Rules : Tea.TeaModel {
        public class RuleActions : Tea.TeaModel {
            ...
            public class ForwardGroupConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("ServerGroupTuples") {
                        self.serverGroupTuples = dict["ServerGroupTuples"] as! [ListRulesResponseBody.Rules.RuleActions.ForwardGroupConfig.ServerGroupTuples]
                    }
                }
            }
            public class InsertHeaderConfig : Tea.TeaModel {
            ...
            public class TrafficMirrorConfig : Tea.TeaModel {
                public class MirrorGroupConfig : Tea.TeaModel {
                    ...
                    public override func fromMap(_ dict: [String: Any]) -> Void {
                        if dict.keys.contains("ServerGroupTuples") {
                            self.serverGroupTuples = dict["ServerGroupTuples"] as! [ListRulesResponseBody.Rules.RuleActions.TrafficMirrorConfig.MirrorGroupConfig.ServerGroupTuples]
                        }
                    }
                }
        ...
        public class RuleConditions : Tea.TeaModel {
            public class CookieConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Values") {
                        self.values = dict["Values"] as! [ListRulesResponseBody.Rules.RuleConditions.CookieConfig.Values]
                    }
                }
            }
            public class HeaderConfig : Tea.TeaModel {
            ...
            public class QueryStringConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Values") {
                        self.values = dict["Values"] as! [ListRulesResponseBody.Rules.RuleConditions.QueryStringConfig.Values]
                    }
                }
            }
            public class SourceIpConfig : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("RuleActions") {
                self.ruleActions = dict["RuleActions"] as! [ListRulesResponseBody.Rules.RuleActions]
            }
            if dict.keys.contains("RuleConditions") {
                self.ruleConditions = dict["RuleConditions"] as! [ListRulesResponseBody.Rules.RuleConditions]
            }
            if dict.keys.contains("RuleId") {
                self.ruleId = dict["RuleId"] as! String
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Rules") {
            self.rules = dict["Rules"] as! [ListRulesResponseBody.Rules]
        }
        if dict.keys.contains("TotalCount") {
            self.totalCount = dict["TotalCount"] as! Int32
        }
...
public class ListSecurityPoliciesResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("SecurityPolicies") {
            self.securityPolicies = dict["SecurityPolicies"] as! [ListSecurityPoliciesResponseBody.SecurityPolicies]
        }
        if dict.keys.contains("TotalCount") {
            self.totalCount = dict["TotalCount"] as! Int32
        }
...
public class ListSecurityPolicyRelationsResponseBody : Tea.TeaModel {
    public class SecrityPolicyRelations : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            if dict.keys.contains("RelatedListeners") {
                self.relatedListeners = dict["RelatedListeners"] as! [ListSecurityPolicyRelationsResponseBody.SecrityPolicyRelations.RelatedListeners]
            }
            if dict.keys.contains("SecurityPolicyId") {
                self.securityPolicyId = dict["SecurityPolicyId"] as! String
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("SecrityPolicyRelations") {
            self.secrityPolicyRelations = dict["SecrityPolicyRelations"] as! [ListSecurityPolicyRelationsResponseBody.SecrityPolicyRelations]
        }
    }
}
...
public class ListServerGroupServersRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tag") {
            self.tag = dict["Tag"] as! [ListServerGroupServersRequest.Tag]
        }
    }
}
...
public class ListServerGroupServersResponseBody : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Servers") {
            self.servers = dict["Servers"] as! [ListServerGroupServersResponseBody.Servers]
        }
        if dict.keys.contains("TotalCount") {
            self.totalCount = dict["TotalCount"] as! Int32
        }
...
public class ListServerGroupsRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tag") {
            self.tag = dict["Tag"] as! [ListServerGroupsRequest.Tag]
        }
        if dict.keys.contains("VpcId") {
            self.vpcId = dict["VpcId"] as! String
        }
...
public class ListServerGroupsResponseBody : Tea.TeaModel {
    public class ServerGroups : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("Tags") {
                self.tags = dict["Tags"] as! [ListServerGroupsResponseBody.ServerGroups.Tags]
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("ServerGroups") {
            self.serverGroups = dict["ServerGroups"] as! [ListServerGroupsResponseBody.ServerGroups]
        }
        if dict.keys.contains("TotalCount") {
            self.totalCount = dict["TotalCount"] as! Int32
        }
...
public class RemoveServersFromServerGroupRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Servers") {
            self.servers = dict["Servers"] as! [RemoveServersFromServerGroupRequest.Servers]
        }
    }
}
...
public class ReplaceServersInServerGroupRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("AddedServers") {
            self.addedServers = dict["AddedServers"] as! [ReplaceServersInServerGroupRequest.AddedServers]
        }
        if dict.keys.contains("ClientToken") {
            self.clientToken = dict["ClientToken"] as! String
        }
        ...
        if dict.keys.contains("RemovedServers") {
            self.removedServers = dict["RemovedServers"] as! [ReplaceServersInServerGroupRequest.RemovedServers]
        }
        if dict.keys.contains("ServerGroupId") {
            self.serverGroupId = dict["ServerGroupId"] as! String
        }
...
public class UnTagResourcesRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tag") {
            self.tag = dict["Tag"] as! [UnTagResourcesRequest.Tag]
        }
        if dict.keys.contains("TagKey") {
            self.tagKey = dict["TagKey"] as! [String]
        }
...
public class UpdateListenerAttributeRequest : Tea.TeaModel {
    ...
    public class DefaultActions : Tea.TeaModel {
        public class ForwardGroupConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("ServerGroupTuples") {
                    self.serverGroupTuples = dict["ServerGroupTuples"] as! [UpdateListenerAttributeRequest.DefaultActions.ForwardGroupConfig.ServerGroupTuples]
                }
            }
        }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("CaCertificates") {
            self.caCertificates = dict["CaCertificates"] as! [UpdateListenerAttributeRequest.CaCertificates]
        }
        if dict.keys.contains("CaEnabled") {
            self.caEnabled = dict["CaEnabled"] as! Bool
        }
        if dict.keys.contains("Certificates") {
            self.certificates = dict["Certificates"] as! [UpdateListenerAttributeRequest.Certificates]
        }
        if dict.keys.contains("ClientToken") {
            self.clientToken = dict["ClientToken"] as! String
        }
        if dict.keys.contains("DefaultActions") {
            self.defaultActions = dict["DefaultActions"] as! [UpdateListenerAttributeRequest.DefaultActions]
        }
        if dict.keys.contains("DryRun") {
            self.dryRun = dict["DryRun"] as! Bool
        }
...
public class UpdateLoadBalancerAddressTypeConfigRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("ZoneMappings") {
            self.zoneMappings = dict["ZoneMappings"] as! [UpdateLoadBalancerAddressTypeConfigRequest.ZoneMappings]
        }
    }
}
...
public class UpdateLoadBalancerZonesRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("ZoneMappings") {
            self.zoneMappings = dict["ZoneMappings"] as! [UpdateLoadBalancerZonesRequest.ZoneMappings]
        }
    }
}
...
public class UpdateRuleAttributeRequest : Tea.TeaModel {
    public class RuleActions : Tea.TeaModel {
        ...
        public class ForwardGroupConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                ...
                if dict.keys.contains("ServerGroupTuples") {
                    self.serverGroupTuples = dict["ServerGroupTuples"] as! [UpdateRuleAttributeRequest.RuleActions.ForwardGroupConfig.ServerGroupTuples]
                }
            }
        }
        public class InsertHeaderConfig : Tea.TeaModel {
        ...
        public class TrafficMirrorConfig : Tea.TeaModel {
            public class MirrorGroupConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("ServerGroupTuples") {
                        self.serverGroupTuples = dict["ServerGroupTuples"] as! [UpdateRuleAttributeRequest.RuleActions.TrafficMirrorConfig.MirrorGroupConfig.ServerGroupTuples]
                    }
                }
            }
    ...
    public class RuleConditions : Tea.TeaModel {
        public class CookieConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("Values") {
                    self.values = dict["Values"] as! [UpdateRuleAttributeRequest.RuleConditions.CookieConfig.Values]
                }
            }
        }
        public class HeaderConfig : Tea.TeaModel {
        ...
        public class QueryStringConfig : Tea.TeaModel {
            ...
            public override func fromMap(_ dict: [String: Any]) -> Void {
                if dict.keys.contains("Values") {
                    self.values = dict["Values"] as! [UpdateRuleAttributeRequest.RuleConditions.QueryStringConfig.Values]
                }
            }
        }
        public class SourceIpConfig : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("RuleActions") {
            self.ruleActions = dict["RuleActions"] as! [UpdateRuleAttributeRequest.RuleActions]
        }
        if dict.keys.contains("RuleConditions") {
            self.ruleConditions = dict["RuleConditions"] as! [UpdateRuleAttributeRequest.RuleConditions]
        }
        if dict.keys.contains("RuleId") {
            self.ruleId = dict["RuleId"] as! String
        }
...
public class UpdateRulesAttributeRequest : Tea.TeaModel {
    public class Rules : Tea.TeaModel {
        public class RuleActions : Tea.TeaModel {
            ...
            public class ForwardGroupConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    ...
                    if dict.keys.contains("ServerGroupTuples") {
                        self.serverGroupTuples = dict["ServerGroupTuples"] as! [UpdateRulesAttributeRequest.Rules.RuleActions.ForwardGroupConfig.ServerGroupTuples]
                    }
                }
            }
            public class InsertHeaderConfig : Tea.TeaModel {
            ...
            public class TrafficMirrorConfig : Tea.TeaModel {
                public class MirrorGroupConfig : Tea.TeaModel {
                    ...
                    public override func fromMap(_ dict: [String: Any]) -> Void {
                        if dict.keys.contains("ServerGroupTuples") {
                            self.serverGroupTuples = dict["ServerGroupTuples"] as! [UpdateRulesAttributeRequest.Rules.RuleActions.TrafficMirrorConfig.MirrorGroupConfig.ServerGroupTuples]
                        }
                    }
                }
        ...
        public class RuleConditions : Tea.TeaModel {
            public class CookieConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Values") {
                        self.values = dict["Values"] as! [UpdateRulesAttributeRequest.Rules.RuleConditions.CookieConfig.Values]
                    }
                }
            }
            public class HeaderConfig : Tea.TeaModel {
            ...
            public class QueryStringConfig : Tea.TeaModel {
                ...
                public override func fromMap(_ dict: [String: Any]) -> Void {
                    if dict.keys.contains("Values") {
                        self.values = dict["Values"] as! [UpdateRulesAttributeRequest.Rules.RuleConditions.QueryStringConfig.Values]
                    }
                }
            }
            public class ResponseHeaderConfig : Tea.TeaModel {
        ...
        public override func fromMap(_ dict: [String: Any]) -> Void {
            ...
            if dict.keys.contains("RuleActions") {
                self.ruleActions = dict["RuleActions"] as! [UpdateRulesAttributeRequest.Rules.RuleActions]
            }
            if dict.keys.contains("RuleConditions") {
                self.ruleConditions = dict["RuleConditions"] as! [UpdateRulesAttributeRequest.Rules.RuleConditions]
            }
            if dict.keys.contains("RuleId") {
                self.ruleId = dict["RuleId"] as! String
            }
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Rules") {
            self.rules = dict["Rules"] as! [UpdateRulesAttributeRequest.Rules]
        }
    }
}
...
public class UpdateServerGroupServersAttributeRequest : Tea.TeaModel {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Servers") {
            self.servers = dict["Servers"] as! [UpdateServerGroupServersAttributeRequest.Servers]
        }
    }
}
