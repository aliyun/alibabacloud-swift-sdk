...
```ogdl
github "alibabacloud-sdk-swift/dataworks-public-20240518" "8.2.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dataworks-public-20240518.git", from: "8.2.0")
]
```
