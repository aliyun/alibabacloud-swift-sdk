...
```ogdl
github "alibabacloud-sdk-swift/dataworks-public-20240518" "7.6.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dataworks-public-20240518.git", from: "7.6.0")
]
```
