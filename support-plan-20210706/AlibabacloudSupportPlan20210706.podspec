Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudSupportPlan20210706"
  spec.version      = "2.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud support-plan (20210706) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/support-plan-20210706" 
