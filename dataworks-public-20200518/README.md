...
```ogdl
github "alibabacloud-sdk-swift/dataworks-public-20200518" "3.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dataworks-public-20200518.git", from: "3.0.1")
]
```
