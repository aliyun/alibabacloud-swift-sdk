...
```ogdl
github "alibabacloud-sdk-swift/dataworks-public-20200518" "4.0.3"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dataworks-public-20200518.git", from: "4.0.3")
]
```
