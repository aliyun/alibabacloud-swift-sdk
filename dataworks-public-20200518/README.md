...
```ogdl
github "alibabacloud-sdk-swift/dataworks-public-20200518" "6.1.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dataworks-public-20200518.git", from: "6.1.1")
]
```
