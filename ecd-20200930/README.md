...
```ruby
pod 'AlibabacloudEcd20200930', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/ecd-20200930" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/ecd-20200930.git", from: "1.0.1")
]
```
