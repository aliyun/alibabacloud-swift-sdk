...
public class ListMtConnectorRequest : Tea.TeaModel {
...
public class ListMtConnectorResponseBody : Tea.TeaModel {
    ...
    public var bizErrorCode: Int64?

    public var data: [ListMtConnectorResponseBody.Data]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.bizErrorCode != nil {
            map["bizErrorCode"] = self.bizErrorCode!
        }
        if self.data != nil {
            var tmp : [Any] = []
            for k in self.data! {
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("bizErrorCode") {
            self.bizErrorCode = dict["bizErrorCode"] as! Int64
        }
        if dict.keys.contains("data") {
            var tmp : [ListMtConnectorResponseBody.Data] = []
            for v in dict["data"] as! [Any] {
                var model = ListMtConnectorResponseBody.Data()
                if v != nil {
...
public class ListMtConnectorResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListMtConnectorResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("body") {
            var model = ListMtConnectorResponseBody()
            model.fromMap(dict["body"] as! [String: Any])
            self.body = model
        }
    }
