...
```ruby
pod 'AlibabacloudDysmsapi20170525', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/dysmsapi-20170525" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dysmsapi-20170525.git", from: "1.0.1")
]
```
