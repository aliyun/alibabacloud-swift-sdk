...
```ruby
pod 'AlibabacloudDocumentAutoml20221229', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/documentautoml-20221229" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/documentautoml-20221229.git", from: "1.0.1")
]
```
