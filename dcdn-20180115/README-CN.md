...
```ruby
pod 'AlibabacloudDcdn20180115', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/dcdn-20180115" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/dcdn-20180115.git", from: "1.0.0")
]
```
