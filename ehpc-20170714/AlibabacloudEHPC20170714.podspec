Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEHPC20170714"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Elastic High Performance Computing (20170714) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/ehpc-20170714" 
