...
```ruby
pod 'AlibabacloudSchedulerx220190430', '~> 1.1.7'
```
...
```ogdl
github "alibabacloud-sdk-swift/schedulerx2-20190430" "1.1.7"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/schedulerx2-20190430.git", from: "1.1.7")
]
```
