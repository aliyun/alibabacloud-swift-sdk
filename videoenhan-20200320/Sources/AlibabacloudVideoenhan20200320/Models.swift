...
public class AbstractEcommerceVideoRequest : Tea.TeaModel {
...
public class AbstractEcommerceVideoAdvanceRequest : Tea.TeaModel {
    public var duration: Double?
...
public class AbstractEcommerceVideoResponseBody : Tea.TeaModel {
    ...
    public var data: AbstractEcommerceVideoResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = AbstractEcommerceVideoResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
...
public class AbstractEcommerceVideoResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AbstractEcommerceVideoResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AbstractEcommerceVideoResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class AbstractFilmVideoRequest : Tea.TeaModel {
...
public class AbstractFilmVideoAdvanceRequest : Tea.TeaModel {
    public var length: Int32?
...
public class AbstractFilmVideoResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var videoUrl: String?
    ...
    public var data: AbstractFilmVideoResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = AbstractFilmVideoResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class AbstractFilmVideoResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: AbstractFilmVideoResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = AbstractFilmVideoResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ConvertHdrVideoRequest : Tea.TeaModel {
...
public class ConvertHdrVideoAdvanceRequest : Tea.TeaModel {
    public var bitrate: Int32?
...
public class ConvertHdrVideoResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var videoURL: String?
    ...
    public var data: ConvertHdrVideoResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = ConvertHdrVideoResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class ConvertHdrVideoResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ConvertHdrVideoResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ConvertHdrVideoResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ReduceVideoNoiseRequest : Tea.TeaModel {
    public var videoUrl: String?
...
public class ReduceVideoNoiseAdvanceRequest : Tea.TeaModel {
    public var videoUrlObject: InputStream?
...
public class ReduceVideoNoiseResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var videoUrl: String?
    ...
    public var data: ReduceVideoNoiseResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = ReduceVideoNoiseResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class ReduceVideoNoiseResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ReduceVideoNoiseResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ReduceVideoNoiseResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ToneSdrVideoRequest : Tea.TeaModel {
    public var bitrate: Int32?

    public var recolorModel: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.recolorModel != nil {
            map["RecolorModel"] = self.recolorModel!
        }
        if self.videoURL != nil {
            map["VideoURL"] = self.videoURL!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RecolorModel"] as? String {
            self.recolorModel = value
        }
        if let value = dict["VideoURL"] as? String {
            self.videoURL = value
        }
...
public class ToneSdrVideoAdvanceRequest : Tea.TeaModel {
    public var bitrate: Int32?
...
public class ToneSdrVideoResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var videoURL: String?
    ...
    public var data: ToneSdrVideoResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Data"] as? [String: Any?] {
            var model = ToneSdrVideoResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
        if let value = dict["Message"] as? String {
...
public class ToneSdrVideoResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ToneSdrVideoResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ToneSdrVideoResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
