Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudVideoenhan20200320"
  spec.version      = "2.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud videoenhan (20200320) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/videoenhan-20200320" 
