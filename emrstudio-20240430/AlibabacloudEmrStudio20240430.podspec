Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudEmrStudio20240430"
  spec.version      = "1.1.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud EmrStudio (20240430) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/emrstudio-20240430" 
