...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func activateEdgeMobileAgentWithOptions(_ request: ActivateEdgeMobileAgentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ActivateEdgeMobileAgentResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.deviceClass)) {
            query["DeviceClass"] = request.deviceClass ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.deviceId)) {
            query["DeviceId"] = request.deviceId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.deviceMeta)) {
        ...
        return Tea.TeaConverter.fromMap(ActivateEdgeMobileAgentResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func activateEdgeMobileAgent(_ request: ActivateEdgeMobileAgentRequest) async throws -> ActivateEdgeMobileAgentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await activateEdgeMobileAgentWithOptions(request as! ActivateEdgeMobileAgentRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func backupFileWithOptions(_ request: BackupFileRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> BackupFileResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.excludeSourceFilePathList)) {
    ...
    public func changeCloudPhoneNodeWithOptions(_ request: ChangeCloudPhoneNodeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ChangeCloudPhoneNodeResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.swapSize)) {
            query["SwapSize"] = request.swapSize!;
        }
        if (!TeaUtils.Client.isUnset(request.upBandwidthLimit)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createAgentSkillWithOptions(_ request: CreateAgentSkillRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateAgentSkillResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.fileList)) {
            query["FileList"] = request.fileList ?? [];
        }
        if (!TeaUtils.Client.isUnset(request.iconKey)) {
            query["IconKey"] = request.iconKey ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.packageOssKey)) {
        ...
        if (!TeaUtils.Client.isUnset(request.skillPackageUrl)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateAgentSkillResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createAgentSkill(_ request: CreateAgentSkillRequest) async throws -> CreateAgentSkillResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createAgentSkillWithOptions(request as! CreateAgentSkillRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func createAndroidInstanceGroupWithOptions(_ tmpReq: CreateAndroidInstanceGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateAndroidInstanceGroupResponse {
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.networkInfo)) {
            request.networkInfoShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.networkInfo, "NetworkInfo", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.amount)) {
            query["Amount"] = request.amount!;
        ...
        if (!TeaUtils.Client.isUnset(request.bandwidthPackageType)) {
        ...
        if (!TeaUtils.Client.isUnset(request.instanceVersion)) {
        ...
        if (!TeaUtils.Client.isUnset(request.networkInfoShrink)) {
    ...
    public func createCloudPhoneNodeWithOptions(_ tmpReq: CreateCloudPhoneNodeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateCloudPhoneNodeResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.useTemplate)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createCreditPackageWithOptions(_ request: CreateCreditPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateCreditPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.autoPay)) {
            query["AutoPay"] = request.autoPay!;
        ...
        if (!TeaUtils.Client.isUnset(request.packageAmount)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateCreditPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createCreditPackage(_ request: CreateCreditPackageRequest) async throws -> CreateCreditPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createCreditPackageWithOptions(request as! CreateCreditPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createEdgeMobileAgentPackageWithOptions(_ request: CreateEdgeMobileAgentPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateEdgeMobileAgentPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.autoPay)) {
            query["AutoPay"] = request.autoPay!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateEdgeMobileAgentPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createEdgeMobileAgentPackage(_ request: CreateEdgeMobileAgentPackageRequest) async throws -> CreateEdgeMobileAgentPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createEdgeMobileAgentPackageWithOptions(request as! CreateEdgeMobileAgentPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMobileAgentPackageWithOptions(_ request: CreateMobileAgentPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateMobileAgentPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.amount)) {
            query["Amount"] = request.amount ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.mobileAgentPackageSpec)) {
            query["MobileAgentPackageSpec"] = request.mobileAgentPackageSpec ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.packageSpecId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateMobileAgentPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createMobileAgentPackage(_ request: CreateMobileAgentPackageRequest) async throws -> CreateMobileAgentPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createMobileAgentPackageWithOptions(request as! CreateMobileAgentPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createScheduledTaskWithOptions(_ tmpReq: CreateScheduledTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateScheduledTaskResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        ...
        if (!TeaUtils.Client.isUnset(request.maxExecutions)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createSystemPropertyTemplateWithOptions(_ tmpReq: CreateSystemPropertyTemplateRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateSystemPropertyTemplateResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: CreateSystemPropertyTemplateShrinkRequest = CreateSystemPropertyTemplateShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.systemPropertyInfo)) {
            request.systemPropertyInfoShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.systemPropertyInfo, "SystemPropertyInfo", "json")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.enableAuto)) {
            query["EnableAuto"] = request.enableAuto!;
        }
        if (!TeaUtils.Client.isUnset(request.filePath)) {
            query["FilePath"] = request.filePath ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.systemPropertyInfoShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateSystemPropertyTemplateResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createSystemPropertyTemplate(_ request: CreateSystemPropertyTemplateRequest) async throws -> CreateSystemPropertyTemplateResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createSystemPropertyTemplateWithOptions(request as! CreateSystemPropertyTemplateRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAgentSkillWithOptions(_ request: DeleteAgentSkillRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteAgentSkillResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteAgentSkillResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteAgentSkill(_ request: DeleteAgentSkillRequest) async throws -> DeleteAgentSkillResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteAgentSkillWithOptions(request as! DeleteAgentSkillRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func deleteBackupFileWithOptions(_ request: DeleteBackupFileRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteBackupFileResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.backupFileIdList)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMobileAgentPackageWithOptions(_ request: DeleteMobileAgentPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteMobileAgentPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteMobileAgentPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteMobileAgentPackage(_ request: DeleteMobileAgentPackageRequest) async throws -> DeleteMobileAgentPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteMobileAgentPackageWithOptions(request as! DeleteMobileAgentPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func deleteScheduledTaskWithOptions(_ request: DeleteScheduledTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteScheduledTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.scheduledId)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteSystemPropertyTemplatesWithOptions(_ request: DeleteSystemPropertyTemplatesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteSystemPropertyTemplatesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteSystemPropertyTemplatesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteSystemPropertyTemplates(_ request: DeleteSystemPropertyTemplatesRequest) async throws -> DeleteSystemPropertyTemplatesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteSystemPropertyTemplatesWithOptions(request as! DeleteSystemPropertyTemplatesRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeAgentTaskWithOptions(_ request: DescribeAgentTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeAgentTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.taskIds)) {
            query["TaskIds"] = request.taskIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeAgentTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeAgentTask(_ request: DescribeAgentTaskRequest) async throws -> DescribeAgentTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeAgentTaskWithOptions(request as! DescribeAgentTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeBucketsWithOptions(_ request: DescribeBucketsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeBucketsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeBucketsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeBuckets(_ request: DescribeBucketsRequest) async throws -> DescribeBucketsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeBucketsWithOptions(request as! DescribeBucketsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeCreditDetailWithOptions(_ request: DescribeCreditDetailRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeCreditDetailResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeCreditDetailResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeCreditDetail(_ request: DescribeCreditDetailRequest) async throws -> DescribeCreditDetailResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeCreditDetailWithOptions(request as! DescribeCreditDetailRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeCreditPackageWithOptions(_ request: DescribeCreditPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeCreditPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.creditPackageId)) {
            query["CreditPackageId"] = request.creditPackageId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.creditPackageStatus)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeCreditPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeCreditPackage(_ request: DescribeCreditPackageRequest) async throws -> DescribeCreditPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeCreditPackageWithOptions(request as! DescribeCreditPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeEdgeMobileAgentPackagesWithOptions(_ request: DescribeEdgeMobileAgentPackagesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeEdgeMobileAgentPackagesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.deviceClass)) {
            query["DeviceClass"] = request.deviceClass ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.licenseKeys)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeEdgeMobileAgentPackagesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeEdgeMobileAgentPackages(_ request: DescribeEdgeMobileAgentPackagesRequest) async throws -> DescribeEdgeMobileAgentPackagesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeEdgeMobileAgentPackagesWithOptions(request as! DescribeEdgeMobileAgentPackagesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeJVSInstanceWithOptions(_ request: DescribeJVSInstanceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeJVSInstanceResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIds)) {
            query["InstanceIds"] = request.instanceIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeJVSInstanceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeJVSInstance(_ request: DescribeJVSInstanceRequest) async throws -> DescribeJVSInstanceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeJVSInstanceWithOptions(request as! DescribeJVSInstanceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func describeMetricListWithOptions(_ request: DescribeMetricListRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeMetricListResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.processInfos)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeMobileAgentPackageWithOptions(_ request: DescribeMobileAgentPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeMobileAgentPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIds)) {
            query["InstanceIds"] = request.instanceIds ?? [];
        ...
        if (!TeaUtils.Client.isUnset(request.packageStatus)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeMobileAgentPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeMobileAgentPackage(_ request: DescribeMobileAgentPackageRequest) async throws -> DescribeMobileAgentPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeMobileAgentPackageWithOptions(request as! DescribeMobileAgentPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeScheduledTaskExecutionsWithOptions(_ request: DescribeScheduledTaskExecutionsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeScheduledTaskExecutionsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.endTime)) {
            query["EndTime"] = request.endTime ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeScheduledTaskExecutionsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeScheduledTaskExecutions(_ request: DescribeScheduledTaskExecutionsRequest) async throws -> DescribeScheduledTaskExecutionsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeScheduledTaskExecutionsWithOptions(request as! DescribeScheduledTaskExecutionsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func describeScheduledTasksWithOptions(_ request: DescribeScheduledTasksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeScheduledTasksResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.scheduledIds)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeSkillsWithOptions(_ request: DescribeSkillsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeSkillsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.statusFilter)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeSkillsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeSkills(_ request: DescribeSkillsRequest) async throws -> DescribeSkillsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeSkillsWithOptions(request as! DescribeSkillsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeSystemPropertyTemplatesWithOptions(_ request: DescribeSystemPropertyTemplatesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeSystemPropertyTemplatesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.maxResults)) {
            query["MaxResults"] = request.maxResults!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeSystemPropertyTemplatesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeSystemPropertyTemplates(_ request: DescribeSystemPropertyTemplatesRequest) async throws -> DescribeSystemPropertyTemplatesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeSystemPropertyTemplatesWithOptions(request as! DescribeSystemPropertyTemplatesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getInstancePropertiesWithOptions(_ request: GetInstancePropertiesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetInstancePropertiesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceId)) {
            query["InstanceId"] = request.instanceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetInstancePropertiesResponse(), tmp)
    }
    ...
    public func importImageWithOptions(_ request: ImportImageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ImportImageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.baseImageId)) {
            query["BaseImageId"] = request.baseImageId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.imageDescription)) {
            query["ImageDescription"] = request.imageDescription ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.imageFileURL)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func installSkillsWithOptions(_ request: InstallSkillsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> InstallSkillsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIds)) {
            query["InstanceIds"] = request.instanceIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(InstallSkillsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func installSkills(_ request: InstallSkillsRequest) async throws -> InstallSkillsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await installSkillsWithOptions(request as! InstallSkillsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func instanceHealerWithOptions(_ request: InstanceHealerRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> InstanceHealerResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIdList)) {
            query["InstanceIdList"] = request.instanceIdList ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(InstanceHealerResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func instanceHealer(_ request: InstanceHealerRequest) async throws -> InstanceHealerResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await instanceHealerWithOptions(request as! InstanceHealerRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listInstanceAdbAttributesWithOptions(_ request: ListInstanceAdbAttributesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListInstanceAdbAttributesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListInstanceAdbAttributesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listInstanceAdbAttributes(_ request: ListInstanceAdbAttributesRequest) async throws -> ListInstanceAdbAttributesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listInstanceAdbAttributesWithOptions(request as! ListInstanceAdbAttributesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func modifyJVSInstanceWithOptions(_ request: ModifyJVSInstanceRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyJVSInstanceResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyJVSInstanceResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyJVSInstance(_ request: ModifyJVSInstanceRequest) async throws -> ModifyJVSInstanceResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyJVSInstanceWithOptions(request as! ModifyJVSInstanceRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyScheduledTaskWithOptions(_ tmpReq: ModifyScheduledTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyScheduledTaskResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ModifyScheduledTaskShrinkRequest = ModifyScheduledTaskShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.runConfig)) {
            request.runConfigShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.runConfig, "RunConfig", "json")
        }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifySystemPropertyTemplateWithOptions(_ tmpReq: ModifySystemPropertyTemplateRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifySystemPropertyTemplateResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ModifySystemPropertyTemplateShrinkRequest = ModifySystemPropertyTemplateShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.systemPropertyInfo)) {
            request.systemPropertyInfoShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.systemPropertyInfo, "SystemPropertyInfo", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifySystemPropertyTemplateResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifySystemPropertyTemplate(_ request: ModifySystemPropertyTemplateRequest) async throws -> ModifySystemPropertyTemplateResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifySystemPropertyTemplateWithOptions(request as! ModifySystemPropertyTemplateRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pauseAgentTaskWithOptions(_ request: PauseAgentTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> PauseAgentTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.taskIds)) {
            query["TaskIds"] = request.taskIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(PauseAgentTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func pauseAgentTask(_ request: PauseAgentTaskRequest) async throws -> PauseAgentTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await pauseAgentTaskWithOptions(request as! PauseAgentTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func refreshAuthTokensWithOptions(_ request: RefreshAuthTokensRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RefreshAuthTokensResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RefreshAuthTokensResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func refreshAuthTokens(_ request: RefreshAuthTokensRequest) async throws -> RefreshAuthTokensResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await refreshAuthTokensWithOptions(request as! RefreshAuthTokensRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func renewMobileAgentPackageWithOptions(_ request: RenewMobileAgentPackageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RenewMobileAgentPackageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.autoPay)) {
            query["AutoPay"] = request.autoPay!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RenewMobileAgentPackageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func renewMobileAgentPackage(_ request: RenewMobileAgentPackageRequest) async throws -> RenewMobileAgentPackageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await renewMobileAgentPackageWithOptions(request as! RenewMobileAgentPackageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func resetAndroidInstancesInGroupWithOptions(_ request: ResetAndroidInstancesInGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResetAndroidInstancesInGroupResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.settingResetType)) {
            query["SettingResetType"] = request.settingResetType!;
        }
        if (!TeaUtils.Client.isUnset(request.targetDataDiskSize)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeAgentTaskWithOptions(_ request: ResumeAgentTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResumeAgentTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.additionalPrompt)) {
            query["AdditionalPrompt"] = request.additionalPrompt ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.clarificationAnswers)) {
            query["ClarificationAnswers"] = request.clarificationAnswers ?? [];
        }
        if (!TeaUtils.Client.isUnset(request.taskIds)) {
            query["TaskIds"] = request.taskIds ?? [];
        }
        if (!TeaUtils.Client.isUnset(request.toolCallId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ResumeAgentTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resumeAgentTask(_ request: ResumeAgentTaskRequest) async throws -> ResumeAgentTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await resumeAgentTaskWithOptions(request as! ResumeAgentTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func runAgentTaskWithOptions(_ tmpReq: RunAgentTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RunAgentTaskResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.saveArtifacts)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RunAgentTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func runAgentTask(_ request: RunAgentTaskRequest) async throws -> RunAgentTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await runAgentTaskWithOptions(request as! RunAgentTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func runSyncCommandWithOptions(_ request: RunSyncCommandRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RunSyncCommandResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.commandContent)) {
            query["CommandContent"] = request.commandContent ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.waitTime)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RunSyncCommandResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func runSyncCommand(_ request: RunSyncCommandRequest) async throws -> RunSyncCommandResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await runSyncCommandWithOptions(request as! RunSyncCommandRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func sendSystemPropertyTemplateWithOptions(_ request: SendSystemPropertyTemplateRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SendSystemPropertyTemplateResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.templateId)) {
            query["TemplateId"] = request.templateId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SendSystemPropertyTemplateResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func sendSystemPropertyTemplate(_ request: SendSystemPropertyTemplateRequest) async throws -> SendSystemPropertyTemplateResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await sendSystemPropertyTemplateWithOptions(request as! SendSystemPropertyTemplateRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startInstanceAdbWithOptions(_ request: StartInstanceAdbRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StartInstanceAdbResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIds)) {
            query["InstanceIds"] = request.instanceIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StartInstanceAdbResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startInstanceAdb(_ request: StartInstanceAdbRequest) async throws -> StartInstanceAdbResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await startInstanceAdbWithOptions(request as! StartInstanceAdbRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopInstanceAdbWithOptions(_ request: StopInstanceAdbRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StopInstanceAdbResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIds)) {
            query["InstanceIds"] = request.instanceIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StopInstanceAdbResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopInstanceAdb(_ request: StopInstanceAdbRequest) async throws -> StopInstanceAdbResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await stopInstanceAdbWithOptions(request as! StopInstanceAdbRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func uninstallSkillsWithOptions(_ request: UninstallSkillsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UninstallSkillsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.instanceIds)) {
            query["InstanceIds"] = request.instanceIds ?? [];
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UninstallSkillsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func uninstallSkills(_ request: UninstallSkillsRequest) async throws -> UninstallSkillsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await uninstallSkillsWithOptions(request as! UninstallSkillsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateCloudPhoneNodeSystemImageWithOptions(_ request: UpdateCloudPhoneNodeSystemImageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateCloudPhoneNodeSystemImageResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.imageId)) {
            query["ImageId"] = request.imageId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateCloudPhoneNodeSystemImageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateCloudPhoneNodeSystemImage(_ request: UpdateCloudPhoneNodeSystemImageRequest) async throws -> UpdateCloudPhoneNodeSystemImageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateCloudPhoneNodeSystemImageWithOptions(request as! UpdateCloudPhoneNodeSystemImageRequest, runtime as! TeaUtils.RuntimeOptions)
    }
