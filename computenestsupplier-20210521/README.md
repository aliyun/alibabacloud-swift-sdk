...
```ruby
pod 'AlibabacloudComputeNestSupplier20210521', '~> 1.0.2'
```
...
```ogdl
github "alibabacloud-sdk-swift/computenestsupplier-20210521" "1.0.2"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/computenestsupplier-20210521.git", from: "1.0.2")
]
```
