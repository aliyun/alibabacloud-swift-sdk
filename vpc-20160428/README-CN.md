...
```ruby
pod 'AlibabacloudVpc20160428', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/vpc-20160428" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/vpc-20160428.git", from: "1.0.1")
]
```
