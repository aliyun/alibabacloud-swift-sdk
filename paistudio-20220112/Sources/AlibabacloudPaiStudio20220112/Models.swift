...
public class CacheService : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.isSharded != nil {
            map["IsSharded"] = self.isSharded!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["IsSharded"] as? Bool {
            self.isSharded = value
        }
        ...
        if let value = dict["SupportRDMA"] as? String {
...
public class Event : Tea.TeaModel {
    ...
    public var triggerTenantId: String?

    public var triggerTime: String?

    public var triggerUserId: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.triggerTenantId != nil {
            map["TriggerTenantId"] = self.triggerTenantId!
        }
        if self.triggerTime != nil {
            map["TriggerTime"] = self.triggerTime!
        }
        if self.triggerUserId != nil {
            map["TriggerUserId"] = self.triggerUserId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["TriggerTenantId"] as? String {
            self.triggerTenantId = value
        }
        if let value = dict["TriggerTime"] as? String {
            self.triggerTime = value
        }
        if let value = dict["TriggerUserId"] as? String {
            self.triggerUserId = value
        }
...
public class QueueMeta : Tea.TeaModel {
    public var gmtDequeuedTime: String?
    ...
    public var scheduledResource: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.scheduledResource != nil {
            map["ScheduledResource"] = self.scheduledResource!
        }
        if self.status != nil {
            map["Status"] = self.status!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ScheduledResource"] as? String {
            self.scheduledResource = value
        }
        if let value = dict["Status"] as? String {
            self.status = value
        }
...
public class QuotaConfig : Tea.TeaModel {
    ...
    public var isEncryptedResource: Bool?
    ...
    public var workloadTypes: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.isEncryptedResource != nil {
            map["IsEncryptedResource"] = self.isEncryptedResource!
        }
        ...
        if self.workloadTypes != nil {
            map["WorkloadTypes"] = self.workloadTypes!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["IsEncryptedResource"] as? Bool {
            self.isEncryptedResource = value
        }
        ...
        if let value = dict["WorkloadTypes"] as? [String] {
            self.workloadTypes = value
        }
    }
}
...
public class SpotBidPreviewItem : Tea.TeaModel {
    public var active: Bool?

    public var allowCrossHpnZone: Bool?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.allowCrossHpnZone != nil {
            map["allowCrossHpnZone"] = self.allowCrossHpnZone!
        }
        if self.clusterId != nil {
            map["clusterId"] = self.clusterId!
        }
        ...
        if self.maxDiscount != nil {
            map["maxDiscount"] = self.maxDiscount!
        }
        if self.message != nil {
            map["message"] = self.message!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["allowCrossHpnZone"] as? Bool {
            self.allowCrossHpnZone = value
        }
        if let value = dict["clusterId"] as? String {
            self.clusterId = value
        }
        ...
        if let value = dict["maxDiscount"] as? Double {
...
public class SpotStockInternalInfo : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.availableQuantity != nil {
            map["availableQuantity"] = self.availableQuantity!
        }
        if self.clusterId != nil {
            map["clusterId"] = self.clusterId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["availableQuantity"] as? Int32 {
            self.availableQuantity = value
        }
        if let value = dict["clusterId"] as? String {
            self.clusterId = value
        }
        ...
        if let value = dict["totalQuantity"] as? Int32 {
            self.totalQuantity = value
        }
    }
}

public class SpotStockItem : Tea.TeaModel {
    public var instanceType: String?

    public var internalInfo: [SpotStockInternalInfo]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.internalInfo != nil {
            var tmp : [Any] = []
            for k in self.internalInfo! {
                tmp.append(k.toMap())
            }
            map["internalInfo"] = tmp
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["internalInfo"] as? [Any?] {
            var tmp : [SpotStockInternalInfo] = []
            for v in value {
                if v != nil {
                    var model = SpotStockInternalInfo()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class WorkloadInfo : Tea.TeaModel {
    public var isScheduled: String?

    public var priority: Int32?

    public var queueMetas: [QueueMeta]?
    ...
    public var workloadCreatedTime: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.queueMetas != nil {
            var tmp : [Any] = []
            for k in self.queueMetas! {
                tmp.append(k.toMap())
            }
            map["QueueMetas"] = tmp
        }
        ...
        if self.workloadCreatedTime != nil {
            map["WorkloadCreatedTime"] = self.workloadCreatedTime!
        }
        if self.workloadId != nil {
            map["WorkloadId"] = self.workloadId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["IsScheduled"] as? String {
            self.isScheduled = value
        }
        if let value = dict["Priority"] as? Int32 {
            self.priority = value
        }
        if let value = dict["QueueMetas"] as? [Any?] {
            var tmp : [QueueMeta] = []
            for v in value {
                if v != nil {
                    var model = QueueMeta()
        ...
        if let value = dict["WorkloadCreatedTime"] as? String {
            self.workloadCreatedTime = value
        }
        if let value = dict["WorkloadId"] as? String {
            self.workloadId = value
        }
...
public class ListNodePodsRequest : Tea.TeaModel {
    public var GPUIndexes: String?

    public var oversoldTypes: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.oversoldTypes != nil {
            map["OversoldTypes"] = self.oversoldTypes!
        }
        if self.resourceGroupId != nil {
            map["ResourceGroupId"] = self.resourceGroupId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["GPUIndexes"] as? String {
            self.GPUIndexes = value
        }
        if let value = dict["OversoldTypes"] as? String {
            self.oversoldTypes = value
        }
        if let value = dict["ResourceGroupId"] as? String {
            self.resourceGroupId = value
        }
...
public class ListNodePodsResponseBody : Tea.TeaModel {
    public var nodePodInfos: [NodePodInfo]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.nodePodInfos != nil {
            var tmp : [Any] = []
            for k in self.nodePodInfos! {
                tmp.append(k.toMap())
            }
            map["NodePodInfos"] = tmp
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["NodePodInfos"] as? [Any?] {
            var tmp : [NodePodInfo] = []
            for v in value {
                if v != nil {
                    var model = NodePodInfo()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListNodePodsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListNodePodsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListNodePodsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListNodeTypesRequest : Tea.TeaModel {
    public var acceleratorType: String?
...
public class ListNodeTypesResponseBody : Tea.TeaModel {
    public var nodeTypes: [NodeType]?

    public var requestId: String?

    public var statistics: [NodeTypeStatistic]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["NodeTypes"] as? [Any?] {
            var tmp : [NodeType] = []
            for v in value {
                if v != nil {
                    var model = NodeType()
        ...
        if let value = dict["Statistics"] as? [Any?] {
            var tmp : [NodeTypeStatistic] = []
            for v in value {
                if v != nil {
                    var model = NodeTypeStatistic()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListNodeTypesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListNodeTypesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListNodeTypesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListQuotaActiveUserUsagesRequest : Tea.TeaModel {
    public var order: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.selfOnly != nil {
            map["SelfOnly"] = self.selfOnly!
        }
        if self.sortBy != nil {
            map["SortBy"] = self.sortBy!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["SelfOnly"] as? Bool {
            self.selfOnly = value
        }
        if let value = dict["SortBy"] as? String {
            self.sortBy = value
...
public class ListQuotaActiveUserUsagesResponseBody : Tea.TeaModel {
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.quotaUserUsage != nil {
            var tmp : [Any] = []
            for k in self.quotaUserUsage! {
                tmp.append(k.toMap())
            }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["QuotaUserUsage"] as? [Any?] {
            var tmp : [QuotaUser] = []
            for v in value {
                if v != nil {
                    var model = QuotaUser()
...
public class ListQuotaActiveUserUsagesResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListQuotaActiveUserUsagesResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListQuotaActiveUserUsagesResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateQuotaRequest : Tea.TeaModel {
    ...
    public var propagateDefaultGPUDriver: Bool?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.propagateDefaultGPUDriver != nil {
            map["PropagateDefaultGPUDriver"] = self.propagateDefaultGPUDriver!
        }
        if self.queueStrategy != nil {
            map["QueueStrategy"] = self.queueStrategy!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["PropagateDefaultGPUDriver"] as? Bool {
            self.propagateDefaultGPUDriver = value
        }
        if let value = dict["QueueStrategy"] as? String {
            self.queueStrategy = value
        }
