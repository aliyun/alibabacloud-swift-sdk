...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func getQuotaWithOptions(_ QuotaId: String, _ request: GetQuotaRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> GetQuotaResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.withNodeMeta)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listNodeTypesWithOptions(_ request: ListNodeTypesRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListNodeTypesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListNodeTypesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listNodeTypes(_ request: ListNodeTypesRequest) async throws -> ListNodeTypesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await listNodeTypesWithOptions(request as! ListNodeTypesRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func listNodesWithOptions(_ tmpReq: ListNodesRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListNodesResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.diskPL)) {
        ...
        if (!TeaUtils.Client.isUnset(request.podNum)) {
        ...
        if (!TeaUtils.Client.isUnset(request.workloadNum)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listQuotaActiveUserUsagesWithOptions(_ QuotaId: String, _ request: ListQuotaActiveUserUsagesRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListQuotaActiveUserUsagesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.order)) {
            query["Order"] = request.order ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.selfOnly)) {
        ...
        if (!TeaUtils.Client.isUnset(request.workloadCount)) {
        ...
        var params: AlibabacloudOpenApi.Params = AlibabacloudOpenApi.Params([
            ...
            "version": "2022-01-12",
            "protocol": "HTTPS",
            "pathname": "/api/v1/quotas/" + (AlibabaCloudOpenApiUtil.Client.getEncodeParam(QuotaId)) + "/activeuserusages",
            "method": "GET",
            "authType": "AK",
            "style": "ROA",
            "reqBodyType": "json",
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListQuotaActiveUserUsagesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listQuotaActiveUserUsages(_ QuotaId: String, _ request: ListQuotaActiveUserUsagesRequest) async throws -> ListQuotaActiveUserUsagesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: [String: String] = [:]
        return try await listQuotaActiveUserUsagesWithOptions(QuotaId as! String, request as! ListQuotaActiveUserUsagesRequest, headers as! [String: String], runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func listQuotaWorkloadsWithOptions(_ QuotaId: String, _ request: ListQuotaWorkloadsRequest, _ headers: [String: String], _ runtime: TeaUtils.RuntimeOptions) async throws -> ListQuotaWorkloadsResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.useOversoldResource)) {
        ...
        if (!TeaUtils.Client.isUnset(request.workloadNames)) {
