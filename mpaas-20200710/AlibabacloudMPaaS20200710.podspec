Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudMPaaS20200710"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Mobile PaaS (20200710) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/mpaas-20200710" 
