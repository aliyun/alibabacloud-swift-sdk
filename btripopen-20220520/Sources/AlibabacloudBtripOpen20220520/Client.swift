...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func addEmployeeWithOptions(_ tmpReq: AddEmployeeRequest, _ headers: AddEmployeeHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddEmployeeResponse {
        ...
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accountEmail)) {
            body["account_email"] = request.accountEmail ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.accountPhone)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addProjectManagerWithOptions(_ tmpReq: AddProjectManagerRequest, _ headers: AddProjectManagerHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> AddProjectManagerResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: AddProjectManagerShrinkRequest = AddProjectManagerShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.orgEntities)) {
            request.orgEntitiesShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.orgEntities, "org_entities", "json")
        }
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.orgEntitiesShrink)) {
            body["org_entities"] = request.orgEntitiesShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.outProjectId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(AddProjectManagerResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func addProjectManager(_ request: AddProjectManagerRequest) async throws -> AddProjectManagerResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: AddProjectManagerHeaders = AddProjectManagerHeaders([:])
        return try await addProjectManagerWithOptions(request as! AddProjectManagerRequest, headers as! AddProjectManagerHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchQueryDepartmentWithOptions(_ request: BatchQueryDepartmentRequest, _ headers: BatchQueryDepartmentHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> BatchQueryDepartmentResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(BatchQueryDepartmentResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchQueryDepartment(_ request: BatchQueryDepartmentRequest) async throws -> BatchQueryDepartmentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: BatchQueryDepartmentHeaders = BatchQueryDepartmentHeaders([:])
        return try await batchQueryDepartmentWithOptions(request as! BatchQueryDepartmentRequest, headers as! BatchQueryDepartmentHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchSubmitPreBillWithOptions(_ tmpReq: BatchSubmitPreBillRequest, _ headers: BatchSubmitPreBillHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> BatchSubmitPreBillResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: BatchSubmitPreBillShrinkRequest = BatchSubmitPreBillShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        if (!TeaUtils.Client.isUnset(request.customerDecision)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(BatchSubmitPreBillResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func batchSubmitPreBill(_ request: BatchSubmitPreBillRequest) async throws -> BatchSubmitPreBillResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: BatchSubmitPreBillHeaders = BatchSubmitPreBillHeaders([:])
        return try await batchSubmitPreBillWithOptions(request as! BatchSubmitPreBillRequest, headers as! BatchSubmitPreBillHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func carBillSettlementQueryWithOptions(_ request: CarBillSettlementQueryRequest, _ headers: CarBillSettlementQueryHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> CarBillSettlementQueryResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.billRecordTimeEnd)) {
            query["bill_record_time_end"] = request.billRecordTimeEnd ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.billRecordTimeStart)) {
    ...
    public func channelCorpCreateWithOptions(_ request: ChannelCorpCreateRequest, _ headers: ChannelCorpCreateHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> ChannelCorpCreateResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.administratorEmail)) {
        ...
        if (!TeaUtils.Client.isUnset(request.baseCurrency)) {
            body["base_currency"] = request.baseCurrency ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.btripRegion)) {
        ...
        if (!TeaUtils.Client.isUnset(request.corpNameEn)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func confirmPreBillWithOptions(_ request: ConfirmPreBillRequest, _ headers: ConfirmPreBillHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> ConfirmPreBillResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.billBatch)) {
            query["bill_batch"] = request.billBatch ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ConfirmPreBillResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func confirmPreBill(_ request: ConfirmPreBillRequest) async throws -> ConfirmPreBillResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: ConfirmPreBillHeaders = ConfirmPreBillHeaders([:])
        return try await confirmPreBillWithOptions(request as! ConfirmPreBillRequest, headers as! ConfirmPreBillHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func estimatedPriceQueryV2WithOptions(_ request: EstimatedPriceQueryV2Request, _ headers: EstimatedPriceQueryV2Headers, _ runtime: TeaUtils.RuntimeOptions) async throws -> EstimatedPriceQueryV2Response {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.bizType)) {
            query["biz_type"] = request.bizType ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.departDate)) {
            query["depart_date"] = request.departDate ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.fromCity)) {
            query["from_city"] = request.fromCity ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.leaveDate)) {
            query["leave_date"] = request.leaveDate ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.toCity)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(EstimatedPriceQueryV2Response(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func estimatedPriceQueryV2(_ request: EstimatedPriceQueryV2Request) async throws -> EstimatedPriceQueryV2Response {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: EstimatedPriceQueryV2Headers = EstimatedPriceQueryV2Headers([:])
        return try await estimatedPriceQueryV2WithOptions(request as! EstimatedPriceQueryV2Request, headers as! EstimatedPriceQueryV2Headers, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func hotelIndexInfoWithOptions(_ request: HotelIndexInfoRequest, _ headers: HotelIndexInfoHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> HotelIndexInfoResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.internation)) {
    ...
    public func hotelOrderCreateWithOptions(_ tmpReq: HotelOrderCreateRequest, _ headers: HotelOrderCreateHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> HotelOrderCreateResponse {
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.memberInfo)) {
            request.memberInfoShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.memberInfo, "member_info", "json")
        }
        ...
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.arrivalTime)) {
        ...
        if (!TeaUtils.Client.isUnset(request.leaveTime)) {
            body["leave_time"] = request.leaveTime ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.memberInfoShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.rpType)) {
    ...
    public func hotelOrderPreValidateWithOptions(_ tmpReq: HotelOrderPreValidateRequest, _ headers: HotelOrderPreValidateHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> HotelOrderPreValidateResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.rateKey)) {
    ...
    public func hotelSearchWithOptions(_ tmpReq: HotelSearchRequest, _ headers: HotelSearchHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> HotelSearchResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.poi)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func ieCarBillSettlementQueryWithOptions(_ request: IeCarBillSettlementQueryRequest, _ headers: IeCarBillSettlementQueryHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IeCarBillSettlementQueryResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.applyId)) {
            query["apply_id"] = request.applyId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IeCarBillSettlementQueryResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func ieCarBillSettlementQuery(_ request: IeCarBillSettlementQueryRequest) async throws -> IeCarBillSettlementQueryResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IeCarBillSettlementQueryHeaders = IeCarBillSettlementQueryHeaders([:])
        return try await ieCarBillSettlementQueryWithOptions(request as! IeCarBillSettlementQueryRequest, headers as! IeCarBillSettlementQueryHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopApplyWithOptions(_ tmpReq: IntlFlightReShopApplyRequest, _ headers: IntlFlightReShopApplyHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopApplyResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: IntlFlightReShopApplyShrinkRequest = IntlFlightReShopApplyShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.selectedJourneys)) {
            request.selectedJourneysShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.selectedJourneys, "selected_journeys", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.selectedPassengers)) {
            request.selectedPassengersShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.selectedPassengers, "selected_passengers", "json")
        }
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.asyncApplyKey)) {
            body["async_apply_key"] = request.asyncApplyKey ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.asyncApplyMode)) {
        ...
        if (!TeaUtils.Client.isUnset(request.outReShopApplyId)) {
            body["out_re_shop_apply_id"] = request.outReShopApplyId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.passengerJourneyGroupKey)) {
            body["passenger_journey_group_key"] = request.passengerJourneyGroupKey ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.reShopReasonCode)) {
            body["re_shop_reason_code"] = request.reShopReasonCode ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.selectedJourneysShrink)) {
            body["selected_journeys"] = request.selectedJourneysShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.selectedPassengersShrink)) {
            body["selected_passengers"] = request.selectedPassengersShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.userIntentionMemo)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopApplyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopApply(_ request: IntlFlightReShopApplyRequest) async throws -> IntlFlightReShopApplyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopApplyHeaders = IntlFlightReShopApplyHeaders([:])
        return try await intlFlightReShopApplyWithOptions(request as! IntlFlightReShopApplyRequest, headers as! IntlFlightReShopApplyHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopCancelWithOptions(_ request: IntlFlightReShopCancelRequest, _ headers: IntlFlightReShopCancelHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopCancelResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.orderId)) {
            body["order_id"] = request.orderId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.reShopApplyId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopCancelResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopCancel(_ request: IntlFlightReShopCancelRequest) async throws -> IntlFlightReShopCancelResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopCancelHeaders = IntlFlightReShopCancelHeaders([:])
        return try await intlFlightReShopCancelWithOptions(request as! IntlFlightReShopCancelRequest, headers as! IntlFlightReShopCancelHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopCreateWithOptions(_ tmpReq: IntlFlightReShopCreateRequest, _ headers: IntlFlightReShopCreateHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopCreateResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: IntlFlightReShopCreateShrinkRequest = IntlFlightReShopCreateShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.selectedPassengers)) {
            request.selectedPassengersShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.selectedPassengers, "selected_passengers", "json")
        }
        ...
        if (!TeaUtils.Client.isUnset(request.totalReShopFee)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopCreateResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopCreate(_ request: IntlFlightReShopCreateRequest) async throws -> IntlFlightReShopCreateResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopCreateHeaders = IntlFlightReShopCreateHeaders([:])
        return try await intlFlightReShopCreateWithOptions(request as! IntlFlightReShopCreateRequest, headers as! IntlFlightReShopCreateHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopDetailWithOptions(_ request: IntlFlightReShopDetailRequest, _ headers: IntlFlightReShopDetailHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopDetailResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.orderId)) {
            query["order_id"] = request.orderId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopDetailResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopDetail(_ request: IntlFlightReShopDetailRequest) async throws -> IntlFlightReShopDetailResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopDetailHeaders = IntlFlightReShopDetailHeaders([:])
        return try await intlFlightReShopDetailWithOptions(request as! IntlFlightReShopDetailRequest, headers as! IntlFlightReShopDetailHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopListSearchWithOptions(_ tmpReq: IntlFlightReShopListSearchRequest, _ headers: IntlFlightReShopListSearchHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopListSearchResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: IntlFlightReShopListSearchShrinkRequest = IntlFlightReShopListSearchShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.searchJourneys)) {
            request.searchJourneysShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.searchJourneys, "search_journeys", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopListSearchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopListSearch(_ request: IntlFlightReShopListSearchRequest) async throws -> IntlFlightReShopListSearchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopListSearchHeaders = IntlFlightReShopListSearchHeaders([:])
        return try await intlFlightReShopListSearchWithOptions(request as! IntlFlightReShopListSearchRequest, headers as! IntlFlightReShopListSearchHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopOtaSearchWithOptions(_ tmpReq: IntlFlightReShopOtaSearchRequest, _ headers: IntlFlightReShopOtaSearchHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopOtaSearchResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: IntlFlightReShopOtaSearchShrinkRequest = IntlFlightReShopOtaSearchShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.searchJourneys)) {
            request.searchJourneysShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.searchJourneys, "search_journeys", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopOtaSearchResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopOtaSearch(_ request: IntlFlightReShopOtaSearchRequest) async throws -> IntlFlightReShopOtaSearchResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopOtaSearchHeaders = IntlFlightReShopOtaSearchHeaders([:])
        return try await intlFlightReShopOtaSearchWithOptions(request as! IntlFlightReShopOtaSearchRequest, headers as! IntlFlightReShopOtaSearchHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopPayWithOptions(_ request: IntlFlightReShopPayRequest, _ headers: IntlFlightReShopPayHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightReShopPayResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.orderId)) {
            body["order_id"] = request.orderId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightReShopPayResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightReShopPay(_ request: IntlFlightReShopPayRequest) async throws -> IntlFlightReShopPayResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightReShopPayHeaders = IntlFlightReShopPayHeaders([:])
        return try await intlFlightReShopPayWithOptions(request as! IntlFlightReShopPayRequest, headers as! IntlFlightReShopPayHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightRefundApplyWithOptions(_ tmpReq: IntlFlightRefundApplyRequest, _ headers: IntlFlightRefundApplyHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightRefundApplyResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: IntlFlightRefundApplyShrinkRequest = IntlFlightRefundApplyShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.refundSegmentList)) {
            request.refundSegmentListShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.refundSegmentList, "refund_segment_list", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.selectedPassengers)) {
            request.selectedPassengersShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.selectedPassengers, "selected_passengers", "json")
        }
        ...
        if (!TeaUtils.Client.isUnset(request.refundReasonCode)) {
            body["refund_reason_code"] = request.refundReasonCode ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.refundSegmentListShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightRefundApplyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightRefundApply(_ request: IntlFlightRefundApplyRequest) async throws -> IntlFlightRefundApplyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightRefundApplyHeaders = IntlFlightRefundApplyHeaders([:])
        return try await intlFlightRefundApplyWithOptions(request as! IntlFlightRefundApplyRequest, headers as! IntlFlightRefundApplyHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightRefundConsultWithOptions(_ request: IntlFlightRefundConsultRequest, _ headers: IntlFlightRefundConsultHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightRefundConsultResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.orderId)) {
            query["order_id"] = request.orderId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightRefundConsultResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightRefundConsult(_ request: IntlFlightRefundConsultRequest) async throws -> IntlFlightRefundConsultResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightRefundConsultHeaders = IntlFlightRefundConsultHeaders([:])
        return try await intlFlightRefundConsultWithOptions(request as! IntlFlightRefundConsultRequest, headers as! IntlFlightRefundConsultHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightRefundDetailWithOptions(_ request: IntlFlightRefundDetailRequest, _ headers: IntlFlightRefundDetailHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> IntlFlightRefundDetailResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.orderId)) {
            query["order_id"] = request.orderId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(IntlFlightRefundDetailResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func intlFlightRefundDetail(_ request: IntlFlightRefundDetailRequest) async throws -> IntlFlightRefundDetailResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: IntlFlightRefundDetailHeaders = IntlFlightRefundDetailHeaders([:])
        return try await intlFlightRefundDetailWithOptions(request as! IntlFlightRefundDetailRequest, headers as! IntlFlightRefundDetailHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func invoiceAddWithOptions(_ request: InvoiceAddRequest, _ headers: InvoiceAddHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> InvoiceAddResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.mailThirdPartId)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func mealApplyModifyWithOptions(_ tmpReq: MealApplyModifyRequest, _ headers: MealApplyModifyHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> MealApplyModifyResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: MealApplyModifyShrinkRequest = MealApplyModifyShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.applyUser)) {
            request.applyUserShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.applyUser, "apply_user", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(MealApplyModifyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func mealApplyModify(_ request: MealApplyModifyRequest) async throws -> MealApplyModifyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: MealApplyModifyHeaders = MealApplyModifyHeaders([:])
        return try await mealApplyModifyWithOptions(request as! MealApplyModifyRequest, headers as! MealApplyModifyHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func monthPreBillGetWithOptions(_ request: MonthPreBillGetRequest, _ headers: MonthPreBillGetHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> MonthPreBillGetResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.billBatch)) {
            query["bill_batch"] = request.billBatch ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(MonthPreBillGetResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func monthPreBillGet(_ request: MonthPreBillGetRequest) async throws -> MonthPreBillGetResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: MonthPreBillGetHeaders = MonthPreBillGetHeaders([:])
        return try await monthPreBillGetWithOptions(request as! MonthPreBillGetRequest, headers as! MonthPreBillGetHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func projectAddWithOptions(_ request: ProjectAddRequest, _ headers: ProjectAddHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> ProjectAddResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.hasManager)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryCompenInfosForOpWithOptions(_ request: QueryCompenInfosForOpRequest, _ headers: QueryCompenInfosForOpHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> QueryCompenInfosForOpResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.category)) {
            query["category"] = request.category!;
        }
        if (!TeaUtils.Client.isUnset(request.compenId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(QueryCompenInfosForOpResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func queryCompenInfosForOp(_ request: QueryCompenInfosForOpRequest) async throws -> QueryCompenInfosForOpResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: QueryCompenInfosForOpHeaders = QueryCompenInfosForOpHeaders([:])
        return try await queryCompenInfosForOpWithOptions(request as! QueryCompenInfosForOpRequest, headers as! QueryCompenInfosForOpHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func removeProjectManagerWithOptions(_ tmpReq: RemoveProjectManagerRequest, _ headers: RemoveProjectManagerHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> RemoveProjectManagerResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: RemoveProjectManagerShrinkRequest = RemoveProjectManagerShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.orgEntities)) {
            request.orgEntitiesShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.orgEntities, "org_entities", "json")
        }
        ...
        if (!TeaUtils.Client.isUnset(request.removeAll)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RemoveProjectManagerResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func removeProjectManager(_ request: RemoveProjectManagerRequest) async throws -> RemoveProjectManagerResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: RemoveProjectManagerHeaders = RemoveProjectManagerHeaders([:])
        return try await removeProjectManagerWithOptions(request as! RemoveProjectManagerRequest, headers as! RemoveProjectManagerHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func trainTicketScanQueryWithOptions(_ request: TrainTicketScanQueryRequest, _ headers: TrainTicketScanQueryHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> TrainTicketScanQueryResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.invoiceDateEnd)) {
            query["invoice_date_end"] = request.invoiceDateEnd ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.invoiceDateStart)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardRelateAddWithOptions(_ tmpReq: TravelStandardRelateAddRequest, _ headers: TravelStandardRelateAddHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> TravelStandardRelateAddResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: TravelStandardRelateAddShrinkRequest = TravelStandardRelateAddShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.addList)) {
            request.addListShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.addList, "add_list", "json")
        }
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.addListShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TravelStandardRelateAddResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardRelateAdd(_ request: TravelStandardRelateAddRequest) async throws -> TravelStandardRelateAddResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: TravelStandardRelateAddHeaders = TravelStandardRelateAddHeaders([:])
        return try await travelStandardRelateAddWithOptions(request as! TravelStandardRelateAddRequest, headers as! TravelStandardRelateAddHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardRelateDeleteWithOptions(_ tmpReq: TravelStandardRelateDeleteRequest, _ headers: TravelStandardRelateDeleteHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> TravelStandardRelateDeleteResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: TravelStandardRelateDeleteShrinkRequest = TravelStandardRelateDeleteShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.removeList)) {
            request.removeListShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.removeList, "remove_list", "json")
        }
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.fromGroup)) {
            body["from_group"] = request.fromGroup!;
        }
        if (!TeaUtils.Client.isUnset(request.removeListShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TravelStandardRelateDeleteResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardRelateDelete(_ request: TravelStandardRelateDeleteRequest) async throws -> TravelStandardRelateDeleteResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: TravelStandardRelateDeleteHeaders = TravelStandardRelateDeleteHeaders([:])
        return try await travelStandardRelateDeleteWithOptions(request as! TravelStandardRelateDeleteRequest, headers as! TravelStandardRelateDeleteHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardRelateQueryWithOptions(_ request: TravelStandardRelateQueryRequest, _ headers: TravelStandardRelateQueryHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> TravelStandardRelateQueryResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.fromGroup)) {
            query["from_group"] = request.fromGroup!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TravelStandardRelateQueryResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardRelateQuery(_ request: TravelStandardRelateQueryRequest) async throws -> TravelStandardRelateQueryResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: TravelStandardRelateQueryHeaders = TravelStandardRelateQueryHeaders([:])
        return try await travelStandardRelateQueryWithOptions(request as! TravelStandardRelateQueryRequest, headers as! TravelStandardRelateQueryHeaders, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardScopeSaveWithOptions(_ request: TravelStandardScopeSaveRequest, _ headers: TravelStandardScopeSaveHeaders, _ runtime: TeaUtils.RuntimeOptions) async throws -> TravelStandardScopeSaveResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.fromGroup)) {
            query["from_group"] = request.fromGroup!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TravelStandardScopeSaveResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func travelStandardScopeSave(_ request: TravelStandardScopeSaveRequest) async throws -> TravelStandardScopeSaveResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        var headers: TravelStandardScopeSaveHeaders = TravelStandardScopeSaveHeaders([:])
        return try await travelStandardScopeSaveWithOptions(request as! TravelStandardScopeSaveRequest, headers as! TravelStandardScopeSaveHeaders, runtime as! TeaUtils.RuntimeOptions)
    }
