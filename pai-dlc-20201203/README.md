...
```ruby
pod 'AlibabacloudPaiDlc20201203', '~> 1.0.1'
```
...
```ogdl
github "alibabacloud-sdk-swift/pai-dlc-20201203" "1.0.1"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/pai-dlc-20201203.git", from: "1.0.1")
]
```
