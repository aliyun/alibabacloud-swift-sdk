...
public class CreateJobTemplateResponseBody : Tea.TeaModel {
    public var defaultVersion: Int32?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["DefaultVersion"] as? Int32 {
...
public class CreateRayHistoryServerRequest : Tea.TeaModel {
    public var accessibility: String?
    ...
    public var maxRuntimeMinutes: Int32?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.maxRuntimeMinutes != nil {
            map["MaxRuntimeMinutes"] = self.maxRuntimeMinutes!
        }
        if self.resourceId != nil {
            map["ResourceId"] = self.resourceId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["MaxRuntimeMinutes"] as? Int32 {
            self.maxRuntimeMinutes = value
        }
        if let value = dict["ResourceId"] as? String {
            self.resourceId = value
        }
...
public class CreateRayHistoryServerResponseBody : Tea.TeaModel {
    public var rayHistoryServerId: String?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.rayHistoryServerId != nil {
            map["RayHistoryServerId"] = self.rayHistoryServerId!
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["RayHistoryServerId"] as? String {
            self.rayHistoryServerId = value
        }
        if let value = dict["RequestId"] as? String {
            self.requestId = value
        }
...
public class CreateRayHistoryServerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateRayHistoryServerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateRayHistoryServerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class CreateSignalRequest : Tea.TeaModel {
    public var signal: String?

    public var target: SignalTarget?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["Signal"] as? String {
            self.signal = value
        }
        if let value = dict["Target"] as? [String: Any?] {
            var model = SignalTarget()
            model.fromMap(value)
            self.target = model
        }
    }
...
public class CreateSignalResponseBody : Tea.TeaModel {
    public var jobId: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.signalId != nil {
            map["SignalId"] = self.signalId!
        }
        if self.status != nil {
            map["Status"] = self.status!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["SignalId"] as? String {
            self.signalId = value
        }
        if let value = dict["Status"] as? String {
            self.status = value
...
public class CreateSignalResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: CreateSignalResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = CreateSignalResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteJobTemplateRequest : Tea.TeaModel {
...
public class DeleteJobTemplateResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteJobTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteJobTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteJobTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DeleteRayHistoryServerRequest : Tea.TeaModel {
...
public class DeleteRayHistoryServerResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class DeleteRayHistoryServerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteRayHistoryServerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteRayHistoryServerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetJobTemplateRequest : Tea.TeaModel {
...
public class GetJobTemplateResponseBody : Tea.TeaModel {
    ...
    public var versions: [GetJobTemplateResponseBody.Versions]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.modifiedBy != nil {
            map["ModifiedBy"] = self.modifiedBy!
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ModifiedBy"] as? String {
        ...
        if let value = dict["Versions"] as? [Any?] {
            var tmp : [GetJobTemplateResponseBody.Versions] = []
            for v in value {
                if v != nil {
                    var model = GetJobTemplateResponseBody.Versions()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class GetJobTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetJobTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetJobTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetRayHistoryServerRequest : Tea.TeaModel {
...
public class GetRayHistoryServerResponseBody : Tea.TeaModel {
    public var accessibility: String?
    ...
    public var rayHistoryServerUrl: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.rayHistoryServerUrl != nil {
            map["RayHistoryServerUrl"] = self.rayHistoryServerUrl!
        }
        if self.reasonCode != nil {
            map["ReasonCode"] = self.reasonCode!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RayHistoryServerUrl"] as? String {
            self.rayHistoryServerUrl = value
        }
        if let value = dict["ReasonCode"] as? String {
            self.reasonCode = value
        }
...
public class GetRayHistoryServerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetRayHistoryServerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetRayHistoryServerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetSignalRequest : Tea.TeaModel {
    public var token: String?
...
public class GetSignalResponseBody : Tea.TeaModel {
    public var gmtCreated: String?
...
public class GetSignalResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetSignalResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetSignalResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListJobTemplatesResponseBody : Tea.TeaModel {
    ...
    public var jobTemplates: [ListJobTemplatesResponseBody.JobTemplates]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["JobTemplates"] as? [Any?] {
            var tmp : [ListJobTemplatesResponseBody.JobTemplates] = []
            for v in value {
                if v != nil {
                    var model = ListJobTemplatesResponseBody.JobTemplates()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListRayHistoryServersRequest : Tea.TeaModel {
    public var displayName: String?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.idPrefix != nil {
            map["IdPrefix"] = self.idPrefix!
        }
        if self.modifiedAfter != nil {
            map["ModifiedAfter"] = self.modifiedAfter!
        }
        if self.order != nil {
            map["Order"] = self.order!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["IdPrefix"] as? String {
            self.idPrefix = value
        }
        if let value = dict["ModifiedAfter"] as? String {
            self.modifiedAfter = value
        }
        if let value = dict["Order"] as? String {
            self.order = value
        }
...
public class ListRayHistoryServersResponseBody : Tea.TeaModel {
    public class RayHistoryServers : Tea.TeaModel {
        public var accessibility: String?
    ...
    public var rayHistoryServers: [ListRayHistoryServersResponseBody.RayHistoryServers]?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.rayHistoryServers != nil {
            var tmp : [Any] = []
            for k in self.rayHistoryServers! {
                tmp.append(k.toMap())
            }
            map["RayHistoryServers"] = tmp
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["RayHistoryServers"] as? [Any?] {
            var tmp : [ListRayHistoryServersResponseBody.RayHistoryServers] = []
            for v in value {
                if v != nil {
                    var model = ListRayHistoryServersResponseBody.RayHistoryServers()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListRayHistoryServersResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListRayHistoryServersResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListRayHistoryServersResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class ListSignalsRequest : Tea.TeaModel {
    public var order: String?
...
public class ListSignalsResponseBody : Tea.TeaModel {
    public class Signals : Tea.TeaModel {
        public var gmtCreated: String?
    ...
    public var signals: [ListSignalsResponseBody.Signals]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Signals"] as? [Any?] {
            var tmp : [ListSignalsResponseBody.Signals] = []
            for v in value {
                if v != nil {
                    var model = ListSignalsResponseBody.Signals()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class ListSignalsResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: ListSignalsResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = ListSignalsResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class SetJobTemplateDefaultVersionRequest : Tea.TeaModel {
    public var version: Int32?
...
public class SetJobTemplateDefaultVersionResponseBody : Tea.TeaModel {
    public var defaultVersion: Int32?
...
public class SetJobTemplateDefaultVersionResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: SetJobTemplateDefaultVersionResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = SetJobTemplateDefaultVersionResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class StartRayHistoryServerRequest : Tea.TeaModel {
...
public class StartRayHistoryServerResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class StartRayHistoryServerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: StartRayHistoryServerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = StartRayHistoryServerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class StopRayHistoryServerRequest : Tea.TeaModel {
...
public class StopRayHistoryServerResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class StopRayHistoryServerResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: StopRayHistoryServerResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = StopRayHistoryServerResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class UpdateJobTemplateRequest : Tea.TeaModel {
    public var constraints: [String: Any]?
...
public class UpdateJobTemplateResponseBody : Tea.TeaModel {
    public var defaultVersion: Int32?
    ...
    public var versionCreated: Bool?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.versionCreated != nil {
            map["VersionCreated"] = self.versionCreated!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["VersionCreated"] as? Bool {
            self.versionCreated = value
        }
    }
}

public class UpdateJobTemplateResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: UpdateJobTemplateResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = UpdateJobTemplateResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
