...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func describeApiGroupsWithOptions(_ request: DescribeApiGroupsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeApiGroupsResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.notClassic)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func exportSwaggerWithOptions(_ request: ExportSwaggerRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ExportSwaggerResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.apiUid)) {
            query["ApiUid"] = request.apiUid ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ExportSwaggerResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func exportSwagger(_ request: ExportSwaggerRequest) async throws -> ExportSwaggerResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await exportSwaggerWithOptions(request as! ExportSwaggerRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func importSwaggerWithOptions(_ request: ImportSwaggerRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ImportSwaggerResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.dataFormat)) {
            query["DataFormat"] = request.dataFormat ?? "";
