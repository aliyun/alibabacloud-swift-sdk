...
```ruby
pod 'AlibabacloudAvatar20220130', '~> 1.0.16'
```
...
```ogdl
github "alibabacloud-sdk-swift/avatar-20220130" "1.0.16"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/avatar-20220130.git", from: "1.0.16")
]
```
