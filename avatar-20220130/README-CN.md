...
```ruby
pod 'AlibabacloudAvatar20220130', '~> 1.0.19'
```
...
```ogdl
github "alibabacloud-sdk-swift/avatar-20220130" "1.0.19"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/avatar-20220130.git", from: "1.0.19")
]
```
