Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudVs20181212"
  spec.version      = "3.5.2"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud video surveillance system (20181212) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/vs-20181212" 
