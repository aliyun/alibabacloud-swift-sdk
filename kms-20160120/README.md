...
```ruby
pod 'AlibabacloudKms20160120', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/kms-20160120" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/kms-20160120.git", from: "1.0.0")
]
```
