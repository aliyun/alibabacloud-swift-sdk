Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudDyvmsapi20170525"
  spec.version      = "3.2.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Dyvmsapi (20170525) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/dyvmsapi-20170525" 
