...
open class Client : AlibabacloudOpenApi.Client {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func checkDataAgentMemoryConfigWithOptions(_ request: CheckDataAgentMemoryConfigRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CheckDataAgentMemoryConfigResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DMSUnit)) {
            query["DMSUnit"] = request.DMSUnit ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CheckDataAgentMemoryConfigResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func checkDataAgentMemoryConfig(_ request: CheckDataAgentMemoryConfigRequest) async throws -> CheckDataAgentMemoryConfigResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await checkDataAgentMemoryConfigWithOptions(request as! CheckDataAgentMemoryConfigRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func configAirflowWithOptions(_ tmpReq: ConfigAirflowRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ConfigAirflowResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: ConfigAirflowShrinkRequest = ConfigAirflowShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.customAirflowCfg)) {
            request.customAirflowCfgShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.customAirflowCfg, "CustomAirflowCfg", "simple")
        }
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.airflowId)) {
            query["AirflowId"] = request.airflowId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.customAirflowCfgShrink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ConfigAirflowResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func configAirflow(_ request: ConfigAirflowRequest) async throws -> ConfigAirflowResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await configAirflowWithOptions(request as! ConfigAirflowRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func configDataAgentMemoryWithOptions(_ request: ConfigDataAgentMemoryRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ConfigDataAgentMemoryResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DMSUnit)) {
            query["DMSUnit"] = request.DMSUnit ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.recallEnabled)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ConfigDataAgentMemoryResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func configDataAgentMemory(_ request: ConfigDataAgentMemoryRequest) async throws -> ConfigDataAgentMemoryResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await configDataAgentMemoryWithOptions(request as! ConfigDataAgentMemoryRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func createAgentWithOptions(_ request: CreateAgentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateAgentResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.expireAfterSeconds)) {
    ...
    public func createCustomAgentWithOptions(_ tmpReq: CreateCustomAgentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateCustomAgentResponse {
        ...
        if (!TeaUtils.Client.isUnset(tmpReq.knowledgeConfigList)) {
            request.knowledgeConfigListShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.knowledgeConfigList, "KnowledgeConfigList", "json")
        }
        if (!TeaUtils.Client.isUnset(tmpReq.knowledgeSemanticConfigList)) {
            request.knowledgeSemanticConfigListShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.knowledgeSemanticConfigList, "KnowledgeSemanticConfigList", "json")
        }
        ...
        if (!TeaUtils.Client.isUnset(request.dataJson)) {
            query["DataJson"] = request.dataJson ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.executionConfigShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.knowledgeConfigListShrink)) {
            query["KnowledgeConfigList"] = request.knowledgeConfigListShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.knowledgeSemanticConfigListShrink)) {
            query["KnowledgeSemanticConfigList"] = request.knowledgeSemanticConfigListShrink ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.name)) {
            query["Name"] = request.name ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.relatedSessionId)) {
            query["RelatedSessionId"] = request.relatedSessionId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.scheduleTaskConfigShrink)) {
        ...
        if (!TeaUtils.Client.isUnset(request.webReportTheme)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentAccuracyTestWithOptions(_ request: CreateDataAgentAccuracyTestRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateDataAgentAccuracyTestResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.evaluationPrompt)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateDataAgentAccuracyTestResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentAccuracyTest(_ request: CreateDataAgentAccuracyTestRequest) async throws -> CreateDataAgentAccuracyTestResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createDataAgentAccuracyTestWithOptions(request as! CreateDataAgentAccuracyTestRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func createDataAgentKnowledgeBaseWithOptions(_ request: CreateDataAgentKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateDataAgentKnowledgeBaseResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.fromKbUuid)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateDataAgentKnowledgeBaseResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentKnowledgeBase(_ request: CreateDataAgentKnowledgeBaseRequest) async throws -> CreateDataAgentKnowledgeBaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createDataAgentKnowledgeBaseWithOptions(request as! CreateDataAgentKnowledgeBaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentSkillMetaWithOptions(_ request: CreateDataAgentSkillMetaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateDataAgentSkillMetaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateDataAgentSkillMetaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentSkillMeta(_ request: CreateDataAgentSkillMetaRequest) async throws -> CreateDataAgentSkillMetaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createDataAgentSkillMetaWithOptions(request as! CreateDataAgentSkillMetaRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentThemeWithOptions(_ request: CreateDataAgentThemeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> CreateDataAgentThemeResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.themeName)) {
            query["ThemeName"] = request.themeName ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.themeType)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(CreateDataAgentThemeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func createDataAgentTheme(_ request: CreateDataAgentThemeRequest) async throws -> CreateDataAgentThemeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await createDataAgentThemeWithOptions(request as! CreateDataAgentThemeRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentWithOptions(_ request: DeleteDataAgentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteDataAgentResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DMSUnit)) {
            query["DMSUnit"] = request.DMSUnit ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteDataAgentResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgent(_ request: DeleteDataAgentRequest) async throws -> DeleteDataAgentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteDataAgentWithOptions(request as! DeleteDataAgentRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentAccuracyTestWithOptions(_ request: DeleteDataAgentAccuracyTestRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteDataAgentAccuracyTestResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestInsId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteDataAgentAccuracyTestResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentAccuracyTest(_ request: DeleteDataAgentAccuracyTestRequest) async throws -> DeleteDataAgentAccuracyTestResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteDataAgentAccuracyTestWithOptions(request as! DeleteDataAgentAccuracyTestRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentKnowledgeBaseWithOptions(_ request: DeleteDataAgentKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteDataAgentKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.DMSUnit)) {
            query["DMSUnit"] = request.DMSUnit ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteDataAgentKnowledgeBaseResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentKnowledgeBase(_ request: DeleteDataAgentKnowledgeBaseRequest) async throws -> DeleteDataAgentKnowledgeBaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteDataAgentKnowledgeBaseWithOptions(request as! DeleteDataAgentKnowledgeBaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func deleteDataAgentMemoryWithOptions(_ request: DeleteDataAgentMemoryRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteDataAgentMemoryResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteDataAgentMemoryResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentMemory(_ request: DeleteDataAgentMemoryRequest) async throws -> DeleteDataAgentMemoryResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteDataAgentMemoryWithOptions(request as! DeleteDataAgentMemoryRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentSkillMetaWithOptions(_ request: DeleteDataAgentSkillMetaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteDataAgentSkillMetaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteDataAgentSkillMetaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDataAgentSkillMeta(_ request: DeleteDataAgentSkillMetaRequest) async throws -> DeleteDataAgentSkillMetaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteDataAgentSkillMetaWithOptions(request as! DeleteDataAgentSkillMetaRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDocumentChunksWithOptions(_ tmpReq: DeleteDocumentChunksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteDocumentChunksResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: DeleteDocumentChunksShrinkRequest = DeleteDocumentChunksShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteDocumentChunksResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteDocumentChunks(_ request: DeleteDocumentChunksRequest) async throws -> DeleteDocumentChunksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteDocumentChunksWithOptions(request as! DeleteDocumentChunksRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteWorkspaceCodeWithOptions(_ request: DeleteWorkspaceCodeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DeleteWorkspaceCodeResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.symlink)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DeleteWorkspaceCodeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func deleteWorkspaceCode(_ request: DeleteWorkspaceCodeRequest) async throws -> DeleteWorkspaceCodeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await deleteWorkspaceCodeWithOptions(request as! DeleteWorkspaceCodeRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeCustomAgentMonitorMetricsWithOptions(_ request: DescribeCustomAgentMonitorMetricsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeCustomAgentMonitorMetricsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.customAgentId)) {
            query["CustomAgentId"] = request.customAgentId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeCustomAgentMonitorMetricsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeCustomAgentMonitorMetrics(_ request: DescribeCustomAgentMonitorMetricsRequest) async throws -> DescribeCustomAgentMonitorMetricsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeCustomAgentMonitorMetricsWithOptions(request as! DescribeCustomAgentMonitorMetricsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDataAgentMetricsWithOptions(_ request: DescribeDataAgentMetricsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeDataAgentMetricsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.endTime)) {
            query["EndTime"] = request.endTime!;
        }
        if (!TeaUtils.Client.isUnset(request.metricNames)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeDataAgentMetricsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDataAgentMetrics(_ request: DescribeDataAgentMetricsRequest) async throws -> DescribeDataAgentMetricsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeDataAgentMetricsWithOptions(request as! DescribeDataAgentMetricsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDataAgentThemeWithOptions(_ request: DescribeDataAgentThemeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeDataAgentThemeResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.themeId)) {
            query["ThemeId"] = request.themeId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeDataAgentThemeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeDataAgentTheme(_ request: DescribeDataAgentThemeRequest) async throws -> DescribeDataAgentThemeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeDataAgentThemeWithOptions(request as! DescribeDataAgentThemeRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeKnowledgeBaseStatsWithOptions(_ request: DescribeKnowledgeBaseStatsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeKnowledgeBaseStatsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.kbUuid)) {
            query["KbUuid"] = request.kbUuid ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeKnowledgeBaseStatsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeKnowledgeBaseStats(_ request: DescribeKnowledgeBaseStatsRequest) async throws -> DescribeKnowledgeBaseStatsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeKnowledgeBaseStatsWithOptions(request as! DescribeKnowledgeBaseStatsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeKnowledgeBaseUploadSignatureWithOptions(_ request: DescribeKnowledgeBaseUploadSignatureRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeKnowledgeBaseUploadSignatureResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.kbUuid)) {
            query["KbUuid"] = request.kbUuid ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeKnowledgeBaseUploadSignatureResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeKnowledgeBaseUploadSignature(_ request: DescribeKnowledgeBaseUploadSignatureRequest) async throws -> DescribeKnowledgeBaseUploadSignatureResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeKnowledgeBaseUploadSignatureWithOptions(request as! DescribeKnowledgeBaseUploadSignatureRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeSkillFileUploadSignatureWithOptions(_ request: DescribeSkillFileUploadSignatureRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeSkillFileUploadSignatureResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.workspaceId)) {
            query["WorkspaceId"] = request.workspaceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeSkillFileUploadSignatureResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeSkillFileUploadSignature(_ request: DescribeSkillFileUploadSignatureRequest) async throws -> DescribeSkillFileUploadSignatureResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeSkillFileUploadSignatureWithOptions(request as! DescribeSkillFileUploadSignatureRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAgenticAgentByInstallTokenWithOptions(_ request: GetAgenticAgentByInstallTokenRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAgenticAgentByInstallTokenResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.installToken)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAgenticAgentByInstallTokenResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAgenticAgentByInstallToken(_ request: GetAgenticAgentByInstallTokenRequest) async throws -> GetAgenticAgentByInstallTokenResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAgenticAgentByInstallTokenWithOptions(request as! GetAgenticAgentByInstallTokenRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getDataAgentTaskModelUsageWithOptions(_ tmpReq: GetDataAgentTaskModelUsageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetDataAgentTaskModelUsageResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: GetDataAgentTaskModelUsageShrinkRequest = GetDataAgentTaskModelUsageShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        ...
        if (!TeaUtils.Client.isUnset(request.payLevel)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetDataAgentTaskModelUsageResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getDataAgentTaskModelUsage(_ request: GetDataAgentTaskModelUsageRequest) async throws -> GetDataAgentTaskModelUsageResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getDataAgentTaskModelUsageWithOptions(request as! GetDataAgentTaskModelUsageRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getDataAgentTaskModelUsageMetricsWithOptions(_ tmpReq: GetDataAgentTaskModelUsageMetricsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetDataAgentTaskModelUsageMetricsResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: GetDataAgentTaskModelUsageMetricsShrinkRequest = GetDataAgentTaskModelUsageMetricsShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
        if (!TeaUtils.Client.isUnset(tmpReq.instanceIds)) {
            request.instanceIdsShrink = AlibabaCloudOpenApiUtil.Client.arrayToStringWithSpecifiedStyle(tmpReq.instanceIds, "InstanceIds", "json")
        }
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetDataAgentTaskModelUsageMetricsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getDataAgentTaskModelUsageMetrics(_ request: GetDataAgentTaskModelUsageMetricsRequest) async throws -> GetDataAgentTaskModelUsageMetricsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getDataAgentTaskModelUsageMetricsWithOptions(request as! GetDataAgentTaskModelUsageMetricsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getDataAgentThemeUploadSignatureWithOptions(_ request: GetDataAgentThemeUploadSignatureRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetDataAgentThemeUploadSignatureResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.themeId)) {
            query["ThemeId"] = request.themeId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetDataAgentThemeUploadSignatureResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getDataAgentThemeUploadSignature(_ request: GetDataAgentThemeUploadSignatureRequest) async throws -> GetDataAgentThemeUploadSignatureResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getDataAgentThemeUploadSignatureWithOptions(request as! GetDataAgentThemeUploadSignatureRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func getSqlConsoleOperationLogWithOptions(_ request: GetSqlConsoleOperationLogRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetSqlConsoleOperationLogResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetSqlConsoleOperationLogResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getSqlConsoleOperationLog(_ request: GetSqlConsoleOperationLogRequest) async throws -> GetSqlConsoleOperationLogResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getSqlConsoleOperationLogWithOptions(request as! GetSqlConsoleOperationLogRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getWorkspaceCodeWithOptions(_ request: GetWorkspaceCodeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetWorkspaceCodeResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetWorkspaceCodeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getWorkspaceCode(_ request: GetWorkspaceCodeRequest) async throws -> GetWorkspaceCodeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getWorkspaceCodeWithOptions(request as! GetWorkspaceCodeRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getWorkspaceCodePublishSettingWithOptions(_ request: GetWorkspaceCodePublishSettingRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetWorkspaceCodePublishSettingResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.workspaceId)) {
            query["WorkspaceId"] = request.workspaceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetWorkspaceCodePublishSettingResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getWorkspaceCodePublishSetting(_ request: GetWorkspaceCodePublishSettingRequest) async throws -> GetWorkspaceCodePublishSettingResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getWorkspaceCodePublishSettingWithOptions(request as! GetWorkspaceCodePublishSettingRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getWorkspaceQuotaWithOptions(_ request: GetWorkspaceQuotaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetWorkspaceQuotaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.workspaceId)) {
            query["WorkspaceId"] = request.workspaceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetWorkspaceQuotaResponse(), tmp)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAirflowVersionsWithOptions(_ request: ListAirflowVersionsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListAirflowVersionsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.workspaceId)) {
            query["WorkspaceId"] = request.workspaceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListAirflowVersionsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listAirflowVersions(_ request: ListAirflowVersionsRequest) async throws -> ListAirflowVersionsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listAirflowVersionsWithOptions(request as! ListAirflowVersionsRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listCustomAgentMonitorSessionsWithOptions(_ request: ListCustomAgentMonitorSessionsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListCustomAgentMonitorSessionsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.customAgentId)) {
            query["CustomAgentId"] = request.customAgentId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListCustomAgentMonitorSessionsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listCustomAgentMonitorSessions(_ request: ListCustomAgentMonitorSessionsRequest) async throws -> ListCustomAgentMonitorSessionsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listCustomAgentMonitorSessionsWithOptions(request as! ListCustomAgentMonitorSessionsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentAccuracyTestInstancesWithOptions(_ request: ListDataAgentAccuracyTestInstancesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentAccuracyTestInstancesResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestInsId)) {
            query["AccuracyTestInsId"] = request.accuracyTestInsId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentAccuracyTestInstancesResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentAccuracyTestInstances(_ request: ListDataAgentAccuracyTestInstancesRequest) async throws -> ListDataAgentAccuracyTestInstancesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentAccuracyTestInstancesWithOptions(request as! ListDataAgentAccuracyTestInstancesRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentAccuracyTestResultsWithOptions(_ request: ListDataAgentAccuracyTestResultsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentAccuracyTestResultsResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestInsId)) {
            query["AccuracyTestInsId"] = request.accuracyTestInsId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.accuracyTestResultId)) {
            query["AccuracyTestResultId"] = request.accuracyTestResultId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.accuracyTestSubtaskId)) {
            query["AccuracyTestSubtaskId"] = request.accuracyTestSubtaskId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.accuracyTestTaskId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentAccuracyTestResultsResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentAccuracyTestResults(_ request: ListDataAgentAccuracyTestResultsRequest) async throws -> ListDataAgentAccuracyTestResultsResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentAccuracyTestResultsWithOptions(request as! ListDataAgentAccuracyTestResultsRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentAccuracyTestTasksWithOptions(_ request: ListDataAgentAccuracyTestTasksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentAccuracyTestTasksResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestInsId)) {
            query["AccuracyTestInsId"] = request.accuracyTestInsId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentAccuracyTestTasksResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentAccuracyTestTasks(_ request: ListDataAgentAccuracyTestTasksRequest) async throws -> ListDataAgentAccuracyTestTasksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentAccuracyTestTasksWithOptions(request as! ListDataAgentAccuracyTestTasksRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func listDataAgentMemoryWithOptions(_ request: ListDataAgentMemoryRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentMemoryResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.contentPattern)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentMemoryResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentMemory(_ request: ListDataAgentMemoryRequest) async throws -> ListDataAgentMemoryResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentMemoryWithOptions(request as! ListDataAgentMemoryRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentSessionWithOptions(_ request: ListDataAgentSessionRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentSessionResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.isSaved)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentSessionResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentSession(_ request: ListDataAgentSessionRequest) async throws -> ListDataAgentSessionResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentSessionWithOptions(request as! ListDataAgentSessionRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentSkillMetaWithOptions(_ request: ListDataAgentSkillMetaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentSkillMetaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.pageNumber)) {
            query["PageNumber"] = request.pageNumber!;
        ...
        if (!TeaUtils.Client.isUnset(request.skillFrom)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentSkillMetaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentSkillMeta(_ request: ListDataAgentSkillMetaRequest) async throws -> ListDataAgentSkillMetaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentSkillMetaWithOptions(request as! ListDataAgentSkillMetaRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentThemeWithOptions(_ request: ListDataAgentThemeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataAgentThemeResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.category)) {
            query["Category"] = request.category ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.themeFrom)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataAgentThemeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataAgentTheme(_ request: ListDataAgentThemeRequest) async throws -> ListDataAgentThemeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataAgentThemeWithOptions(request as! ListDataAgentThemeRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataCenterDatabaseWithOptions(_ request: ListDataCenterDatabaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataCenterDatabaseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.callFrom)) {
            query["CallFrom"] = request.callFrom ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataCenterDatabaseResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataCenterDatabase(_ request: ListDataCenterDatabaseRequest) async throws -> ListDataCenterDatabaseResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataCenterDatabaseWithOptions(request as! ListDataCenterDatabaseRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataCenterTableWithOptions(_ request: ListDataCenterTableRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDataCenterTableResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.callFrom)) {
            query["CallFrom"] = request.callFrom ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDataCenterTableResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDataCenterTable(_ request: ListDataCenterTableRequest) async throws -> ListDataCenterTableResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDataCenterTableWithOptions(request as! ListDataCenterTableRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDocumentChunksWithOptions(_ request: ListDocumentChunksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListDocumentChunksResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.chunkTitlePattern)) {
        ...
        if (!TeaUtils.Client.isUnset(request.sortFieldName)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListDocumentChunksResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listDocumentChunks(_ request: ListDocumentChunksRequest) async throws -> ListDocumentChunksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listDocumentChunksWithOptions(request as! ListDocumentChunksRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listKnowledgeBasesWithOptions(_ request: ListKnowledgeBasesRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListKnowledgeBasesResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.filters)) {
            body["Filters"] = request.filters ?? "";
    ...
    public func listKnowledgeBases(_ request: ListKnowledgeBasesRequest) async throws -> ListKnowledgeBasesResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listKnowledgeBasesWithOptions(request as! ListKnowledgeBasesRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func listWorkspaceCodeWithOptions(_ request: ListWorkspaceCodeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ListWorkspaceCodeResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ListWorkspaceCodeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func listWorkspaceCode(_ request: ListWorkspaceCodeRequest) async throws -> ListWorkspaceCodeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await listWorkspaceCodeWithOptions(request as! ListWorkspaceCodeRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyCustomAgentWithOptions(_ tmpReq: ModifyCustomAgentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyCustomAgentResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyCustomAgentResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyCustomAgent(_ request: ModifyCustomAgentRequest) async throws -> ModifyCustomAgentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyCustomAgentWithOptions(request as! ModifyCustomAgentRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyDataAgentThemeWithOptions(_ request: ModifyDataAgentThemeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ModifyDataAgentThemeResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ModifyDataAgentThemeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func modifyDataAgentTheme(_ request: ModifyDataAgentThemeRequest) async throws -> ModifyDataAgentThemeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await modifyDataAgentThemeWithOptions(request as! ModifyDataAgentThemeRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func operateCustomAgentWithOptions(_ request: OperateCustomAgentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> OperateCustomAgentResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(OperateCustomAgentResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func operateCustomAgent(_ request: OperateCustomAgentRequest) async throws -> OperateCustomAgentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await operateCustomAgentWithOptions(request as! OperateCustomAgentRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func redeployAirflowWithOptions(_ request: RedeployAirflowRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> RedeployAirflowResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.airflowId)) {
            query["AirflowId"] = request.airflowId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(RedeployAirflowResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func redeployAirflow(_ request: RedeployAirflowRequest) async throws -> RedeployAirflowResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await redeployAirflowWithOptions(request as! RedeployAirflowRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resetAgenticApiKeyWithOptions(_ request: ResetAgenticApiKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> ResetAgenticApiKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.expireAfterSeconds)) {
            query["ExpireAfterSeconds"] = request.expireAfterSeconds!;
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(ResetAgenticApiKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func resetAgenticApiKey(_ request: ResetAgenticApiKeyRequest) async throws -> ResetAgenticApiKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await resetAgenticApiKeyWithOptions(request as! ResetAgenticApiKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func saveWorkspaceCodeWithOptions(_ request: SaveWorkspaceCodeRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SaveWorkspaceCodeResponse {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SaveWorkspaceCodeResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func saveWorkspaceCode(_ request: SaveWorkspaceCodeRequest) async throws -> SaveWorkspaceCodeResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await saveWorkspaceCodeWithOptions(request as! SaveWorkspaceCodeRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func sendChatMessageWithOptions(_ tmpReq: SendChatMessageRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SendChatMessageResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.userOssBucket)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setWorkspaceCodePublishSettingWithOptions(_ request: SetWorkspaceCodePublishSettingRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SetWorkspaceCodePublishSettingResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.workspaceId)) {
            query["WorkspaceId"] = request.workspaceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SetWorkspaceCodePublishSettingResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setWorkspaceCodePublishSetting(_ request: SetWorkspaceCodePublishSettingRequest) async throws -> SetWorkspaceCodePublishSettingResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await setWorkspaceCodePublishSettingWithOptions(request as! SetWorkspaceCodePublishSettingRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setWorkspaceQuotaWithOptions(_ request: SetWorkspaceQuotaRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SetWorkspaceQuotaResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        if (!TeaUtils.Client.isUnset(request.cuQuota)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SetWorkspaceQuotaResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setWorkspaceQuota(_ request: SetWorkspaceQuotaRequest) async throws -> SetWorkspaceQuotaResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await setWorkspaceQuotaWithOptions(request as! SetWorkspaceQuotaRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func startDataAgentAccuracyTestTaskWithOptions(_ request: StartDataAgentAccuracyTestTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StartDataAgentAccuracyTestTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestInsId)) {
            query["AccuracyTestInsId"] = request.accuracyTestInsId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.csvFile)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StartDataAgentAccuracyTestTaskResponse(), tmp)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopDataAgentAccuracyTestTaskWithOptions(_ request: StopDataAgentAccuracyTestTaskRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> StopDataAgentAccuracyTestTaskResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestTaskId)) {
            query["AccuracyTestTaskId"] = request.accuracyTestTaskId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(StopDataAgentAccuracyTestTaskResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func stopDataAgentAccuracyTestTask(_ request: StopDataAgentAccuracyTestTaskRequest) async throws -> StopDataAgentAccuracyTestTaskResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await stopDataAgentAccuracyTestTaskWithOptions(request as! StopDataAgentAccuracyTestTaskRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateDataAgentAccuracyTestWithOptions(_ request: UpdateDataAgentAccuracyTestRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateDataAgentAccuracyTestResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.accuracyTestInsId)) {
            query["AccuracyTestInsId"] = request.accuracyTestInsId ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.customerAgentId)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateDataAgentAccuracyTestResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateDataAgentAccuracyTest(_ request: UpdateDataAgentAccuracyTestRequest) async throws -> UpdateDataAgentAccuracyTestResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateDataAgentAccuracyTestWithOptions(request as! UpdateDataAgentAccuracyTestRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateDataAgentMemoryWithOptions(_ request: UpdateDataAgentMemoryRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateDataAgentMemoryResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.content)) {
            query["Content"] = request.content ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpdateDataAgentMemoryResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateDataAgentMemory(_ request: UpdateDataAgentMemoryRequest) async throws -> UpdateDataAgentMemoryResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateDataAgentMemoryWithOptions(request as! UpdateDataAgentMemoryRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateDocumentWithOptions(_ request: UpdateDocumentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateDocumentResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.documentName)) {
            body["DocumentName"] = request.documentName ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateDocument(_ request: UpdateDocumentRequest) async throws -> UpdateDocumentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await updateDocumentWithOptions(request as! UpdateDocumentRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func updateKnowledgeBaseWithOptions(_ request: UpdateKnowledgeBaseRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpdateKnowledgeBaseResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.description_)) {
            query["Description"] = request.description_ ?? "";
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func uploadDocumentWithOptions(_ tmpReq: UploadDocumentRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UploadDocumentResponse {
        try TeaUtils.Client.validateModel(tmpReq)
        var request: UploadDocumentShrinkRequest = UploadDocumentShrinkRequest([:])
        AlibabaCloudOpenApiUtil.Client.convert(tmpReq, request)
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func uploadDocument(_ request: UploadDocumentRequest) async throws -> UploadDocumentResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await uploadDocumentWithOptions(request as! UploadDocumentRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func upsertDocumentChunksWithOptions(_ request: UpsertDocumentChunksRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> UpsertDocumentChunksResponse {
        try TeaUtils.Client.validateModel(request)
        var body: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(UpsertDocumentChunksResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func upsertDocumentChunks(_ request: UpsertDocumentChunksRequest) async throws -> UpsertDocumentChunksResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await upsertDocumentChunksWithOptions(request as! UpsertDocumentChunksRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func workspaceActionLogWithOptions(_ request: WorkspaceActionLogRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> WorkspaceActionLogResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(WorkspaceActionLogResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func workspaceActionLog(_ request: WorkspaceActionLogRequest) async throws -> WorkspaceActionLogResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await workspaceActionLogWithOptions(request as! WorkspaceActionLogRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func workspaceActionStatusWithOptions(_ request: WorkspaceActionStatusRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> WorkspaceActionStatusResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.key)) {
            query["Key"] = request.key ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(WorkspaceActionStatusResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func workspaceActionStatus(_ request: WorkspaceActionStatusRequest) async throws -> WorkspaceActionStatusResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await workspaceActionStatusWithOptions(request as! WorkspaceActionStatusRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func workspaceCodePublishWithOptions(_ request: WorkspaceCodePublishRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> WorkspaceCodePublishResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.workspaceId)) {
            query["WorkspaceId"] = request.workspaceId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(WorkspaceCodePublishResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func workspaceCodePublish(_ request: WorkspaceCodePublishRequest) async throws -> WorkspaceCodePublishResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await workspaceCodePublishWithOptions(request as! WorkspaceCodePublishRequest, runtime as! TeaUtils.RuntimeOptions)
    }
}
