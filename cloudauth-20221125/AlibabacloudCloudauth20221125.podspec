Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudCloudauth20221125"
  spec.version      = "1.2.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ID Verification (20221125) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/cloudauth-20221125" 
