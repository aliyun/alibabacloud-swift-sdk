...
public class DescribeGroupsResponseBody : Tea.TeaModel {
    public class Groups : Tea.TeaModel {
        ...
        public var downloadNeedApproval: Bool?
        ...
        public var uploadNeedApproval: Bool?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.downloadNeedApproval != nil {
                map["DownloadNeedApproval"] = self.downloadNeedApproval!
            }
            if self.groupId != nil {
                map["GroupId"] = self.groupId!
            }
            ...
            if self.uploadNeedApproval != nil {
                map["UploadNeedApproval"] = self.uploadNeedApproval!
            }
            if self.userCount != nil {
                map["UserCount"] = self.userCount!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["DownloadNeedApproval"] as? Bool {
                self.downloadNeedApproval = value
            }
            if let value = dict["GroupId"] as? String {
                self.groupId = value
            }
            ...
            if let value = dict["UploadNeedApproval"] as? Bool {
                self.uploadNeedApproval = value
            }
...
public class DescribeOrgsResponseBody : Tea.TeaModel {
    public class Orgs : Tea.TeaModel {
        public class ResourcePolicyList : Tea.TeaModel {
            public var policyId: String?
        ...
        public var resourcePolicyList: [DescribeOrgsResponseBody.Orgs.ResourcePolicyList]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.resourcePolicyList != nil {
                var tmp : [Any] = []
                for k in self.resourcePolicyList! {
                    tmp.append(k.toMap())
                }
                map["ResourcePolicyList"] = tmp
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ResourcePolicyList"] as? [Any?] {
                var tmp : [DescribeOrgsResponseBody.Orgs.ResourcePolicyList] = []
                for v in value {
                    if v != nil {
                        var model = DescribeOrgsResponseBody.Orgs.ResourcePolicyList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class DescribeUserRequest : Tea.TeaModel {
    public var businessChannel: String?

    public var endUserId: String?

    public var requireExtraAttributes: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.requireExtraAttributes != nil {
            map["RequireExtraAttributes"] = self.requireExtraAttributes!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["RequireExtraAttributes"] as? [String] {
            self.requireExtraAttributes = value
        }
    }
}

public class DescribeUserResponseBody : Tea.TeaModel {
    public class User : Tea.TeaModel {
        ...
        public var externalInfo: DescribeUserResponseBody.User.ExternalInfo?
        ...
        public var properties: [DescribeUserResponseBody.User.Properties]?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.orgPaths != nil {
                map["OrgPaths"] = self.orgPaths!
            }
            if self.phone != nil {
                map["Phone"] = self.phone!
            }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ExternalInfo"] as? [String: Any?] {
                var model = DescribeUserResponseBody.User.ExternalInfo()
                model.fromMap(value)
            ...
            if let value = dict["OrgPaths"] as? [String] {
                self.orgPaths = value
            }
            if let value = dict["Phone"] as? String {
                self.phone = value
            ...
            if let value = dict["Properties"] as? [Any?] {
                var tmp : [DescribeUserResponseBody.User.Properties] = []
                for v in value {
                    if v != nil {
                        var model = DescribeUserResponseBody.User.Properties()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
    ...
    public var user: DescribeUserResponseBody.User?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["User"] as? [String: Any?] {
            var model = DescribeUserResponseBody.User()
            model.fromMap(value)
            self.user = model
        }
    }
...
public class DescribeUserResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DescribeUserResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DescribeUserResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DescribeUsersResponseBody : Tea.TeaModel {
    public class Users : Tea.TeaModel {
        public class Extras : Tea.TeaModel {
            ...
            public var resourcePolicyList: [DescribeUsersResponseBody.Users.Extras.ResourcePolicyList]?
            ...
            public override func fromMap(_ dict: [String: Any?]?) -> Void {
                ...
                if let value = dict["ResourcePolicyList"] as? [Any?] {
                    var tmp : [DescribeUsersResponseBody.Users.Extras.ResourcePolicyList] = []
                    for v in value {
                        if v != nil {
                            var model = DescribeUsersResponseBody.Users.Extras.ResourcePolicyList()
                            if v != nil {
                                model.fromMap(v as? [String: Any?])
                            }
                            tmp.append(model)
...
public class FilterUsersRequest : Tea.TeaModel {
    ...
    public var showExtras: [String: String]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["ShowExtras"] as? [String: String] {
            self.showExtras = value
        }
        if let value = dict["Status"] as? Int32 {
            self.status = value
...
public class FilterUsersResponseBody : Tea.TeaModel {
    public class Users : Tea.TeaModel {
        ...
        public var resourcePolicyList: [FilterUsersResponseBody.Users.ResourcePolicyList]?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ResourcePolicyList"] as? [Any?] {
                var tmp : [FilterUsersResponseBody.Users.ResourcePolicyList] = []
                for v in value {
                    if v != nil {
                        var model = FilterUsersResponseBody.Users.ResourcePolicyList()
                        if v != nil {
                            model.fromMap(v as? [String: Any?])
                        }
                        tmp.append(model)
...
public class GetAdUsersCountRequest : Tea.TeaModel {
    public var bizType: String?
...
public class GetAdUsersCountResponseBody : Tea.TeaModel {
    public var adUserCount: Int32?
    ...
    public override func toMap() -> [String : Any] {
        var map = super.toMap()
        if self.adUserCount != nil {
            map["AdUserCount"] = self.adUserCount!
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["AdUserCount"] as? Int32 {
            self.adUserCount = value
        }
        if let value = dict["RequestId"] as? String {
            self.requestId = value
        }
...
public class GetAdUsersCountResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetAdUsersCountResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetAdUsersCountResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class GetUsersCountRequest : Tea.TeaModel {
    public var bizType: String?
...
public class GetUsersCountResponseBody : Tea.TeaModel {
    public var groupCount: Int32?

    public var maxUserNumber: Int32?

    public var orgCount: Int32?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.maxUserNumber != nil {
            map["MaxUserNumber"] = self.maxUserNumber!
        }
        if self.orgCount != nil {
            map["OrgCount"] = self.orgCount!
        }
        if self.requestId != nil {
            map["RequestId"] = self.requestId!
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["MaxUserNumber"] as? Int32 {
            self.maxUserNumber = value
        }
        if let value = dict["OrgCount"] as? Int32 {
            self.orgCount = value
        }
        if let value = dict["RequestId"] as? String {
            self.requestId = value
...
public class GetUsersCountResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetUsersCountResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = GetUsersCountResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class TransferResourcesIntoGroupRequest : Tea.TeaModel {
    ...
    public var resources: [TransferResourcesIntoGroupRequest.Resources]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Resources"] as? [Any?] {
            var tmp : [TransferResourcesIntoGroupRequest.Resources] = []
            for v in value {
                if v != nil {
                    var model = TransferResourcesIntoGroupRequest.Resources()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class TransferResourcesIntoGroupResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class TransferResourcesIntoGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: TransferResourcesIntoGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = TransferResourcesIntoGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class TransferResourcesOutofGroupRequest : Tea.TeaModel {
    public class Resources : Tea.TeaModel {
        public var regionId: String?
    ...
    public var resources: [TransferResourcesOutofGroupRequest.Resources]?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Resources"] as? [Any?] {
            var tmp : [TransferResourcesOutofGroupRequest.Resources] = []
            for v in value {
                if v != nil {
                    var model = TransferResourcesOutofGroupRequest.Resources()
                    if v != nil {
                        model.fromMap(v as? [String: Any?])
                    }
                    tmp.append(model)
...
public class TransferResourcesOutofGroupResponseBody : Tea.TeaModel {
    public var requestId: String?
...
public class TransferResourcesOutofGroupResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: TransferResourcesOutofGroupResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = TransferResourcesOutofGroupResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
