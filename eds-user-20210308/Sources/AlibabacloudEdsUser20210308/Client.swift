...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func describeGroupsWithOptions(_ request: DescribeGroupsRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeGroupsResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.transferFileNeedApproval)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeUserWithOptions(_ request: DescribeUserRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeUserResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.businessChannel)) {
            query["BusinessChannel"] = request.businessChannel ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.requireExtraAttributes)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(DescribeUserResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func describeUser(_ request: DescribeUserRequest) async throws -> DescribeUserResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await describeUserWithOptions(request as! DescribeUserRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func describeUsersWithOptions(_ tmpReq: DescribeUsersRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeUsersResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.excludeGroupId)) {
    ...
    public func filterUsersWithOptions(_ tmpReq: FilterUsersRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> FilterUsersResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.showExtras)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAdUsersCountWithOptions(_ request: GetAdUsersCountRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAdUsersCountResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.businessChannel)) {
            query["BusinessChannel"] = request.businessChannel ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAdUsersCountResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAdUsersCount(_ request: GetAdUsersCountRequest) async throws -> GetAdUsersCountResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAdUsersCountWithOptions(request as! GetAdUsersCountRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getUsersCountWithOptions(_ request: GetUsersCountRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetUsersCountResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.businessChannel)) {
            query["BusinessChannel"] = request.businessChannel ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetUsersCountResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getUsersCount(_ request: GetUsersCountRequest) async throws -> GetUsersCountResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getUsersCountWithOptions(request as! GetUsersCountRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func transferResourcesIntoGroupWithOptions(_ request: TransferResourcesIntoGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> TransferResourcesIntoGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.businessChannel)) {
            query["BusinessChannel"] = request.businessChannel ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TransferResourcesIntoGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func transferResourcesIntoGroup(_ request: TransferResourcesIntoGroupRequest) async throws -> TransferResourcesIntoGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await transferResourcesIntoGroupWithOptions(request as! TransferResourcesIntoGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func transferResourcesOutofGroupWithOptions(_ request: TransferResourcesOutofGroupRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> TransferResourcesOutofGroupResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.businessChannel)) {
            query["BusinessChannel"] = request.businessChannel ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(TransferResourcesOutofGroupResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func transferResourcesOutofGroup(_ request: TransferResourcesOutofGroupRequest) async throws -> TransferResourcesOutofGroupResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await transferResourcesOutofGroupWithOptions(request as! TransferResourcesOutofGroupRequest, runtime as! TeaUtils.RuntimeOptions)
    }
