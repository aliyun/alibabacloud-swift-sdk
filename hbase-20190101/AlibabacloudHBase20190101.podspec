Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudHBase20190101"
  spec.version      = "1.1.4"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud ApsaraDB for Hbase (20190101) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/hbase-20190101" 
