Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudServicecatalog20210901"
  spec.version      = "1.0.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud servicecatalog (20210901) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/servicecatalog-20210901" 
