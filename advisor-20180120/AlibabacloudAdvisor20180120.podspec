Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudAdvisor20180120"
  spec.version      = "1.1.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud Intelligent Advisor (20180120) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/advisor-20180120" 
