...
public class SegmentVideoBodyRequest : Tea.TeaModel {
...
public class SegmentVideoBodyAdvanceRequest : Tea.TeaModel {
...
public class SegmentVideoBodyResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        public var videoUrl: String?
    ...
    public var data: SegmentVideoBodyResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        if dict.keys.contains("Data") {
            var model = SegmentVideoBodyResponseBody.Data()
            model.fromMap(dict["Data"] as! [String: Any])
            self.data = model
        }
...
public class SegmentVideoBodyResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: SegmentVideoBodyResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("body") {
            var model = SegmentVideoBodyResponseBody()
            model.fromMap(dict["body"] as! [String: Any])
            self.body = model
        }
    }
