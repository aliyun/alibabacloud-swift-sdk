...
public class GetExpressConnectRouterRequest : Tea.TeaModel {
    public var clientToken: String?
...
public class GetExpressConnectRouterResponseBody : Tea.TeaModel {
    public class Tags : Tea.TeaModel {
        public var aliUid: Int64?
    ...
    public var tags: [GetExpressConnectRouterResponseBody.Tags]?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("Tags") && dict["Tags"] != nil {
            var tmp : [GetExpressConnectRouterResponseBody.Tags] = []
            for v in dict["Tags"] as! [Any] {
                var model = GetExpressConnectRouterResponseBody.Tags()
                if v != nil {
                    model.fromMap(v as! [String: Any])
                }
                tmp.append(model)
...
public class GetExpressConnectRouterResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: GetExpressConnectRouterResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any]) -> Void {
        ...
        if dict.keys.contains("body") && dict["body"] != nil {
            var model = GetExpressConnectRouterResponseBody()
            model.fromMap(dict["body"] as! [String: Any])
            self.body = model
        }
    }
