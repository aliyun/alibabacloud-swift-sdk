...
open class Client : AlibabacloudOpenApi.Client {
    ...
    public func describeVodDomainCertificateInfoWithOptions(_ request: DescribeVodDomainCertificateInfoRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> DescribeVodDomainCertificateInfoResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.heraApiAutoVersion)) {
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAppPlayKeyWithOptions(_ request: GetAppPlayKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> GetAppPlayKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.appId)) {
            query["AppId"] = request.appId ?? "";
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(GetAppPlayKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func getAppPlayKey(_ request: GetAppPlayKeyRequest) async throws -> GetAppPlayKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await getAppPlayKeyWithOptions(request as! GetAppPlayKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setAppPlayKeyWithOptions(_ request: SetAppPlayKeyRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SetAppPlayKeyResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.appId)) {
            query["AppId"] = request.appId ?? "";
        ...
        if (!TeaUtils.Client.isUnset(request.playKey)) {
        ...
        var tmp: [String: Any] = try await callApi(params as! AlibabacloudOpenApi.Params, req as! AlibabacloudOpenApi.OpenApiRequest, runtime as! TeaUtils.RuntimeOptions)
        return Tea.TeaConverter.fromMap(SetAppPlayKeyResponse(), tmp)
    }

    @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
    public func setAppPlayKey(_ request: SetAppPlayKeyRequest) async throws -> SetAppPlayKeyResponse {
        var runtime: TeaUtils.RuntimeOptions = TeaUtils.RuntimeOptions([:])
        return try await setAppPlayKeyWithOptions(request as! SetAppPlayKeyRequest, runtime as! TeaUtils.RuntimeOptions)
    }
    ...
    public func submitAIImageAuditJobWithOptions(_ request: SubmitAIImageAuditJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitAIImageAuditJobResponse {
        try TeaUtils.Client.validateModel(request)
        var query: [String: Any] = [:]
        if (!TeaUtils.Client.isUnset(request.censorProvider)) {
            query["CensorProvider"] = request.censorProvider ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.imageService)) {
    ...
    public func submitAIMediaAuditJobWithOptions(_ request: SubmitAIMediaAuditJobRequest, _ runtime: TeaUtils.RuntimeOptions) async throws -> SubmitAIMediaAuditJobResponse {
        ...
        if (!TeaUtils.Client.isUnset(request.videoService)) {
            query["VideoService"] = request.videoService ?? "";
        }
        if (!TeaUtils.Client.isUnset(request.voiceService)) {
