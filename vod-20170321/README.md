...
```ruby
pod 'AlibabacloudVod20170321', '~> 1.0.4'
```
...
```ogdl
github "alibabacloud-sdk-swift/vod-20170321" "1.0.4"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/vod-20170321.git", from: "1.0.4")
]
```
