...
public class DeleteFaceRecordV2Request : Tea.TeaModel {
    public var faceGroupCode: String?
...
public class DeleteFaceRecordV2ResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public var deleted: String?

        public var deletedGroupCodes: String?
        ...
        public override func toMap() -> [String : Any] {
            ...
            if self.deletedGroupCodes != nil {
                map["DeletedGroupCodes"] = self.deletedGroupCodes!
            }
            return map
        }
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["DeletedGroupCodes"] as? String {
                self.deletedGroupCodes = value
            }
        }
    }
    public var code: String?
    ...
    public var result: DeleteFaceRecordV2ResponseBody.Result?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Result"] as? [String: Any?] {
            var model = DeleteFaceRecordV2ResponseBody.Result()
            model.fromMap(value)
            self.result = model
        }
    }
...
public class DeleteFaceRecordV2Response : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DeleteFaceRecordV2ResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DeleteFaceRecordV2ResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class DocOcrV2AdvanceRequest : Tea.TeaModel {
    public var cardSide: String?
...
public class DocOcrV2ResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public var extIdInfo: String?
    ...
    public var result: DocOcrV2ResponseBody.Result?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Result"] as? [String: Any?] {
            var model = DocOcrV2ResponseBody.Result()
            model.fromMap(value)
            self.result = model
        }
    }
...
public class DocOcrV2Response : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DocOcrV2ResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DocOcrV2ResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class EkycVerifyV2Request : Tea.TeaModel {
    public var authorize: String?
...
public class EkycVerifyV2AdvanceRequest : Tea.TeaModel {
    public var authorize: String?
...
public class EkycVerifyV2ResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public var extFaceInfo: String?
    ...
    public var result: EkycVerifyV2ResponseBody.Result?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Result"] as? [String: Any?] {
            var model = EkycVerifyV2ResponseBody.Result()
            model.fromMap(value)
            self.result = model
        }
    }
...
public class EkycVerifyV2Response : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: EkycVerifyV2ResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = EkycVerifyV2ResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class FaceCompareResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        ...
        public var extFaceInfo: FaceCompareResponseBody.Result.ExtFaceInfo?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ExtFaceInfo"] as? [String: Any?] {
                var model = FaceCompareResponseBody.Result.ExtFaceInfo()
                model.fromMap(value)
...
public class FaceCompareV2Request : Tea.TeaModel {
    public var facePictureQualityCheck: String?
...
public class FaceCompareV2AdvanceRequest : Tea.TeaModel {
    public var facePictureQualityCheck: String?
...
public class FaceCompareV2ResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        public class ExtFaceInfo : Tea.TeaModel {
            public var faceQualityScore: Double?
        ...
        public var extFaceInfo: FaceCompareV2ResponseBody.Result.ExtFaceInfo?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            guard let dict else { return }
            if let value = dict["ExtFaceInfo"] as? [String: Any?] {
                var model = FaceCompareV2ResponseBody.Result.ExtFaceInfo()
                model.fromMap(value)
                self.extFaceInfo = model
            }
            if let value = dict["FaceComparisonScore"] as? Double {
    ...
    public var result: FaceCompareV2ResponseBody.Result?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Result"] as? [String: Any?] {
            var model = FaceCompareV2ResponseBody.Result()
            model.fromMap(value)
            self.result = model
        }
    }
...
public class FaceCompareV2Response : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: FaceCompareV2ResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = FaceCompareV2ResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
...
public class FaceDuplicationCheckIntlResponseBody : Tea.TeaModel {
    public class Result : Tea.TeaModel {
        ...
        public var extFaceInfo: FaceDuplicationCheckIntlResponseBody.Result.ExtFaceInfo?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["ExtFaceInfo"] as? [String: Any?] {
                var model = FaceDuplicationCheckIntlResponseBody.Result.ExtFaceInfo()
                model.fromMap(value)
                self.extFaceInfo = model
            }
