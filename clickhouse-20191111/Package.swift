...
let package = Package(
        name: "AlibabacloudClickhouse20191111",
        ...
        products: [
            .library(
                    name: "AlibabacloudClickhouse20191111",
                    targets: ["AlibabacloudClickhouse20191111"])
        ],
        dependencies: [
            ...
            .package(url: "https://github.com/alibabacloud-sdk-swift/darabonba-openapi", from: "1.0.6"),
