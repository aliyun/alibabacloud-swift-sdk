...
public class DocumentParseOnlineApiRequest : Tea.TeaModel {
...
public class DocumentParseOnlineApiResponseBody : Tea.TeaModel {
    public class Data : Tea.TeaModel {
        ...
        public var usage: DocumentParseOnlineApiResponseBody.Data.Usage?
        ...
        public override func fromMap(_ dict: [String: Any?]?) -> Void {
            ...
            if let value = dict["Usage"] as? [String: Any?] {
                var model = DocumentParseOnlineApiResponseBody.Data.Usage()
                model.fromMap(value)
                self.usage = model
            }
        }
    ...
    public var data: DocumentParseOnlineApiResponseBody.Data?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["Data"] as? [String: Any?] {
            var model = DocumentParseOnlineApiResponseBody.Data()
            model.fromMap(value)
            self.data = model
        }
...
public class DocumentParseOnlineApiResponse : Tea.TeaModel {
    public var headers: [String: String]?

    public var statusCode: Int32?

    public var body: DocumentParseOnlineApiResponseBody?
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["body"] as? [String: Any?] {
            var model = DocumentParseOnlineApiResponseBody()
            model.fromMap(value)
            self.body = model
        }
    }
