...
```ruby
pod 'AlibabacloudMse20190531', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/mse-20190531" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/mse-20190531.git", from: "1.0.0")
]
```
