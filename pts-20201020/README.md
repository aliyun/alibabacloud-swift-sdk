...
```ruby
pod 'AlibabacloudPTS20201020', '~> 1.0.0'
```
...
```ogdl
github "alibabacloud-sdk-swift/pts-20201020" "1.0.0"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/alibabacloud-sdk-swift/pts-20201020.git", from: "1.0.0")
]
```
