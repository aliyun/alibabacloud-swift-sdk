...
public class Function : Tea.TeaModel {
    ...
    public var lockInfo: FunctionLockInfo?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.lockInfo != nil {
            map["lockInfo"] = self.lockInfo?.toMap()
        }
        if self.logConfig != nil {
            map["logConfig"] = self.logConfig?.toMap()
        }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        ...
        if let value = dict["lockInfo"] as? [String: Any?] {
            var model = FunctionLockInfo()
            model.fromMap(value)
            self.lockInfo = model
        }
        if let value = dict["logConfig"] as? [String: Any?] {
...
public class FunctionLockInfo : Tea.TeaModel {
    public var lockedAt: String?

    public var lockedBy: String?

    public var lockedResources: [String]?
    ...
    public override func toMap() -> [String : Any] {
        ...
        if self.lockedAt != nil {
            map["lockedAt"] = self.lockedAt!
        }
        if self.lockedBy != nil {
            map["lockedBy"] = self.lockedBy!
        }
        if self.lockedResources != nil {
            map["lockedResources"] = self.lockedResources!
        }
        return map
    }
    ...
    public override func fromMap(_ dict: [String: Any?]?) -> Void {
        guard let dict else { return }
        if let value = dict["lockedAt"] as? String {
            self.lockedAt = value
        }
        if let value = dict["lockedBy"] as? String {
            self.lockedBy = value
        }
        if let value = dict["lockedResources"] as? [String] {
            self.lockedResources = value
        }
    }
}
...
public class ListSessionsOutput : Tea.TeaModel {
    public var nextToken: String?
...
public class CreateSessionRequest : Tea.TeaModel {
    public var body: CreateSessionInput?
...
public class CreateSnapshotRequest : Tea.TeaModel {
    public var body: CreateSnapshotInput?
...
public class ListSessionsResponse : Tea.TeaModel {
    ...
    public var body: ListSessionsOutput?
...
public class ListSnapshotsResponse : Tea.TeaModel {
    ...
    public var body: ListSnapshotsOutput?
...
public class PauseSessionResponse : Tea.TeaModel {
    public var headers: [String: String]?
...
public class ResumeSessionResponse : Tea.TeaModel {
    public var headers: [String: String]?
...
public class UpdateSessionRequest : Tea.TeaModel {
    public var body: UpdateSessionInput?
...
public class UpdateSessionResponse : Tea.TeaModel {
    public var headers: [String: String]?
