Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudOpenanalyticsOpen20180619"
  spec.version      = "1.0.0"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud openanalytics-open (20180619) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/openanalytics-open-20180619" 
