Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudAIPodcast20250228"
  spec.version      = "1.0.3"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud AIPodcast (20250228) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/aipodcast-20250228" 
