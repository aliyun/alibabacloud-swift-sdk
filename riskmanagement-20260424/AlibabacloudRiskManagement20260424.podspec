Pod::Spec.new do |spec|
  ...
  spec.name         = "AlibabacloudRiskManagement20260424"
  spec.version      = "1.1.1"
  spec.license      = "Apache 2.0"
  spec.summary      = "Alibaba Cloud RiskManagement (20260424) SDK Library for Swift"
  spec.homepage     = "https://github.com/alibabacloud-sdk-swift/riskmanagement-20260424" 
